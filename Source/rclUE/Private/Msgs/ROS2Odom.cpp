...
void UROS2OdomMsg::Init() { nav_msgs__msg__Odometry__init(&odometry_msg); }

void UROS2OdomMsg::Fini() { nav_msgs__msg__Odometry__fini(&odometry_msg); }
...
void *UROS2OdomMsg::Get() { return &odometry_msg; }
