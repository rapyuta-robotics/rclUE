...
void UROS2VerticesMsg::Init() { pcl_msgs__msg__Vertices__init(&vertices_msg); }

void UROS2VerticesMsg::Fini() { pcl_msgs__msg__Vertices__fini(&vertices_msg); }
...
void *UROS2VerticesMsg::Get() { return &vertices_msg; }
