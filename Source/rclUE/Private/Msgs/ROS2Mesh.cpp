...
void UROS2MeshMsg::Init() { shape_msgs__msg__Mesh__init(&mesh_msg); }

void UROS2MeshMsg::Fini() { shape_msgs__msg__Mesh__fini(&mesh_msg); }
...
void UROS2MeshMsg::SetMsg(const FROSMesh &Inputs) { Inputs.SetROS2(mesh_msg); }

void UROS2MeshMsg::GetMsg(FROSMesh &Outputs) const {
  Outputs.SetFromROS2(mesh_msg);
}

void *UROS2MeshMsg::Get() { return &mesh_msg; }
