...
void UROS2JoyMsg::Init() { sensor_msgs__msg__Joy__init(&joy_msg); }

void UROS2JoyMsg::Fini() { sensor_msgs__msg__Joy__fini(&joy_msg); }
...
void UROS2JoyMsg::SetMsg(const FROSJoy &Inputs) { Inputs.SetROS2(joy_msg); }

void UROS2JoyMsg::GetMsg(FROSJoy &Outputs) const {
  Outputs.SetFromROS2(joy_msg);
}

void *UROS2JoyMsg::Get() { return &joy_msg; }
