...
void UROS2ImuMsg::Init() { sensor_msgs__msg__Imu__init(&imu_msg); }

void UROS2ImuMsg::Fini() { sensor_msgs__msg__Imu__fini(&imu_msg); }
...
void UROS2ImuMsg::SetMsg(const FROSImu &Inputs) { Inputs.SetROS2(imu_msg); }

void UROS2ImuMsg::GetMsg(FROSImu &Outputs) const {
  Outputs.SetFromROS2(imu_msg);
}

void *UROS2ImuMsg::Get() { return &imu_msg; }
