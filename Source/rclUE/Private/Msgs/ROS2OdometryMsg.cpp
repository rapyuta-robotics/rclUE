...
void UROS2OdometryMsg::Update(const FOdometryData data)
{
    ...
    memcpy(odometry_pub_msg.header.frame_id.data, TCHAR_TO_ANSI(*data.frame_id), (data.frame_id.Len()+1)*sizeof(char));
    ...
    memcpy(odometry_pub_msg.child_frame_id.data, TCHAR_TO_ANSI(*data.child_frame_id), (data.child_frame_id.Len()+1)*sizeof(char));
