...
void UROS2ByteMsg::Init() { example_interfaces__msg__Byte__init(&byte_msg); }

void UROS2ByteMsg::Fini() { example_interfaces__msg__Byte__fini(&byte_msg); }
...
void UROS2ByteMsg::SetMsg(const FROSByte &Inputs) { Inputs.SetROS2(byte_msg); }

void UROS2ByteMsg::GetMsg(FROSByte &Outputs) const {
  Outputs.SetFromROS2(byte_msg);
}

void *UROS2ByteMsg::Get() { return &byte_msg; }
