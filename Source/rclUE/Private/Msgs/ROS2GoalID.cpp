...
void UROS2GoalIDMsg::Init() { actionlib_msgs__msg__GoalID__init(&goal_id_msg); }

void UROS2GoalIDMsg::Fini() { actionlib_msgs__msg__GoalID__fini(&goal_id_msg); }
...
void *UROS2GoalIDMsg::Get() { return &goal_id_msg; }
