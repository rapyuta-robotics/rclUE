...
void UROS2PoseMsg::Init() { geometry_msgs__msg__Pose__init(&pose_msg); }

void UROS2PoseMsg::Fini() { geometry_msgs__msg__Pose__fini(&pose_msg); }
...
void UROS2PoseMsg::SetMsg(const FROSPose &Inputs) { Inputs.SetROS2(pose_msg); }

void UROS2PoseMsg::GetMsg(FROSPose &Outputs) const {
  Outputs.SetFromROS2(pose_msg);
}

void *UROS2PoseMsg::Get() { return &pose_msg; }
