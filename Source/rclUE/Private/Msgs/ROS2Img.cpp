...
void UROS2ImgMsg::Init() { sensor_msgs__msg__Image__init(&image_msg); }

void UROS2ImgMsg::Fini() { sensor_msgs__msg__Image__fini(&image_msg); }
...
void UROS2ImgMsg::SetMsg(const FROSImg &Inputs) { Inputs.SetROS2(image_msg); }

void UROS2ImgMsg::GetMsg(FROSImg &Outputs) const {
  Outputs.SetFromROS2(image_msg);
}

void *UROS2ImgMsg::Get() { return &image_msg; }
