...
UROS2MultiDOFJointTrajPointMsg::GetTypeSupport() const {
  return ROSIDL_GET_MSG_TYPE_SUPPORT(trajectory_msgs, msg,
                                     MultiDOFJointTrajectoryPoint);
}

void UROS2MultiDOFJointTrajPointMsg::SetMsg(
    const FROSMultiDOFJointTrajPoint &Inputs) {
  Inputs.SetROS2(multi_dof_joint_trajectory_point_msg);
}

void UROS2MultiDOFJointTrajPointMsg::GetMsg(
    FROSMultiDOFJointTrajPoint &Outputs) const {
