...
void UROS2PathMsg::Init() { nav_msgs__msg__Path__init(&path_msg); }

void UROS2PathMsg::Fini() { nav_msgs__msg__Path__fini(&path_msg); }
...
void UROS2PathMsg::SetMsg(const FROSPath &Inputs) { Inputs.SetROS2(path_msg); }

void UROS2PathMsg::GetMsg(FROSPath &Outputs) const {
  Outputs.SetFromROS2(path_msg);
}

void *UROS2PathMsg::Get() { return &path_msg; }
