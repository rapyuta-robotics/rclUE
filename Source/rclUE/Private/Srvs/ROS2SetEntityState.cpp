...
UROS2SetEntityStateSrv::GetTypeSupport() const {
...
void UROS2SetEntityStateSrv::SetResponse(
    const FROSSetEntityStateRes &Response) {
  Response.SetROS2(SetEntityState_res);
}

void UROS2SetEntityStateSrv::GetResponse(
    FROSSetEntityStateRes &Response) const {
  Response.SetFromROS2(SetEntityState_res);
}

void *UROS2SetEntityStateSrv::GetRequest() { return &SetEntityState_req; }

void *UROS2SetEntityStateSrv::GetResponse() { return &SetEntityState_res; }
