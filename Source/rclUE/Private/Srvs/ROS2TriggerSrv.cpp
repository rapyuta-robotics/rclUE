...
void UROS2TriggerSrv::SetRequest(const FROSTrigger_Request& Request)
{
    Request.SetROS2(Trigger_req);
}

void UROS2TriggerSrv::GetRequest(FROSTrigger_Request& Request) const
{
    Request.SetFromROS2(Trigger_req);
}

void UROS2TriggerSrv::SetResponse(const FROSTrigger_Response& Response)
{
    Response.SetROS2(Trigger_res);
}

void UROS2TriggerSrv::GetResponse(FROSTrigger_Response& Response) const
{
