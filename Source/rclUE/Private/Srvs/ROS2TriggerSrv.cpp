...
void UROS2TriggerSrv::SetRequest(const FROSTriggerRequest& Request)
{
    Request.SetROS2(Trigger_req);
}

void UROS2TriggerSrv::GetRequest(FROSTriggerRequest& Request) const
{
    Request.SetFromROS2(Trigger_req);
}

void UROS2TriggerSrv::SetResponse(const FROSTriggerResponse& Response)
{
    Response.SetROS2(Trigger_res);
}

void UROS2TriggerSrv::GetResponse(FROSTriggerResponse& Response) const
{
