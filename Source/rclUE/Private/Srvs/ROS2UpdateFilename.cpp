...
UROS2UpdateFilenameSrv::GetTypeSupport() const {
...
void UROS2UpdateFilenameSrv::SetResponse(
    const FROSUpdateFilenameRes &Response) {
  Response.SetROS2(UpdateFilename_res);
}

void UROS2UpdateFilenameSrv::GetResponse(
    FROSUpdateFilenameRes &Response) const {
  Response.SetFromROS2(UpdateFilename_res);
}

void *UROS2UpdateFilenameSrv::GetRequest() { return &UpdateFilename_req; }

void *UROS2UpdateFilenameSrv::GetResponse() { return &UpdateFilename_res; }
