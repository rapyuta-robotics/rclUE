...
void UROS2GetInt32FromIdSrv::SetRequest(const FROSGetInt32FromId_Request& Request)
{
    Request.SetROS2(GetInt32FromId_req);
}

void UROS2GetInt32FromIdSrv::GetRequest(FROSGetInt32FromId_Request& Request) const
{
    Request.SetFromROS2(GetInt32FromId_req);
}

void UROS2GetInt32FromIdSrv::SetResponse(const FROSGetInt32FromId_Response& Response)
{
    Response.SetROS2(GetInt32FromId_res);
}

void UROS2GetInt32FromIdSrv::GetResponse(FROSGetInt32FromId_Response& Response) const
{
