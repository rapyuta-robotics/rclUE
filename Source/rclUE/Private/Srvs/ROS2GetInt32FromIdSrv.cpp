...
#include "Srvs/ROS2GetInt32FromIdSrv.h"
...
void UROS2GetInt32FromIdSrv::SetRequest(const FROSGetInt32FromIdRequest& Request)
{
    Request.SetROS2(GetInt32FromId_req);
}

void UROS2GetInt32FromIdSrv::GetRequest(FROSGetInt32FromIdRequest& Request) const
{
    Request.SetFromROS2(GetInt32FromId_req);
}

void UROS2GetInt32FromIdSrv::SetResponse(const FROSGetInt32FromIdResponse& Response)
{
    Response.SetROS2(GetInt32FromId_res);
}

void UROS2GetInt32FromIdSrv::GetResponse(FROSGetInt32FromIdResponse& Response) const
{
