...
void UROS2GetPlanSrv::SetRequest(const FROSGetPlanRequest& Request)
{
    Request.SetROS2(GetPlan_req);
}

void UROS2GetPlanSrv::GetRequest(FROSGetPlanRequest& Request) const
{
    Request.SetFromROS2(GetPlan_req);
}

void UROS2GetPlanSrv::SetResponse(const FROSGetPlanResponse& Response)
{
    Response.SetROS2(GetPlan_res);
}

void UROS2GetPlanSrv::GetResponse(FROSGetPlanResponse& Response) const
{
