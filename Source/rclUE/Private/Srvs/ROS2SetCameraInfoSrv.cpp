...
void UROS2SetCameraInfoSrv::SetRequest(const FROSSetCameraInfoRequest& Request)
{
    Request.SetROS2(SetCameraInfo_req);
}

void UROS2SetCameraInfoSrv::GetRequest(FROSSetCameraInfoRequest& Request) const
{
    Request.SetFromROS2(SetCameraInfo_req);
}

void UROS2SetCameraInfoSrv::SetResponse(const FROSSetCameraInfoResponse& Response)
{
    Response.SetROS2(SetCameraInfo_res);
}

void UROS2SetCameraInfoSrv::GetResponse(FROSSetCameraInfoResponse& Response) const
{
