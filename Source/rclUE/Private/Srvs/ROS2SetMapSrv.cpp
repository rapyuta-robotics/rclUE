...
void UROS2SetMapSrv::SetRequest(const FROSSetMapRequest& Request)
{
    Request.SetROS2(SetMap_req);
}

void UROS2SetMapSrv::GetRequest(FROSSetMapRequest& Request) const
{
    Request.SetFromROS2(SetMap_req);
}

void UROS2SetMapSrv::SetResponse(const FROSSetMapResponse& Response)
{
    Response.SetROS2(SetMap_res);
}

void UROS2SetMapSrv::GetResponse(FROSSetMapResponse& Response) const
{
