...
void UROS2AttachSrv::SetRequest(const FROSAttachRequest& Request)
{
    Request.SetROS2(Attach_req);
}

void UROS2AttachSrv::GetRequest(FROSAttachRequest& Request) const
{
    Request.SetFromROS2(Attach_req);
}

void UROS2AttachSrv::SetResponse(const FROSAttachResponse& Response)
{
    Response.SetROS2(Attach_res);
}

void UROS2AttachSrv::GetResponse(FROSAttachResponse& Response) const
{
