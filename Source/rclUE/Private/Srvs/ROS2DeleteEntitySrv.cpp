...
void UROS2DeleteEntitySrv::GetRequest(FROSDeleteEntity_Request& Request) const
{
...
void UROS2DeleteEntitySrv::GetResponse(FROSDeleteEntity_Response& Response) const
{
