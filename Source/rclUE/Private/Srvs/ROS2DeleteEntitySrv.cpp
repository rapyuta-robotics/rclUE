...
void UROS2DeleteEntitySrv::SetRequest(const FROSDeleteEntityRequest& Request)
{
    Request.SetROS2(DeleteEntity_req);
}

void UROS2DeleteEntitySrv::GetRequest(FROSDeleteEntityRequest& Request) const
{
    Request.SetFromROS2(DeleteEntity_req);
}

void UROS2DeleteEntitySrv::SetResponse(const FROSDeleteEntityResponse& Response)
{
    Response.SetROS2(DeleteEntity_res);
}

void UROS2DeleteEntitySrv::GetResponse(FROSDeleteEntityResponse& Response) const
{
