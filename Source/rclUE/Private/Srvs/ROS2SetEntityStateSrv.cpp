...
void UROS2SetEntityStateSrv::GetRequest(FROSSetEntityState_Request& Request) const
{
...
void UROS2SetEntityStateSrv::GetResponse(FROSSetEntityState_Response& Response) const
{
