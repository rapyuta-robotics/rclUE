...
void UROS2GetBoolFromIdSrv::SetRequest(const FROSGetBoolFromIdRequest& Request)
{
    Request.SetROS2(GetBoolFromId_req);
}

void UROS2GetBoolFromIdSrv::GetRequest(FROSGetBoolFromIdRequest& Request) const
{
    Request.SetFromROS2(GetBoolFromId_req);
}

void UROS2GetBoolFromIdSrv::SetResponse(const FROSGetBoolFromIdResponse& Response)
{
    Response.SetROS2(GetBoolFromId_res);
}

void UROS2GetBoolFromIdSrv::GetResponse(FROSGetBoolFromIdResponse& Response) const
{
