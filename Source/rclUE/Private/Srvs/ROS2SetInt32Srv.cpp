...
void UROS2SetInt32Srv::SetRequest(const FROSSetInt32Request& Request)
{
    Request.SetROS2(SetInt32_req);
}

void UROS2SetInt32Srv::GetRequest(FROSSetInt32Request& Request) const
{
    Request.SetFromROS2(SetInt32_req);
}

void UROS2SetInt32Srv::SetResponse(const FROSSetInt32Response& Response)
{
    Response.SetROS2(SetInt32_res);
}

void UROS2SetInt32Srv::GetResponse(FROSSetInt32Response& Response) const
{
