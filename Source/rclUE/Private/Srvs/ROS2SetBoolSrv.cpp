...
void UROS2SetBoolSrv::SetRequest(const FROSSetBoolRequest& Request)
{
    Request.SetROS2(SetBool_req);
}

void UROS2SetBoolSrv::GetRequest(FROSSetBoolRequest& Request) const
{
    Request.SetFromROS2(SetBool_req);
}

void UROS2SetBoolSrv::SetResponse(const FROSSetBoolResponse& Response)
{
    Response.SetROS2(SetBool_res);
}

void UROS2SetBoolSrv::GetResponse(FROSSetBoolResponse& Response) const
{
