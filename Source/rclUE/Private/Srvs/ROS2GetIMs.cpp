...
const rosidl_service_type_support_t *UROS2GetIMsSrv::GetTypeSupport() const {
  return ROSIDL_GET_SRV_TYPE_SUPPORT(visualization_msgs, srv,
...
void *UROS2GetIMsSrv::GetRequest() { return &GetInteractiveMarkers_req; }

void *UROS2GetIMsSrv::GetResponse() { return &GetInteractiveMarkers_res; }
