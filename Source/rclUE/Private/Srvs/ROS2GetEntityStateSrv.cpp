...
void UROS2GetEntityStateSrv::SetRequest(const FROSGetEntityStateRequest& Request)
{
    Request.SetROS2(GetEntityState_req);
}

void UROS2GetEntityStateSrv::GetRequest(FROSGetEntityStateRequest& Request) const
{
    Request.SetFromROS2(GetEntityState_req);
}

void UROS2GetEntityStateSrv::SetResponse(const FROSGetEntityStateResponse& Response)
{
    Response.SetROS2(GetEntityState_res);
}

void UROS2GetEntityStateSrv::GetResponse(FROSGetEntityStateResponse& Response) const
{
