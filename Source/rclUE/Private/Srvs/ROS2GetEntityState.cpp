...
UROS2GetEntityStateSrv::GetTypeSupport() const {
...
void UROS2GetEntityStateSrv::SetResponse(
    const FROSGetEntityStateRes &Response) {
  Response.SetROS2(GetEntityState_res);
}

void UROS2GetEntityStateSrv::GetResponse(
    FROSGetEntityStateRes &Response) const {
  Response.SetFromROS2(GetEntityState_res);
}

void *UROS2GetEntityStateSrv::GetRequest() { return &GetEntityState_req; }

void *UROS2GetEntityStateSrv::GetResponse() { return &GetEntityState_res; }
