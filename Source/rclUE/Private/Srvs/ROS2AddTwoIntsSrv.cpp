...
void UROS2AddTwoIntsSrv::SetRequest(const FROSAddTwoInts_Request& Request)
{
    Request.SetROS2(AddTwoInts_req);
}

void UROS2AddTwoIntsSrv::GetRequest(FROSAddTwoInts_Request& Request) const
{
    Request.SetFromROS2(AddTwoInts_req);
}

void UROS2AddTwoIntsSrv::SetResponse(const FROSAddTwoInts_Response& Response)
{
    Response.SetROS2(AddTwoInts_res);
}

void UROS2AddTwoIntsSrv::GetResponse(FROSAddTwoInts_Response& Response) const
{
