...
struct RCLUE_API FROSFibonacciSendGoalRequest
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSFibonacciSendGoalResponse
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSFibonacciGetResultRequest
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSFibonacciGetResultResponse
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSFibonacciFeedbackMessage
{
	GENERATED_BODY()
...
public:
	...
	void SetGoalRequest(const FROSFibonacciSendGoalRequest& Goal);

  	UFUNCTION(BlueprintCallable)
	void GetGoalRequest(FROSFibonacciSendGoalRequest& Goal) const;
	
  	UFUNCTION(BlueprintCallable)
	void SetGoalResponse(const FROSFibonacciSendGoalResponse& Goal);

  	UFUNCTION(BlueprintCallable)
	void GetGoalResponse(FROSFibonacciSendGoalResponse& Goal) const;
	
  	UFUNCTION(BlueprintCallable)
	void SetResultRequest(const FROSFibonacciGetResultRequest& Result);

  	UFUNCTION(BlueprintCallable)
	void GetResultRequest(FROSFibonacciGetResultRequest& Result) const;
	
  	UFUNCTION(BlueprintCallable)
	void SetResultResponse(const FROSFibonacciGetResultResponse& Result);

  	UFUNCTION(BlueprintCallable)
	void GetResultResponse(FROSFibonacciGetResultResponse& Result) const;

  	UFUNCTION(BlueprintCallable)
	void SetFeedback(const FROSFibonacciFeedbackMessage& Feedback);

  	UFUNCTION(BlueprintCallable)
	void GetFeedback(FROSFibonacciFeedbackMessage& Feedback) const;
	
  	UFUNCTION(BlueprintCallable)
	void SetGoalIdToFeedback(FROSFibonacciFeedbackMessage& Feedback);
