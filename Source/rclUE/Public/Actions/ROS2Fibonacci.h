...
public:
  ...
  FROSFibonacciSGReq() { UROS2Utils::GenerateRandomUUID16(GoalId); }

  void SetFromROS2(const example_interfaces__action__Fibonacci_SendGoal_Request
                       &in_ros_data) {
    for (int i = 0; i < 16; i++) {
  ...
  void SetROS2(example_interfaces__action__Fibonacci_SendGoal_Request
                   &out_ros_data) const {
    for (int i = 0; i < 16; i++) {
...
public:
  ...
  void SetFromROS2(const example_interfaces__action__Fibonacci_SendGoal_Response
                       &in_ros_data) {
    bAccepted = in_ros_data.accepted;
    Stamp = UROS2Utils::ROSStampToFloat(in_ros_data.stamp);
  }

  void SetROS2(example_interfaces__action__Fibonacci_SendGoal_Response
                   &out_ros_data) const {
...
public:
  ...
  FROSFibonacciGRReq() { GoalId.Init(0, 16); }

  void SetFromROS2(const example_interfaces__action__Fibonacci_GetResult_Request
                       &in_ros_data) {
    for (int i = 0; i < 16; i++) {
      GoalId[i] = in_ros_data.goal_id.uuid[i];
    }
  ...
  void SetROS2(example_interfaces__action__Fibonacci_GetResult_Request
                   &out_ros_data) const {
    for (int i = 0; i < 16; i++) {
      out_ros_data.goal_id.uuid[i] = GoalId[i];
    }
...
public:
  ...
  void SetROS2(example_interfaces__action__Fibonacci_GetResult_Response
    ...
    if (!rosidl_runtime_c__int32__Sequence__init(&out_ros_data.result.sequence,
                                                 Sequence.Num())) {
...
public:
  ...
  FROSFibonacciFB() { GoalId.Init(0, 16); }

  void SetFromROS2(const example_interfaces__action__Fibonacci_FeedbackMessage
                       &in_ros_data) {
    for (int i = 0; i < 16; i++) {
      GoalId[i] = in_ros_data.goal_id.uuid[i];
    }
  ...
  void SetROS2(example_interfaces__action__Fibonacci_FeedbackMessage
    ...
    if (!rosidl_runtime_c__int32__Sequence__init(
            &out_ros_data.feedback.sequence, Sequence.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field "
