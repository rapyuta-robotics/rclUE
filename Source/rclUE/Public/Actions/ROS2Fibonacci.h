...
public:
    ...
    void SetROS2(example_interfaces__action__Fibonacci_GetResult_Response& out_ros_data) const
    {
        ...
        rosidl_runtime_c__int32__Sequence__init(&out_ros_data.result.sequence, Sequence.Num());
...
public:
    ...
    void SetROS2(example_interfaces__action__Fibonacci_FeedbackMessage& out_ros_data) const
    {
        ...
        rosidl_runtime_c__int32__Sequence__init(&out_ros_data.feedback.sequence, Sequence.Num());
