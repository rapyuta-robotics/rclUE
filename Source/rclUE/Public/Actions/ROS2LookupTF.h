...
public:
    ...
    void SetROS2(tf2_msgs__action__LookupTransform_SendGoal_Request& out_ros_data) const
    {
        ...
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(TargetFrame, out_ros_data.goal.target_frame);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(SourceFrame, out_ros_data.goal.source_frame);
        ...
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(FixedFrame, out_ros_data.goal.fixed_frame);
