...
public:
  ...
  FROSLookupTFSGReq() { UROS2Utils::GenerateRandomUUID16(GoalId); }

  void SetFromROS2(
      const tf2_msgs__action__LookupTransform_SendGoal_Request &in_ros_data) {
    for (int i = 0; i < 16; i++) {
  ...
  void SetROS2(
      tf2_msgs__action__LookupTransform_SendGoal_Request &out_ros_data) const {
    for (int i = 0; i < 16; i++) {
...
public:
  ...
  void SetFromROS2(
      const tf2_msgs__action__LookupTransform_SendGoal_Response &in_ros_data) {
    bAccepted = in_ros_data.accepted;
    Stamp = UROS2Utils::ROSStampToFloat(in_ros_data.stamp);
  }

  void SetROS2(
      tf2_msgs__action__LookupTransform_SendGoal_Response &out_ros_data) const {
...
public:
  ...
  FROSLookupTFGRReq() { GoalId.Init(0, 16); }

  void SetFromROS2(
      const tf2_msgs__action__LookupTransform_GetResult_Request &in_ros_data) {
    for (int i = 0; i < 16; i++) {
      GoalId[i] = in_ros_data.goal_id.uuid[i];
    }
  }
  ...
  void SetROS2(
      tf2_msgs__action__LookupTransform_GetResult_Request &out_ros_data) const {
    for (int i = 0; i < 16; i++) {
      out_ros_data.goal_id.uuid[i] = GoalId[i];
    }
  }
...
public:
  ...
  FROSLookupTFFB() { GoalId.Init(0, 16); }

  void SetFromROS2(
      const tf2_msgs__action__LookupTransform_FeedbackMessage &in_ros_data) {
    for (int i = 0; i < 16; i++) {
      GoalId[i] = in_ros_data.goal_id.uuid[i];
    }
  }
  ...
  void SetROS2(
      tf2_msgs__action__LookupTransform_FeedbackMessage &out_ros_data) const {
    for (int i = 0; i < 16; i++) {
      out_ros_data.goal_id.uuid[i] = GoalId[i];
    }
  }
