...
struct RCLUE_API FROSGetBoolFromIdRequest
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSGetBoolFromIdResponse
{
	GENERATED_BODY()
...
public:
	...
	// used by client
  	UFUNCTION(BlueprintCallable)
	void SetRequest(const FROSGetBoolFromIdRequest& Request);
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void GetRequest(FROSGetBoolFromIdRequest& Request) const;
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void SetResponse(const FROSGetBoolFromIdResponse& Response);
	
	// used by client
  	UFUNCTION(BlueprintCallable)
	void GetResponse(FROSGetBoolFromIdResponse& Response) const;
