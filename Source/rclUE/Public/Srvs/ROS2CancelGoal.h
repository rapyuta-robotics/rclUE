...
public:
	...
	void SetROS2(action_msgs__srv__CancelGoal_Response& out_ros_data) const
	{
		...
		if (!action_msgs__msg__GoalInfo__Sequence__init(&out_ros_data.goals_canceling, GoalsCanceling.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.goals_canceling  "));}
