...
public:
	...
	void SetROS2(ue_msgs__srv__SpawnEntities_Request& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.type, Type.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.type  "));}
		...
		if (!ue_msgs__msg__EntityState__Sequence__init(&out_ros_data.state, State.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.state  "));}
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.tags, Tags.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.tags  "));}
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.json_parameters, JsonParameters.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.json_parameters  "));}
