...
struct RCLUE_API FGetEntityState_Request
{
	GENERATED_BODY()
...
public:
	...
	void SetFromROS2(ue_msgs__srv__GetEntityState_Request data)
	{
	...
	void SetROS2(ue_msgs__srv__GetEntityState_Request& data) const
	{
...
USTRUCT(Blueprintable)
struct RCLUE_API FGetEntityState_Response
{
	GENERATED_BODY()
...
public:
	...
	void SetFromROS2(ue_msgs__srv__GetEntityState_Response data)
	{
	...
	void SetROS2(ue_msgs__srv__GetEntityState_Response& data) const
	{
...
public:
	...
	// used by client
  	UFUNCTION(BlueprintCallable)
	void SetInputs(const FGetEntityState_Request Input);
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void GetInputs(FGetEntityState_Request& Input) const;
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void SetOutput(const FGetEntityState_Response Output);
	
	// used by client
  	UFUNCTION(BlueprintCallable)
	void GetOutput(FGetEntityState_Response& Output) const;
	
	// TODO these are for a future refactoring, as it requires to adapt the rest of the codes
	// used by client
  	UFUNCTION(BlueprintCallable)
	void SetRequest(const FGetEntityState_Request Request);
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void GetRequest(FGetEntityState_Request& Request) const;
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void SetResponse(const FGetEntityState_Response Response);
	
	// used by client
  	UFUNCTION(BlueprintCallable)
	void GetResponse(FGetEntityState_Response& Response) const;
