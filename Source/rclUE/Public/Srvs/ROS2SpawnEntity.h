...
public:
    ...
    {
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(Xml, out_ros_data.xml);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(RobotNamespace, out_ros_data.robot_namespace);
