...
struct RCLUE_API FROSGetInt32FromIdRequest
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSGetInt32FromIdResponse
{
	GENERATED_BODY()
...
public:
	...
	// used by client
  	UFUNCTION(BlueprintCallable)
	void SetRequest(const FROSGetInt32FromIdRequest& Request);
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void GetRequest(FROSGetInt32FromIdRequest& Request) const;
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void SetResponse(const FROSGetInt32FromIdResponse& Response);
	
	// used by client
  	UFUNCTION(BlueprintCallable)
	void GetResponse(FROSGetInt32FromIdResponse& Response) const;
