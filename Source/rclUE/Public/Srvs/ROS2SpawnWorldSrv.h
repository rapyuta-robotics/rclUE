...
public:
	...
	void SetROS2(ue_msgs__srv__SpawnWorld_Request& out_ros_data) const
	{
		...
		out_ros_data.world_model.data = (decltype(out_ros_data.world_model.data))malloc((strLength+1)*sizeof(decltype(*out_ros_data.world_model.data)));
		...
		out_ros_data.world_instance_name.data = (decltype(out_ros_data.world_instance_name.data))malloc((strLength+1)*sizeof(decltype(*out_ros_data.world_instance_name.data)));
