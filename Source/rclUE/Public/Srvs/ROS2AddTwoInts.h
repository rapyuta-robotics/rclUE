...
public:
  ...
  void
  SetFromROS2(const example_interfaces__srv__AddTwoInts_Request &in_ros_data) {
    A = in_ros_data.a;
  ...
  void
  SetROS2(example_interfaces__srv__AddTwoInts_Request &out_ros_data) const {
    out_ros_data.a = A;
...
public:
  ...
  void
  SetFromROS2(const example_interfaces__srv__AddTwoInts_Response &in_ros_data) {
    Sum = in_ros_data.sum;
  }

  void
  SetROS2(example_interfaces__srv__AddTwoInts_Response &out_ros_data) const {
