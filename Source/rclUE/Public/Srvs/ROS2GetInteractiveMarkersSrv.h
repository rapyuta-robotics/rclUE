...
#include "ROS2GetInteractiveMarkersSrv.generated.h"

// potential problem: if this struct is defined multiple times!
USTRUCT(Blueprintable)
struct RCLUE_API FROSGetInteractiveMarkersRequest
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct RCLUE_API FROSGetInteractiveMarkersResponse
{
	GENERATED_BODY()
...
UCLASS()
class RCLUE_API UROS2GetInteractiveMarkersSrv : public UROS2GenericSrv
{
	GENERATED_BODY()
...
public:
	...
	// used by client
  	UFUNCTION(BlueprintCallable)
	void SetRequest(const FROSGetInteractiveMarkersRequest& Request);
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void GetRequest(FROSGetInteractiveMarkersRequest& Request) const;
	
	// used by service
  	UFUNCTION(BlueprintCallable)
	void SetResponse(const FROSGetInteractiveMarkersResponse& Response);
	
	// used by client
  	UFUNCTION(BlueprintCallable)
	void GetResponse(FROSGetInteractiveMarkersResponse& Response) const;
