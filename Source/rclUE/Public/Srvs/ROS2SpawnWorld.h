...
public:
    ...
    {
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(WorldModel, out_ros_data.world_model);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(WorldInstanceName, out_ros_data.world_instance_name);

        Pose.SetROS2(out_ros_data.pose);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(JsonParameters, out_ros_data.json_parameters);
    }
};
