...
public:
	...
	void SetFromROS2(sensor_msgs__msg__FluidPressure rosdata)
	{
		...
		fluid_pressure = rosdata.fluid_pressure;
	...
	void SetROS2(sensor_msgs__msg__FluidPressure& rosdata) const
	{
		...
		rosdata.fluid_pressure = fluid_pressure;
