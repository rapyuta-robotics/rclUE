...
public:
    ...
    void SetROS2(sensor_msgs__msg__CameraInfo& out_ros_data) const
    {
        ...
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(DistortionModel, out_ros_data.distortion_model);

        rosidl_runtime_c__float64__Sequence__init(&out_ros_data.d, D.Num());
