...
public:
	...
	void SetROS2(visualization_msgs__msg__Marker& out_ros_data) const
	{
		...
		if (!std_msgs__msg__ColorRGBA__Sequence__init(&out_ros_data.colors, Colors.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.colors  "));}
		...
		if (!visualization_msgs__msg__UVCoordinate__Sequence__init(&out_ros_data.uv_coordinates, UvCoordinates.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.uv_coordinates  "));}
