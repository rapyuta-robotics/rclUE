...
public:
	...
	void SetROS2(visualization_msgs__msg__InteractiveMarkerControl& out_ros_data) const
	{
		...
		if (!visualization_msgs__msg__Marker__Sequence__init(&out_ros_data.markers, Markers.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.markers  "));}
