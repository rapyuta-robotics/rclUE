...
// Generated
#include "ROS2SIWorldResource.generated.h"

USTRUCT(Blueprintable)
struct RCLUE_API FROSSIWorldResource
{
    GENERATED_BODY()
...
public:
    ...
    void SetFromROS2(const simulation_interfaces__msg__WorldResource& in_ros_data)
    {
    ...
    void SetROS2(simulation_interfaces__msg__WorldResource& out_ros_data) const
    {
...
UCLASS()
class RCLUE_API UROS2SIWorldResourceMsg : public UROS2GenericMsg
{
    GENERATED_BODY()
...
public:
    ...
    void SetMsg(const FROSSIWorldResource& Input);

    UFUNCTION(BlueprintCallable)
    void GetMsg(FROSSIWorldResource& Output) const;
...
private:
    ...
    simulation_interfaces__msg__WorldResource world_resource_msg;
};
