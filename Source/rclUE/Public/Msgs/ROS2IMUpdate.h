  ...
  void SetROS2(
    ...
    if (out_ros_data.markers.data) {
      visualization_msgs__msg__InteractiveMarker__Sequence__fini(
          &out_ros_data.markers);
    }
    if (!visualization_msgs__msg__InteractiveMarker__Sequence__init(
            &out_ros_data.markers, Markers.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.markers  "));
    }
    ...
    if (!visualization_msgs__msg__InteractiveMarkerPose__Sequence__init(
            &out_ros_data.poses, Poses.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.poses  "));
    }
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.erases,
                                                  Erases.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.erases  "));
    }
