...
public:
    ...
    void SetROS2(visualization_msgs__msg__MenuEntry& out_ros_data) const
    {
        ...
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(Title, out_ros_data.title);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(Command, out_ros_data.command);
