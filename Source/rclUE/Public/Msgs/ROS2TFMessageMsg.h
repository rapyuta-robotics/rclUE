...
public:
    ...
    void SetFromROS2(const tf2_msgs__msg__TFMessage& in_ros_data)
    {
        ...
        for (auto i = 0; i < in_ros_data.transforms.size; ++i)
        {
            ...
            TransformsHeaderFrameId[i].AppendChars(in_ros_data.transforms.data[i].header.frame_id.data,
                                                   in_ros_data.transforms.data[i].header.frame_id.size);
        }

        for (auto i = 0; i < in_ros_data.transforms.size; ++i)
        {
            TransformsChildFrameId.Emplace("");
            TransformsChildFrameId[i].AppendChars(in_ros_data.transforms.data[i].child_frame_id.data,
                                                  in_ros_data.transforms.data[i].child_frame_id.size);
        }
    ...
    void SetROS2(tf2_msgs__msg__TFMessage& out_ros_data) const
    {
        ...
        out_ros_data.transforms.data =
            (geometry_msgs__msg__TransformStamped*)malloc(sizeof(geometry_msgs__msg__TransformStamped) * num);
        ...
        for (auto i = 0; i < num; ++i)
        {
...

            {
                ...
                memcpy(out_ros_data.transforms.data[i].header.frame_id.data,
                       TCHAR_TO_UTF8(*TransformsHeaderFrameId[i]),
...

            {
                ...
                out_ros_data.transforms.data[i].child_frame_id.data =
                    (decltype(out_ros_data.transforms.data[i].child_frame_id.data))malloc(
                        (strLength + 1) * sizeof(decltype(*out_ros_data.transforms.data[i].child_frame_id.data)));
