...
public:
	...
	void SetROS2(sensor_msgs__msg__MultiDOFJointState& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.joint_names, JointNames.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.joint_names  "));}
		...
		if (!geometry_msgs__msg__Transform__Sequence__init(&out_ros_data.transforms, Transforms.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.transforms  "));}
		...
		if (!geometry_msgs__msg__Twist__Sequence__init(&out_ros_data.twist, Twist.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.twist  "));}
		...
		if (!geometry_msgs__msg__Wrench__Sequence__init(&out_ros_data.wrench, Wrench.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.wrench  "));}
