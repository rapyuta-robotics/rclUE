...
public:
    ...
    void SetROS2(visualization_msgs__msg__InteractiveMarkerFeedback& out_ros_data) const
    {
        ...
        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(ClientId, out_ros_data.client_id);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(MarkerName, out_ros_data.marker_name);

        UROS2Utils::StringUEToROS<rosidl_runtime_c__String>(ControlName, out_ros_data.control_name);
