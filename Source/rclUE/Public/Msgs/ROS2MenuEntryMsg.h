...
#include "ROS2MenuEntryMsg.generated.h"
...
public:
	...
	void SetROS2(visualization_msgs__msg__MenuEntry& out_ros_data) const
	{
		...
		out_ros_data.title.data = (decltype(out_ros_data.title.data))malloc((strLength+1)*sizeof(decltype(*out_ros_data.title.data)));
		memcpy(out_ros_data.title.data, TCHAR_TO_UTF8(*Title), (strLength+1)*sizeof(char));
		...
		out_ros_data.command.data = (decltype(out_ros_data.command.data))malloc((strLength+1)*sizeof(decltype(*out_ros_data.command.data)));
		memcpy(out_ros_data.command.data, TCHAR_TO_UTF8(*Command), (strLength+1)*sizeof(char));
