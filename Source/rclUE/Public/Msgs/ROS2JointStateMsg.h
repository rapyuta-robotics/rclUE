...
public:
    ...
    void SetROS2(sensor_msgs__msg__JointState& out_ros_data) const
    {
        ...
        out_ros_data.position.data =
            (decltype(out_ros_data.position.data))malloc((position.Num()) * sizeof(decltype(*out_ros_data.position.data)));
        ...
        out_ros_data.velocity.data =
            (decltype(out_ros_data.velocity.data))malloc((velocity.Num()) * sizeof(decltype(*out_ros_data.velocity.data)));
        ...
        out_ros_data.effort.data =
            (decltype(out_ros_data.effort.data))malloc((effort.Num()) * sizeof(decltype(*out_ros_data.effort.data)));
