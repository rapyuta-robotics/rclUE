...
public:
  ...
  SetFromROS2(const example_interfaces__msg__UInt16MultiArray &in_ros_data) {
    ...
    UROS2Utils::SequenceROSToUEArray<uint16, uint16>(
  ...
  void SetROS2(example_interfaces__msg__UInt16MultiArray &out_ros_data) const {
    ...
    if (!rosidl_runtime_c__uint16__Sequence__init(&out_ros_data.data,
                                                  Data.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.data  "));
    }
    UROS2Utils::ArrayUEToROSSequence<uint16, uint16>(
