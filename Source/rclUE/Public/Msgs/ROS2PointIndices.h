...
public:
	...
	void SetROS2(pcl_msgs__msg__PointIndices& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__int32__Sequence__init(&out_ros_data.indices, Indices.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.indices  "));}
