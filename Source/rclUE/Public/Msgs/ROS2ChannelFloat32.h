...
public:
	...
	void SetROS2(sensor_msgs__msg__ChannelFloat32& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__float32__Sequence__init(&out_ros_data.values, Values.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.values  "));}
