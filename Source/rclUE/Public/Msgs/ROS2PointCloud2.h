...
public:
  ...
  void SetROS2(sensor_msgs__msg__PointCloud2 &out_ros_data) const {
    ...
    if (!sensor_msgs__msg__PointField__Sequence__init(&out_ros_data.fields,
                                                      Fields.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.fields  "));
    }
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&out_ros_data.data,
                                                 Data.Num())) {
      UE_LOG(LogTemp, Error,
