...
public:
	...
	void SetFromROS2(geometry_msgs__msg__PointStamped rosdata)
	{
		...
		point_x = rosdata.point.x;

		point_y = rosdata.point.y;

		point_z = rosdata.point.z;

		
	}

	void SetROS2(geometry_msgs__msg__PointStamped& rosdata) const
	{
		...
		rosdata.point.x = point_x;

		rosdata.point.y = point_y;

		rosdata.point.z = point_z;
