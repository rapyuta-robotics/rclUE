...
public:
	...
	void SetROS2(sensor_msgs__msg__JoyFeedbackArray& out_ros_data) const
	{
		...
		if (!sensor_msgs__msg__JoyFeedback__Sequence__init(&out_ros_data.array, Array.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.array  "));}
