...
public:
	...
	void SetROS2(sensor_msgs__msg__Joy& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__float32__Sequence__init(&out_ros_data.axes, Axes.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.axes  "));}
		...
		if (!rosidl_runtime_c__int32__Sequence__init(&out_ros_data.buttons, Buttons.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.buttons  "));}
