  ...
  void SetROS2(visualization_msgs__msg__InteractiveMarker &out_ros_data) const {
    ...
    if (out_ros_data.menu_entries.data) {
      visualization_msgs__msg__MenuEntry__Sequence__fini(
          &out_ros_data.menu_entries);
    }
    if (!visualization_msgs__msg__MenuEntry__Sequence__init(
            &out_ros_data.menu_entries, MenuEntries.Num())) {
      UE_LOG(
          LogTemp, Error,
          TEXT("failed to create array for field out_ros_data.menu_entries  "));
    }
    ...
    if (out_ros_data.controls.data) {
      visualization_msgs__msg__InteractiveMarkerControl__Sequence__fini(
          &out_ros_data.controls);
    }
    if (!visualization_msgs__msg__InteractiveMarkerControl__Sequence__init(
            &out_ros_data.controls, Controls.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.controls  "));
    }
