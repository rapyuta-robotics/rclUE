...
public:
	...
	void SetROS2(sensor_msgs__msg__BatteryState& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__float32__Sequence__init(&out_ros_data.cell_voltage, CellVoltage.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.cell_voltage  "));}
		...
		if (!rosidl_runtime_c__float32__Sequence__init(&out_ros_data.cell_temperature, CellTemperature.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.cell_temperature  "));}
