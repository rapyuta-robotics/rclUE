...
public:
  ...
  void SetROS2(sensor_msgs__msg__MultiEchoLaserScan &out_ros_data) const {
    ...
    if (!sensor_msgs__msg__LaserEcho__Sequence__init(&out_ros_data.ranges,
                                                     Ranges.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.ranges  "));
    }
    ...
    if (!sensor_msgs__msg__LaserEcho__Sequence__init(&out_ros_data.intensities,
                                                     Intensities.Num())) {
      UE_LOG(
          LogTemp, Error,
          TEXT("failed to create array for field out_ros_data.intensities  "));
    }
    UROS2Utils::ArrayUEToROSSequence<sensor_msgs__msg__LaserEcho,
                                     FROSLaserEcho>(
