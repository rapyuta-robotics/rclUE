...
public:
	...
	void SetROS2(pcl_msgs__msg__PolygonMesh& out_ros_data) const
	{
		...
		if (!pcl_msgs__msg__Vertices__Sequence__init(&out_ros_data.polygons, Polygons.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.polygons  "));}
