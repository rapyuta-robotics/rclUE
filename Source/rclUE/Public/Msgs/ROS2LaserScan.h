...
public:
    ...
    void SetROS2(sensor_msgs__msg__LaserScan& out_ros_data) const
    {
        ...
        rosidl_runtime_c__float32__Sequence__init(&out_ros_data.ranges, Ranges.Num());
        ...
        rosidl_runtime_c__float32__Sequence__init(&out_ros_data.intensities, Intensities.Num());
