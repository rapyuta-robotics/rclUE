...
public:
  ...
  void
  SetFromROS2(const example_interfaces__msg__Int16MultiArray &in_ros_data) {
    Layout.SetFromROS2(in_ros_data.layout);

    UROS2Utils::SequenceROSToUEArray<int16, int16>(in_ros_data.data.data, Data,
  ...
  void SetROS2(example_interfaces__msg__Int16MultiArray &out_ros_data) const {
    ...
    if (!rosidl_runtime_c__int16__Sequence__init(&out_ros_data.data,
                                                 Data.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.data  "));
    }
    UROS2Utils::ArrayUEToROSSequence<int16, int16>(Data, out_ros_data.data.data,
                                                   Data.Num());
  }
};
