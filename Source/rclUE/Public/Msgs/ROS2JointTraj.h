...
public:
	...
	void SetROS2(trajectory_msgs__msg__JointTrajectory& out_ros_data) const
	{
		...
		if (!trajectory_msgs__msg__JointTrajectoryPoint__Sequence__init(&out_ros_data.points, Points.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.points  "));}
