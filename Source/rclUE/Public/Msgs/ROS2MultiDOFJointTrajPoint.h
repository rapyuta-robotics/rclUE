...
public:
    ...
    {
        geometry_msgs__msg__Transform__Sequence__init(&out_ros_data.transforms, Transforms.Num());
        UROS2Utils::TransformArrayUEToROSSequence(Transforms, out_ros_data.transforms.data, Transforms.Num());

        geometry_msgs__msg__Twist__Sequence__init(&out_ros_data.velocities, Velocities.Num());
        ...
        geometry_msgs__msg__Twist__Sequence__init(&out_ros_data.accelerations, Accelerations.Num());
        UROS2Utils::ArrayUEToROSSequence<geometry_msgs__msg__Twist, FROSTwist>(
