...
public:
  ...
  void SetFromROS2(const geometry_msgs__msg__PoseArray &in_ros_data) {
    ...
    UROS2Utils::SequenceROSToUEArray<geometry_msgs__msg__Pose, FROSPose>(
  ...
  void SetROS2(geometry_msgs__msg__PoseArray &out_ros_data) const {
    ...
    if (!geometry_msgs__msg__Pose__Sequence__init(&out_ros_data.poses,
                                                  Poses.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.poses  "));
    }
    UROS2Utils::ArrayUEToROSSequence<geometry_msgs__msg__Pose, FROSPose>(
