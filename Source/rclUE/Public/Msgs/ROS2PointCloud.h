...
public:
  ...
  void SetROS2(sensor_msgs__msg__PointCloud &out_ros_data) const {
    ...
    if (!geometry_msgs__msg__Point32__Sequence__init(&out_ros_data.points,
                                                     Points.Num())) {
    ...
    if (!sensor_msgs__msg__ChannelFloat32__Sequence__init(
            &out_ros_data.channels, Channels.Num())) {
      UE_LOG(LogTemp, Error,
             TEXT("failed to create array for field out_ros_data.channels  "));
    }
