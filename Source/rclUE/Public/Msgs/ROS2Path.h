...
public:
	...
	void SetROS2(nav_msgs__msg__Path& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__PoseStamped__Sequence__init(&out_ros_data.poses, Poses.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.poses  "));}
