...
#include "ROS2InteractiveMarkerControlMsg.generated.h"

USTRUCT(Blueprintable)
struct RCLUE_API FROSInteractiveMarkerControl
{
	GENERATED_BODY()
...
UCLASS()
class RCLUE_API UROS2InteractiveMarkerControlMsg : public UROS2GenericMsg
{
	GENERATED_BODY()
...
public:
	...
	void SetMsg(const FROSInteractiveMarkerControl& Input);
	
  	UFUNCTION(BlueprintCallable)
	void GetMsg(FROSInteractiveMarkerControl& Output) const;
