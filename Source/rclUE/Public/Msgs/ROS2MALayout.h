...
public:
	...
	void SetROS2(example_interfaces__msg__MultiArrayLayout& out_ros_data) const
	{
		...
		if (!example_interfaces__msg__MultiArrayDimension__Sequence__init(&out_ros_data.dim, Dim.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.dim  "));}
