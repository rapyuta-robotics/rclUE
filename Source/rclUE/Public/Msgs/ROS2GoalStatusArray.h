  ...
  void SetROS2(actionlib_msgs__msg__GoalStatusArray &out_ros_data) const {
    ...
    if (out_ros_data.status_list.data) {
      actionlib_msgs__msg__GoalStatus__Sequence__fini(
          &out_ros_data.status_list);
    }
    if (!actionlib_msgs__msg__GoalStatus__Sequence__init(
            &out_ros_data.status_list, StatusList.Num())) {
      UE_LOG(
          LogTemp, Error,
          TEXT("failed to create array for field out_ros_data.status_list  "));
    }
