...
public:
	...
	void SetROS2(diagnostic_msgs__msg__DiagnosticStatus& out_ros_data) const
	{
		...
		if (!diagnostic_msgs__msg__KeyValue__Sequence__init(&out_ros_data.values, Values.Num())) {UE_LOG(LogTemp, Error, TEXT("failed to create array for field out_ros_data.values  "));}
