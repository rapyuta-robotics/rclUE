...
{
  ue_msgs__srv__GetBoolFromId_Request * msg = (ue_msgs__srv__GetBoolFromId_Request *)malloc(sizeof(ue_msgs__srv__GetBoolFromId_Request));
  if (!msg) {
    return NULL;
  }
...
ue_msgs__srv__GetBoolFromId_Request__Sequence__init(ue_msgs__srv__GetBoolFromId_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ue_msgs__srv__GetBoolFromId_Request *)calloc(size, sizeof(ue_msgs__srv__GetBoolFromId_Request));
    if (!data) {
      return false;
    }
...
{
  ue_msgs__srv__GetBoolFromId_Request__Sequence * array = (ue_msgs__srv__GetBoolFromId_Request__Sequence *)malloc(sizeof(ue_msgs__srv__GetBoolFromId_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ue_msgs__srv__GetBoolFromId_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ue_msgs__srv__GetBoolFromId_Request * data =
      (ue_msgs__srv__GetBoolFromId_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__srv__GetBoolFromId_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ue_msgs__srv__GetBoolFromId_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  ue_msgs__srv__GetBoolFromId_Response * msg = (ue_msgs__srv__GetBoolFromId_Response *)malloc(sizeof(ue_msgs__srv__GetBoolFromId_Response));
  if (!msg) {
    return NULL;
  }
...
ue_msgs__srv__GetBoolFromId_Response__Sequence__init(ue_msgs__srv__GetBoolFromId_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ue_msgs__srv__GetBoolFromId_Response *)calloc(size, sizeof(ue_msgs__srv__GetBoolFromId_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ue_msgs__srv__GetBoolFromId_Response__Sequence * array = (ue_msgs__srv__GetBoolFromId_Response__Sequence *)malloc(sizeof(ue_msgs__srv__GetBoolFromId_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ue_msgs__srv__GetBoolFromId_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ue_msgs__srv__GetBoolFromId_Response * data =
      (ue_msgs__srv__GetBoolFromId_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__srv__GetBoolFromId_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ue_msgs__srv__GetBoolFromId_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
