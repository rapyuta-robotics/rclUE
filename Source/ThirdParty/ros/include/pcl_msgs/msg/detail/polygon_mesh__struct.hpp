...
struct PolygonMesh_
{
  ...
  using _polygons_type =
    std::vector<pcl_msgs::msg::Vertices_<ContainerAllocator>, typename ContainerAllocator::template rebind<pcl_msgs::msg::Vertices_<ContainerAllocator>>::other>;
  ...
  Type & set__polygons(
    const std::vector<pcl_msgs::msg::Vertices_<ContainerAllocator>, typename ContainerAllocator::template rebind<pcl_msgs::msg::Vertices_<ContainerAllocator>>::other> & _arg)
  {
    this->polygons = _arg;
    return *this;
  }
