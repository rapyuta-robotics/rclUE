...
#include "JointTrajectoryControllerState_Plugin.h"
...
namespace control_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ----------------------------------------------------------------------------
            *  Type JointTrajectoryControllerState_
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                JointTrajectoryControllerState_ *sample = NULL;

                sample = new (std::nothrow) JointTrajectoryControllerState_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!control_msgs::msg::dds_::JointTrajectoryControllerState__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            JointTrajectoryControllerState_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!control_msgs::msg::dds_::JointTrajectoryControllerState__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return control_msgs::msg::dds_::JointTrajectoryControllerState_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            JointTrajectoryControllerState_PluginSupport_destroy_data_w_params(
                ...
                control_msgs::msg::dds_::JointTrajectoryControllerState__finalize_w_params(sample,dealloc_params);
            ...
            JointTrajectoryControllerState_PluginSupport_destroy_data_ex(
                ...
                control_msgs::msg::dds_::JointTrajectoryControllerState__finalize_ex(sample,deallocate_pointers);
            ...
            JointTrajectoryControllerState_PluginSupport_destroy_data(
                ...
                control_msgs::msg::dds_::JointTrajectoryControllerState_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return control_msgs::msg::dds_::JointTrajectoryControllerState__copy(dst,(const JointTrajectoryControllerState_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    control_msgs::msg::dds_::JointTrajectoryControllerState_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    control_msgs::msg::dds_::JointTrajectoryControllerState_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                JointTrajectoryControllerState__finalize_optional_members(sample, RTI_TRUE);
                ...
                const JointTrajectoryControllerState_ *src)
            {
                ...
                return control_msgs::msg::dds_::JointTrajectoryControllerState_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        control_msgs::msg::dds_::JointTrajectoryControllerState__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const JointTrajectoryControllerState_ *sample)
            {
                ...
                result = control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                JointTrajectoryControllerState__finalize_optional_members(sample, RTI_TRUE);
                return JointTrajectoryControllerState_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!JointTrajectoryControllerState_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                data = DDS_DynamicData_new(
                    JointTrajectoryControllerState__get_typecode(), 
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "JointTrajectoryControllerState_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_deserialize_sample( 
            ...
            RTIBool JointTrajectoryControllerState_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = JointTrajectoryControllerState_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool JointTrajectoryControllerState_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                JointTrajectoryControllerState_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_deserialize_sample(
            ...
            RTIBool JointTrajectoryControllerState_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                JointTrajectoryControllerState_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = JointTrajectoryControllerState_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *JointTrajectoryControllerState_Plugin_new(void) 
            { 
                ...
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                JointTrajectoryControllerState_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                JointTrajectoryControllerState_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                JointTrajectoryControllerState__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_min_size;

                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                JointTrajectoryControllerState_Plugin_get_sample;
                ...
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)control_msgs::msg::dds_::JointTrajectoryControllerState__get_typecode();
                ...
                JointTrajectoryControllerState_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                JointTrajectoryControllerState_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                control_msgs::msg::dds_::JointTrajectoryControllerState_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = JointTrajectoryControllerState_TYPENAME;

                return plugin;
            }

            void
            JointTrajectoryControllerState_Plugin_delete(struct PRESTypePlugin *plugin)
            {
