...
{
  control_msgs__msg__JointJog * msg = (control_msgs__msg__JointJog *)malloc(sizeof(control_msgs__msg__JointJog));
  if (!msg) {
    return NULL;
  }
...
control_msgs__msg__JointJog__Sequence__init(control_msgs__msg__JointJog__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (control_msgs__msg__JointJog *)calloc(size, sizeof(control_msgs__msg__JointJog));
    if (!data) {
      return false;
    }
...
{
  control_msgs__msg__JointJog__Sequence * array = (control_msgs__msg__JointJog__Sequence *)malloc(sizeof(control_msgs__msg__JointJog__Sequence));
  if (!array) {
    return NULL;
  }
