...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *UInt32MultiArray_TYPENAME = "std_msgs::msg::dds_::UInt32MultiArray_";
            ...
            DDS_TypeCode* UInt32MultiArray__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::UInt32MultiArray_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                UInt32MultiArray__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)std_msgs::msg::dds_::MultiArrayLayout__get_typecode();
            ...
            RTIBool UInt32MultiArray__initialize(
                ...
                return std_msgs::msg::dds_::UInt32MultiArray__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                UInt32MultiArray_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::UInt32MultiArray__initialize_w_params(
                    sample,&allocParams);
                ...
                UInt32MultiArray_* sample)
            {
                ...
                std_msgs::msg::dds_::UInt32MultiArray__finalize_ex(sample,RTI_TRUE);
            }
                ...
                UInt32MultiArray_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::UInt32MultiArray__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::UInt32MultiArray__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::UInt32MultiArray__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::UInt32MultiArray__copy
