...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *UInt8MultiArray_TYPENAME = "std_msgs::msg::dds_::UInt8MultiArray_";
            ...
            DDS_TypeCode* UInt8MultiArray__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::UInt8MultiArray_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                UInt8MultiArray__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)std_msgs::msg::dds_::MultiArrayLayout__get_typecode();
            ...
            RTIBool UInt8MultiArray__initialize(
                ...
                return std_msgs::msg::dds_::UInt8MultiArray__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                UInt8MultiArray_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::UInt8MultiArray__initialize_w_params(
                    sample,&allocParams);
                ...
                UInt8MultiArray_* sample)
            {
                ...
                std_msgs::msg::dds_::UInt8MultiArray__finalize_ex(sample,RTI_TRUE);
            }
                ...
                UInt8MultiArray_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::UInt8MultiArray__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::UInt8MultiArray__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::UInt8MultiArray__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::UInt8MultiArray__copy
