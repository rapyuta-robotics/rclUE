...
#ifndef Float64MultiArray_Plugin_88064955_h
#define Float64MultiArray_Plugin_88064955_h
...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define Float64MultiArray_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Float64MultiArray_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Float64MultiArray_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Float64MultiArray_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Float64MultiArray_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Float64MultiArray_*
            ...
            Float64MultiArray_PluginSupport_copy_data(
                Float64MultiArray_ *out,
                const Float64MultiArray_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Float64MultiArray_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Float64MultiArray_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            Float64MultiArray_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Float64MultiArray_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            Float64MultiArray_Plugin_new(void);

            NDDSUSERDllExport extern void
            Float64MultiArray_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Float64MultiArray_Plugin_88064955_h */
