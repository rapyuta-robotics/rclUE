...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Int8_TYPENAME = "std_msgs::msg::dds_::Int8_";
            ...
            DDS_TypeCode* Int8__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::Int8_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Int8__initialize(
                Int8_* sample) {
                return std_msgs::msg::dds_::Int8__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Int8_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::Int8__initialize_w_params(
                    sample,&allocParams);
                ...
                Int8_* sample)
            {
                ...
                std_msgs::msg::dds_::Int8__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Int8_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::Int8__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::Int8__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::Int8__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::Int8__copy
