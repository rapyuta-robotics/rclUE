...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Float64_TYPENAME = "std_msgs::msg::dds_::Float64_";
            ...
            DDS_TypeCode* Float64__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::Float64_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Float64__initialize(
                Float64_* sample) {
                return std_msgs::msg::dds_::Float64__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Float64_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::Float64__initialize_w_params(
                    sample,&allocParams);
                ...
                Float64_* sample)
            {
                ...
                std_msgs::msg::dds_::Float64__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Float64_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::Float64__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::Float64__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::Float64__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::Float64__copy
