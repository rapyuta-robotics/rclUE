        ...
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
                ...
                const struct DDS_TypeAllocationParams_t * alloc_params) 
            {
                ...
                if (!std_msgs::msg::dds_::Float64MultiArray__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            Float64MultiArray_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!std_msgs::msg::dds_::Float64MultiArray__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return std_msgs::msg::dds_::Float64MultiArray_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            Float64MultiArray_PluginSupport_destroy_data_w_params(
                ...
                std_msgs::msg::dds_::Float64MultiArray__finalize_w_params(sample,dealloc_params);
            ...
            Float64MultiArray_PluginSupport_destroy_data_ex(
                ...
                std_msgs::msg::dds_::Float64MultiArray__finalize_ex(sample,deallocate_pointers);
            ...
            Float64MultiArray_PluginSupport_destroy_data(
                ...
                std_msgs::msg::dds_::Float64MultiArray_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return std_msgs::msg::dds_::Float64MultiArray__copy(dst,(const Float64MultiArray_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    std_msgs::msg::dds_::Float64MultiArray_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    std_msgs::msg::dds_::Float64MultiArray_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = std_msgs::msg::dds_::Float64MultiArray_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        std_msgs::msg::dds_::Float64MultiArray_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        std_msgs::msg::dds_::Float64MultiArray_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                const Float64MultiArray_ *src)
            {
                ...
                return std_msgs::msg::dds_::Float64MultiArray_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        std_msgs::msg::dds_::Float64MultiArray__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const Float64MultiArray_ *sample)
            {
                ...
                result = std_msgs::msg::dds_::Float64MultiArray_Plugin_serialize(
                ...
                void *endpoint_plugin_qos)
            {
                ...
                result= std_msgs::msg::dds_::Float64MultiArray_Plugin_deserialize_sample( 
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!std_msgs::msg::dds_::Float64MultiArray_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!std_msgs::msg::dds_::Float64MultiArray_Plugin_deserialize_sample(
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= std_msgs::msg::dds_::Float64MultiArray_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += std_msgs::msg::dds_::Float64MultiArray_Plugin_get_serialized_sample_max_size_ex(
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                std_msgs::msg::dds_::Float64MultiArray_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_copy_sample;
                ...
                std_msgs::msg::dds_::Float64MultiArray_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                std_msgs::msg::dds_::Float64MultiArray_Plugin_get_serialized_sample_min_size;
                ...
                std_msgs::msg::dds_::Float64MultiArray_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)std_msgs::msg::dds_::Float64MultiArray__get_typecode();
