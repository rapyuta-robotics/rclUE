...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *ByteMultiArray_TYPENAME = "std_msgs::msg::dds_::ByteMultiArray_";
            ...
            DDS_TypeCode* ByteMultiArray__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::ByteMultiArray_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                ByteMultiArray__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)std_msgs::msg::dds_::MultiArrayLayout__get_typecode();
            ...
            RTIBool ByteMultiArray__initialize(
                ...
                return std_msgs::msg::dds_::ByteMultiArray__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                ByteMultiArray_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::ByteMultiArray__initialize_w_params(
                    sample,&allocParams);
                ...
                ByteMultiArray_* sample)
            {
                ...
                std_msgs::msg::dds_::ByteMultiArray__finalize_ex(sample,RTI_TRUE);
            }
                ...
                ByteMultiArray_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::ByteMultiArray__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::ByteMultiArray__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::ByteMultiArray__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::ByteMultiArray__copy
