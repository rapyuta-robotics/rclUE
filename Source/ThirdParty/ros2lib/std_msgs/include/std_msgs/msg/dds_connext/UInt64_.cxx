...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *UInt64_TYPENAME = "std_msgs::msg::dds_::UInt64_";
            ...
            DDS_TypeCode* UInt64__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::UInt64_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool UInt64__initialize(
                UInt64_* sample) {
                return std_msgs::msg::dds_::UInt64__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                UInt64_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::UInt64__initialize_w_params(
                    sample,&allocParams);
                ...
                UInt64_* sample)
            {
                ...
                std_msgs::msg::dds_::UInt64__finalize_ex(sample,RTI_TRUE);
            }
                ...
                UInt64_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::UInt64__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::UInt64__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::UInt64__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::UInt64__copy
