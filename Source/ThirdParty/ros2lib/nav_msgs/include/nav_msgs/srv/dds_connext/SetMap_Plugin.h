...
#ifndef SetMap_Plugin_460795926_h
#define SetMap_Plugin_460795926_h
...
namespace nav_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define SetMap_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define SetMap_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define SetMap_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define SetMap_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define SetMap_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern SetMap_Request_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            SetMap_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                SetMap_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            SetMap_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SetMap_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            SetMap_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            SetMap_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace nav_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define SetMap_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define SetMap_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define SetMap_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define SetMap_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define SetMap_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern SetMap_Response_*
            ...
            SetMap_Response_PluginSupport_copy_data(
                SetMap_Response_ *out,
                const SetMap_Response_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            SetMap_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                SetMap_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            SetMap_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SetMap_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            SetMap_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            SetMap_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* SetMap_Plugin_460795926_h */
