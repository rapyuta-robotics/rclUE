...
bool ue_msgs__msg__entity_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ue_msgs.msg._entity_state.EntityState", full_classname_dest, 37) == 0);
  }
  ue_msgs__msg__EntityState * ros_message = _ros_message;
  {  // name
...
PyObject * ue_msgs__msg__entity_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ue_msgs.msg._entity_state");
  ...
  ue_msgs__msg__EntityState * ros_message = (ue_msgs__msg__EntityState *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
