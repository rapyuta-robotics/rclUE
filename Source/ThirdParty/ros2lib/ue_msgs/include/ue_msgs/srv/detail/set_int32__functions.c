...
{
  ue_msgs__srv__SetInt32_Request * msg = (ue_msgs__srv__SetInt32_Request *)malloc(sizeof(ue_msgs__srv__SetInt32_Request));
  if (!msg) {
    return NULL;
  }
...
ue_msgs__srv__SetInt32_Request__Sequence__init(ue_msgs__srv__SetInt32_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ue_msgs__srv__SetInt32_Request *)calloc(size, sizeof(ue_msgs__srv__SetInt32_Request));
    if (!data) {
      return false;
    }
...
{
  ue_msgs__srv__SetInt32_Request__Sequence * array = (ue_msgs__srv__SetInt32_Request__Sequence *)malloc(sizeof(ue_msgs__srv__SetInt32_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ue_msgs__srv__SetInt32_Response * msg = (ue_msgs__srv__SetInt32_Response *)malloc(sizeof(ue_msgs__srv__SetInt32_Response));
  if (!msg) {
    return NULL;
  }
...
ue_msgs__srv__SetInt32_Response__Sequence__init(ue_msgs__srv__SetInt32_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ue_msgs__srv__SetInt32_Response *)calloc(size, sizeof(ue_msgs__srv__SetInt32_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ue_msgs__srv__SetInt32_Response__Sequence * array = (ue_msgs__srv__SetInt32_Response__Sequence *)malloc(sizeof(ue_msgs__srv__SetInt32_Response__Sequence));
  if (!array) {
    return NULL;
  }
