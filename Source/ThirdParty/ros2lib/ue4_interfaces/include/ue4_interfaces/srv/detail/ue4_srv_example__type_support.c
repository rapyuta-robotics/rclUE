...
#include <stddef.h>
#include "ue4_interfaces/srv/detail/ue4_srv_example__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_members = {
  "ue4_interfaces__srv",  // service namespace
  "UE4SrvExample",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_Request_message_type_support_handle,
  NULL  // response message
  // ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_Response_message_type_support_handle
};

static rosidl_service_type_support_t ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_type_support_handle = {
  0,
  &ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue4_interfaces, srv, UE4SrvExample)() {
  if (!ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_type_support_handle.typesupport_identifier) {
    ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_type_support_handle.data;
  ...
  return &ue4_interfaces__srv__detail__ue4_srv_example__rosidl_typesupport_introspection_c__UE4SrvExample_service_type_support_handle;
}
