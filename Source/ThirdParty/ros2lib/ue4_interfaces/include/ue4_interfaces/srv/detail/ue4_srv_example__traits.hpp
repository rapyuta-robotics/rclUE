...
#ifndef UE4_INTERFACES__SRV__DETAIL__UE4_SRV_EXAMPLE__TRAITS_HPP_
#define UE4_INTERFACES__SRV__DETAIL__UE4_SRV_EXAMPLE__TRAITS_HPP_
...
template<>
inline const char * name<ue4_interfaces::srv::UE4SrvExample_Request>()
{
  return "ue4_interfaces/srv/UE4SrvExample_Request";
}
...
template<>
inline const char * name<ue4_interfaces::srv::UE4SrvExample_Response>()
{
  return "ue4_interfaces/srv/UE4SrvExample_Response";
}
...
template<>
inline const char * name<ue4_interfaces::srv::UE4SrvExample>()
{
  return "ue4_interfaces/srv/UE4SrvExample";
}
...
#endif  // UE4_INTERFACES__SRV__DETAIL__UE4_SRV_EXAMPLE__TRAITS_HPP_
