...
namespace example_interfaces {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *String_TYPENAME = "example_interfaces::msg::dds_::String_";
            ...
            DDS_TypeCode* String__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"example_interfaces::msg::dds_::String_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool String__initialize(
                String_* sample) {
                return example_interfaces::msg::dds_::String__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                String_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return example_interfaces::msg::dds_::String__initialize_w_params(
                    sample,&allocParams);
                ...
                String_* sample)
            {
                ...
                example_interfaces::msg::dds_::String__finalize_ex(sample,RTI_TRUE);
            }
                ...
                String_* sample,RTIBool deletePointers)
            {
                ...
                example_interfaces::msg::dds_::String__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params example_interfaces::msg::dds_::String__initialize_w_params

            #define T_finalize_w_params   example_interfaces::msg::dds_::String__finalize_w_params
            #define T_copy       example_interfaces::msg::dds_::String__copy
