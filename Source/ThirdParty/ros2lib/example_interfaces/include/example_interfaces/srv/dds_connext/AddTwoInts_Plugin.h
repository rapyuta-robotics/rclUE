...
#ifndef AddTwoInts_Plugin_1960903651_h
#define AddTwoInts_Plugin_1960903651_h
...
namespace example_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define AddTwoInts_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define AddTwoInts_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define AddTwoInts_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define AddTwoInts_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define AddTwoInts_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern AddTwoInts_Request_*
            ...
            AddTwoInts_Request_PluginSupport_copy_data(
                AddTwoInts_Request_ *out,
                const AddTwoInts_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            AddTwoInts_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            AddTwoInts_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                AddTwoInts_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            AddTwoInts_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AddTwoInts_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            AddTwoInts_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            AddTwoInts_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace example_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define AddTwoInts_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define AddTwoInts_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define AddTwoInts_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define AddTwoInts_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define AddTwoInts_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern AddTwoInts_Response_*
            ...
            AddTwoInts_Response_PluginSupport_copy_data(
                AddTwoInts_Response_ *out,
                const AddTwoInts_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            AddTwoInts_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            AddTwoInts_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                AddTwoInts_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            AddTwoInts_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AddTwoInts_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            AddTwoInts_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            AddTwoInts_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* AddTwoInts_Plugin_1960903651_h */
