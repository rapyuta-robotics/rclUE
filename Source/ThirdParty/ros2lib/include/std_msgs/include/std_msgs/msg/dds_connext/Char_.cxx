...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Char_TYPENAME = "std_msgs::msg::dds_::Char_";
            ...
            DDS_TypeCode* Char__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::Char_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Char__initialize(
                Char_* sample) {
                return std_msgs::msg::dds_::Char__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Char_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::Char__initialize_w_params(
                    sample,&allocParams);
                ...
                Char_* sample)
            {
                ...
                std_msgs::msg::dds_::Char__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Char_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::Char__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::Char__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::Char__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::Char__copy
