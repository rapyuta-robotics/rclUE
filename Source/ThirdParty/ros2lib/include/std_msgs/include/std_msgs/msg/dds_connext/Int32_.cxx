...
namespace std_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Int32_TYPENAME = "std_msgs::msg::dds_::Int32_";
            ...
            DDS_TypeCode* Int32__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_msgs::msg::dds_::Int32_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Int32__initialize(
                Int32_* sample) {
                return std_msgs::msg::dds_::Int32__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Int32_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_msgs::msg::dds_::Int32__initialize_w_params(
                    sample,&allocParams);
                ...
                Int32_* sample)
            {
                ...
                std_msgs::msg::dds_::Int32__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Int32_* sample,RTIBool deletePointers)
            {
                ...
                std_msgs::msg::dds_::Int32__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_msgs::msg::dds_::Int32__initialize_w_params

            #define T_finalize_w_params   std_msgs::msg::dds_::Int32__finalize_w_params
            #define T_copy       std_msgs::msg::dds_::Int32__copy
