        ...
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
                ...
                const struct DDS_TypeAllocationParams_t * alloc_params) 
            {
                ...
                if (!sensor_msgs::msg::dds_::Imu__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            Imu_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!sensor_msgs::msg::dds_::Imu__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return sensor_msgs::msg::dds_::Imu_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            Imu_PluginSupport_destroy_data_w_params(
                ...
                sensor_msgs::msg::dds_::Imu__finalize_w_params(sample,dealloc_params);
            ...
            Imu_PluginSupport_destroy_data_ex(
                ...
                sensor_msgs::msg::dds_::Imu__finalize_ex(sample,deallocate_pointers);
            ...
            Imu_PluginSupport_destroy_data(
                ...
                sensor_msgs::msg::dds_::Imu_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            Imu_PluginSupport_copy_data(
                ...
                const Imu_ *src)
            {
                return sensor_msgs::msg::dds_::Imu__copy(dst,(const Imu_*) src);
            }
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printArray(
                    ...
                    "orientation_covariance_", indent_level + 1);        
                ...
                RTICdrType_printArray(
                    ...
                    (RTICdrTypePrintFunction)RTICdrType_printDouble, 
                    "angular_velocity_covariance_", indent_level + 1);        
                ...
                RTICdrType_printArray(
                    ...
                    (RTICdrTypePrintFunction)RTICdrType_printDouble, 
                    "linear_acceleration_covariance_", indent_level + 1);        
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    sensor_msgs::msg::dds_::Imu_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    sensor_msgs::msg::dds_::Imu_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = sensor_msgs::msg::dds_::Imu_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        sensor_msgs::msg::dds_::Imu_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        sensor_msgs::msg::dds_::Imu_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                const Imu_ *src)
            {
                ...
                return sensor_msgs::msg::dds_::Imu_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_sample) {
                    ...
                    if (!RTICdrStream_serializePrimitiveArray(
                        stream, (void*) sample->orientation_covariance_, (9), RTI_CDR_DOUBLE_TYPE)) {
                        return RTI_FALSE;
                    }
                    ...
                    if (!RTICdrStream_serializePrimitiveArray(
                        stream, (void*) sample->angular_velocity_covariance_, (9), RTI_CDR_DOUBLE_TYPE)) {
                        return RTI_FALSE;
                    }
                    ...
                    if (!RTICdrStream_serializePrimitiveArray(
                        stream, (void*) sample->linear_acceleration_covariance_, (9), RTI_CDR_DOUBLE_TYPE)) {
                        return RTI_FALSE;
                    }
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        sensor_msgs::msg::dds_::Imu__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const Imu_ *sample)
            {
                ...
                result = sensor_msgs::msg::dds_::Imu_Plugin_serialize(
                ...
                void *endpoint_plugin_qos)
            {
                ...
                result= sensor_msgs::msg::dds_::Imu_Plugin_deserialize_sample( 
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!sensor_msgs::msg::dds_::Imu_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!sensor_msgs::msg::dds_::Imu_Plugin_deserialize_sample(
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= sensor_msgs::msg::dds_::Imu_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += sensor_msgs::msg::dds_::Imu_Plugin_get_serialized_sample_max_size_ex(
                    endpoint_data, overflow,RTI_FALSE, encapsulation_id, current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                sensor_msgs::msg::dds_::Imu_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                sensor_msgs::msg::dds_::Imu_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                sensor_msgs::msg::dds_::Imu_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                sensor_msgs::msg::dds_::Imu_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                sensor_msgs::msg::dds_::Imu_Plugin_copy_sample;
                ...
                sensor_msgs::msg::dds_::Imu_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                sensor_msgs::msg::dds_::Imu_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                sensor_msgs::msg::dds_::Imu_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                sensor_msgs::msg::dds_::Imu_Plugin_get_serialized_sample_min_size;
                ...
                sensor_msgs::msg::dds_::Imu_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)sensor_msgs::msg::dds_::Imu__get_typecode();
