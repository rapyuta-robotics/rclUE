...
#ifndef RelativeHumidity_Plugin_953196074_h
#define RelativeHumidity_Plugin_953196074_h
...
namespace sensor_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define RelativeHumidity_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define RelativeHumidity_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define RelativeHumidity_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define RelativeHumidity_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define RelativeHumidity_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern RelativeHumidity_*
            ...
            RelativeHumidity_PluginSupport_copy_data(
                RelativeHumidity_ *out,
                const RelativeHumidity_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            RelativeHumidity_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                RelativeHumidity_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            RelativeHumidity_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RelativeHumidity_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            RelativeHumidity_Plugin_new(void);

            NDDSUSERDllExport extern void
            RelativeHumidity_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* RelativeHumidity_Plugin_953196074_h */
