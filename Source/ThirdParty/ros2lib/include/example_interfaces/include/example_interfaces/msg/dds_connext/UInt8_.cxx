...
namespace example_interfaces {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *UInt8_TYPENAME = "example_interfaces::msg::dds_::UInt8_";
            ...
            DDS_TypeCode* UInt8__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"example_interfaces::msg::dds_::UInt8_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool UInt8__initialize(
                UInt8_* sample) {
                return example_interfaces::msg::dds_::UInt8__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                UInt8_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return example_interfaces::msg::dds_::UInt8__initialize_w_params(
                    sample,&allocParams);
                ...
                UInt8_* sample)
            {
                ...
                example_interfaces::msg::dds_::UInt8__finalize_ex(sample,RTI_TRUE);
            }
                ...
                UInt8_* sample,RTIBool deletePointers)
            {
                ...
                example_interfaces::msg::dds_::UInt8__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params example_interfaces::msg::dds_::UInt8__initialize_w_params

            #define T_finalize_w_params   example_interfaces::msg::dds_::UInt8__finalize_w_params
            #define T_copy       example_interfaces::msg::dds_::UInt8__copy
