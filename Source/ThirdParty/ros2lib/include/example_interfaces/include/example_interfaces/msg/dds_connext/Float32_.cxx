...
namespace example_interfaces {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Float32_TYPENAME = "example_interfaces::msg::dds_::Float32_";
            ...
            DDS_TypeCode* Float32__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"example_interfaces::msg::dds_::Float32_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Float32__initialize(
                Float32_* sample) {
                return example_interfaces::msg::dds_::Float32__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Float32_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return example_interfaces::msg::dds_::Float32__initialize_w_params(
                    sample,&allocParams);
                ...
                Float32_* sample)
            {
                ...
                example_interfaces::msg::dds_::Float32__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Float32_* sample,RTIBool deletePointers)
            {
                ...
                example_interfaces::msg::dds_::Float32__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params example_interfaces::msg::dds_::Float32__initialize_w_params

            #define T_finalize_w_params   example_interfaces::msg::dds_::Float32__finalize_w_params
            #define T_copy       example_interfaces::msg::dds_::Float32__copy
