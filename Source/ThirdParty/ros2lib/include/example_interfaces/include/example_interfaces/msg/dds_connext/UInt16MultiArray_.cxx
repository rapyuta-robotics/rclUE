...
namespace example_interfaces {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *UInt16MultiArray_TYPENAME = "example_interfaces::msg::dds_::UInt16MultiArray_";
            ...
            DDS_TypeCode* UInt16MultiArray__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"example_interfaces::msg::dds_::UInt16MultiArray_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                UInt16MultiArray__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)example_interfaces::msg::dds_::MultiArrayLayout__get_typecode();
            ...
            RTIBool UInt16MultiArray__initialize(
                ...
                return example_interfaces::msg::dds_::UInt16MultiArray__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                UInt16MultiArray_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return example_interfaces::msg::dds_::UInt16MultiArray__initialize_w_params(
                    sample,&allocParams);
                ...
                UInt16MultiArray_* sample)
            {
                ...
                example_interfaces::msg::dds_::UInt16MultiArray__finalize_ex(sample,RTI_TRUE);
            }
                ...
                UInt16MultiArray_* sample,RTIBool deletePointers)
            {
                ...
                example_interfaces::msg::dds_::UInt16MultiArray__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params example_interfaces::msg::dds_::UInt16MultiArray__initialize_w_params

            #define T_finalize_w_params   example_interfaces::msg::dds_::UInt16MultiArray__finalize_w_params
            #define T_copy       example_interfaces::msg::dds_::UInt16MultiArray__copy
