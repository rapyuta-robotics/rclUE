    ...
    namespace msg {
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                MultiDOFJointState_ *sample = NULL;

                sample = new (std::nothrow) MultiDOFJointState_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!sensor_msgs::msg::dds_::MultiDOFJointState__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            MultiDOFJointState_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!sensor_msgs::msg::dds_::MultiDOFJointState__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return sensor_msgs::msg::dds_::MultiDOFJointState_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            MultiDOFJointState_PluginSupport_destroy_data_w_params(
                ...
                sensor_msgs::msg::dds_::MultiDOFJointState__finalize_w_params(sample,dealloc_params);
            ...
            MultiDOFJointState_PluginSupport_destroy_data_ex(
                ...
                sensor_msgs::msg::dds_::MultiDOFJointState__finalize_ex(sample,deallocate_pointers);
            ...
            MultiDOFJointState_PluginSupport_destroy_data(
                ...
                sensor_msgs::msg::dds_::MultiDOFJointState_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return sensor_msgs::msg::dds_::MultiDOFJointState__copy(dst,(const MultiDOFJointState_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    sensor_msgs::msg::dds_::MultiDOFJointState_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    sensor_msgs::msg::dds_::MultiDOFJointState_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                MultiDOFJointState__finalize_optional_members(sample, RTI_TRUE);
                ...
                const MultiDOFJointState_ *src)
            {
                ...
                return sensor_msgs::msg::dds_::MultiDOFJointState_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        sensor_msgs::msg::dds_::MultiDOFJointState__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const MultiDOFJointState_ *sample)
            {
                ...
                result = sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                MultiDOFJointState__finalize_optional_members(sample, RTI_TRUE);
                return MultiDOFJointState_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!MultiDOFJointState_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                data = DDS_DynamicData_new(
                    MultiDOFJointState__get_typecode(), 
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "MultiDOFJointState_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_deserialize_sample( 
            ...
            RTIBool MultiDOFJointState_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = MultiDOFJointState_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool MultiDOFJointState_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                MultiDOFJointState_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_deserialize_sample(
            ...
            RTIBool MultiDOFJointState_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                MultiDOFJointState_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = MultiDOFJointState_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *MultiDOFJointState_Plugin_new(void) 
            { 
                ...
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                MultiDOFJointState_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                MultiDOFJointState_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                MultiDOFJointState__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_min_size;

                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                MultiDOFJointState_Plugin_get_sample;
                ...
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)sensor_msgs::msg::dds_::MultiDOFJointState__get_typecode();
                ...
                MultiDOFJointState_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                MultiDOFJointState_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                sensor_msgs::msg::dds_::MultiDOFJointState_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = MultiDOFJointState_TYPENAME;

                return plugin;
            }

            void
            MultiDOFJointState_Plugin_delete(struct PRESTypePlugin *plugin)
            {
