...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovariance__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovariance__fini(
        geometry_msgs__msg__AccelWithCovariance* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__AccelWithCovariance*
    geometry_msgs__msg__AccelWithCovariance__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovariance__destroy(
        geometry_msgs__msg__AccelWithCovariance* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovariance__are_equal(
        const geometry_msgs__msg__AccelWithCovariance* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovariance__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovariance__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovariance__Sequence__fini(
        geometry_msgs__msg__AccelWithCovariance__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__AccelWithCovariance__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovariance__Sequence__destroy(
        geometry_msgs__msg__AccelWithCovariance__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovariance__Sequence__are_equal(
        const geometry_msgs__msg__AccelWithCovariance__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovariance__Sequence__copy(
