...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_message_member_array[2] = {
            {
                "linear",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_message_members = {
            ...
            geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_init_function,    // function to initialize message
                                                                                                   // memory (memory has to be
                                                                                                   // allocated)
            geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_message_type_support_handle = {
            0,
            &geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Twist)()
    {
        ...
        geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_message_member_array[1].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Vector3)();
        if (!geometry_msgs__msg__Twist__rosidl_typesupport_introspection_c__Twist_message_type_support_handle
