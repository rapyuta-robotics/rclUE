...
{
public:
    explicit Init_TransformStamped_transform(::geometry_msgs::msg::TransformStamped& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_TransformStamped_child_frame_id(::geometry_msgs::msg::TransformStamped& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_TransformStamped_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::TransformStamped>()
{
