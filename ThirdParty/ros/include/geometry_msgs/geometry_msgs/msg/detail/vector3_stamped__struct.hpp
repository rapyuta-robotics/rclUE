...
struct Vector3Stamped_
{
    ...
    explicit Vector3Stamped_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), vector(_alloc, _init)
    {
        (void)_init;
    }
    ...
    _header_type header;
    using _vector_type = geometry_msgs::msg::Vector3_<ContainerAllocator>;
    _vector_type vector;
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__geometry_msgs__msg__Vector3Stamped std::shared_ptr<geometry_msgs::msg::Vector3Stamped_<ContainerAllocator>>
        Ptr;
...
using Vector3Stamped = geometry_msgs::msg::Vector3Stamped_<std::allocator<void>>;
