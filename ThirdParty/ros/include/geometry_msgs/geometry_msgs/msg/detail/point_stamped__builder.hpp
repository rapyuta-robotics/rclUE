...
{
public:
    explicit Init_PointStamped_point(::geometry_msgs::msg::PointStamped& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PointStamped_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::PointStamped>()
{
