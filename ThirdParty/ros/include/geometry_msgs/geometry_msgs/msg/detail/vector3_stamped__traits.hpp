...
inline void to_flow_style_yaml(const Vector3Stamped& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const Vector3Stamped& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::Vector3Stamped& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct is_message<geometry_msgs::msg::Vector3Stamped> : std::true_type
{
};
