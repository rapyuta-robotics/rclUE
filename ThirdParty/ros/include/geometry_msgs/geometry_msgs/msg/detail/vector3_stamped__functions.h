...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__Vector3Stamped__init(geometry_msgs__msg__Vector3Stamped* msg);

    /// Finalize msg/Vector3Stamped message.
    /**
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__Vector3Stamped__fini(geometry_msgs__msg__Vector3Stamped* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__Vector3Stamped* geometry_msgs__msg__Vector3Stamped__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__Vector3Stamped__destroy(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__Vector3Stamped__are_equal(
        const geometry_msgs__msg__Vector3Stamped* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__Vector3Stamped__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__Vector3Stamped__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__Vector3Stamped__Sequence__fini(
        geometry_msgs__msg__Vector3Stamped__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__Vector3Stamped__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__Vector3Stamped__Sequence__destroy(
        geometry_msgs__msg__Vector3Stamped__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__Vector3Stamped__Sequence__are_equal(
        const geometry_msgs__msg__Vector3Stamped__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__Vector3Stamped__Sequence__copy(
