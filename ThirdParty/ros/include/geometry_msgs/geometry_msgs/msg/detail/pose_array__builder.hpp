...
{
public:
    explicit Init_PoseArray_poses(::geometry_msgs::msg::PoseArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PoseArray_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::PoseArray>()
{
