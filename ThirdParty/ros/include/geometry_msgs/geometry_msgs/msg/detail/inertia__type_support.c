...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__Inertia__rosidl_typesupport_introspection_c__Inertia_message_member_array[8] = {
            {
                "m",                                                    // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__Inertia__rosidl_typesupport_introspection_c__Inertia_message_members = {
            ...
            geometry_msgs__msg__Inertia__rosidl_typesupport_introspection_c__Inertia_init_function,    // function to initialize
                                                                                                       // message memory (memory has
                                                                                                       // to be allocated)
            geometry_msgs__msg__Inertia__rosidl_typesupport_introspection_c__Inertia_fini_function     // function to terminate
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Inertia)()
    {
        ...
        if (!geometry_msgs__msg__Inertia__rosidl_typesupport_introspection_c__Inertia_message_type_support_handle
