...
void Polygon_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__Polygon__points(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const geometry_msgs::msg::Point32*>(get_const_function__Polygon__points(untyped_member, index));
    auto& value = *reinterpret_cast<geometry_msgs::msg::Point32*>(untyped_value);
    value = item;
}

void assign_function__Polygon__points(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<geometry_msgs::msg::Point32*>(get_function__Polygon__points(untyped_member, index));
