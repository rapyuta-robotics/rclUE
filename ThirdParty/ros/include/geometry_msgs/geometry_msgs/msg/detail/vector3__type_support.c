...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_message_member_array[3] = {
            {
                "x",                                                    // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_message_members = {
            ...
            geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_init_function,    // function to initialize
                                                                                                       // message memory (memory has
                                                                                                       // to be allocated)
            geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_message_type_support_handle = {
            0,
            &geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_message_members,
    ...
    {
        if (!geometry_msgs__msg__Vector3__rosidl_typesupport_introspection_c__Vector3_message_type_support_handle
