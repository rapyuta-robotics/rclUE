...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__TwistWithCovariance__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__TwistWithCovariance__fini(
        geometry_msgs__msg__TwistWithCovariance* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__TwistWithCovariance*
    geometry_msgs__msg__TwistWithCovariance__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__TwistWithCovariance__destroy(
        geometry_msgs__msg__TwistWithCovariance* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__TwistWithCovariance__are_equal(
        const geometry_msgs__msg__TwistWithCovariance* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__TwistWithCovariance__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__TwistWithCovariance__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__TwistWithCovariance__Sequence__fini(
        geometry_msgs__msg__TwistWithCovariance__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__TwistWithCovariance__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__TwistWithCovariance__Sequence__destroy(
        geometry_msgs__msg__TwistWithCovariance__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__TwistWithCovariance__Sequence__are_equal(
        const geometry_msgs__msg__TwistWithCovariance__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__TwistWithCovariance__Sequence__copy(
