...
struct Twist_
{
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::Twist_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::Twist_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::Twist_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::Twist_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::Twist_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::Twist_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::Twist_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::Twist_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<geometry_msgs::msg::Twist_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::Twist_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__geometry_msgs__msg__Twist std::shared_ptr<geometry_msgs::msg::Twist_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__geometry_msgs__msg__Twist std::shared_ptr<geometry_msgs::msg::Twist_<ContainerAllocator> const> ConstPtr;
