...
inline void to_flow_style_yaml(const Inertia& msg, std::ostream& out)
{
    out << "{";
    // member: m
    {
...
inline void to_block_style_yaml(const Inertia& msg, std::ostream& out, size_t indentation = 0)
{
    // member: m
    {
        if (indentation > 0)
...
[[deprecated("use geometry_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const geometry_msgs::msg::Inertia& msg,
                                                                                            std::ostream& out,
...
[[deprecated("use geometry_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const geometry_msgs::msg::Inertia& msg)
{
...
template<>
struct is_message<geometry_msgs::msg::Inertia> : std::true_type
{
};
