...
{
public:
    explicit Init_Vector3_z(::geometry_msgs::msg::Vector3& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Vector3_y(::geometry_msgs::msg::Vector3& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Vector3_x() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Vector3>()
{
