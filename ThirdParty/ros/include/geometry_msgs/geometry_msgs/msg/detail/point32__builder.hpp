...
{
public:
    explicit Init_Point32_z(::geometry_msgs::msg::Point32& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Point32_y(::geometry_msgs::msg::Point32& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Point32_x() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Point32>()
{
