...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__Point__rosidl_typesupport_introspection_c__Point_message_member_array[3] = {
            {
                "x",                                                    // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__Point__rosidl_typesupport_introspection_c__Point_message_members = {
            ...
            geometry_msgs__msg__Point__rosidl_typesupport_introspection_c__Point_init_function,    // function to initialize message
                                                                                                   // memory (memory has to be
                                                                                                   // allocated)
            geometry_msgs__msg__Point__rosidl_typesupport_introspection_c__Point_fini_function     // function to terminate message
    ...
    {
        if (!geometry_msgs__msg__Point__rosidl_typesupport_introspection_c__Point_message_type_support_handle
