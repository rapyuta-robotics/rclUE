...
{
public:
    explicit Init_Inertia_izz(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Inertia_iyz(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Inertia_iyy(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Inertia_ixz(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Inertia_ixy(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Inertia_ixx(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Inertia_com(::geometry_msgs::msg::Inertia& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Inertia_m() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Inertia>()
{
