...
inline void to_flow_style_yaml(const Accel& msg, std::ostream& out)
{
    out << "{";
    // member: linear
    {
...
inline void to_block_style_yaml(const Accel& msg, std::ostream& out, size_t indentation = 0)
{
    // member: linear
    {
        if (indentation > 0)
...
[[deprecated("use geometry_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const geometry_msgs::msg::Accel& msg,
                                                                                            std::ostream& out,
...
[[deprecated("use geometry_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const geometry_msgs::msg::Accel& msg)
{
...
template<>
struct has_fixed_size<geometry_msgs::msg::Accel> : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Vector3>::value>
{
};
...
template<>
struct is_message<geometry_msgs::msg::Accel> : std::true_type
{
};
