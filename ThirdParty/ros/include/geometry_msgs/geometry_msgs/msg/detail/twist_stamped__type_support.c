...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_message_member_array[2] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_message_members = {
            ...
            geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_message_member_array,    // message
                                                                                                                        // members
            geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_init_function,    // function to
                                                                                                                 // initialize
                                                                                                                 // message memory
                                                                                                                 // (memory has to
                                                                                                                 // be allocated)
            geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_fini_function     // function to
                                                                                                                // terminate message
                                                                                                                // instance (will
                                                                                                                // not free memory)
    };
    ...
    static rosidl_message_type_support_t
        geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_message_type_support_handle = {
            0,
            &geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, TwistStamped)()
    {
        ...
        if (!geometry_msgs__msg__TwistStamped__rosidl_typesupport_introspection_c__TwistStamped_message_type_support_handle
