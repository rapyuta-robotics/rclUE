...
{
public:
    explicit Init_TwistWithCovarianceStamped_twist(::geometry_msgs::msg::TwistWithCovarianceStamped& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_TwistWithCovarianceStamped_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::TwistWithCovarianceStamped>()
{
