...
{
public:
    explicit Init_Quaternion_w(::geometry_msgs::msg::Quaternion& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Quaternion_z(::geometry_msgs::msg::Quaternion& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Quaternion_y(::geometry_msgs::msg::Quaternion& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Quaternion_x() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Quaternion>()
{
