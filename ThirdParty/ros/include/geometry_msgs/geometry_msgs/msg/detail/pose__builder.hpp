...
{
public:
    explicit Init_Pose_orientation(::geometry_msgs::msg::Pose& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Pose_position() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Pose>()
{
