...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_geometry_msgs cdr_serialize(const geometry_msgs::msg::TwistWithCovariance& ros_message,
...
get_serialized_size(const geometry_msgs::msg::TwistWithCovariance& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_geometry_msgs max_serialized_size_TwistWithCovariance(bool& full_bounded,
                                                                                                    bool& is_plain,
