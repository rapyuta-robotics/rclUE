...
struct TransformStamped_
{
    ...
    explicit TransformStamped_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), child_frame_id(_alloc), transform(_alloc, _init)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->child_frame_id = "";
    ...
    using _transform_type = geometry_msgs::msg::Transform_<ContainerAllocator>;
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::TransformStamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::TransformStamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::TransformStamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::TransformStamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::TransformStamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::TransformStamped_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::TransformStamped_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::TransformStamped_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<geometry_msgs::msg::TransformStamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::TransformStamped_<ContainerAllocator> const>;
...
using TransformStamped = geometry_msgs::msg::TransformStamped_<std::allocator<void>>;
