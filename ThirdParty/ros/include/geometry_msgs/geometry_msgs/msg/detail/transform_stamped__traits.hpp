...
inline void to_flow_style_yaml(const TransformStamped& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const TransformStamped& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::TransformStamped& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<geometry_msgs::msg::TransformStamped> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<geometry_msgs::msg::TransformStamped> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<geometry_msgs::msg::TransformStamped> : std::true_type
{
};
