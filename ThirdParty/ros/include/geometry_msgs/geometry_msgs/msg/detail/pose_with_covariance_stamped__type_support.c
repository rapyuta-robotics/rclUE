...
extern "C"
{
    ...
    void geometry_msgs__msg__PoseWithCovarianceStamped__rosidl_typesupport_introspection_c__PoseWithCovarianceStamped_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__PoseWithCovarianceStamped__rosidl_typesupport_introspection_c__PoseWithCovarianceStamped_message_member_array
            [2] = {{
                       "header",                                                // name
    ...
    static rosidl_message_type_support_t
        geometry_msgs__msg__PoseWithCovarianceStamped__rosidl_typesupport_introspection_c__PoseWithCovarianceStamped_message_type_support_handle =
            {
                0,
                &geometry_msgs__msg__PoseWithCovarianceStamped__rosidl_typesupport_introspection_c__PoseWithCovarianceStamped_message_members,
                                                      ...
                                                      PoseWithCovarianceStamped)()
    {
        ...
        if (!geometry_msgs__msg__PoseWithCovarianceStamped__rosidl_typesupport_introspection_c__PoseWithCovarianceStamped_message_type_support_handle
