...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_message_member_array[2] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_message_members = {
            ...
            geometry_msgs__msg__PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_message_member_array,    // message
                                                                                                                            // members
            geometry_msgs__msg__PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_init_function,    // function to
                                                                                                                     // initialize
                                                                                                                     // message
                                                                                                                     // memory
                                                                                                                     // (memory has
                                                                                                                     // to be
                                                                                                                     // allocated)
            geometry_msgs__msg__PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_fini_function     // function to
                                                                                                                     // terminate
                                                                                                                     // message
                                                                                                                     // instance
                                                                                                                     // (will not
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PolygonStamped)()
    {
        ...
        if (!geometry_msgs__msg__PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_message_type_support_handle
