...
extern "C"
{
    ...
    get_serialized_size_geometry_msgs__msg__Vector3Stamped(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geometry_msgs size_t
    max_serialized_size_geometry_msgs__msg__Vector3Stamped(bool& full_bounded, bool& is_plain, size_t current_alignment);
