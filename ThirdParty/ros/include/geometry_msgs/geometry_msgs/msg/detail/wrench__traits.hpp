...
inline void to_flow_style_yaml(const Wrench& msg, std::ostream& out)
{
    out << "{";
    // member: force
    {
...
inline void to_block_style_yaml(const Wrench& msg, std::ostream& out, size_t indentation = 0)
{
    // member: force
    {
        if (indentation > 0)
...
[[deprecated("use geometry_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const geometry_msgs::msg::Wrench& msg,
                                                                                            std::ostream& out,
...
[[deprecated("use geometry_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const geometry_msgs::msg::Wrench& msg)
{
...
template<>
struct has_fixed_size<geometry_msgs::msg::Wrench> : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Vector3>::value>
{
};
...
template<>
struct is_message<geometry_msgs::msg::Wrench> : std::true_type
{
};
