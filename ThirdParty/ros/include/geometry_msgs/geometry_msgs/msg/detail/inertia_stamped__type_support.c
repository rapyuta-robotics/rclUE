...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_message_member_array[2] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_message_members = {
            ...
            geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_message_member_array,    // message
                                                                                                                            // members
            geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_init_function,    // function to
                                                                                                                     // initialize
                                                                                                                     // message
                                                                                                                     // memory
                                                                                                                     // (memory has
                                                                                                                     // to be
                                                                                                                     // allocated)
            geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_fini_function     // function to
                                                                                                                     // terminate
                                                                                                                     // message
                                                                                                                     // instance
                                                                                                                     // (will not
    ...
    static rosidl_message_type_support_t
        geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_message_type_support_handle = {
            0,
            &geometry_msgs__msg__InertiaStamped__rosidl_typesupport_introspection_c__InertiaStamped_message_members,
