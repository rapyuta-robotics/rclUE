...
struct TwistWithCovarianceStamped_
{
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator> const>;
...
using TwistWithCovarianceStamped = geometry_msgs::msg::TwistWithCovarianceStamped_<std::allocator<void>>;
