...
{
public:
    explicit Init_PolygonStamped_polygon(::geometry_msgs::msg::PolygonStamped& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PolygonStamped_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::PolygonStamped>()
{
