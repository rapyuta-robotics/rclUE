...
struct PolygonStamped_
{
    ...
    explicit PolygonStamped_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), polygon(_alloc, _init)
    {
        (void)_init;
    }
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::PolygonStamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::PolygonStamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::PolygonStamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::PolygonStamped_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__geometry_msgs__msg__PolygonStamped std::shared_ptr<geometry_msgs::msg::PolygonStamped_<ContainerAllocator>>
        Ptr;
...
using PolygonStamped = geometry_msgs::msg::PolygonStamped_<std::allocator<void>>;
