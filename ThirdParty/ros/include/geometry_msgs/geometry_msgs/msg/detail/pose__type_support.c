...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__Pose__rosidl_typesupport_introspection_c__Pose_message_member_array[2] = {
            {
                "position",                                              // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__Pose__rosidl_typesupport_introspection_c__Pose_message_members = {
            ...
            geometry_msgs__msg__Pose__rosidl_typesupport_introspection_c__Pose_init_function,    // function to initialize message
                                                                                                 // memory (memory has to be
                                                                                                 // allocated)
            geometry_msgs__msg__Pose__rosidl_typesupport_introspection_c__Pose_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        geometry_msgs__msg__Pose__rosidl_typesupport_introspection_c__Pose_message_type_support_handle = {
            0,
            &geometry_msgs__msg__Pose__rosidl_typesupport_introspection_c__Pose_message_members,
