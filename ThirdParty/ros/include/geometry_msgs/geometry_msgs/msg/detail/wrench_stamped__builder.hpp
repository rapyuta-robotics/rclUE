...
{
public:
    explicit Init_WrenchStamped_wrench(::geometry_msgs::msg::WrenchStamped& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_WrenchStamped_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::WrenchStamped>()
{
