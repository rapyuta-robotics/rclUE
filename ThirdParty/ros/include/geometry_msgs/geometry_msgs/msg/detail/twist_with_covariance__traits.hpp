...
inline void to_flow_style_yaml(const TwistWithCovariance& msg, std::ostream& out)
{
    out << "{";
    // member: twist
    {
...
inline void to_block_style_yaml(const TwistWithCovariance& msg, std::ostream& out, size_t indentation = 0)
{
    // member: twist
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::TwistWithCovariance& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct is_message<geometry_msgs::msg::TwistWithCovariance> : std::true_type
{
};
