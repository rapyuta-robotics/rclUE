...
inline void to_flow_style_yaml(const QuaternionStamped& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const QuaternionStamped& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::QuaternionStamped& msg, std::ostream& out, size_t indentation = 0)
{
...
struct has_fixed_size<geometry_msgs::msg::QuaternionStamped>
    : std::integral_constant<bool,
                             has_fixed_size<geometry_msgs::msg::Quaternion>::value && has_fixed_size<std_msgs::msg::Header>::value>
{
};
...
template<>
struct is_message<geometry_msgs::msg::QuaternionStamped> : std::true_type
{
};
