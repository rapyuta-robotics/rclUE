...
{
public:
    explicit Init_Pose2D_theta(::geometry_msgs::msg::Pose2D& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Pose2D_y(::geometry_msgs::msg::Pose2D& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Pose2D_x() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Pose2D>()
{
