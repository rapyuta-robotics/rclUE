...
inline void to_flow_style_yaml(const Transform& msg, std::ostream& out)
{
    out << "{";
    // member: translation
    {
...
inline void to_block_style_yaml(const Transform& msg, std::ostream& out, size_t indentation = 0)
{
    // member: translation
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::Transform& msg, std::ostream& out, size_t indentation = 0)
{
    geometry_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use geometry_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const geometry_msgs::msg::Transform& msg)
{
...
struct has_fixed_size<geometry_msgs::msg::Transform>
    : std::integral_constant<bool,
                             has_fixed_size<geometry_msgs::msg::Quaternion>::value &&
                                 has_fixed_size<geometry_msgs::msg::Vector3>::value>
{
};
...
template<>
struct is_message<geometry_msgs::msg::Transform> : std::true_type
{
};
