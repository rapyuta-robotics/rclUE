...
struct AccelWithCovarianceStamped_
{
    ...
    explicit AccelWithCovarianceStamped_(
    ...
    _header_type header;
    using _accel_type = geometry_msgs::msg::AccelWithCovariance_<ContainerAllocator>;
    _accel_type accel;
    ...
    Type& set__accel(const geometry_msgs::msg::AccelWithCovariance_<ContainerAllocator>& _arg)
    {
        this->accel = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator> const>;
...
using AccelWithCovarianceStamped = geometry_msgs::msg::AccelWithCovarianceStamped_<std::allocator<void>>;
