...
struct TwistStamped_
{
    ...
    explicit TwistStamped_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), twist(_alloc, _init)
    {
        (void)_init;
    }
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::TwistStamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::TwistStamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::TwistStamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::TwistStamped_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__geometry_msgs__msg__TwistStamped std::shared_ptr<geometry_msgs::msg::TwistStamped_<ContainerAllocator>> Ptr;
...
using TwistStamped = geometry_msgs::msg::TwistStamped_<std::allocator<void>>;
