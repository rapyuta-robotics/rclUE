...
inline void to_flow_style_yaml(const AccelWithCovariance& msg, std::ostream& out)
{
    out << "{";
    // member: accel
    {
...
inline void to_block_style_yaml(const AccelWithCovariance& msg, std::ostream& out, size_t indentation = 0)
{
    // member: accel
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::AccelWithCovariance& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct is_message<geometry_msgs::msg::AccelWithCovariance> : std::true_type
{
};
