...
struct PoseWithCovarianceStamped_
{
    ...
    // pointer types
    using RawPtr = geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>*;
    using ConstRawPtr = const geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator> const>;
...
using PoseWithCovarianceStamped = geometry_msgs::msg::PoseWithCovarianceStamped_<std::allocator<void>>;
