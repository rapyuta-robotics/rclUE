...
inline void to_flow_style_yaml(const PoseWithCovariance& msg, std::ostream& out)
{
    out << "{";
    // member: pose
    {
...
inline void to_block_style_yaml(const PoseWithCovariance& msg, std::ostream& out, size_t indentation = 0)
{
    // member: pose
    {
        if (indentation > 0)
...
to_yaml(const geometry_msgs::msg::PoseWithCovariance& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct is_message<geometry_msgs::msg::PoseWithCovariance> : std::true_type
{
};
