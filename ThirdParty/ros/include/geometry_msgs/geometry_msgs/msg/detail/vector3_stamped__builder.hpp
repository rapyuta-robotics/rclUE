...
{
public:
    explicit Init_Vector3Stamped_vector(::geometry_msgs::msg::Vector3Stamped& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Vector3Stamped_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Vector3Stamped>()
{
