...
{
public:
    explicit Init_Wrench_torque(::geometry_msgs::msg::Wrench& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Wrench_force() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::geometry_msgs::msg::Wrench>()
{
