...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovarianceStamped__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovarianceStamped__fini(
        geometry_msgs__msg__AccelWithCovarianceStamped* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__AccelWithCovarianceStamped*
    geometry_msgs__msg__AccelWithCovarianceStamped__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovarianceStamped__destroy(
        geometry_msgs__msg__AccelWithCovarianceStamped* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovarianceStamped__are_equal(
        const geometry_msgs__msg__AccelWithCovarianceStamped* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovarianceStamped__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__fini(
        geometry_msgs__msg__AccelWithCovarianceStamped__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs geometry_msgs__msg__AccelWithCovarianceStamped__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs void geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__destroy(
        geometry_msgs__msg__AccelWithCovarianceStamped__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs bool geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__copy(
