...
extern "C"
{
    ...
    void* geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__get_function__Polygon__points(void* untyped_member,
                                                                                                         size_t index)
    {
        ...
        void* untyped_value)
    {
        const geometry_msgs__msg__Point32* item =
            ((const geometry_msgs__msg__Point32*)
                 geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__get_const_function__Polygon__points(
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__Point32* item =
            ((geometry_msgs__msg__Point32*)
                 geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__get_function__Polygon__points(untyped_member,
                                                                                                                index));
        const geometry_msgs__msg__Point32* value = (const geometry_msgs__msg__Point32*)(untyped_value);
        *item = *value;
    }

    bool geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__resize_function__Polygon__points(void* untyped_member,
                                                                                                           size_t size)
    {
        geometry_msgs__msg__Point32__Sequence* member = (geometry_msgs__msg__Point32__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__Polygon_message_member_array[1] = {{
            "points",                                                // name
            ...
            NULL,                                                    // default value
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__size_function__Polygon__points,    // size() function
                                                                                                                // pointer
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__get_const_function__Polygon__points,    // get_const(index)
                                                                                                                     // function
                                                                                                                     // pointer
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__get_function__Polygon__points,      // get(index)
                                                                                                                 // function pointer
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__fetch_function__Polygon__points,    // fetch(index,
                                                                                                                 // &value) function
                                                                                                                 // pointer
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__assign_function__Polygon__points,    // assign(index,
                                                                                                                  // value) function
                                                                                                                  // pointer
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__resize_function__Polygon__points     // resize(index)
                                                                                                                 // function pointer
        }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__Polygon_message_members = {
            ...
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__Polygon_init_function,    // function to initialize
                                                                                                       // message memory (memory has
                                                                                                       // to be allocated)
            geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__Polygon_fini_function     // function to terminate
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Polygon)()
    {
        ...
        if (!geometry_msgs__msg__Polygon__rosidl_typesupport_introspection_c__Polygon_message_type_support_handle
