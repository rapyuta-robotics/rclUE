...
#define ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_INIT(STRUCT_NAME)         \
    ...
    bool rosidl_runtime_c__##STRUCT_NAME##__Sequence__init(rosidl_runtime_c__##STRUCT_NAME##__Sequence* sequence, size_t size);
...
#define ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_FINI(STRUCT_NAME)         \
    ...
    ROSIDL_GENERATOR_C_PUBLIC                                                  \
    void rosidl_runtime_c__##STRUCT_NAME##__Sequence__fini(rosidl_runtime_c__##STRUCT_NAME##__Sequence* sequence);
...
#define ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_EQ(STRUCT_NAME)                                                    \
    ...
    ROSIDL_GENERATOR_C_PUBLIC                                                                                           \
    bool rosidl_runtime_c__##STRUCT_NAME##__Sequence__are_equal(const rosidl_runtime_c__##STRUCT_NAME##__Sequence* lhs, \
...
#define ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(STRUCT_NAME)                                               \
    ...
    ROSIDL_GENERATOR_C_PUBLIC                                                                                        \
    bool rosidl_runtime_c__##STRUCT_NAME##__Sequence__copy(const rosidl_runtime_c__##STRUCT_NAME##__Sequence* input, \
...
#define ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_FUNCTIONS(STRUCT_NAME) \
    ...
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__bool__Sequence__are_equal(const rosidl_runtime_c__boolean__Sequence* lhs,
                                                     const rosidl_runtime_c__boolean__Sequence* rhs);
    /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(bool) */
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__bool__Sequence__copy(const rosidl_runtime_c__boolean__Sequence* input,
    ...
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__float32__Sequence__are_equal(const rosidl_runtime_c__float__Sequence* lhs,
                                                        const rosidl_runtime_c__float__Sequence* rhs);
    /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(float32) */
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__float32__Sequence__copy(const rosidl_runtime_c__float__Sequence* input,
    ...
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__float64__Sequence__are_equal(const rosidl_runtime_c__double__Sequence* lhs,
                                                        const rosidl_runtime_c__double__Sequence* rhs);
    /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(float64) */
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__float64__Sequence__copy(const rosidl_runtime_c__double__Sequence* input,
