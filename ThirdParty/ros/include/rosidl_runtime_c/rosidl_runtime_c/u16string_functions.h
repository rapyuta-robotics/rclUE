...
extern "C"
{
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__U16String__are_equal(const rosidl_runtime_c__U16String* lhs, const rosidl_runtime_c__U16String* rhs);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__U16String__Sequence__are_equal(const rosidl_runtime_c__U16String__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC
    bool rosidl_runtime_c__U16String__Sequence__copy(const rosidl_runtime_c__U16String__Sequence* input,
