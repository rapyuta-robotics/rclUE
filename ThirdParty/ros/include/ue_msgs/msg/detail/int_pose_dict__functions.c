...
ue_msgs__msg__IntPoseDict__init(ue_msgs__msg__IntPoseDict * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ue_msgs__msg__IntPoseDict__fini(msg);
    return false;
  }
  // entries
  if (!ue_msgs__msg__IntPoseEntry__Sequence__init(&msg->entries, 0)) {
    ue_msgs__msg__IntPoseDict__fini(msg);
    return false;
  }
  return true;
...
ue_msgs__msg__IntPoseDict__fini(ue_msgs__msg__IntPoseDict * msg)
{
  ...
  // entries
  ue_msgs__msg__IntPoseEntry__Sequence__fini(&msg->entries);
}
...
ue_msgs__msg__IntPoseDict__are_equal(const ue_msgs__msg__IntPoseDict * lhs, const ue_msgs__msg__IntPoseDict * rhs)
{
  ...
  // entries
  if (!ue_msgs__msg__IntPoseEntry__Sequence__are_equal(
  ...
  ue_msgs__msg__IntPoseDict * output)
{
  ...
  // entries
  if (!ue_msgs__msg__IntPoseEntry__Sequence__copy(
...
ue_msgs__msg__IntPoseDict__create()
{
  ...
  ue_msgs__msg__IntPoseDict * msg = (ue_msgs__msg__IntPoseDict *)allocator.allocate(sizeof(ue_msgs__msg__IntPoseDict), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ue_msgs__msg__IntPoseDict));
  bool success = ue_msgs__msg__IntPoseDict__init(msg);
  if (!success) {
...
ue_msgs__msg__IntPoseDict__Sequence__init(ue_msgs__msg__IntPoseDict__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ue_msgs__msg__IntPoseDict * data = NULL;

  if (size) {
    data = (ue_msgs__msg__IntPoseDict *)allocator.zero_allocate(size, sizeof(ue_msgs__msg__IntPoseDict), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ue_msgs__msg__IntPoseDict__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ue_msgs__msg__IntPoseDict__fini(&data[i - 1]);
      }
...
ue_msgs__msg__IntPoseDict__Sequence__fini(ue_msgs__msg__IntPoseDict__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ue_msgs__msg__IntPoseDict__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ue_msgs__msg__IntPoseDict__Sequence * array = (ue_msgs__msg__IntPoseDict__Sequence *)allocator.allocate(sizeof(ue_msgs__msg__IntPoseDict__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ue_msgs__msg__IntPoseDict__Sequence__init(array, size);
  if (!success) {
...
ue_msgs__msg__IntPoseDict__Sequence__destroy(ue_msgs__msg__IntPoseDict__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ue_msgs__msg__IntPoseDict__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ue_msgs__msg__IntPoseDict__Sequence__are_equal(const ue_msgs__msg__IntPoseDict__Sequence * lhs, const ue_msgs__msg__IntPoseDict__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ue_msgs__msg__IntPoseDict__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ue_msgs__msg__IntPoseDict__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ue_msgs__msg__IntPoseDict);
    ue_msgs__msg__IntPoseDict * data =
      (ue_msgs__msg__IntPoseDict *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__msg__IntPoseDict__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ue_msgs__msg__IntPoseDict__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ue_msgs__msg__IntPoseDict__copy(
