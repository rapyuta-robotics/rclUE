...
struct IntPointDict_
{
  ...
  _header_type header;
  using _entries_type =
    std::vector<ue_msgs::msg::IntPointEntry_<ContainerAllocator>, typename ContainerAllocator::template rebind<ue_msgs::msg::IntPointEntry_<ContainerAllocator>>::other>;
  ...
  Type & set__entries(
    const std::vector<ue_msgs::msg::IntPointEntry_<ContainerAllocator>, typename ContainerAllocator::template rebind<ue_msgs::msg::IntPointEntry_<ContainerAllocator>>::other> & _arg)
  {
    this->entries = _arg;
    return *this;
  }
