...
struct HitEvent_
{
    ...
    explicit HitEvent_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : normal_impluse(_init), hit_result(_init)
    {
    ...
    explicit HitEvent_(const ContainerAllocator& _alloc,
    ...
    using _normal_impluse_type = geometry_msgs::msg::Vector3_<ContainerAllocator>;
    ...
    Type& set__normal_impluse(const geometry_msgs::msg::Vector3_<ContainerAllocator>& _arg)
    {
    ...
    // pointer types
    using RawPtr = ue_msgs::msg::HitEvent_<ContainerAllocator>*;
    using ConstRawPtr = const ue_msgs::msg::HitEvent_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<ue_msgs::msg::HitEvent_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<ue_msgs::msg::HitEvent_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__ue_msgs__msg__HitEvent std::shared_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__ue_msgs__msg__HitEvent std::shared_ptr<ue_msgs::msg::HitEvent_<ContainerAllocator> const> ConstPtr;
...
using HitEvent = ue_msgs::msg::HitEvent_<std::allocator<void>>;
