...
extern "C"
{
    ...
    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ue_msgs size_t get_serialized_size_ue_msgs__msg__HitEvent(const void* untyped_ros_message,
                                                                                                   size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ue_msgs size_t max_serialized_size_ue_msgs__msg__HitEvent(bool& full_bounded,
                                                                                                   size_t current_alignment);
