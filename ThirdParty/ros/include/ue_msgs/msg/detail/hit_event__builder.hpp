...
{
public:
    explicit Init_HitEvent_other_component_name(::ue_msgs::msg::HitEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitEvent_hit_result(::ue_msgs::msg::HitEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitEvent_normal_impluse(::ue_msgs::msg::HitEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitEvent_other_actor_name(::ue_msgs::msg::HitEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_HitEvent_self_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::msg::HitEvent>()
{
