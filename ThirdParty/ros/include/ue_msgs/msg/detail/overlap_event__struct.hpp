...
struct OverlapEvent_
{
    ...
    using _other_body_index_type = int32_t;
    ...
    Type& set__other_body_index(const int32_t& _arg)
    {
        this->other_body_index = _arg;
        return *this;
    }
    Type& set__from_sweep(const bool& _arg)
    {
    ...
    // pointer types
    using RawPtr = ue_msgs::msg::OverlapEvent_<ContainerAllocator>*;
    using ConstRawPtr = const ue_msgs::msg::OverlapEvent_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<ue_msgs::msg::OverlapEvent_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<ue_msgs::msg::OverlapEvent_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__ue_msgs__msg__OverlapEvent std::shared_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__ue_msgs__msg__OverlapEvent std::shared_ptr<ue_msgs::msg::OverlapEvent_<ContainerAllocator> const> ConstPtr;
...
using OverlapEvent = ue_msgs::msg::OverlapEvent_<std::allocator<void>>;
