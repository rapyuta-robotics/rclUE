...
ue_msgs__msg__EntityStateMultiArray__init(ue_msgs__msg__EntityStateMultiArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ue_msgs__msg__EntityStateMultiArray__fini(msg);
    return false;
  }
  // entity_states
  if (!ue_msgs__msg__EntityState__Sequence__init(&msg->entity_states, 0)) {
    ue_msgs__msg__EntityStateMultiArray__fini(msg);
    return false;
  }
  return true;
...
ue_msgs__msg__EntityStateMultiArray__fini(ue_msgs__msg__EntityStateMultiArray * msg)
{
  ...
  // entity_states
  ue_msgs__msg__EntityState__Sequence__fini(&msg->entity_states);
}
...
ue_msgs__msg__EntityStateMultiArray__are_equal(const ue_msgs__msg__EntityStateMultiArray * lhs, const ue_msgs__msg__EntityStateMultiArray * rhs)
{
  ...
  if (!ue_msgs__msg__EntityState__Sequence__are_equal(
      &(lhs->entity_states), &(rhs->entity_states)))
  {
    return false;
  }
  return true;
  ...
  ue_msgs__msg__EntityStateMultiArray * output)
{
  ...
  if (!ue_msgs__msg__EntityState__Sequence__copy(
      &(input->entity_states), &(output->entity_states)))
  {
    return false;
  }
  return true;
...
ue_msgs__msg__EntityStateMultiArray__create()
{
  ...
  ue_msgs__msg__EntityStateMultiArray * msg = (ue_msgs__msg__EntityStateMultiArray *)allocator.allocate(sizeof(ue_msgs__msg__EntityStateMultiArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ue_msgs__msg__EntityStateMultiArray));
  bool success = ue_msgs__msg__EntityStateMultiArray__init(msg);
  if (!success) {
...
ue_msgs__msg__EntityStateMultiArray__Sequence__init(ue_msgs__msg__EntityStateMultiArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ue_msgs__msg__EntityStateMultiArray * data = NULL;

  if (size) {
    data = (ue_msgs__msg__EntityStateMultiArray *)allocator.zero_allocate(size, sizeof(ue_msgs__msg__EntityStateMultiArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ue_msgs__msg__EntityStateMultiArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ue_msgs__msg__EntityStateMultiArray__fini(&data[i - 1]);
      }
...
ue_msgs__msg__EntityStateMultiArray__Sequence__fini(ue_msgs__msg__EntityStateMultiArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ue_msgs__msg__EntityStateMultiArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ue_msgs__msg__EntityStateMultiArray__Sequence * array = (ue_msgs__msg__EntityStateMultiArray__Sequence *)allocator.allocate(sizeof(ue_msgs__msg__EntityStateMultiArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ue_msgs__msg__EntityStateMultiArray__Sequence__init(array, size);
  if (!success) {
...
ue_msgs__msg__EntityStateMultiArray__Sequence__destroy(ue_msgs__msg__EntityStateMultiArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ue_msgs__msg__EntityStateMultiArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ue_msgs__msg__EntityStateMultiArray__Sequence__are_equal(const ue_msgs__msg__EntityStateMultiArray__Sequence * lhs, const ue_msgs__msg__EntityStateMultiArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ue_msgs__msg__EntityStateMultiArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ue_msgs__msg__EntityStateMultiArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ue_msgs__msg__EntityStateMultiArray);
    ue_msgs__msg__EntityStateMultiArray * data =
      (ue_msgs__msg__EntityStateMultiArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__msg__EntityStateMultiArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ue_msgs__msg__EntityStateMultiArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ue_msgs__msg__EntityStateMultiArray__copy(
