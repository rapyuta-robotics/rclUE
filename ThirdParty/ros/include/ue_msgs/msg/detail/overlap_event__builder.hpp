...
{
public:
    explicit Init_OverlapEvent_other_body_index(::ue_msgs::msg::OverlapEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_OverlapEvent_other_component_name(::ue_msgs::msg::OverlapEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_OverlapEvent_other_actor_name(::ue_msgs::msg::OverlapEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_OverlapEvent_self_name(::ue_msgs::msg::OverlapEvent& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_OverlapEvent_begin() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::msg::OverlapEvent>()
{
