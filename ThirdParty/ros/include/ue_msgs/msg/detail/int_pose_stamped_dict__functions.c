  ...
  ue_msgs__msg__IntPoseStampedDict__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ue_msgs__msg__IntPoseStampedDict * data =
      (ue_msgs__msg__IntPoseStampedDict *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__msg__IntPoseStampedDict__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ue_msgs__msg__IntPoseStampedDict__fini(&data[i]);
        }
        free(data);
        return false;
      }
