...
bool ue_msgs__msg__HitEvent__init(ue_msgs__msg__HitEvent* msg)
{
    if (!msg)
    {
        return false;
...
void ue_msgs__msg__HitEvent__fini(ue_msgs__msg__HitEvent* msg)
{
    if (!msg)
    {
        return;
...
bool ue_msgs__msg__HitEvent__are_equal(const ue_msgs__msg__HitEvent* lhs, const ue_msgs__msg__HitEvent* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // normal_impluse
    if (!geometry_msgs__msg__Vector3__are_equal(&(lhs->normal_impluse), &(rhs->normal_impluse)))
    {
        return false;
    }
    // hit_result
...
bool ue_msgs__msg__HitEvent__copy(const ue_msgs__msg__HitEvent* input, ue_msgs__msg__HitEvent* output)
{
    if (!input || !output)
    {
        return false;
    ...
    // normal_impluse
    if (!geometry_msgs__msg__Vector3__copy(&(input->normal_impluse), &(output->normal_impluse)))
    {
        return false;
    }
    // hit_result
...
ue_msgs__msg__HitEvent* ue_msgs__msg__HitEvent__create()
{
...
void ue_msgs__msg__HitEvent__destroy(ue_msgs__msg__HitEvent* msg)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (msg)
    {
...
bool ue_msgs__msg__HitEvent__Sequence__init(ue_msgs__msg__HitEvent__Sequence* array, size_t size)
{
    if (!array)
    {
        return false;
...
void ue_msgs__msg__HitEvent__Sequence__fini(ue_msgs__msg__HitEvent__Sequence* array)
{
    if (!array)
    {
        return;
...
ue_msgs__msg__HitEvent__Sequence* ue_msgs__msg__HitEvent__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ue_msgs__msg__HitEvent__Sequence* array =
        (ue_msgs__msg__HitEvent__Sequence*)allocator.allocate(sizeof(ue_msgs__msg__HitEvent__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void ue_msgs__msg__HitEvent__Sequence__destroy(ue_msgs__msg__HitEvent__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
    {
...
bool ue_msgs__msg__HitEvent__Sequence__are_equal(const ue_msgs__msg__HitEvent__Sequence* lhs,
                                                 const ue_msgs__msg__HitEvent__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool ue_msgs__msg__HitEvent__Sequence__copy(const ue_msgs__msg__HitEvent__Sequence* input, ue_msgs__msg__HitEvent__Sequence* output)
{
    if (!input || !output)
    {
        return false;
    ...
    {
        const size_t allocation_size = input->size * sizeof(ue_msgs__msg__HitEvent);
        ue_msgs__msg__HitEvent* data = (ue_msgs__msg__HitEvent*)realloc(output->data, allocation_size);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!ue_msgs__msg__HitEvent__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
