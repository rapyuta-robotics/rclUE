...
void Overlaps_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<ue_msgs::msg::OverlappingObjects>*>(untyped_member);
    return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Overlaps_message_member_array[2] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            ue_msgs::msg::OverlappingObjects>(),       // members of sub message
        true,                                          // is array
        0,                                             // array size
        false,                                         // is upper bound
