...
{
public:
    explicit Init_HitResult_trace_end(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_trace_start(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_location(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_normal(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_impact_point(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_impact_normal(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_time(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_physics_material_name(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_penetration_depth(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_my_item(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_my_bone_name(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_item(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_bone_name(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_face_index(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_element_index(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_distance(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_actor_name(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_component_name(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_HitResult_start_penetrating(::ue_msgs::msg::HitResult& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_HitResult_blocking_hit() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::msg::HitResult>()
{
