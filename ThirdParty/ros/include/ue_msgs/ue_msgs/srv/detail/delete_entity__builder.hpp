...
{
public:
    Init_DeleteEntity_Request_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::DeleteEntity_Request>()
{
...
{
public:
    explicit Init_DeleteEntity_Response_status_message(::ue_msgs::srv::DeleteEntity_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_DeleteEntity_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::DeleteEntity_Response>()
{
