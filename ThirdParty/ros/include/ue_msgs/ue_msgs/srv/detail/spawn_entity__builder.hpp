...
{
public:
    explicit Init_SpawnEntity_Request_json_parameters(::ue_msgs::srv::SpawnEntity_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnEntity_Request_tags(::ue_msgs::srv::SpawnEntity_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnEntity_Request_state(::ue_msgs::srv::SpawnEntity_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnEntity_Request_robot_namespace(::ue_msgs::srv::SpawnEntity_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SpawnEntity_Request_xml() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::SpawnEntity_Request>()
{
...
{
public:
    explicit Init_SpawnEntity_Response_status_message(::ue_msgs::srv::SpawnEntity_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SpawnEntity_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::SpawnEntity_Response>()
{
