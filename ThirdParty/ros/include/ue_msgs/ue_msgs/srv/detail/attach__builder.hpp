...
{
public:
    explicit Init_Attach_Request_name2(::ue_msgs::srv::Attach_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Attach_Request_name1() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::Attach_Request>()
{
...
{
public:
    Init_Attach_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::Attach_Response>()
{
