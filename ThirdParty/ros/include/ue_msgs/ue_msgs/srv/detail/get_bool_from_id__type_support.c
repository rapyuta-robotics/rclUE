...
extern "C"
{
    ...
    void ue_msgs__srv__GetBoolFromId_Request__rosidl_typesupport_introspection_c__GetBoolFromId_Request_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__srv__GetBoolFromId_Request__rosidl_typesupport_introspection_c__GetBoolFromId_Request_message_member_array[1] = {{
            "id",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        ue_msgs__srv__GetBoolFromId_Request__rosidl_typesupport_introspection_c__GetBoolFromId_Request_message_members = {
            ...
            ue_msgs__srv__GetBoolFromId_Request__rosidl_typesupport_introspection_c__GetBoolFromId_Request_init_function,    // function
                                                                                                                             // to
                                                                                                                             // initialize
                                                                                                                             // message
                                                                                                                             // memory
                                                                                                                             ...
                                                                                                                             // be
                                                                                                                             // allocated)
            ue_msgs__srv__GetBoolFromId_Request__rosidl_typesupport_introspection_c__GetBoolFromId_Request_fini_function    // function
                                                                                                                            // to
                                                                                                                            // terminate
                                                                                                                            // message
                                                                                                                            // instance
    ...
    {
        if (!ue_msgs__srv__GetBoolFromId_Request__rosidl_typesupport_introspection_c__GetBoolFromId_Request_message_type_support_handle
...
extern "C"
{
    ...
    void ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_message_member_array[3] = {
            {
                "success",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_message_members = {
            ...
            ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_init_function,    // function
                                                                                                                               // to
                                                                                                                               // initialize
                                                                                                                               // message
                                                                                                                               // memory
                                                                                                                               ...
                                                                                                                               // be
                                                                                                                               // allocated)
            ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_fini_function    // function
                                                                                                                              // to
                                                                                                                              // terminate
                                                                                                                              // message
                                                                                                                              // instance
    ...
    {
        if (!ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            ue_msgs__srv__GetBoolFromId_Response__rosidl_typesupport_introspection_c__GetBoolFromId_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
{
    if (!ue_msgs__srv__detail__get_bool_from_id__rosidl_typesupport_introspection_c__GetBoolFromId_service_type_support_handle
             .typesupport_identifier)
    {
        ue_msgs__srv__detail__get_bool_from_id__rosidl_typesupport_introspection_c__GetBoolFromId_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, ue_msgs, srv, GetBoolFromId_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, ue_msgs, srv, GetBoolFromId_Response)()
                ->data;
    }
