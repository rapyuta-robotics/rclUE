...
{
public:
    Init_GetInt32FromId_Request_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::GetInt32FromId_Request>()
{
...
{
public:
    explicit Init_GetInt32FromId_Response_data(::ue_msgs::srv::GetInt32FromId_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_GetInt32FromId_Response_remarks(::ue_msgs::srv::GetInt32FromId_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GetInt32FromId_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::GetInt32FromId_Response>()
{
