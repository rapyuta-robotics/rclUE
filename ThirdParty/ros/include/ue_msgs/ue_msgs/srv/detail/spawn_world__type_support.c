...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__srv__SpawnWorld_Request__rosidl_typesupport_introspection_c__SpawnWorld_Request_message_member_array[4] = {
            {
                "world_model",                                              // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        ue_msgs__srv__SpawnWorld_Request__rosidl_typesupport_introspection_c__SpawnWorld_Request_message_members = {
            ...
            ue_msgs__srv__SpawnWorld_Request__rosidl_typesupport_introspection_c__SpawnWorld_Request_message_member_array,    // message
                                                                                                                              // members
            ue_msgs__srv__SpawnWorld_Request__rosidl_typesupport_introspection_c__SpawnWorld_Request_init_function,    // function
                                                                                                                       // to
                                                                                                                       // initialize
                                                                                                                       // message
                                                                                                                       // memory
                                                                                                                       ...
                                                                                                                       // has to be
                                                                                                                       // allocated)
            ue_msgs__srv__SpawnWorld_Request__rosidl_typesupport_introspection_c__SpawnWorld_Request_fini_function    // function to
                                                                                                                      // terminate
                                                                                                                      // message
                                                                                                                      // instance
                                                                                                                      // (will not
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, srv, SpawnWorld_Request)()
    {
        ...
        if (!ue_msgs__srv__SpawnWorld_Request__rosidl_typesupport_introspection_c__SpawnWorld_Request_message_type_support_handle
...
extern "C"
{
    ...
    void ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_message_member_array[2] = {
            {
                "success",                                               // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_message_members = {
            ...
            ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_init_function,    // function
                                                                                                                         // to
                                                                                                                         // initialize
                                                                                                                         // message
                                                                                                                         // memory
                                                                                                                         ...
                                                                                                                         // be
                                                                                                                         // allocated)
            ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_fini_function    // function
                                                                                                                        // to
                                                                                                                        // terminate
                                                                                                                        // message
                                                                                                                        // instance
    ...
    {
        if (!ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            ue_msgs__srv__SpawnWorld_Response__rosidl_typesupport_introspection_c__SpawnWorld_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
{
    if (!ue_msgs__srv__detail__spawn_world__rosidl_typesupport_introspection_c__SpawnWorld_service_type_support_handle
             .typesupport_identifier)
    {
        ue_msgs__srv__detail__spawn_world__rosidl_typesupport_introspection_c__SpawnWorld_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    rosidl_typesupport_introspection_c__ServiceMembers* service_members =
        (rosidl_typesupport_introspection_c__ServiceMembers*)
            ue_msgs__srv__detail__spawn_world__rosidl_typesupport_introspection_c__SpawnWorld_service_type_support_handle.data;

    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, ue_msgs, srv, SpawnWorld_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, ue_msgs, srv, SpawnWorld_Response)()
                ->data;
    }
