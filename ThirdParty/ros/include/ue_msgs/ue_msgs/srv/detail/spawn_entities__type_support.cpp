...
void SpawnEntities_Request_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__SpawnEntities_Request__type(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__SpawnEntities_Request__type(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__SpawnEntities_Request__type(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__SpawnEntities_Request__type(untyped_member, index));
...
{
    auto& member = *reinterpret_cast<std::vector<ue_msgs::msg::EntityState>*>(untyped_member);
    return &member[index];
}

void fetch_function__SpawnEntities_Request__state(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__SpawnEntities_Request__state(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<ue_msgs::msg::EntityState*>(get_function__SpawnEntities_Request__state(untyped_member, index));
...
void fetch_function__SpawnEntities_Request__tags(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__SpawnEntities_Request__tags(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__SpawnEntities_Request__tags(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__SpawnEntities_Request__tags(untyped_member, index));
    const auto& value = *reinterpret_cast<const std::string*>(untyped_value);
    item = value;
}
...
void fetch_function__SpawnEntities_Request__json_parameters(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__SpawnEntities_Request__json_parameters(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__SpawnEntities_Request__json_parameters(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__SpawnEntities_Request__json_parameters(untyped_member, index));
    const auto& value = *reinterpret_cast<const std::string*>(untyped_value);
    item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SpawnEntities_Request_message_member_array[4] = {
    ...
    },
    {
        ...
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ue_msgs::msg::EntityState>(),    // members of sub
                                                                                                                 // message
        true,                                                                                                    // is array
        0,                                                                                                       // array size
        false,                                                                                                   // is upper bound
...
void SpawnEntities_Response_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
get_service_type_support_handle<ue_msgs::srv::SpawnEntities>()
{
    ...
    auto service_type_support = &::ue_msgs::srv::rosidl_typesupport_introspection_cpp::SpawnEntities_service_type_support_handle;
    ...
    if (service_members->request_members_ == nullptr || service_members->response_members_ == nullptr)
    {
        ...
        service_members->request_members_ = static_cast<const ::rosidl_typesupport_introspection_cpp::MessageMembers*>(
            ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<::ue_msgs::srv::SpawnEntities_Request>()->data);
