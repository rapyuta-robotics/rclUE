...
void GetBoolFromId_Request_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void GetBoolFromId_Response_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
get_service_type_support_handle<ue_msgs::srv::GetBoolFromId>()
{
    ...
    auto service_type_support = &::ue_msgs::srv::rosidl_typesupport_introspection_cpp::GetBoolFromId_service_type_support_handle;
    ...
    if (service_members->request_members_ == nullptr || service_members->response_members_ == nullptr)
    {
        ...
        service_members->request_members_ = static_cast<const ::rosidl_typesupport_introspection_cpp::MessageMembers*>(
            ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<::ue_msgs::srv::GetBoolFromId_Request>()->data);
