...
inline void to_flow_style_yaml(const SpawnWorld_Request& msg, std::ostream& out)
{
    out << "{";
    // member: world_model
    {
...
inline void to_block_style_yaml(const SpawnWorld_Request& msg, std::ostream& out, size_t indentation = 0)
{
    // member: world_model
    {
        if (indentation > 0)
...
[[deprecated("use ue_msgs::srv::to_block_style_yaml() instead")]] inline void to_yaml(const ue_msgs::srv::SpawnWorld_Request& msg,
                                                                                      std::ostream& out,
...
[[deprecated("use ue_msgs::srv::to_yaml() instead")]] inline std::string to_yaml(const ue_msgs::srv::SpawnWorld_Request& msg)
{
...
template<>
struct has_fixed_size<ue_msgs::srv::SpawnWorld_Request> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<ue_msgs::srv::SpawnWorld_Request> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<ue_msgs::srv::SpawnWorld_Request> : std::true_type
{
};
...
inline void to_flow_style_yaml(const SpawnWorld_Response& msg, std::ostream& out)
{
    out << "{";
    // member: success
    {
...
inline void to_block_style_yaml(const SpawnWorld_Response& msg, std::ostream& out, size_t indentation = 0)
{
    // member: success
    {
        if (indentation > 0)
...
[[deprecated("use ue_msgs::srv::to_block_style_yaml() instead")]] inline void to_yaml(const ue_msgs::srv::SpawnWorld_Response& msg,
                                                                                      std::ostream& out,
                                                                                      size_t indentation = 0)
{
    ue_msgs::srv::to_block_style_yaml(msg, out, indentation);
...
[[deprecated("use ue_msgs::srv::to_yaml() instead")]] inline std::string to_yaml(const ue_msgs::srv::SpawnWorld_Response& msg)
{
    return ue_msgs::srv::to_yaml(msg);
}
...
template<>
struct has_fixed_size<ue_msgs::srv::SpawnWorld_Response> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<ue_msgs::srv::SpawnWorld_Response> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<ue_msgs::srv::SpawnWorld_Response> : std::true_type
{
};
...
template<>
struct is_service<ue_msgs::srv::SpawnWorld> : std::true_type
{
};

template<>
struct is_service_request<ue_msgs::srv::SpawnWorld_Request> : std::true_type
{
};

template<>
struct is_service_response<ue_msgs::srv::SpawnWorld_Response> : std::true_type
{
};
