...
{
public:
    explicit Init_GetEntityState_Request_reference_frame(::ue_msgs::srv::GetEntityState_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GetEntityState_Request_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::GetEntityState_Request>()
{
...
{
public:
    explicit Init_GetEntityState_Response_success(::ue_msgs::srv::GetEntityState_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GetEntityState_Response_state() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::GetEntityState_Response>()
{
