...
{
public:
    explicit Init_SpawnEntities_Request_json_parameters(::ue_msgs::srv::SpawnEntities_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnEntities_Request_tags(::ue_msgs::srv::SpawnEntities_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnEntities_Request_state(::ue_msgs::srv::SpawnEntities_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SpawnEntities_Request_type() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::SpawnEntities_Request>()
{
...
{
public:
    explicit Init_SpawnEntities_Response_status_message(::ue_msgs::srv::SpawnEntities_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SpawnEntities_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::SpawnEntities_Response>()
{
