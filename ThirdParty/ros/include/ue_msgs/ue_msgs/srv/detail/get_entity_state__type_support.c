...
extern "C"
{
    ...
    void ue_msgs__srv__GetEntityState_Request__rosidl_typesupport_introspection_c__GetEntityState_Request_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__srv__GetEntityState_Request__rosidl_typesupport_introspection_c__GetEntityState_Request_message_member_array[2] = {
            {
                "name",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        ue_msgs__srv__GetEntityState_Request__rosidl_typesupport_introspection_c__GetEntityState_Request_message_members = {
            ...
            ue_msgs__srv__GetEntityState_Request__rosidl_typesupport_introspection_c__GetEntityState_Request_init_function,    // function
                                                                                                                               // to
                                                                                                                               // initialize
                                                                                                                               // message
                                                                                                                               // memory
                                                                                                                               ...
                                                                                                                               // be
                                                                                                                               // allocated)
            ue_msgs__srv__GetEntityState_Request__rosidl_typesupport_introspection_c__GetEntityState_Request_fini_function    // function
                                                                                                                              // to
                                                                                                                              // terminate
                                                                                                                              // message
                                                                                                                              // instance
...
extern "C"
{
    ...
    void ue_msgs__srv__GetEntityState_Response__rosidl_typesupport_introspection_c__GetEntityState_Response_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__srv__GetEntityState_Response__rosidl_typesupport_introspection_c__GetEntityState_Response_message_member_array[2] =
            {{
                 "state",                                                   // name
    ...
    {
        ue_msgs__srv__GetEntityState_Response__rosidl_typesupport_introspection_c__GetEntityState_Response_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, msg, EntityState)();
        if (!ue_msgs__srv__GetEntityState_Response__rosidl_typesupport_introspection_c__GetEntityState_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            ue_msgs__srv__GetEntityState_Response__rosidl_typesupport_introspection_c__GetEntityState_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, srv, GetEntityState)()
{
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, ue_msgs, srv, GetEntityState_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, ue_msgs, srv, GetEntityState_Response)()
                ->data;
    }
