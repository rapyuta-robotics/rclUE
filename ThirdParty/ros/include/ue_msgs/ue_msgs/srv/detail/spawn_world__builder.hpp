...
{
public:
    explicit Init_SpawnWorld_Request_json_parameters(::ue_msgs::srv::SpawnWorld_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnWorld_Request_pose(::ue_msgs::srv::SpawnWorld_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SpawnWorld_Request_world_instance_name(::ue_msgs::srv::SpawnWorld_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SpawnWorld_Request_world_model() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::SpawnWorld_Request>()
{
...
{
public:
    explicit Init_SpawnWorld_Response_status_message(::ue_msgs::srv::SpawnWorld_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SpawnWorld_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::SpawnWorld_Response>()
{
