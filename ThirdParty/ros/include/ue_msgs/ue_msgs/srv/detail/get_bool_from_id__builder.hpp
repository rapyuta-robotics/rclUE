...
{
public:
    Init_GetBoolFromId_Request_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::GetBoolFromId_Request>()
{
...
{
public:
    explicit Init_GetBoolFromId_Response_data(::ue_msgs::srv::GetBoolFromId_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_GetBoolFromId_Response_remarks(::ue_msgs::srv::GetBoolFromId_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GetBoolFromId_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::ue_msgs::srv::GetBoolFromId_Response>()
{
