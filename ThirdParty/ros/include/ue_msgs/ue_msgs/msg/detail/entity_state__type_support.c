...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_message_member_array[4] = {
            {
                "name",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_message_members = {
            ...
            ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_init_function,    // function to initialize
                                                                                                         // message memory (memory
                                                                                                         // has to be allocated)
            ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_message_type_support_handle = {
            0,
            &ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, msg, EntityState)()
    {
        ...
        if (!ue_msgs__msg__EntityState__rosidl_typesupport_introspection_c__EntityState_message_type_support_handle
