  ...
  ue_msgs__msg__EntityStateMultiArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ue_msgs__msg__EntityStateMultiArray * data =
      (ue_msgs__msg__EntityStateMultiArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__msg__EntityStateMultiArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ue_msgs__msg__EntityStateMultiArray__fini(&output->data[i]);
        }
        return false;
      }
    }
