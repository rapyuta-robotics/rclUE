...
// IWYU pragma: private, include "ue_msgs/msg/int_point_entry.hpp"
...
inline std::string to_yaml(const IntPointEntry & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const ue_msgs::msg::IntPointEntry & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ue_msgs::msg::IntPointEntry & msg)
{
