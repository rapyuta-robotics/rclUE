...
struct IntPoseDict_
{
  ...
  _header_type header;
  using _entries_type =
    std::vector<ue_msgs::msg::IntPoseEntry_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ue_msgs::msg::IntPoseEntry_<ContainerAllocator>>>;
  ...
  Type & set__entries(
    const std::vector<ue_msgs::msg::IntPoseEntry_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ue_msgs::msg::IntPoseEntry_<ContainerAllocator>>> & _arg)
  {
    this->entries = _arg;
    return *this;
  }
