...
void fetch_function__IntPoseDict__entries(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ue_msgs::msg::IntPoseEntry *>(
    get_const_function__IntPoseDict__entries(untyped_member, index));
  auto & value = *reinterpret_cast<ue_msgs::msg::IntPoseEntry *>(untyped_value);
  value = item;
}

void assign_function__IntPoseDict__entries(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ue_msgs::msg::IntPoseEntry *>(
    get_function__IntPoseDict__entries(untyped_member, index));
  const auto & value = *reinterpret_cast<const ue_msgs::msg::IntPoseEntry *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IntPoseDict_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__IntPoseDict__entries,  // fetch(index, &value) function pointer
    assign_function__IntPoseDict__entries,  // assign(index, value) function pointer
