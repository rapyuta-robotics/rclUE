...
inline void to_flow_style_yaml(const EntityState& msg, std::ostream& out)
{
    out << "{";
    // member: name
    {
...
inline void to_block_style_yaml(const EntityState& msg, std::ostream& out, size_t indentation = 0)
{
    // member: name
    {
        if (indentation > 0)
...
[[deprecated("use ue_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const ue_msgs::msg::EntityState& msg,
                                                                                      std::ostream& out,
...
[[deprecated("use ue_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const ue_msgs::msg::EntityState& msg)
{
...
template<>
struct has_fixed_size<ue_msgs::msg::EntityState> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<ue_msgs::msg::EntityState> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<ue_msgs::msg::EntityState> : std::true_type
{
};
