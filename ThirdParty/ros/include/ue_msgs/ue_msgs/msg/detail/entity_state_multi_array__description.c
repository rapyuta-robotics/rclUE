  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xb3, 0x16, 0xf0, 0x0e, 0x45, 0x93, 0xda, 0x75,
      0x36, 0x78, 0xda, 0xb3, 0xf1, 0xfd, 0x4e, 0xb5,
      0x24, 0xd7, 0xa5, 0xfd, 0x15, 0xbb, 0x93, 0x55,
      0x7a, 0x61, 0x3e, 0x7b, 0x74, 0x0f, 0x27, 0x42,
    }};
  return &hash;
}
...
static char ue_msgs__msg__EntityStateMultiArray__TYPE_NAME[] = "ue_msgs/msg/EntityStateMultiArray";
...
static char ue_msgs__msg__EntityStateMultiArray__FIELD_NAME__header[] = "header";
static char ue_msgs__msg__EntityStateMultiArray__FIELD_NAME__entity_states[] = "entity_states";

static rosidl_runtime_c__type_description__Field ue_msgs__msg__EntityStateMultiArray__FIELDS[] = {
  {
    {ue_msgs__msg__EntityStateMultiArray__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {ue_msgs__msg__EntityStateMultiArray__FIELD_NAME__entity_states, 13, 13},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ue_msgs__msg__EntityStateMultiArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {ue_msgs__msg__EntityStateMultiArray__TYPE_NAME, 33, 33},
      {ue_msgs__msg__EntityStateMultiArray__FIELDS, 2, 2},
    },
    {ue_msgs__msg__EntityStateMultiArray__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "ue_msgs/EntityState[] entity_states";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ue_msgs__msg__EntityStateMultiArray__get_individual_type_description_source(NULL),
