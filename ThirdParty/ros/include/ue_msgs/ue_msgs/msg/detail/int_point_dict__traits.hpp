...
// Member 'entries'
#include "ue_msgs/msg/detail/int_point_entry__traits.hpp"
...
inline std::string to_yaml(const IntPointDict & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const ue_msgs::msg::IntPointDict & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ue_msgs::msg::IntPointDict & msg)
{
