...
inline std::string to_yaml(const IntPoseStampedEntry & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const ue_msgs::msg::IntPoseStampedEntry & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ue_msgs::msg::IntPoseStampedEntry & msg)
{
