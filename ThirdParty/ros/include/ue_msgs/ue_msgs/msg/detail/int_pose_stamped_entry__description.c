  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe5, 0x55, 0x00, 0x76, 0xbf, 0xa6, 0x55, 0x3c,
      0xa6, 0x0d, 0x1b, 0x48, 0xc1, 0xa4, 0x84, 0x41,
      0xdb, 0x0e, 0xc9, 0x1d, 0xee, 0x47, 0xa0, 0x56,
      0xf4, 0xf6, 0xf5, 0x50, 0x2f, 0x5e, 0xf0, 0xab,
    }};
  return &hash;
}
...
static char ue_msgs__msg__IntPoseStampedEntry__TYPE_NAME[] = "ue_msgs/msg/IntPoseStampedEntry";
...
static char ue_msgs__msg__IntPoseStampedEntry__FIELD_NAME__key[] = "key";
static char ue_msgs__msg__IntPoseStampedEntry__FIELD_NAME__value[] = "value";

static rosidl_runtime_c__type_description__Field ue_msgs__msg__IntPoseStampedEntry__FIELDS[] = {
  {
    {ue_msgs__msg__IntPoseStampedEntry__FIELD_NAME__key, 3, 3},
    {
  ...
  {
    {ue_msgs__msg__IntPoseStampedEntry__FIELD_NAME__value, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ue_msgs__msg__IntPoseStampedEntry__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {ue_msgs__msg__IntPoseStampedEntry__TYPE_NAME, 31, 31},
      {ue_msgs__msg__IntPoseStampedEntry__FIELDS, 2, 2},
    },
    {ue_msgs__msg__IntPoseStampedEntry__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  "# Key-value entry for int to geometry_msgs/PoseStamped mapping\n"
  "int32 key\n"
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ue_msgs__msg__IntPoseStampedEntry__get_individual_type_description_source(NULL),
