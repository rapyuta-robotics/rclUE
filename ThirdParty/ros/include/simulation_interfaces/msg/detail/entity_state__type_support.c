...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, EntityState)() {
  EntityState__rosidl_typesupport_introspection_c__EntityState_message_member_array[0].members_ =
  ...
  EntityState__rosidl_typesupport_introspection_c__EntityState_message_member_array[3].members_ =
