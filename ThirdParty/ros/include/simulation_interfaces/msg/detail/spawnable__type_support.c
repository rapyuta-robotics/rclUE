...
void Spawnable__rosidl_typesupport_introspection_c__Spawnable_init_function(
...
void Spawnable__rosidl_typesupport_introspection_c__Spawnable_fini_function(void * message_memory)
{
  simulation_interfaces__msg__Spawnable__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_member_array[3] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_members = {
  "simulation_interfaces__msg",  // message namespace
  "Spawnable",  // message name
  3,  // number of fields
  sizeof(simulation_interfaces__msg__Spawnable),
  Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_member_array,  // message members
  Spawnable__rosidl_typesupport_introspection_c__Spawnable_init_function,  // function to initialize message memory (memory has to be allocated)
  Spawnable__rosidl_typesupport_introspection_c__Spawnable_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_type_support_handle = {
  0,
  &Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Spawnable)() {
  Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Resource)();
  Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Bounds)();
  if (!Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_type_support_handle.typesupport_identifier) {
    Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Spawnable__rosidl_typesupport_introspection_c__Spawnable_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
