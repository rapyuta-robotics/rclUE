...
class Init_GetNamedPoses_Event_response
{
public:
  explicit Init_GetNamedPoses_Event_response(::simulation_interfaces::srv::GetNamedPoses_Event & msg)
  : msg_(msg)
  {}
  ::simulation_interfaces::srv::GetNamedPoses_Event response(::simulation_interfaces::srv::GetNamedPoses_Event::_response_type arg)
  {
...
private:
  ::simulation_interfaces::srv::GetNamedPoses_Event msg_;
};

class Init_GetNamedPoses_Event_request
{
public:
  explicit Init_GetNamedPoses_Event_request(::simulation_interfaces::srv::GetNamedPoses_Event & msg)
  : msg_(msg)
  {}
  Init_GetNamedPoses_Event_response request(::simulation_interfaces::srv::GetNamedPoses_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetNamedPoses_Event_response(msg_);
  }
...
class Init_GetNamedPoses_Event_info
{
public:
  Init_GetNamedPoses_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetNamedPoses_Event_request info(::simulation_interfaces::srv::GetNamedPoses_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetNamedPoses_Event_request(msg_);
  }
...
template<>
inline
auto build<::simulation_interfaces::srv::GetNamedPoses_Event>()
{
  return simulation_interfaces::srv::builder::Init_GetNamedPoses_Event_info();
}
