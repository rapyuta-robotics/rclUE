  ...
  std::ostream & out)
{
  ...
  {
    out << "set_acceleration: ";
    rosidl_generator_traits::value_to_yaml(msg.set_acceleration, out);
  }
  out << "}";
...
inline void to_yaml(
  const simulation_interfaces::srv::SetEntityState_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const simulation_interfaces::srv::SetEntityState_Request & msg)
{
...
[[deprecated("use simulation_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::srv::SetEntityState_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::srv::SetEntityState_Response & msg)
{
  return simulation_interfaces::srv::to_yaml(msg);
}
...
[[deprecated("use simulation_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::srv::SetEntityState_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::srv::SetEntityState_Event & msg)
{
  return simulation_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<simulation_interfaces::srv::SetEntityState_Event>()
{
  return "simulation_interfaces::srv::SetEntityState_Event";
}

template<>
inline const char * name<simulation_interfaces::srv::SetEntityState_Event>()
{
  return "simulation_interfaces/srv/SetEntityState_Event";
}

template<>
struct has_fixed_size<simulation_interfaces::srv::SetEntityState_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<simulation_interfaces::srv::SetEntityState_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<simulation_interfaces::srv::SetEntityState_Request>::value && has_bounded_size<simulation_interfaces::srv::SetEntityState_Response>::value> {};

template<>
struct is_message<simulation_interfaces::srv::SetEntityState_Event>
  : std::true_type {};
