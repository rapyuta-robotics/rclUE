...
enum
{
  simulation_interfaces__srv__GetCurrentWorld_Event__request__MAX_SIZE = 1
};
// response
enum
{
  simulation_interfaces__srv__GetCurrentWorld_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetCurrentWorld in the package simulation_interfaces.
typedef struct simulation_interfaces__srv__GetCurrentWorld_Event
{
  service_msgs__msg__ServiceEventInfo info;
  simulation_interfaces__srv__GetCurrentWorld_Request__Sequence request;
  simulation_interfaces__srv__GetCurrentWorld_Response__Sequence response;
} simulation_interfaces__srv__GetCurrentWorld_Event;

// Struct for a sequence of simulation_interfaces__srv__GetCurrentWorld_Event.
typedef struct simulation_interfaces__srv__GetCurrentWorld_Event__Sequence
{
