...
enum
{
  simulation_interfaces__srv__GetSpawnables_Event__request__MAX_SIZE = 1
};
// response
enum
{
  simulation_interfaces__srv__GetSpawnables_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetSpawnables in the package simulation_interfaces.
typedef struct simulation_interfaces__srv__GetSpawnables_Event
{
  service_msgs__msg__ServiceEventInfo info;
  simulation_interfaces__srv__GetSpawnables_Request__Sequence request;
  simulation_interfaces__srv__GetSpawnables_Response__Sequence response;
} simulation_interfaces__srv__GetSpawnables_Event;

// Struct for a sequence of simulation_interfaces__srv__GetSpawnables_Event.
typedef struct simulation_interfaces__srv__GetSpawnables_Event__Sequence
{
