...
{
public:
  explicit Init_SetEntityState_Event_response(::simulation_interfaces::srv::SetEntityState_Event & msg)
  : msg_(msg)
  {}
  ::simulation_interfaces::srv::SetEntityState_Event response(::simulation_interfaces::srv::SetEntityState_Event::_response_type arg)
  {
...
private:
  ::simulation_interfaces::srv::SetEntityState_Event msg_;
};

class Init_SetEntityState_Event_request
{
public:
  explicit Init_SetEntityState_Event_request(::simulation_interfaces::srv::SetEntityState_Event & msg)
  : msg_(msg)
  {}
  Init_SetEntityState_Event_response request(::simulation_interfaces::srv::SetEntityState_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetEntityState_Event_request info(::simulation_interfaces::srv::SetEntityState_Event::_info_type arg)
  {
...
template<>
inline
auto build<::simulation_interfaces::srv::SetEntityState_Event>()
{
  return simulation_interfaces::srv::builder::Init_SetEntityState_Event_info();
}
