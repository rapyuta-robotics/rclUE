...
[[deprecated("use simulation_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::srv::SpawnEntity_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::srv::SpawnEntity_Event & msg)
{
  return simulation_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<simulation_interfaces::srv::SpawnEntity_Event>()
{
  return "simulation_interfaces::srv::SpawnEntity_Event";
}

template<>
inline const char * name<simulation_interfaces::srv::SpawnEntity_Event>()
{
  return "simulation_interfaces/srv/SpawnEntity_Event";
}

template<>
struct has_fixed_size<simulation_interfaces::srv::SpawnEntity_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<simulation_interfaces::srv::SpawnEntity_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<simulation_interfaces::srv::SpawnEntity_Request>::value && has_bounded_size<simulation_interfaces::srv::SpawnEntity_Response>::value> {};

template<>
struct is_message<simulation_interfaces::srv::SpawnEntity_Event>
  : std::true_type {};
