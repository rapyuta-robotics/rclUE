...
inline void to_flow_style_yaml(
  const SetEntityInfo_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: entity
...
inline std::string to_yaml(const SetEntityInfo_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const simulation_interfaces::srv::SetEntityInfo_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const simulation_interfaces::srv::SetEntityInfo_Request & msg)
{
...
inline void to_flow_style_yaml(
  const SetEntityInfo_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: result
...
inline std::string to_yaml(const SetEntityInfo_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use simulation_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::srv::SetEntityInfo_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::srv::SetEntityInfo_Response & msg)
{
  return simulation_interfaces::srv::to_yaml(msg);
}
...
inline std::string to_yaml(const SetEntityInfo_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use simulation_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::srv::SetEntityInfo_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::srv::SetEntityInfo_Event & msg)
{
  return simulation_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<simulation_interfaces::srv::SetEntityInfo_Event>()
{
  return "simulation_interfaces::srv::SetEntityInfo_Event";
}

template<>
inline const char * name<simulation_interfaces::srv::SetEntityInfo_Event>()
{
  return "simulation_interfaces/srv/SetEntityInfo_Event";
}

template<>
struct has_fixed_size<simulation_interfaces::srv::SetEntityInfo_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<simulation_interfaces::srv::SetEntityInfo_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<simulation_interfaces::srv::SetEntityInfo_Request>::value && has_bounded_size<simulation_interfaces::srv::SetEntityInfo_Response>::value> {};

template<>
struct is_message<simulation_interfaces::srv::SetEntityInfo_Event>
  : std::true_type {};
