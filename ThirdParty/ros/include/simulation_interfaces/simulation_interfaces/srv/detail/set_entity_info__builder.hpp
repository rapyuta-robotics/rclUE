...
class Init_SetEntityInfo_Event_response
{
public:
  explicit Init_SetEntityInfo_Event_response(::simulation_interfaces::srv::SetEntityInfo_Event & msg)
  : msg_(msg)
  {}
  ::simulation_interfaces::srv::SetEntityInfo_Event response(::simulation_interfaces::srv::SetEntityInfo_Event::_response_type arg)
  {
...
private:
  ::simulation_interfaces::srv::SetEntityInfo_Event msg_;
};

class Init_SetEntityInfo_Event_request
{
public:
  explicit Init_SetEntityInfo_Event_request(::simulation_interfaces::srv::SetEntityInfo_Event & msg)
  : msg_(msg)
  {}
  Init_SetEntityInfo_Event_response request(::simulation_interfaces::srv::SetEntityInfo_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetEntityInfo_Event_response(msg_);
  }
...
class Init_SetEntityInfo_Event_info
{
public:
  Init_SetEntityInfo_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetEntityInfo_Event_request info(::simulation_interfaces::srv::SetEntityInfo_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetEntityInfo_Event_request(msg_);
  }
...
template<>
inline
auto build<::simulation_interfaces::srv::SetEntityInfo_Event>()
{
  return simulation_interfaces::srv::builder::Init_SetEntityInfo_Event_info();
}
