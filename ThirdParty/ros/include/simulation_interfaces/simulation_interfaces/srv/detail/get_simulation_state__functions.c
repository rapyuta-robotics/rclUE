...
simulation_interfaces__srv__GetSimulationState_Request__create(void)
{
  ...
  simulation_interfaces__srv__GetSimulationState_Request * msg = (simulation_interfaces__srv__GetSimulationState_Request *)allocator.allocate(sizeof(simulation_interfaces__srv__GetSimulationState_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(simulation_interfaces__srv__GetSimulationState_Request));
  bool success = simulation_interfaces__srv__GetSimulationState_Request__init(msg);
  if (!success) {
...
simulation_interfaces__srv__GetSimulationState_Request__destroy(simulation_interfaces__srv__GetSimulationState_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    simulation_interfaces__srv__GetSimulationState_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
simulation_interfaces__srv__GetSimulationState_Request__Sequence__init(simulation_interfaces__srv__GetSimulationState_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Request * data = NULL;

  if (size) {
    data = (simulation_interfaces__srv__GetSimulationState_Request *)allocator.zero_allocate(size, sizeof(simulation_interfaces__srv__GetSimulationState_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = simulation_interfaces__srv__GetSimulationState_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        simulation_interfaces__srv__GetSimulationState_Request__fini(&data[i - 1]);
      }
...
simulation_interfaces__srv__GetSimulationState_Request__Sequence__fini(simulation_interfaces__srv__GetSimulationState_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      simulation_interfaces__srv__GetSimulationState_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Request__Sequence * array = (simulation_interfaces__srv__GetSimulationState_Request__Sequence *)allocator.allocate(sizeof(simulation_interfaces__srv__GetSimulationState_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = simulation_interfaces__srv__GetSimulationState_Request__Sequence__init(array, size);
  if (!success) {
...
simulation_interfaces__srv__GetSimulationState_Request__Sequence__destroy(simulation_interfaces__srv__GetSimulationState_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    simulation_interfaces__srv__GetSimulationState_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
simulation_interfaces__srv__GetSimulationState_Request__Sequence__are_equal(const simulation_interfaces__srv__GetSimulationState_Request__Sequence * lhs, const simulation_interfaces__srv__GetSimulationState_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!simulation_interfaces__srv__GetSimulationState_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  simulation_interfaces__srv__GetSimulationState_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(simulation_interfaces__srv__GetSimulationState_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    simulation_interfaces__srv__GetSimulationState_Request * data =
      (simulation_interfaces__srv__GetSimulationState_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!simulation_interfaces__srv__GetSimulationState_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          simulation_interfaces__srv__GetSimulationState_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!simulation_interfaces__srv__GetSimulationState_Request__copy(
...
simulation_interfaces__srv__GetSimulationState_Response__init(simulation_interfaces__srv__GetSimulationState_Response * msg)
{
  ...
  if (!simulation_interfaces__msg__SimulationState__init(&msg->state)) {
    simulation_interfaces__srv__GetSimulationState_Response__fini(msg);
    return false;
  }
  // result
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Response * msg = (simulation_interfaces__srv__GetSimulationState_Response *)allocator.allocate(sizeof(simulation_interfaces__srv__GetSimulationState_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(simulation_interfaces__srv__GetSimulationState_Response));
  bool success = simulation_interfaces__srv__GetSimulationState_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
simulation_interfaces__srv__GetSimulationState_Response__Sequence__init(simulation_interfaces__srv__GetSimulationState_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Response * data = NULL;

  if (size) {
    data = (simulation_interfaces__srv__GetSimulationState_Response *)allocator.zero_allocate(size, sizeof(simulation_interfaces__srv__GetSimulationState_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = simulation_interfaces__srv__GetSimulationState_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        simulation_interfaces__srv__GetSimulationState_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
simulation_interfaces__srv__GetSimulationState_Response__Sequence__fini(simulation_interfaces__srv__GetSimulationState_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      simulation_interfaces__srv__GetSimulationState_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Response__Sequence * array = (simulation_interfaces__srv__GetSimulationState_Response__Sequence *)allocator.allocate(sizeof(simulation_interfaces__srv__GetSimulationState_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = simulation_interfaces__srv__GetSimulationState_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
simulation_interfaces__srv__GetSimulationState_Response__Sequence__destroy(simulation_interfaces__srv__GetSimulationState_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    simulation_interfaces__srv__GetSimulationState_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
simulation_interfaces__srv__GetSimulationState_Response__Sequence__are_equal(const simulation_interfaces__srv__GetSimulationState_Response__Sequence * lhs, const simulation_interfaces__srv__GetSimulationState_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!simulation_interfaces__srv__GetSimulationState_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  simulation_interfaces__srv__GetSimulationState_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(simulation_interfaces__srv__GetSimulationState_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    simulation_interfaces__srv__GetSimulationState_Response * data =
      (simulation_interfaces__srv__GetSimulationState_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!simulation_interfaces__srv__GetSimulationState_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          simulation_interfaces__srv__GetSimulationState_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!simulation_interfaces__srv__GetSimulationState_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
simulation_interfaces__srv__GetSimulationState_Event__init(simulation_interfaces__srv__GetSimulationState_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    simulation_interfaces__srv__GetSimulationState_Event__fini(msg);
    return false;
  }
  // request
  if (!simulation_interfaces__srv__GetSimulationState_Request__Sequence__init(&msg->request, 0)) {
    simulation_interfaces__srv__GetSimulationState_Event__fini(msg);
    return false;
  }
  // response
  if (!simulation_interfaces__srv__GetSimulationState_Response__Sequence__init(&msg->response, 0)) {
    simulation_interfaces__srv__GetSimulationState_Event__fini(msg);
    return false;
  }
  return true;
...
simulation_interfaces__srv__GetSimulationState_Event__fini(simulation_interfaces__srv__GetSimulationState_Event * msg)
{
  ...
  // request
  simulation_interfaces__srv__GetSimulationState_Request__Sequence__fini(&msg->request);
  // response
  simulation_interfaces__srv__GetSimulationState_Response__Sequence__fini(&msg->response);
}
...
simulation_interfaces__srv__GetSimulationState_Event__are_equal(const simulation_interfaces__srv__GetSimulationState_Event * lhs, const simulation_interfaces__srv__GetSimulationState_Event * rhs)
{
  ...
  // request
  if (!simulation_interfaces__srv__GetSimulationState_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!simulation_interfaces__srv__GetSimulationState_Response__Sequence__are_equal(
  ...
  simulation_interfaces__srv__GetSimulationState_Event * output)
{
  ...
  // request
  if (!simulation_interfaces__srv__GetSimulationState_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!simulation_interfaces__srv__GetSimulationState_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Event * msg = (simulation_interfaces__srv__GetSimulationState_Event *)allocator.allocate(sizeof(simulation_interfaces__srv__GetSimulationState_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(simulation_interfaces__srv__GetSimulationState_Event));
  bool success = simulation_interfaces__srv__GetSimulationState_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
simulation_interfaces__srv__GetSimulationState_Event__Sequence__init(simulation_interfaces__srv__GetSimulationState_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Event * data = NULL;

  if (size) {
    data = (simulation_interfaces__srv__GetSimulationState_Event *)allocator.zero_allocate(size, sizeof(simulation_interfaces__srv__GetSimulationState_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = simulation_interfaces__srv__GetSimulationState_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        simulation_interfaces__srv__GetSimulationState_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
simulation_interfaces__srv__GetSimulationState_Event__Sequence__fini(simulation_interfaces__srv__GetSimulationState_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      simulation_interfaces__srv__GetSimulationState_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulation_interfaces__srv__GetSimulationState_Event__Sequence * array = (simulation_interfaces__srv__GetSimulationState_Event__Sequence *)allocator.allocate(sizeof(simulation_interfaces__srv__GetSimulationState_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = simulation_interfaces__srv__GetSimulationState_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
simulation_interfaces__srv__GetSimulationState_Event__Sequence__destroy(simulation_interfaces__srv__GetSimulationState_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    simulation_interfaces__srv__GetSimulationState_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
simulation_interfaces__srv__GetSimulationState_Event__Sequence__are_equal(const simulation_interfaces__srv__GetSimulationState_Event__Sequence * lhs, const simulation_interfaces__srv__GetSimulationState_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!simulation_interfaces__srv__GetSimulationState_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  simulation_interfaces__srv__GetSimulationState_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(simulation_interfaces__srv__GetSimulationState_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    simulation_interfaces__srv__GetSimulationState_Event * data =
      (simulation_interfaces__srv__GetSimulationState_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!simulation_interfaces__srv__GetSimulationState_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          simulation_interfaces__srv__GetSimulationState_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!simulation_interfaces__srv__GetSimulationState_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
