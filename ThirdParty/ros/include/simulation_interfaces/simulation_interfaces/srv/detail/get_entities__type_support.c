...
void simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  simulation_interfaces__srv__GetEntities_Event__init(message_memory);
}

void simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntities_Event__fini(message_memory);
}

size_t simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__size_function__GetEntities_Event__request(
  const void * untyped_member)
{
  const simulation_interfaces__srv__GetEntities_Request__Sequence * member =
    (const simulation_interfaces__srv__GetEntities_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_const_function__GetEntities_Event__request(
  const void * untyped_member, size_t index)
{
  const simulation_interfaces__srv__GetEntities_Request__Sequence * member =
    (const simulation_interfaces__srv__GetEntities_Request__Sequence *)(untyped_member);
...
void * simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_function__GetEntities_Event__request(
  void * untyped_member, size_t index)
{
  simulation_interfaces__srv__GetEntities_Request__Sequence * member =
    (simulation_interfaces__srv__GetEntities_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__fetch_function__GetEntities_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const simulation_interfaces__srv__GetEntities_Request * item =
    ((const simulation_interfaces__srv__GetEntities_Request *)
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_const_function__GetEntities_Event__request(untyped_member, index));
  simulation_interfaces__srv__GetEntities_Request * value =
    (simulation_interfaces__srv__GetEntities_Request *)(untyped_value);
  *value = *item;
}

void simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__assign_function__GetEntities_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  simulation_interfaces__srv__GetEntities_Request * item =
    ((simulation_interfaces__srv__GetEntities_Request *)
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_function__GetEntities_Event__request(untyped_member, index));
  const simulation_interfaces__srv__GetEntities_Request * value =
    (const simulation_interfaces__srv__GetEntities_Request *)(untyped_value);
  *item = *value;
}

bool simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__resize_function__GetEntities_Event__request(
  void * untyped_member, size_t size)
{
  simulation_interfaces__srv__GetEntities_Request__Sequence * member =
    (simulation_interfaces__srv__GetEntities_Request__Sequence *)(untyped_member);
  simulation_interfaces__srv__GetEntities_Request__Sequence__fini(member);
  return simulation_interfaces__srv__GetEntities_Request__Sequence__init(member, size);
}

size_t simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__size_function__GetEntities_Event__response(
  const void * untyped_member)
{
  const simulation_interfaces__srv__GetEntities_Response__Sequence * member =
    (const simulation_interfaces__srv__GetEntities_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_const_function__GetEntities_Event__response(
  const void * untyped_member, size_t index)
{
  const simulation_interfaces__srv__GetEntities_Response__Sequence * member =
    (const simulation_interfaces__srv__GetEntities_Response__Sequence *)(untyped_member);
...
void * simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_function__GetEntities_Event__response(
  void * untyped_member, size_t index)
{
  simulation_interfaces__srv__GetEntities_Response__Sequence * member =
    (simulation_interfaces__srv__GetEntities_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__fetch_function__GetEntities_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const simulation_interfaces__srv__GetEntities_Response * item =
    ((const simulation_interfaces__srv__GetEntities_Response *)
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_const_function__GetEntities_Event__response(untyped_member, index));
  simulation_interfaces__srv__GetEntities_Response * value =
    (simulation_interfaces__srv__GetEntities_Response *)(untyped_value);
  *value = *item;
}

void simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__assign_function__GetEntities_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  simulation_interfaces__srv__GetEntities_Response * item =
    ((simulation_interfaces__srv__GetEntities_Response *)
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_function__GetEntities_Event__response(untyped_member, index));
  const simulation_interfaces__srv__GetEntities_Response * value =
    (const simulation_interfaces__srv__GetEntities_Response *)(untyped_value);
  *item = *value;
}

bool simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__resize_function__GetEntities_Event__response(
  void * untyped_member, size_t size)
{
  simulation_interfaces__srv__GetEntities_Response__Sequence * member =
    (simulation_interfaces__srv__GetEntities_Response__Sequence *)(untyped_member);
  simulation_interfaces__srv__GetEntities_Response__Sequence__fini(member);
  return simulation_interfaces__srv__GetEntities_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(simulation_interfaces__srv__GetEntities_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(simulation_interfaces__srv__GetEntities_Event, request),  // bytes offset in struct
    NULL,  // default value
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__size_function__GetEntities_Event__request,  // size() function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_const_function__GetEntities_Event__request,  // get_const(index) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_function__GetEntities_Event__request,  // get(index) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__fetch_function__GetEntities_Event__request,  // fetch(index, &value) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__assign_function__GetEntities_Event__request,  // assign(index, value) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__resize_function__GetEntities_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(simulation_interfaces__srv__GetEntities_Event, response),  // bytes offset in struct
    NULL,  // default value
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__size_function__GetEntities_Event__response,  // size() function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_const_function__GetEntities_Event__response,  // get_const(index) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__get_function__GetEntities_Event__response,  // get(index) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__fetch_function__GetEntities_Event__response,  // fetch(index, &value) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__assign_function__GetEntities_Event__response,  // assign(index, value) function pointer
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__resize_function__GetEntities_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "GetEntities_Event",  // message name
  3,  // number of fields
  sizeof(simulation_interfaces__srv__GetEntities_Event),
  false,  // has_any_key_member_
  simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_member_array,  // message members
  simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_type_support_handle = {
  0,
  &simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_simulation_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Event)() {
  simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Request)();
  simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Response)();
  if (!simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_type_support_handle.typesupport_identifier) {
    simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t simulation_interfaces__srv__detail__get_entities__rosidl_typesupport_introspection_c__GetEntities_service_type_support_handle = {
  ...
  &simulation_interfaces__srv__GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_type_support_handle,
  &simulation_interfaces__srv__GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_type_support_handle,
  &simulation_interfaces__srv__GetEntities_Event__rosidl_typesupport_introspection_c__GetEntities_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_simulation_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Event)()->data;
  }
