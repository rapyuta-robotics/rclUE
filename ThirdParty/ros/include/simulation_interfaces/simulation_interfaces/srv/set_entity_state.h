...
#ifndef SIMULATION_INTERFACES__SRV__SET_ENTITY_STATE_H_
#define SIMULATION_INTERFACES__SRV__SET_ENTITY_STATE_H_
...
#endif  // SIMULATION_INTERFACES__SRV__SET_ENTITY_STATE_H_
