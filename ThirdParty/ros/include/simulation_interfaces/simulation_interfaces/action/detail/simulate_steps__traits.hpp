...
inline void to_flow_style_yaml(
  const SimulateSteps_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SimulateSteps_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use simulation_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::action::SimulateSteps_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::action::SimulateSteps_SendGoal_Event & msg)
{
  return simulation_interfaces::action::to_yaml(msg);
}

template<>
inline const char * data_type<simulation_interfaces::action::SimulateSteps_SendGoal_Event>()
{
  return "simulation_interfaces::action::SimulateSteps_SendGoal_Event";
}

template<>
inline const char * name<simulation_interfaces::action::SimulateSteps_SendGoal_Event>()
{
  return "simulation_interfaces/action/SimulateSteps_SendGoal_Event";
}

template<>
struct has_fixed_size<simulation_interfaces::action::SimulateSteps_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<simulation_interfaces::action::SimulateSteps_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<simulation_interfaces::action::SimulateSteps_SendGoal_Request>::value && has_bounded_size<simulation_interfaces::action::SimulateSteps_SendGoal_Response>::value> {};

template<>
struct is_message<simulation_interfaces::action::SimulateSteps_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const SimulateSteps_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SimulateSteps_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use simulation_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const simulation_interfaces::action::SimulateSteps_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  simulation_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use simulation_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const simulation_interfaces::action::SimulateSteps_GetResult_Event & msg)
{
  return simulation_interfaces::action::to_yaml(msg);
}

template<>
inline const char * data_type<simulation_interfaces::action::SimulateSteps_GetResult_Event>()
{
  return "simulation_interfaces::action::SimulateSteps_GetResult_Event";
}

template<>
inline const char * name<simulation_interfaces::action::SimulateSteps_GetResult_Event>()
{
  return "simulation_interfaces/action/SimulateSteps_GetResult_Event";
}

template<>
struct has_fixed_size<simulation_interfaces::action::SimulateSteps_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<simulation_interfaces::action::SimulateSteps_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<simulation_interfaces::action::SimulateSteps_GetResult_Request>::value && has_bounded_size<simulation_interfaces::action::SimulateSteps_GetResult_Response>::value> {};

template<>
struct is_message<simulation_interfaces::action::SimulateSteps_GetResult_Event>
  : std::true_type {};
