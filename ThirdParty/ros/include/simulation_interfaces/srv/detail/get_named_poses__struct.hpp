...
struct GetNamedPoses_Response_
{
  ...
  _result_type result;
  using _poses_type =
    std::vector<simulation_interfaces::msg::NamedPose_<ContainerAllocator>, typename ContainerAllocator::template rebind<simulation_interfaces::msg::NamedPose_<ContainerAllocator>>::other>;
  _poses_type poses;
  ...
  Type & set__poses(
    const std::vector<simulation_interfaces::msg::NamedPose_<ContainerAllocator>, typename ContainerAllocator::template rebind<simulation_interfaces::msg::NamedPose_<ContainerAllocator>>::other> & _arg)
  {
    this->poses = _arg;
    return *this;
  }
