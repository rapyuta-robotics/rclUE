...
void GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_init_function(
...
void GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntities_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_member_array[1] = {
  {
    "filters",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_members = {
  ...
  GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_member_array,  // message members
  GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_type_support_handle = {
  0,
  &GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Request)() {
  GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_member_array[0].members_ =
  ...
  if (!GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_type_support_handle.typesupport_identifier) {
    GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetEntities_Request__rosidl_typesupport_introspection_c__GetEntities_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntities_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_member_array[2] = {
  {
    "result",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "GetEntities_Response",  // message name
  2,  // number of fields
  sizeof(simulation_interfaces__srv__GetEntities_Response),
  GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_member_array,  // message members
  GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_type_support_handle = {
  0,
  &GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntities_Response)() {
  GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Result)();
  if (!GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_type_support_handle.typesupport_identifier) {
    GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetEntities_Response__rosidl_typesupport_introspection_c__GetEntities_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
