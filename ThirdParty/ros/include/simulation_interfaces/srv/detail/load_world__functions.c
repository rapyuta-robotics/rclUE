  ...
  simulation_interfaces__srv__LoadWorld_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    simulation_interfaces__srv__LoadWorld_Request * data =
      (simulation_interfaces__srv__LoadWorld_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!simulation_interfaces__srv__LoadWorld_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          simulation_interfaces__srv__LoadWorld_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  simulation_interfaces__srv__LoadWorld_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    simulation_interfaces__srv__LoadWorld_Response * data =
      (simulation_interfaces__srv__LoadWorld_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!simulation_interfaces__srv__LoadWorld_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          simulation_interfaces__srv__LoadWorld_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
