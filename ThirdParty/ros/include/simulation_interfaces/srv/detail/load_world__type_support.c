...
void LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_init_function(
...
void LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_fini_function(void * message_memory)
{
  simulation_interfaces__srv__LoadWorld_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_member_array[3] = {
  {
    "world_resource",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_members = {
  ...
  LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_member_array,  // message members
  LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_type_support_handle = {
  0,
  &LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, LoadWorld_Request)() {
  LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Resource)();
  if (!LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_type_support_handle.typesupport_identifier) {
    LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LoadWorld_Request__rosidl_typesupport_introspection_c__LoadWorld_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_fini_function(void * message_memory)
{
  simulation_interfaces__srv__LoadWorld_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_member_array[2] = {
  {
    "result",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "LoadWorld_Response",  // message name
  2,  // number of fields
  sizeof(simulation_interfaces__srv__LoadWorld_Response),
  LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_member_array,  // message members
  LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_type_support_handle = {
  0,
  &LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, LoadWorld_Response)() {
  LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Result)();
  LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_member_array[1].members_ =
  ...
  if (!LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_type_support_handle.typesupport_identifier) {
    LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LoadWorld_Response__rosidl_typesupport_introspection_c__LoadWorld_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
