...
void GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_init_function(
...
void GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetAvailableWorlds_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_member_array[4] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_members = {
  ...
  GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_member_array,  // message members
  GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_type_support_handle = {
  0,
  &GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetAvailableWorlds_Request)() {
  GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_member_array[1].members_ =
  ...
  if (!GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_type_support_handle.typesupport_identifier) {
    GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetAvailableWorlds_Request__rosidl_typesupport_introspection_c__GetAvailableWorlds_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetAvailableWorlds_Response__fini(message_memory);
}

size_t GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__size_function__WorldResource__worlds(
...
const void * GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__get_const_function__WorldResource__worlds(
...
void * GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__get_function__WorldResource__worlds(
...
bool GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__resize_function__WorldResource__worlds(
...
static rosidl_typesupport_introspection_c__MessageMember GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_member_array[2] = {
  {
    "result",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
  ...
  },
  {
    ...
    NULL,  // default value
    GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__size_function__WorldResource__worlds,  // size() function pointer
    GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__get_const_function__WorldResource__worlds,  // get_const(index) function pointer
    GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__get_function__WorldResource__worlds,  // get(index) function pointer
    GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__resize_function__WorldResource__worlds  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "GetAvailableWorlds_Response",  // message name
  2,  // number of fields
  sizeof(simulation_interfaces__srv__GetAvailableWorlds_Response),
  GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_member_array,  // message members
  GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_type_support_handle = {
  0,
  &GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetAvailableWorlds_Response)() {
  GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Result)();
  GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_member_array[1].members_ =
  ...
  if (!GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_type_support_handle.typesupport_identifier) {
    GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetAvailableWorlds_Response__rosidl_typesupport_introspection_c__GetAvailableWorlds_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
