...
static rosidl_typesupport_introspection_c__MessageMember GetEntityState_Request__rosidl_typesupport_introspection_c__GetEntityState_Request_message_member_array[1] = {
  {
    "entity",  // name
