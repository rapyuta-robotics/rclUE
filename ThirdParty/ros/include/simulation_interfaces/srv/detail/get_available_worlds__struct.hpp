...
struct GetAvailableWorlds_Response_
{
  ...
  _result_type result;
  using _worlds_type =
    std::vector<simulation_interfaces::msg::WorldResource_<ContainerAllocator>, typename ContainerAllocator::template rebind<simulation_interfaces::msg::WorldResource_<ContainerAllocator>>::other>;
  _worlds_type worlds;
  ...
  Type & set__worlds(
    const std::vector<simulation_interfaces::msg::WorldResource_<ContainerAllocator>, typename ContainerAllocator::template rebind<simulation_interfaces::msg::WorldResource_<ContainerAllocator>>::other> & _arg)
  {
    this->worlds = _arg;
    return *this;
  }
