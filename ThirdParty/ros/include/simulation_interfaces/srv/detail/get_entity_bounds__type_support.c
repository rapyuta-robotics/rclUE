...
void GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_init_function(
...
void GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntityBounds_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_member_array[1] = {
  {
    "entity",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_members = {
  ...
  GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_member_array,  // message members
  GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_type_support_handle = {
  0,
  &GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntityBounds_Request)() {
  if (!GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_type_support_handle.typesupport_identifier) {
    GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetEntityBounds_Request__rosidl_typesupport_introspection_c__GetEntityBounds_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntityBounds_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_member_array[2] = {
  {
    "result",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "GetEntityBounds_Response",  // message name
  2,  // number of fields
  sizeof(simulation_interfaces__srv__GetEntityBounds_Response),
  GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_member_array,  // message members
  GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_type_support_handle = {
  0,
  &GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntityBounds_Response)() {
  GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Result)();
  GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Bounds)();
  if (!GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_type_support_handle.typesupport_identifier) {
    GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetEntityBounds_Response__rosidl_typesupport_introspection_c__GetEntityBounds_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
