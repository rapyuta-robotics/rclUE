...
void GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_init_function(
...
void GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetSimulationState_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_members = {
  ...
  GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_member_array,  // message members
  GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_type_support_handle = {
  0,
  &GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetSimulationState_Request)() {
  if (!GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_type_support_handle.typesupport_identifier) {
    GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetSimulationState_Request__rosidl_typesupport_introspection_c__GetSimulationState_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetSimulationState_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_member_array[2] = {
  {
    "state",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "GetSimulationState_Response",  // message name
  2,  // number of fields
  sizeof(simulation_interfaces__srv__GetSimulationState_Response),
  GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_member_array,  // message members
  GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_type_support_handle = {
  0,
  &GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetSimulationState_Response)() {
  GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_member_array[0].members_ =
  ...
  GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Result)();
  if (!GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_type_support_handle.typesupport_identifier) {
    GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetSimulationState_Response__rosidl_typesupport_introspection_c__GetSimulationState_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
