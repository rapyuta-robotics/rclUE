...
void GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_init_function(
...
void GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntitiesStates_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_member_array[1] = {
  {
    "filters",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_members = {
  ...
  GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_member_array,  // message members
  GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_type_support_handle = {
  0,
  &GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntitiesStates_Request)() {
  GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_member_array[0].members_ =
  ...
  if (!GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_type_support_handle.typesupport_identifier) {
    GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetEntitiesStates_Request__rosidl_typesupport_introspection_c__GetEntitiesStates_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_fini_function(void * message_memory)
{
  simulation_interfaces__srv__GetEntitiesStates_Response__fini(message_memory);
}

size_t GetEntitiesStates_Response__rosidl_typesupport_introspection_c__size_function__EntityState__states(
...
const void * GetEntitiesStates_Response__rosidl_typesupport_introspection_c__get_const_function__EntityState__states(
...
void * GetEntitiesStates_Response__rosidl_typesupport_introspection_c__get_function__EntityState__states(
...
bool GetEntitiesStates_Response__rosidl_typesupport_introspection_c__resize_function__EntityState__states(
...
static rosidl_typesupport_introspection_c__MessageMember GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_member_array[3] = {
  {
    "result",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
  ...
  },
  {
    ...
    NULL,  // default value
    GetEntitiesStates_Response__rosidl_typesupport_introspection_c__size_function__EntityState__states,  // size() function pointer
    GetEntitiesStates_Response__rosidl_typesupport_introspection_c__get_const_function__EntityState__states,  // get_const(index) function pointer
    GetEntitiesStates_Response__rosidl_typesupport_introspection_c__get_function__EntityState__states,  // get(index) function pointer
    GetEntitiesStates_Response__rosidl_typesupport_introspection_c__resize_function__EntityState__states  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_members = {
  "simulation_interfaces__srv",  // message namespace
  "GetEntitiesStates_Response",  // message name
  3,  // number of fields
  sizeof(simulation_interfaces__srv__GetEntitiesStates_Response),
  GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_member_array,  // message members
  GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_type_support_handle = {
  0,
  &GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, srv, GetEntitiesStates_Response)() {
  GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_interfaces, msg, Result)();
  GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_member_array[2].members_ =
  ...
  if (!GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_type_support_handle.typesupport_identifier) {
    GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetEntitiesStates_Response__rosidl_typesupport_introspection_c__GetEntitiesStates_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
