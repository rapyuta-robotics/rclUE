...
public:
    explicit PubListener(CustomPublisherInfo* info)
        : publisher_info_(info), deadline_changes_(false), liveliness_changes_(false), incompatible_qos_changes_(false)
    {
    }
    ...
    RMW_FASTRTPS_SHARED_CPP_PUBLIC
    void on_offered_incompatible_qos(eprosima::fastdds::dds::DataWriter*,
    ...
    RMW_FASTRTPS_SHARED_CPP_PUBLIC
    void set_on_new_event_callback(rmw_event_type_t event_type, const void* user_data, rmw_event_callback_t callback) final;
...
private:
    ...
    std::set<eprosima::fastrtps::rtps::GUID_t> subscriptions_ RCPPUTILS_TSA_GUARDED_BY(discovery_m_);

    bool deadline_changes_ RCPPUTILS_TSA_GUARDED_BY(on_new_event_m_);

    eprosima::fastdds::dds::OfferedDeadlineMissedStatus offered_deadline_missed_status_ RCPPUTILS_TSA_GUARDED_BY(on_new_event_m_);
    ...
    eprosima::fastdds::dds::OfferedIncompatibleQosStatus incompatible_qos_status_ RCPPUTILS_TSA_GUARDED_BY(on_new_event_m_);
};
