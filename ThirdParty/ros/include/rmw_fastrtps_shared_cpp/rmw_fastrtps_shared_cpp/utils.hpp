 ...
 */
RMW_FASTRTPS_SHARED_CPP_PUBLIC
bool cast_or_create_topic(eprosima::fastdds::dds::DomainParticipant* participant,
 ...
 */
RMW_FASTRTPS_SHARED_CPP_PUBLIC
bool find_and_check_topic_and_type(const CustomParticipantInfo* participant_info,
                                   const std::string& topic_name,
                                   const std::string& type_name,
 ...
 */
RMW_FASTRTPS_SHARED_CPP_PUBLIC
void remove_topic_and_type(const CustomParticipantInfo* participant_info,
...
*/
RMW_FASTRTPS_SHARED_CPP_PUBLIC
bool create_content_filtered_topic(eprosima::fastdds::dds::DomainParticipant* participant,
 ...
 */
RMW_FASTRTPS_SHARED_CPP_PUBLIC
bool create_datareader(const eprosima::fastdds::dds::DataReaderQos& datareader_qos,
