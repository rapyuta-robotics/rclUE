...
extern "C"
{
    ...
    get_serialized_size_std_msgs__msg__UInt32MultiArray(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs size_t
    max_serialized_size_std_msgs__msg__UInt32MultiArray(bool& full_bounded, bool& is_plain, size_t current_alignment);
