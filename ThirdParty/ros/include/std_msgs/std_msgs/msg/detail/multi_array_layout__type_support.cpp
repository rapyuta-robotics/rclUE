...
void MultiArrayLayout_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<std_msgs::msg::MultiArrayDimension>*>(untyped_member);
    return &member[index];
}

void fetch_function__MultiArrayLayout__dim(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__MultiArrayLayout__dim(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std_msgs::msg::MultiArrayDimension*>(get_function__MultiArrayLayout__dim(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiArrayLayout_message_member_array[2] = {
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            std_msgs::msg::MultiArrayDimension>(),         // members of sub message
        true,                                              // is array
        0,                                                 // array size
