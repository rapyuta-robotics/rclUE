...
extern "C"
{
    ...
    void* std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__get_function__MultiArrayLayout__dim(
        ...
        size_t index)
    {
        std_msgs__msg__MultiArrayDimension__Sequence* member = (std_msgs__msg__MultiArrayDimension__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        std_msgs__msg__MultiArrayDimension* value = (std_msgs__msg__MultiArrayDimension*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        std_msgs__msg__MultiArrayDimension* item =
            ((std_msgs__msg__MultiArrayDimension*)
                 std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__get_function__MultiArrayLayout__dim(
                     untyped_member, index));
        const std_msgs__msg__MultiArrayDimension* value = (const std_msgs__msg__MultiArrayDimension*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_member_array[2] = {
            {
                "dim",                                                   // name
                ...
                NULL,                                                    // default value
                std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__size_function__MultiArrayLayout__dim,    // size()
                                                                                                                              // function
                                                                                                                              // pointer
                ...
                std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__get_function__MultiArrayLayout__dim,    // get(index)
                                                                                                                             // function
                                                                                                                             // pointer
                std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__fetch_function__MultiArrayLayout__dim,    // fetch(index,
                                                                                                                               // &value)
                                                                                                                               // function
                                                                                                                               // pointer
                ...
                std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__resize_function__MultiArrayLayout__dim    // resize(index)
                                                                                                                               // function
                                                                                                                               // pointer
            },
            {
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_members = {
            ...
            std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_member_array,    // message
                                                                                                                           // members
            std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_init_function,    // function to
                                                                                                                    // initialize
                                                                                                                    // message
                                                                                                                    // memory
                                                                                                                    // (memory has
                                                                                                                    // to be
                                                                                                                    // allocated)
            std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_fini_function     // function to
                                                                                                                    // terminate
                                                                                                                    // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, MultiArrayLayout)()
    {
        ...
        if (!std_msgs__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_type_support_handle
