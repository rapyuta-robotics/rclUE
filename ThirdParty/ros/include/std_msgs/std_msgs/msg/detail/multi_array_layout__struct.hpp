...
struct MultiArrayLayout_
{
    ...
    using _dim_type = std::vector<std_msgs::msg::MultiArrayDimension_<ContainerAllocator>,
    ...
    _dim_type dim;
    using _data_offset_type = uint32_t;
    _data_offset_type data_offset;

    // setters for named parameter idiom
    Type& set__dim(const std::vector<std_msgs::msg::MultiArrayDimension_<ContainerAllocator>,
                                     typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                         std_msgs::msg::MultiArrayDimension_<ContainerAllocator>>>& _arg)
    {
        this->dim = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = std_msgs::msg::MultiArrayLayout_<ContainerAllocator>*;
    using ConstRawPtr = const std_msgs::msg::MultiArrayLayout_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<std_msgs::msg::MultiArrayLayout_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<std_msgs::msg::MultiArrayLayout_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__std_msgs__msg__MultiArrayLayout std::shared_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__std_msgs__msg__MultiArrayLayout std::shared_ptr<std_msgs::msg::MultiArrayLayout_<ContainerAllocator> const>
        ConstPtr;
...
using MultiArrayLayout = std_msgs::msg::MultiArrayLayout_<std::allocator<void>>;
