...
{
public:
    explicit Init_MultiArrayDimension_stride(::std_msgs::msg::MultiArrayDimension& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiArrayDimension_size(::std_msgs::msg::MultiArrayDimension& msg) : msg_(msg)
    {
    }
...
template<>
inline auto build<::std_msgs::msg::MultiArrayDimension>()
{
