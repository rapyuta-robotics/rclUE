...
struct String_
{
    ...
    // pointer types
    using RawPtr = std_msgs::msg::String_<ContainerAllocator>*;
    using ConstRawPtr = const std_msgs::msg::String_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<std_msgs::msg::String_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<std_msgs::msg::String_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<std_msgs::msg::String_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<std_msgs::msg::String_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<std_msgs::msg::String_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<std_msgs::msg::String_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<std_msgs::msg::String_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<std_msgs::msg::String_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__std_msgs__msg__String std::shared_ptr<std_msgs::msg::String_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__std_msgs__msg__String std::shared_ptr<std_msgs::msg::String_<ContainerAllocator> const> ConstPtr;
