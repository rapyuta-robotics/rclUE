...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        std_msgs__msg__UInt8__rosidl_typesupport_introspection_c__UInt8_message_member_array[1] = {{
            "data",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        std_msgs__msg__UInt8__rosidl_typesupport_introspection_c__UInt8_message_members = {
            ...
            std_msgs__msg__UInt8__rosidl_typesupport_introspection_c__UInt8_init_function,    // function to initialize message
                                                                                              // memory (memory has to be allocated)
            std_msgs__msg__UInt8__rosidl_typesupport_introspection_c__UInt8_fini_function     // function to terminate message
