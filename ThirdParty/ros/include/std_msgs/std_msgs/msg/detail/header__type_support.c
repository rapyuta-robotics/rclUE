...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        std_msgs__msg__Header__rosidl_typesupport_introspection_c__Header_message_member_array[2] = {
            {
                "stamp",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        std_msgs__msg__Header__rosidl_typesupport_introspection_c__Header_message_members = {
            ...
            std_msgs__msg__Header__rosidl_typesupport_introspection_c__Header_init_function,    // function to initialize message
                                                                                                // memory (memory has to be
                                                                                                // allocated)
            std_msgs__msg__Header__rosidl_typesupport_introspection_c__Header_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        std_msgs__msg__Header__rosidl_typesupport_introspection_c__Header_message_type_support_handle = {
            0,
            &std_msgs__msg__Header__rosidl_typesupport_introspection_c__Header_message_members,
