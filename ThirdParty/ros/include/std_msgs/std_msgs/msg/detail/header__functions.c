...
bool std_msgs__msg__Header__are_equal(const std_msgs__msg__Header* lhs, const std_msgs__msg__Header* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool std_msgs__msg__Header__copy(const std_msgs__msg__Header* input, std_msgs__msg__Header* output)
{
    if (!input || !output)
    {
        return false;
...
std_msgs__msg__Header* std_msgs__msg__Header__create()
{
...
bool std_msgs__msg__Header__Sequence__init(std_msgs__msg__Header__Sequence* array, size_t size)
{
    if (!array)
    {
        return false;
...
void std_msgs__msg__Header__Sequence__fini(std_msgs__msg__Header__Sequence* array)
{
    if (!array)
    {
        return;
...
std_msgs__msg__Header__Sequence* std_msgs__msg__Header__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    std_msgs__msg__Header__Sequence* array =
        (std_msgs__msg__Header__Sequence*)allocator.allocate(sizeof(std_msgs__msg__Header__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void std_msgs__msg__Header__Sequence__destroy(std_msgs__msg__Header__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
    {
...
bool std_msgs__msg__Header__Sequence__are_equal(const std_msgs__msg__Header__Sequence* lhs,
...
bool std_msgs__msg__Header__Sequence__copy(const std_msgs__msg__Header__Sequence* input, std_msgs__msg__Header__Sequence* output)
{
    if (!input || !output)
    {
        return false;
    ...
    {
        const size_t allocation_size = input->size * sizeof(std_msgs__msg__Header);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        std_msgs__msg__Header* data = (std_msgs__msg__Header*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!std_msgs__msg__Header__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
