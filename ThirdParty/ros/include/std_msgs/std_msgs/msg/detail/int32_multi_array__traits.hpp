...
inline void to_flow_style_yaml(const Int32MultiArray& msg, std::ostream& out)
{
    out << "{";
    // member: layout
    {
...
inline void to_block_style_yaml(const Int32MultiArray& msg, std::ostream& out, size_t indentation = 0)
{
    // member: layout
    {
        if (indentation > 0)
...
[[deprecated("use std_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const std_msgs::msg::Int32MultiArray& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use std_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const std_msgs::msg::Int32MultiArray& msg)
{
...
template<>
struct has_fixed_size<std_msgs::msg::Int32MultiArray> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<std_msgs::msg::Int32MultiArray> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<std_msgs::msg::Int32MultiArray> : std::true_type
{
};
