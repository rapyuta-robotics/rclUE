...
extern "C"
{
    ...
    {
        const rosidl_runtime_c__uint64__Sequence* member = (const rosidl_runtime_c__uint64__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__get_function__UInt64MultiArray__data(
        ...
        size_t index)
    {
        rosidl_runtime_c__uint64__Sequence* member = (rosidl_runtime_c__uint64__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        const uint64_t* item =
            ((const uint64_t*)
                 std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__get_const_function__UInt64MultiArray__data(
                     untyped_member, index));
        uint64_t* value = (uint64_t*)(untyped_value);
        *value = *item;
    }
    ...
    {
        uint64_t* item =
            ((uint64_t*)std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__get_function__UInt64MultiArray__data(
                untyped_member, index));
        const uint64_t* value = (const uint64_t*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_member_array[2] = {
            {
                "layout",                                                // name
            ...
            },
            {
                ...
                NULL,                                                   // default value
                std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__size_function__UInt64MultiArray__data,    // size()
                                                                                                                               // function
                                                                                                                               // pointer
                ...
                std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__get_function__UInt64MultiArray__data,    // get(index)
                                                                                                                              // function
                                                                                                                              // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_members = {
            ...
            std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_member_array,    // message
                                                                                                                           // members
            std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_init_function,    // function to
                                                                                                                    // initialize
                                                                                                                    // message
                                                                                                                    // memory
                                                                                                                    // (memory has
                                                                                                                    // to be
                                                                                                                    // allocated)
            std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_fini_function     // function to
                                                                                                                    // terminate
                                                                                                                    // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    static rosidl_message_type_support_t
        std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_type_support_handle = {
            0,
            &std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, UInt64MultiArray)()
    {
        ...
        if (!std_msgs__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_type_support_handle
