...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        std_msgs__msg__Int32__rosidl_typesupport_introspection_c__Int32_message_member_array[1] = {{
            "data",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        std_msgs__msg__Int32__rosidl_typesupport_introspection_c__Int32_message_members = {
            ...
            std_msgs__msg__Int32__rosidl_typesupport_introspection_c__Int32_init_function,    // function to initialize message
                                                                                              // memory (memory has to be allocated)
            std_msgs__msg__Int32__rosidl_typesupport_introspection_c__Int32_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        std_msgs__msg__Int32__rosidl_typesupport_introspection_c__Int32_message_type_support_handle = {
            0,
            &std_msgs__msg__Int32__rosidl_typesupport_introspection_c__Int32_message_members,
