...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_member_array[4] = {
            {
                "r",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_members = {
            ...
            std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_init_function,    // function to initialize
                                                                                                      // message memory (memory has
                                                                                                      // to be allocated)
            std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_fini_function     // function to terminate
    ...
    {
        if (!std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_type_support_handle
