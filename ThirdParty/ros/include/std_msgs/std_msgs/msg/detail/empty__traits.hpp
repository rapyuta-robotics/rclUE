...
[[deprecated("use std_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const std_msgs::msg::Empty& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use std_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const std_msgs::msg::Empty& msg)
{
...
template<>
struct has_fixed_size<std_msgs::msg::Empty> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<std_msgs::msg::Empty> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<std_msgs::msg::Empty> : std::true_type
{
};
