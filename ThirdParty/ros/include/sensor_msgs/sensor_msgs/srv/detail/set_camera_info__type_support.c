...
extern "C"
{
    ...
    void sensor_msgs__srv__SetCameraInfo_Request__rosidl_typesupport_introspection_c__SetCameraInfo_Request_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__srv__SetCameraInfo_Request__rosidl_typesupport_introspection_c__SetCameraInfo_Request_message_member_array[1] =
            {{
                "camera_info",                                                     // name
    ...
    {
        sensor_msgs__srv__SetCameraInfo_Request__rosidl_typesupport_introspection_c__SetCameraInfo_Request_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, CameraInfo)();
        if (!sensor_msgs__srv__SetCameraInfo_Request__rosidl_typesupport_introspection_c__SetCameraInfo_Request_message_type_support_handle
...
extern "C"
{
    ...
    void sensor_msgs__srv__SetCameraInfo_Response__rosidl_typesupport_introspection_c__SetCameraInfo_Response_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__srv__SetCameraInfo_Response__rosidl_typesupport_introspection_c__SetCameraInfo_Response_message_member_array
            [2] = {{
                       "success",                                                      // name
    ...
    {
        if (!sensor_msgs__srv__SetCameraInfo_Response__rosidl_typesupport_introspection_c__SetCameraInfo_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            sensor_msgs__srv__SetCameraInfo_Response__rosidl_typesupport_introspection_c__SetCameraInfo_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_sensor_msgs const rosidl_service_type_support_t*
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, srv, SetCameraInfo)()
{
    if (!sensor_msgs__srv__detail__set_camera_info__rosidl_typesupport_introspection_c__SetCameraInfo_service_type_support_handle
             .typesupport_identifier)
    {
        sensor_msgs__srv__detail__set_camera_info__rosidl_typesupport_introspection_c__SetCameraInfo_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, sensor_msgs, srv, SetCameraInfo_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, sensor_msgs, srv, SetCameraInfo_Response)()
                ->data;
    }
