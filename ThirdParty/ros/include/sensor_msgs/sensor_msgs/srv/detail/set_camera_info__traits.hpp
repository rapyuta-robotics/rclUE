...
inline void to_flow_style_yaml(const SetCameraInfo_Request& msg, std::ostream& out)
{
    out << "{";
    // member: camera_info
    {
...
inline void to_block_style_yaml(const SetCameraInfo_Request& msg, std::ostream& out, size_t indentation = 0)
{
    // member: camera_info
    {
        if (indentation > 0)
...
[[deprecated("use sensor_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const sensor_msgs::srv::SetCameraInfo_Request& msg, std::ostream& out, size_t indentation = 0)
{
    sensor_msgs::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use sensor_msgs::srv::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct is_message<sensor_msgs::srv::SetCameraInfo_Request> : std::true_type
{
};
...
inline void to_flow_style_yaml(const SetCameraInfo_Response& msg, std::ostream& out)
{
    out << "{";
    // member: success
    {
...
inline void to_block_style_yaml(const SetCameraInfo_Response& msg, std::ostream& out, size_t indentation = 0)
{
    // member: success
    {
        if (indentation > 0)
...
[[deprecated("use sensor_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const sensor_msgs::srv::SetCameraInfo_Response& msg, std::ostream& out, size_t indentation = 0)
{
    sensor_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
template<>
struct has_fixed_size<sensor_msgs::srv::SetCameraInfo_Response> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<sensor_msgs::srv::SetCameraInfo_Response> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<sensor_msgs::srv::SetCameraInfo_Response> : std::true_type
{
};
...
template<>
struct is_service<sensor_msgs::srv::SetCameraInfo> : std::true_type
{
};

template<>
struct is_service_request<sensor_msgs::srv::SetCameraInfo_Request> : std::true_type
{
};

template<>
struct is_service_response<sensor_msgs::srv::SetCameraInfo_Response> : std::true_type
{
};
