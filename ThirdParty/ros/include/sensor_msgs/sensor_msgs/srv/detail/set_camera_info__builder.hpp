...
{
public:
    Init_SetCameraInfo_Request_camera_info() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::srv::SetCameraInfo_Request>()
{
...
{
public:
    explicit Init_SetCameraInfo_Response_status_message(::sensor_msgs::srv::SetCameraInfo_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SetCameraInfo_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::srv::SetCameraInfo_Response>()
{
