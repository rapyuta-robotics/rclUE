...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__MultiEchoLaserScan__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__MultiEchoLaserScan__fini(
        sensor_msgs__msg__MultiEchoLaserScan* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs sensor_msgs__msg__MultiEchoLaserScan* sensor_msgs__msg__MultiEchoLaserScan__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__MultiEchoLaserScan__destroy(
        sensor_msgs__msg__MultiEchoLaserScan* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__MultiEchoLaserScan__are_equal(
        const sensor_msgs__msg__MultiEchoLaserScan* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__MultiEchoLaserScan__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__MultiEchoLaserScan__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__MultiEchoLaserScan__Sequence__fini(
        sensor_msgs__msg__MultiEchoLaserScan__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs sensor_msgs__msg__MultiEchoLaserScan__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__MultiEchoLaserScan__Sequence__destroy(
        sensor_msgs__msg__MultiEchoLaserScan__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__MultiEchoLaserScan__Sequence__are_equal(
        const sensor_msgs__msg__MultiEchoLaserScan__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__MultiEchoLaserScan__Sequence__copy(
