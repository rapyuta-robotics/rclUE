...
extern "C"
{
    ...
    {
        uint8_t* item =
            ((uint8_t*)sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__get_function__CompressedImage__data(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_member_array[3] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__get_function__CompressedImage__data,    // get(index)
                                                                                                                               // function
                                                                                                                               // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_members = {
            ...
            sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_member_array,    // message
                                                                                                                            // members
            sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_init_function,    // function to
                                                                                                                     // initialize
                                                                                                                     // message
                                                                                                                     // memory
                                                                                                                     // (memory has
                                                                                                                     // to be
                                                                                                                     // allocated)
            sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_fini_function     // function to
                                                                                                                     // terminate
                                                                                                                     // message
                                                                                                                     // instance
                                                                                                                     // (will not
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_type_support_handle = {
            0,
            &sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, CompressedImage)()
    {
        ...
        if (!sensor_msgs__msg__CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_type_support_handle
