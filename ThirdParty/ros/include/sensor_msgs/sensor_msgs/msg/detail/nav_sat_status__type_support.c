...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__NavSatStatus__rosidl_typesupport_introspection_c__NavSatStatus_message_member_array[2] = {
            {
                "status",                                             // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__NavSatStatus__rosidl_typesupport_introspection_c__NavSatStatus_message_members = {
            ...
            sensor_msgs__msg__NavSatStatus__rosidl_typesupport_introspection_c__NavSatStatus_message_member_array,    // message
                                                                                                                      // members
            sensor_msgs__msg__NavSatStatus__rosidl_typesupport_introspection_c__NavSatStatus_init_function,           // function to
                                                                                                               // initialize message
                                                                                                               // memory (memory has
                                                                                                               // to be allocated)
            sensor_msgs__msg__NavSatStatus__rosidl_typesupport_introspection_c__NavSatStatus_fini_function    // function to
                                                                                                              // terminate message
                                                                                                              // instance (will not
                                                                                                              // free memory)
    };
    ...
    {
        if (!sensor_msgs__msg__NavSatStatus__rosidl_typesupport_introspection_c__NavSatStatus_message_type_support_handle
