...
extern "C"
{
    ...
    void sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_member_array[3] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_members = {
            ...
            sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_member_array,    // message
                                                                                                                              // members
            sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_init_function,    // function
                                                                                                                       // to
                                                                                                                       // initialize
                                                                                                                       // message
                                                                                                                       // memory
                                                                                                                       ...
                                                                                                                       // has to be
                                                                                                                       // allocated)
            sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_fini_function    // function to
                                                                                                                      // terminate
                                                                                                                      // message
                                                                                                                      // instance
                                                                                                                      // (will not
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_type_support_handle = {
            0,
            &sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, RelativeHumidity)()
    {
        ...
        if (!sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_type_support_handle
