...
{
public:
    explicit Init_CameraInfo_roi(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_binning_y(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_binning_x(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_p(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_r(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_k(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_d(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_distortion_model(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_width(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CameraInfo_height(::sensor_msgs::msg::CameraInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_CameraInfo_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::CameraInfo>()
{
