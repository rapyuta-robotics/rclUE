...
extern "C"
{
    ...
    get_serialized_size_sensor_msgs__msg__MultiDOFJointState(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sensor_msgs size_t
    max_serialized_size_sensor_msgs__msg__MultiDOFJointState(bool& full_bounded, bool& is_plain, size_t current_alignment);
