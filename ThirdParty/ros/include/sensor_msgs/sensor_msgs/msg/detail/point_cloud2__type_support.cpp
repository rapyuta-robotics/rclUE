...
void PointCloud2_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<sensor_msgs::msg::PointField>*>(untyped_member);
    return &member[index];
}

void fetch_function__PointCloud2__fields(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const sensor_msgs::msg::PointField*>(get_const_function__PointCloud2__fields(untyped_member, index));
    auto& value = *reinterpret_cast<sensor_msgs::msg::PointField*>(untyped_value);
    value = item;
}

void assign_function__PointCloud2__fields(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<sensor_msgs::msg::PointField*>(get_function__PointCloud2__fields(untyped_member, index));
...
void fetch_function__PointCloud2__data(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const uint8_t*>(get_const_function__PointCloud2__data(untyped_member, index));
    auto& value = *reinterpret_cast<uint8_t*>(untyped_value);
    value = item;
}

void assign_function__PointCloud2__data(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<uint8_t*>(get_function__PointCloud2__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointCloud2_message_member_array[9] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sensor_msgs::msg::PointField>(),    // members of
                                                                                                                    // sub message
        true,                                                                                                       // is array
        0,                                                                                                          // array size
        false,                                              // is upper bound
