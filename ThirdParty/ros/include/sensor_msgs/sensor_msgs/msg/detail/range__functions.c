...
bool sensor_msgs__msg__Range__are_equal(const sensor_msgs__msg__Range* lhs, const sensor_msgs__msg__Range* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool sensor_msgs__msg__Range__copy(const sensor_msgs__msg__Range* input, sensor_msgs__msg__Range* output)
{
    if (!input || !output)
    {
        return false;
...
sensor_msgs__msg__Range* sensor_msgs__msg__Range__create()
{
...
bool sensor_msgs__msg__Range__Sequence__init(sensor_msgs__msg__Range__Sequence* array, size_t size)
{
    if (!array)
    {
        return false;
...
void sensor_msgs__msg__Range__Sequence__fini(sensor_msgs__msg__Range__Sequence* array)
{
    if (!array)
    {
        return;
...
sensor_msgs__msg__Range__Sequence* sensor_msgs__msg__Range__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensor_msgs__msg__Range__Sequence* array =
        (sensor_msgs__msg__Range__Sequence*)allocator.allocate(sizeof(sensor_msgs__msg__Range__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void sensor_msgs__msg__Range__Sequence__destroy(sensor_msgs__msg__Range__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
    {
...
bool sensor_msgs__msg__Range__Sequence__are_equal(const sensor_msgs__msg__Range__Sequence* lhs,
...
bool sensor_msgs__msg__Range__Sequence__copy(const sensor_msgs__msg__Range__Sequence* input,
                                             sensor_msgs__msg__Range__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(sensor_msgs__msg__Range);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        sensor_msgs__msg__Range* data =
            (sensor_msgs__msg__Range*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!sensor_msgs__msg__Range__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
