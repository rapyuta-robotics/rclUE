...
{
public:
    explicit Init_NavSatFix_position_covariance_type(::sensor_msgs::msg::NavSatFix& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NavSatFix_position_covariance(::sensor_msgs::msg::NavSatFix& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NavSatFix_altitude(::sensor_msgs::msg::NavSatFix& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NavSatFix_longitude(::sensor_msgs::msg::NavSatFix& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NavSatFix_latitude(::sensor_msgs::msg::NavSatFix& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NavSatFix_status(::sensor_msgs::msg::NavSatFix& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_NavSatFix_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::NavSatFix>()
{
