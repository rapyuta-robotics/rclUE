...
inline void to_flow_style_yaml(const MultiDOFJointState& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const MultiDOFJointState& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
to_yaml(const sensor_msgs::msg::MultiDOFJointState& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<sensor_msgs::msg::MultiDOFJointState> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<sensor_msgs::msg::MultiDOFJointState> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<sensor_msgs::msg::MultiDOFJointState> : std::true_type
{
};
