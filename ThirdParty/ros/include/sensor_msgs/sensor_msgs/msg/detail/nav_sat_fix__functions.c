...
bool sensor_msgs__msg__NavSatFix__are_equal(const sensor_msgs__msg__NavSatFix* lhs, const sensor_msgs__msg__NavSatFix* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // status
    if (!sensor_msgs__msg__NavSatStatus__are_equal(&(lhs->status), &(rhs->status)))
    {
        return false;
    }
    // latitude
...
bool sensor_msgs__msg__NavSatFix__copy(const sensor_msgs__msg__NavSatFix* input, sensor_msgs__msg__NavSatFix* output)
{
    if (!input || !output)
    {
        return false;
    ...
    // status
    if (!sensor_msgs__msg__NavSatStatus__copy(&(input->status), &(output->status)))
    {
        return false;
    }
    // latitude
...
sensor_msgs__msg__NavSatFix* sensor_msgs__msg__NavSatFix__create()
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensor_msgs__msg__NavSatFix* msg =
        (sensor_msgs__msg__NavSatFix*)allocator.allocate(sizeof(sensor_msgs__msg__NavSatFix), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool sensor_msgs__msg__NavSatFix__Sequence__init(sensor_msgs__msg__NavSatFix__Sequence* array, size_t size)
{
    if (!array)
    {
        return false;
...
void sensor_msgs__msg__NavSatFix__Sequence__fini(sensor_msgs__msg__NavSatFix__Sequence* array)
{
    if (!array)
    {
        return;
...
sensor_msgs__msg__NavSatFix__Sequence* sensor_msgs__msg__NavSatFix__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensor_msgs__msg__NavSatFix__Sequence* array =
        (sensor_msgs__msg__NavSatFix__Sequence*)allocator.allocate(sizeof(sensor_msgs__msg__NavSatFix__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void sensor_msgs__msg__NavSatFix__Sequence__destroy(sensor_msgs__msg__NavSatFix__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
    {
...
bool sensor_msgs__msg__NavSatFix__Sequence__are_equal(const sensor_msgs__msg__NavSatFix__Sequence* lhs,
                                                      const sensor_msgs__msg__NavSatFix__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool sensor_msgs__msg__NavSatFix__Sequence__copy(const sensor_msgs__msg__NavSatFix__Sequence* input,
                                                 sensor_msgs__msg__NavSatFix__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(sensor_msgs__msg__NavSatFix);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        sensor_msgs__msg__NavSatFix* data =
            (sensor_msgs__msg__NavSatFix*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!sensor_msgs__msg__NavSatFix__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
