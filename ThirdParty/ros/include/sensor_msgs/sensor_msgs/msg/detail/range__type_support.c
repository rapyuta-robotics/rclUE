...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__Range__rosidl_typesupport_introspection_c__Range_message_member_array[6] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__Range__rosidl_typesupport_introspection_c__Range_message_members = {
            ...
            sensor_msgs__msg__Range__rosidl_typesupport_introspection_c__Range_init_function,    // function to initialize message
                                                                                                 // memory (memory has to be
                                                                                                 // allocated)
            sensor_msgs__msg__Range__rosidl_typesupport_introspection_c__Range_fini_function     // function to terminate message
