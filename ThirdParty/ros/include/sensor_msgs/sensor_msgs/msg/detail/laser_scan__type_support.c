...
extern "C"
{
    ...
    void* sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_function__LaserScan__ranges(void* untyped_member,
                                                                                                           size_t index)
    {
    ...
    {
        const float* item =
            ((const float*)sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_const_function__LaserScan__ranges(
    ...
    {
        float* item = ((float*)sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_function__LaserScan__ranges(
            untyped_member, index));
        const float* value = (const float*)(untyped_value);
        *item = *value;
    }

    bool sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__resize_function__LaserScan__ranges(void* untyped_member,
                                                                                                             size_t size)
    {
        rosidl_runtime_c__float__Sequence* member = (rosidl_runtime_c__float__Sequence*)(untyped_member);
    ...
    {
        float* item =
            ((float*)sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_function__LaserScan__intensities(
                untyped_member, index));
        const float* value = (const float*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_member_array[10] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                  // default value
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__size_function__LaserScan__ranges,    // size()
                                                                                                                      // function
                                                                                                                      // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_const_function__LaserScan__ranges,    // get_const(index)
                                                                                                                           // function
                                                                                                                           // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_function__LaserScan__ranges,      // get(index)
                                                                                                                       // function
                                                                                                                       // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__fetch_function__LaserScan__ranges,    // fetch(index,
                                                                                                                       // &value)
                                                                                                                       // function
                                                                                                                       // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__assign_function__LaserScan__ranges,    // assign(index,
                                                                                                                        // value)
                                                                                                                        // function
                                                                                                                        // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__resize_function__LaserScan__ranges    // resize(index)
                                                                                                                       // function
                                                                                                                       // pointer
            },
            {
                ...
                NULL,                                                  // default value
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__size_function__LaserScan__intensities,    // size()
                                                                                                                           // function
                                                                                                                           // pointer
                ...
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__get_function__LaserScan__intensities,    // get(index)
                                                                                                                          // function
                                                                                                                          // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__fetch_function__LaserScan__intensities,    // fetch(index,
                                                                                                                            // &value)
                                                                                                                            // function
                                                                                                                            // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__assign_function__LaserScan__intensities,    // assign(index,
                                                                                                                             // value)
                                                                                                                             // function
                                                                                                                             // pointer
                sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__resize_function__LaserScan__intensities    // resize(index)
                                                                                                                            // function
                                                                                                                            // pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_members = {
            ...
            sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_init_function,    // function to initialize
                                                                                                         // message memory (memory
                                                                                                         // has to be allocated)
            sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_type_support_handle = {
            0,
            &sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, LaserScan)()
    {
        ...
        if (!sensor_msgs__msg__LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_type_support_handle
