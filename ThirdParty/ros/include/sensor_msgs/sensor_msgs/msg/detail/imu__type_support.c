...
extern "C"
{
    ...
    void* sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__orientation_covariance(void* untyped_member,
                                                                                                               size_t index)
    {
        ...
        void* untyped_value)
    {
        const double* item =
            ((const double*)
                 sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_const_function__Imu__orientation_covariance(
    ...
    {
        double* item =
            ((double*)sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__orientation_covariance(
                untyped_member, index));
        ...
        void* untyped_value)
    {
        const double* item =
            ((const double*)
                 sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_const_function__Imu__angular_velocity_covariance(
                     untyped_member, index));
        double* value = (double*)(untyped_value);
        *value = *item;
    }
    ...
    {
        double* item =
            ((double*)sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__angular_velocity_covariance(
                untyped_member, index));
        const double* value = (const double*)(untyped_value);
        *item = *value;
    }
        ...
        void* untyped_value)
    {
        const double* item =
            ((const double*)
                 sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_const_function__Imu__linear_acceleration_covariance(
                     untyped_member, index));
        double* value = (double*)(untyped_value);
        *value = *item;
    }
    ...
    {
        double* item =
            ((double*)sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__linear_acceleration_covariance(
                untyped_member, index));
        const double* value = (const double*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__Imu_message_member_array[7] = {
        ...
        },
        {
            ...
            NULL,                                                       // default value
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__size_function__Imu__orientation_covariance,    // size()
                                                                                                                      // function
                                                                                                                      // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_const_function__Imu__orientation_covariance,    // get_const(index)
                                                                                                                           // function
                                                                                                                           // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__orientation_covariance,      // get(index)
                                                                                                                       // function
                                                                                                                       // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__fetch_function__Imu__orientation_covariance,    // fetch(index,
                                                                                                                       // &value)
                                                                                                                       // function
                                                                                                                       // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__assign_function__Imu__orientation_covariance,    // assign(index,
                                                                                                                        // value)
                                                                                                                        // function
                                                                                                                        // pointer
            NULL    // resize(index) function pointer
        ...
        },
        {
            ...
            NULL,                                                            // default value
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__size_function__Imu__angular_velocity_covariance,    // size()
                                                                                                                           // function
                                                                                                                           // pointer
            ...
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__angular_velocity_covariance,    // get(index)
                                                                                                                          // function
                                                                                                                          // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__fetch_function__Imu__angular_velocity_covariance,    // fetch(index,
                                                                                                                            // &value)
                                                                                                                            // function
                                                                                                                            // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__assign_function__Imu__angular_velocity_covariance,    // assign(index,
                                                                                                                             // value)
                                                                                                                             // function
                                                                                                                             // pointer
            NULL    // resize(index) function pointer
        ...
        },
        {
            ...
            NULL,                                                               // default value
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__size_function__Imu__linear_acceleration_covariance,    // size()
                                                                                                                              // function
                                                                                                                              // pointer
            ...
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__get_function__Imu__linear_acceleration_covariance,    // get(index)
                                                                                                                             // function
                                                                                                                             // pointer
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__fetch_function__Imu__linear_acceleration_covariance,    // fetch(index,
                                                                                                                               // &value)
                                                                                                                               // function
                                                                                                                               // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__Imu_message_members = {
            ...
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__Imu_init_function,    // function to initialize message
                                                                                             // memory (memory has to be allocated)
            sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__Imu_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__Imu_message_type_support_handle = {
            0,
            &sensor_msgs__msg__Imu__rosidl_typesupport_introspection_c__Imu_message_members,
