...
{
public:
    explicit Init_JointState_effort(::sensor_msgs::msg::JointState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JointState_velocity(::sensor_msgs::msg::JointState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JointState_position(::sensor_msgs::msg::JointState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JointState_name(::sensor_msgs::msg::JointState& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_JointState_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::JointState>()
{
