...
inline void to_flow_style_yaml(const RegionOfInterest& msg, std::ostream& out)
{
    out << "{";
    // member: x_offset
    {
...
inline void to_block_style_yaml(const RegionOfInterest& msg, std::ostream& out, size_t indentation = 0)
{
    // member: x_offset
    {
        if (indentation > 0)
...
to_yaml(const sensor_msgs::msg::RegionOfInterest& msg, std::ostream& out, size_t indentation = 0)
{
    sensor_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use sensor_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const sensor_msgs::msg::RegionOfInterest& msg)
{
...
template<>
struct has_fixed_size<sensor_msgs::msg::RegionOfInterest> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<sensor_msgs::msg::RegionOfInterest> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<sensor_msgs::msg::RegionOfInterest> : std::true_type
{
};
