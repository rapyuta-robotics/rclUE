...
extern "C"
{
    ...
    {
        double* item =
            ((double*)sensor_msgs__msg__NavSatFix__rosidl_typesupport_introspection_c__get_function__NavSatFix__position_covariance(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__NavSatFix__rosidl_typesupport_introspection_c__NavSatFix_message_member_array[7] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__NavSatFix__rosidl_typesupport_introspection_c__NavSatFix_message_members = {
            ...
            sensor_msgs__msg__NavSatFix__rosidl_typesupport_introspection_c__NavSatFix_init_function,    // function to initialize
                                                                                                         // message memory (memory
                                                                                                         // has to be allocated)
            sensor_msgs__msg__NavSatFix__rosidl_typesupport_introspection_c__NavSatFix_fini_function     // function to terminate
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, NavSatFix)()
    {
        ...
        if (!sensor_msgs__msg__NavSatFix__rosidl_typesupport_introspection_c__NavSatFix_message_type_support_handle
