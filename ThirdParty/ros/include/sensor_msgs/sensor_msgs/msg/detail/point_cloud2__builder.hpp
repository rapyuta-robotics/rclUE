...
{
public:
    explicit Init_PointCloud2_is_dense(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_data(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_row_step(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_point_step(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_is_bigendian(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_fields(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_width(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud2_height(::sensor_msgs::msg::PointCloud2& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PointCloud2_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::PointCloud2>()
{
