...
void MultiDOFJointState_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__MultiDOFJointState__joint_names(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__MultiDOFJointState__joint_names(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__MultiDOFJointState__joint_names(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__MultiDOFJointState__joint_names(untyped_member, index));
...
{
    auto& member = *reinterpret_cast<std::vector<geometry_msgs::msg::Transform>*>(untyped_member);
    return &member[index];
}

void fetch_function__MultiDOFJointState__transforms(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__MultiDOFJointState__transforms(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<geometry_msgs::msg::Transform*>(get_function__MultiDOFJointState__transforms(untyped_member, index));
...
void fetch_function__MultiDOFJointState__twist(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const geometry_msgs::msg::Twist*>(get_const_function__MultiDOFJointState__twist(untyped_member, index));
    auto& value = *reinterpret_cast<geometry_msgs::msg::Twist*>(untyped_value);
    value = item;
}

void assign_function__MultiDOFJointState__twist(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<geometry_msgs::msg::Twist*>(get_function__MultiDOFJointState__twist(untyped_member, index));
...
{
    auto& member = *reinterpret_cast<std::vector<geometry_msgs::msg::Wrench>*>(untyped_member);
    return &member[index];
}

void fetch_function__MultiDOFJointState__wrench(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const geometry_msgs::msg::Wrench*>(get_const_function__MultiDOFJointState__wrench(untyped_member, index));
    auto& value = *reinterpret_cast<geometry_msgs::msg::Wrench*>(untyped_value);
    value = item;
}

void assign_function__MultiDOFJointState__wrench(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<geometry_msgs::msg::Wrench*>(get_function__MultiDOFJointState__wrench(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiDOFJointState_message_member_array[5] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<geometry_msgs::msg::Transform>(),    // members of
                                                                                                                     // sub message
        true,                                                                                                        // is array
        0,                                                                                                           // array size
        false,                                                         // is upper bound
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<geometry_msgs::msg::Twist>(),    // members of sub
                                                                                                                 // message
        true,                                                                                                    // is array
        0,                                                                                                       // array size
        false,                                                                                                   // is upper bound
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<geometry_msgs::msg::Wrench>(),    // members of sub
                                                                                                                  // message
        true,                                                                                                     // is array
        0,                                                                                                        // array size
        false,                                                                                                    // is upper bound
