...
extern "C"
{
    ...
    void* sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__get_function__LaserEcho__echoes(void* untyped_member,
                                                                                                           size_t index)
    {
    ...
    {
        const float* item =
            ((const float*)sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__get_const_function__LaserEcho__echoes(
    ...
    {
        float* item = ((float*)sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__get_function__LaserEcho__echoes(
            untyped_member, index));
        const float* value = (const float*)(untyped_value);
        *item = *value;
    }

    bool sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__resize_function__LaserEcho__echoes(void* untyped_member,
                                                                                                             size_t size)
    {
        rosidl_runtime_c__float__Sequence* member = (rosidl_runtime_c__float__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_message_member_array[1] = {{
            "echoes",                                              // name
            ...
            NULL,                                                  // default value
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__size_function__LaserEcho__echoes,    // size() function
                                                                                                                  // pointer
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__get_const_function__LaserEcho__echoes,    // get_const(index)
                                                                                                                       // function
                                                                                                                       // pointer
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__get_function__LaserEcho__echoes,    // get(index)
                                                                                                                 // function pointer
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__fetch_function__LaserEcho__echoes,     // fetch(index,
                                                                                                                    // &value)
                                                                                                                    // function
                                                                                                                    // pointer
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__assign_function__LaserEcho__echoes,    // assign(index,
                                                                                                                    // value)
                                                                                                                    // function
                                                                                                                    // pointer
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__resize_function__LaserEcho__echoes     // resize(index)
                                                                                                                    // function
                                                                                                                    // pointer
        }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_message_members = {
            ...
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_init_function,    // function to initialize
                                                                                                         // message memory (memory
                                                                                                         // has to be allocated)
            sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_message_type_support_handle = {
            0,
            &sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_message_members,
    ...
    {
        if (!sensor_msgs__msg__LaserEcho__rosidl_typesupport_introspection_c__LaserEcho_message_type_support_handle
