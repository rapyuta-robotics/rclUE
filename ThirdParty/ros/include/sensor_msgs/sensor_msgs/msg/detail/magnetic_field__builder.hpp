...
{
public:
    explicit Init_MagneticField_magnetic_field_covariance(::sensor_msgs::msg::MagneticField& msg) : msg_(msg)
    {
    }
    ::sensor_msgs::msg::MagneticField magnetic_field_covariance(
        ::sensor_msgs::msg::MagneticField::_magnetic_field_covariance_type arg)
    {
...
{
public:
    explicit Init_MagneticField_magnetic_field(::sensor_msgs::msg::MagneticField& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MagneticField_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::MagneticField>()
{
