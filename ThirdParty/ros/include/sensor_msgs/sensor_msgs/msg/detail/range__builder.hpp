...
{
public:
    explicit Init_Range_range(::sensor_msgs::msg::Range& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Range_max_range(::sensor_msgs::msg::Range& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Range_min_range(::sensor_msgs::msg::Range& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Range_field_of_view(::sensor_msgs::msg::Range& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Range_radiation_type(::sensor_msgs::msg::Range& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Range_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::Range>()
{
