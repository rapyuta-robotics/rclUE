...
extern "C"
{
    ...
    void sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_fini_function(
        void* message_memory)
    {
    ...
    const void*
    sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_const_function__MultiDOFJointState__joint_names(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__String__Sequence* member = (const rosidl_runtime_c__String__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        rosidl_runtime_c__String* item =
            ((rosidl_runtime_c__String*)
                 sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_function__MultiDOFJointState__joint_names(
                     untyped_member, index));
    ...
    const void*
    sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_const_function__MultiDOFJointState__transforms(
        const void* untyped_member,
        size_t index)
    {
        const geometry_msgs__msg__Transform__Sequence* member = (const geometry_msgs__msg__Transform__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__Transform* item =
            ((geometry_msgs__msg__Transform*)
                 sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_function__MultiDOFJointState__transforms(
                     untyped_member, index));
    ...
    const void*
    sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_const_function__MultiDOFJointState__twist(
        const void* untyped_member,
        size_t index)
    {
        const geometry_msgs__msg__Twist__Sequence* member = (const geometry_msgs__msg__Twist__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__Twist* item =
            ((geometry_msgs__msg__Twist*)
                 sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_function__MultiDOFJointState__twist(
                     untyped_member, index));
    ...
    size_t sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__size_function__MultiDOFJointState__wrench(
        const void* untyped_member)
    {
        const geometry_msgs__msg__Wrench__Sequence* member = (const geometry_msgs__msg__Wrench__Sequence*)(untyped_member);
        return member->size;
    }

    const void*
    sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_const_function__MultiDOFJointState__wrench(
        const void* untyped_member,
        size_t index)
    {
        const geometry_msgs__msg__Wrench__Sequence* member = (const geometry_msgs__msg__Wrench__Sequence*)(untyped_member);
    ...
    void* sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_function__MultiDOFJointState__wrench(
        ...
        size_t index)
    {
        geometry_msgs__msg__Wrench__Sequence* member = (geometry_msgs__msg__Wrench__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        const geometry_msgs__msg__Wrench* item =
            ((const geometry_msgs__msg__Wrench*)
                 sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_const_function__MultiDOFJointState__wrench(
                     untyped_member, index));
        geometry_msgs__msg__Wrench* value = (geometry_msgs__msg__Wrench*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__Wrench* item =
            ((geometry_msgs__msg__Wrench*)
                 sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__get_function__MultiDOFJointState__wrench(
                     untyped_member, index));
        const geometry_msgs__msg__Wrench* value = (const geometry_msgs__msg__Wrench*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_member_array[5] = {
            {
                "header",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_members = {
            ...
            sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_init_function,    // function
                                                                                                                           // to
                                                                                                                           // initialize
                                                                                                                           // message
                                                                                                                           // memory
                                                                                                                           ...
                                                                                                                           // be
                                                                                                                           // allocated)
            sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_fini_function    // function
                                                                                                                          // to
                                                                                                                          // terminate
                                                                                                                          // message
                                                                                                                          // instance
    ...
    {
        sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
        sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_member_array[2]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Transform)();
        sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_member_array[3]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Twist)();
        sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_member_array[4]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Wrench)();
        if (!sensor_msgs__msg__MultiDOFJointState__rosidl_typesupport_introspection_c__MultiDOFJointState_message_type_support_handle
