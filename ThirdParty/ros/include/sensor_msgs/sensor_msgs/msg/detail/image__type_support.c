...
extern "C"
{
    ...
    size_t sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__size_function__Image__data(const void* untyped_member)
    {
    ...
    void* sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__get_function__Image__data(void* untyped_member, size_t index)
    {
        rosidl_runtime_c__uint8__Sequence* member = (rosidl_runtime_c__uint8__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__fetch_function__Image__data(const void* untyped_member,
                                                                                                  size_t index,
                                                                                                  void* untyped_value)
    {
        const uint8_t* item =
            ((const uint8_t*)sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__get_const_function__Image__data(
                untyped_member, index));
        uint8_t* value = (uint8_t*)(untyped_value);
        *value = *item;
    }

    void sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__assign_function__Image__data(void* untyped_member,
                                                                                                   size_t index,
                                                                                                   const void* untyped_value)
    {
        uint8_t* item = ((uint8_t*)sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__get_function__Image__data(
            untyped_member, index));
        const uint8_t* value = (const uint8_t*)(untyped_value);
        *item = *value;
    }

    bool sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__resize_function__Image__data(void* untyped_member,
                                                                                                   size_t size)
    {
        rosidl_runtime_c__uint8__Sequence* member = (rosidl_runtime_c__uint8__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__Image_message_member_array[7] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                  // default value
                sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__size_function__Image__data,         // size() function
                                                                                                                 // pointer
                sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__get_const_function__Image__data,    // get_const(index)
                                                                                                                 // function pointer
                sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__get_function__Image__data,      // get(index) function
                                                                                                             // pointer
                sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__fetch_function__Image__data,    // fetch(index, &value)
                                                                                                             // function pointer
                sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__assign_function__Image__data,    // assign(index,
                                                                                                              // value) function
                                                                                                              // pointer
                sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__resize_function__Image__data     // resize(index)
                                                                                                              // function pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__Image_message_members = {
            ...
            sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__Image_init_function,    // function to initialize message
                                                                                                 // memory (memory has to be
                                                                                                 // allocated)
            sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__Image_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__Image_message_type_support_handle = {
            0,
            &sensor_msgs__msg__Image__rosidl_typesupport_introspection_c__Image_message_members,
