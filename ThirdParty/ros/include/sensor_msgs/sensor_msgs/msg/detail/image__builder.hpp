...
{
public:
    explicit Init_Image_data(::sensor_msgs::msg::Image& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Image_step(::sensor_msgs::msg::Image& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Image_is_bigendian(::sensor_msgs::msg::Image& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Image_encoding(::sensor_msgs::msg::Image& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Image_width(::sensor_msgs::msg::Image& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Image_height(::sensor_msgs::msg::Image& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Image_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::Image>()
{
