...
struct CompressedImage_
{
    ...
    explicit CompressedImage_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), format(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->format = "";
    ...
    // pointer types
    using RawPtr = sensor_msgs::msg::CompressedImage_<ContainerAllocator>*;
    using ConstRawPtr = const sensor_msgs::msg::CompressedImage_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::CompressedImage_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::CompressedImage_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__sensor_msgs__msg__CompressedImage std::shared_ptr<sensor_msgs::msg::CompressedImage_<ContainerAllocator>>
        Ptr;
...
using CompressedImage = sensor_msgs::msg::CompressedImage_<std::allocator<void>>;
