...
inline void to_flow_style_yaml(const ChannelFloat32& msg, std::ostream& out)
{
    out << "{";
    // member: name
    {
...
inline void to_block_style_yaml(const ChannelFloat32& msg, std::ostream& out, size_t indentation = 0)
{
    // member: name
    {
        if (indentation > 0)
...
to_yaml(const sensor_msgs::msg::ChannelFloat32& msg, std::ostream& out, size_t indentation = 0)
{
    sensor_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use sensor_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const sensor_msgs::msg::ChannelFloat32& msg)
{
...
template<>
struct has_fixed_size<sensor_msgs::msg::ChannelFloat32> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<sensor_msgs::msg::ChannelFloat32> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<sensor_msgs::msg::ChannelFloat32> : std::true_type
{
};
