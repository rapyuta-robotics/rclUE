...
{
public:
    explicit Init_RegionOfInterest_do_rectify(::sensor_msgs::msg::RegionOfInterest& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_RegionOfInterest_width(::sensor_msgs::msg::RegionOfInterest& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_RegionOfInterest_height(::sensor_msgs::msg::RegionOfInterest& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_RegionOfInterest_y_offset(::sensor_msgs::msg::RegionOfInterest& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_RegionOfInterest_x_offset() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::RegionOfInterest>()
{
