...
{
public:
    explicit Init_PointField_count(::sensor_msgs::msg::PointField& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointField_datatype(::sensor_msgs::msg::PointField& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointField_offset(::sensor_msgs::msg::PointField& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PointField_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::PointField>()
{
