...
{
public:
    explicit Init_CompressedImage_data(::sensor_msgs::msg::CompressedImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_CompressedImage_format(::sensor_msgs::msg::CompressedImage& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_CompressedImage_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::CompressedImage>()
{
