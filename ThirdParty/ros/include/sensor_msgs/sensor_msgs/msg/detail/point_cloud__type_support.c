...
extern "C"
{
    ...
    {
        const geometry_msgs__msg__Point32__Sequence* member = (const geometry_msgs__msg__Point32__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_function__PointCloud__points(void* untyped_member,
                                                                                                             size_t index)
    {
        geometry_msgs__msg__Point32__Sequence* member = (geometry_msgs__msg__Point32__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        geometry_msgs__msg__Point32* value = (geometry_msgs__msg__Point32*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__Point32* item =
            ((geometry_msgs__msg__Point32*)
                 sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_function__PointCloud__points(untyped_member,
                                                                                                                    index));
        const geometry_msgs__msg__Point32* value = (const geometry_msgs__msg__Point32*)(untyped_value);
        *item = *value;
    }

    bool sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__resize_function__PointCloud__points(void* untyped_member,
                                                                                                               size_t size)
    {
        geometry_msgs__msg__Point32__Sequence* member = (geometry_msgs__msg__Point32__Sequence*)(untyped_member);
    ...
    void* sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_function__PointCloud__channels(void* untyped_member,
                                                                                                               size_t index)
    {
        sensor_msgs__msg__ChannelFloat32__Sequence* member = (sensor_msgs__msg__ChannelFloat32__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        const sensor_msgs__msg__ChannelFloat32* item =
            ((const sensor_msgs__msg__ChannelFloat32*)
                 sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_const_function__PointCloud__channels(
                     untyped_member, index));
        sensor_msgs__msg__ChannelFloat32* value = (sensor_msgs__msg__ChannelFloat32*)(untyped_value);
        *value = *item;
    }
        ...
        sensor_msgs__msg__ChannelFloat32* item =
            ((sensor_msgs__msg__ChannelFloat32*)
                 sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_function__PointCloud__channels(
                     untyped_member, index));
        const sensor_msgs__msg__ChannelFloat32* value = (const sensor_msgs__msg__ChannelFloat32*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__PointCloud_message_member_array[3] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                    // default value
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__size_function__PointCloud__points,    // size()
                                                                                                                        // function
                                                                                                                        // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_const_function__PointCloud__points,    // get_const(index)
                                                                                                                             // function
                                                                                                                             // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_function__PointCloud__points,    // get(index)
                                                                                                                       // function
                                                                                                                       // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__fetch_function__PointCloud__points,    // fetch(index,
                                                                                                                         // &value)
                                                                                                                         // function
                                                                                                                         // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__assign_function__PointCloud__points,    // assign(index,
                                                                                                                          // value)
                                                                                                                          // function
                                                                                                                          // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__resize_function__PointCloud__points    // resize(index)
                                                                                                                         // function
                                                                                                                         // pointer
            },
            {
                ...
                NULL,                                                    // default value
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__size_function__PointCloud__channels,    // size()
                                                                                                                          // function
                                                                                                                          // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_const_function__PointCloud__channels,    // get_const(index)
                                                                                                                               // function
                                                                                                                               // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__get_function__PointCloud__channels,    // get(index)
                                                                                                                         // function
                                                                                                                         // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__fetch_function__PointCloud__channels,    // fetch(index,
                                                                                                                           // &value)
                                                                                                                           // function
                                                                                                                           // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__assign_function__PointCloud__channels,    // assign(index,
                                                                                                                            // value)
                                                                                                                            // function
                                                                                                                            // pointer
                sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__resize_function__PointCloud__channels    // resize(index)
                                                                                                                           // function
                                                                                                                           // pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__PointCloud_message_members = {
            ...
            sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__PointCloud_init_function,    // function to initialize
                                                                                                           // message memory (memory
                                                                                                           // has to be allocated)
            sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__PointCloud_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__PointCloud_message_type_support_handle = {
            0,
            &sensor_msgs__msg__PointCloud__rosidl_typesupport_introspection_c__PointCloud_message_members,
