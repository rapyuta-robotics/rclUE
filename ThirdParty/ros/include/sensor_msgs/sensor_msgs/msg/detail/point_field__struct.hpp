...
struct PointField_
{
    ...
    _offset_type offset;
    using _datatype_type = uint8_t;
    _datatype_type datatype;
    using _count_type = uint32_t;
    _count_type count;
    ...
    static constexpr uint8_t INT8 = 1u;
    static constexpr uint8_t UINT8 = 2u;
    static constexpr uint8_t INT16 = 3u;
    static constexpr uint8_t UINT16 = 4u;
    static constexpr uint8_t INT32 = 5u;
    static constexpr uint8_t UINT32 = 6u;
    static constexpr uint8_t FLOAT32 = 7u;
    static constexpr uint8_t FLOAT64 = 8u;

    // pointer types
    using RawPtr = sensor_msgs::msg::PointField_<ContainerAllocator>*;
    using ConstRawPtr = const sensor_msgs::msg::PointField_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<sensor_msgs::msg::PointField_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<sensor_msgs::msg::PointField_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::PointField_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::PointField_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::PointField_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::PointField_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<sensor_msgs::msg::PointField_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<sensor_msgs::msg::PointField_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__sensor_msgs__msg__PointField std::shared_ptr<sensor_msgs::msg::PointField_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__sensor_msgs__msg__PointField std::shared_ptr<sensor_msgs::msg::PointField_<ContainerAllocator> const>
        ConstPtr;
...
using PointField = sensor_msgs::msg::PointField_<std::allocator<void>>;
