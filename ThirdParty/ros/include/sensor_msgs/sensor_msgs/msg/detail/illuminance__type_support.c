...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__Illuminance__rosidl_typesupport_introspection_c__Illuminance_message_member_array[3] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__Illuminance__rosidl_typesupport_introspection_c__Illuminance_message_members = {
            ...
            sensor_msgs__msg__Illuminance__rosidl_typesupport_introspection_c__Illuminance_message_member_array,    // message
                                                                                                                    // members
            sensor_msgs__msg__Illuminance__rosidl_typesupport_introspection_c__Illuminance_init_function,           // function to
                                                                                                             // initialize message
                                                                                                             // memory (memory has
                                                                                                             // to be allocated)
            sensor_msgs__msg__Illuminance__rosidl_typesupport_introspection_c__Illuminance_fini_function    // function to terminate
                                                                                                            // message instance
                                                                                                            // (will not free
                                                                                                            // memory)
    };
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, Illuminance)()
    {
        ...
        if (!sensor_msgs__msg__Illuminance__rosidl_typesupport_introspection_c__Illuminance_message_type_support_handle
