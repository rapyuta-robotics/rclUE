...
extern "C"
{
    ...
    void sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_fini_function(
        void* message_memory)
    {
    ...
    {
        const sensor_msgs__msg__JoyFeedback__Sequence* member = (const sensor_msgs__msg__JoyFeedback__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__get_function__JoyFeedbackArray__array(
        ...
        size_t index)
    {
        sensor_msgs__msg__JoyFeedback__Sequence* member = (sensor_msgs__msg__JoyFeedback__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        sensor_msgs__msg__JoyFeedback* value = (sensor_msgs__msg__JoyFeedback*)(untyped_value);
        *value = *item;
    }
        ...
        sensor_msgs__msg__JoyFeedback* item =
            ((sensor_msgs__msg__JoyFeedback*)
                 sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__get_function__JoyFeedbackArray__array(
                     untyped_member, index));
        const sensor_msgs__msg__JoyFeedback* value = (const sensor_msgs__msg__JoyFeedback*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_message_member_array[1] = {{
            "array",                                                 // name
            ...
            NULL,                                                    // default value
            sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__size_function__JoyFeedbackArray__array,    // size()
                                                                                                                               // function
                                                                                                                               // pointer
            ...
            sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__get_function__JoyFeedbackArray__array,    // get(index)
                                                                                                                              // function
                                                                                                                              // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_message_members = {
            ...
            sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_message_member_array,    // message
                                                                                                                              // members
            sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_init_function,    // function
                                                                                                                       // to
                                                                                                                       // initialize
                                                                                                                       // message
                                                                                                                       // memory
                                                                                                                       ...
                                                                                                                       // has to be
                                                                                                                       // allocated)
            sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_fini_function    // function to
                                                                                                                      // terminate
                                                                                                                      // message
                                                                                                                      // instance
                                                                                                                      // (will not
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_message_type_support_handle = {
            0,
            &sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, JoyFeedbackArray)()
    {
        ...
        if (!sensor_msgs__msg__JoyFeedbackArray__rosidl_typesupport_introspection_c__JoyFeedbackArray_message_type_support_handle
