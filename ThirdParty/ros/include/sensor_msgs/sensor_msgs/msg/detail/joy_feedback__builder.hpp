...
{
public:
    explicit Init_JoyFeedback_intensity(::sensor_msgs::msg::JoyFeedback& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JoyFeedback_id(::sensor_msgs::msg::JoyFeedback& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_JoyFeedback_type() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::JoyFeedback>()
{
