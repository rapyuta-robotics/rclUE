...
inline void to_flow_style_yaml(const RelativeHumidity& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const RelativeHumidity& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
to_yaml(const sensor_msgs::msg::RelativeHumidity& msg, std::ostream& out, size_t indentation = 0)
{
    sensor_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use sensor_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const sensor_msgs::msg::RelativeHumidity& msg)
{
...
template<>
struct is_message<sensor_msgs::msg::RelativeHumidity> : std::true_type
{
};
