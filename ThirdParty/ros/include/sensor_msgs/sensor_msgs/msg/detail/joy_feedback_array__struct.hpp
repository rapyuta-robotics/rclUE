...
struct JoyFeedbackArray_
{
    ...
    using _array_type = std::vector<sensor_msgs::msg::JoyFeedback_<ContainerAllocator>,
    ...
    Type& set__array(const std::vector<sensor_msgs::msg::JoyFeedback_<ContainerAllocator>,
                                       typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                           sensor_msgs::msg::JoyFeedback_<ContainerAllocator>>>& _arg)
    {
        this->array = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>*;
    using ConstRawPtr = const sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__sensor_msgs__msg__JoyFeedbackArray std::shared_ptr<sensor_msgs::msg::JoyFeedbackArray_<ContainerAllocator>>
        Ptr;
...
using JoyFeedbackArray = sensor_msgs::msg::JoyFeedbackArray_<std::allocator<void>>;
