...
{
public:
    explicit Init_PointCloud_channels(::sensor_msgs::msg::PointCloud& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PointCloud_points(::sensor_msgs::msg::PointCloud& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PointCloud_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::PointCloud>()
{
