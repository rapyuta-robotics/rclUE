...
void MultiEchoLaserScan_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<sensor_msgs::msg::LaserEcho>*>(untyped_member);
    return &member[index];
}

void fetch_function__MultiEchoLaserScan__ranges(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__MultiEchoLaserScan__ranges(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<sensor_msgs::msg::LaserEcho*>(get_function__MultiEchoLaserScan__ranges(untyped_member, index));
...
void fetch_function__MultiEchoLaserScan__intensities(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const sensor_msgs::msg::LaserEcho*>(
...
void assign_function__MultiEchoLaserScan__intensities(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<sensor_msgs::msg::LaserEcho*>(get_function__MultiEchoLaserScan__intensities(untyped_member, index));
    const auto& value = *reinterpret_cast<const sensor_msgs::msg::LaserEcho*>(untyped_value);
    item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiEchoLaserScan_message_member_array[10] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sensor_msgs::msg::LaserEcho>(),    // members of sub
                                                                                                                   // message
        true,                                                                                                      // is array
        0,                                                                                                         // array size
        false,                                                                                                     // is upper bound
