...
{
public:
    explicit Init_TimeReference_source(::sensor_msgs::msg::TimeReference& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_TimeReference_time_ref(::sensor_msgs::msg::TimeReference& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_TimeReference_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::TimeReference>()
{
