...
bool sensor_msgs__msg__CameraInfo__are_equal(const sensor_msgs__msg__CameraInfo* lhs, const sensor_msgs__msg__CameraInfo* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // distortion_model
    if (!rosidl_runtime_c__String__are_equal(&(lhs->distortion_model), &(rhs->distortion_model)))
    {
        return false;
    }
    // d
    if (!rosidl_runtime_c__double__Sequence__are_equal(&(lhs->d), &(rhs->d)))
    {
        return false;
    }
    // k
    ...
    // roi
    if (!sensor_msgs__msg__RegionOfInterest__are_equal(&(lhs->roi), &(rhs->roi)))
    {
        return false;
    }
    return true;
...
bool sensor_msgs__msg__CameraInfo__copy(const sensor_msgs__msg__CameraInfo* input, sensor_msgs__msg__CameraInfo* output)
{
    if (!input || !output)
    {
        return false;
    ...
    // distortion_model
    if (!rosidl_runtime_c__String__copy(&(input->distortion_model), &(output->distortion_model)))
    {
        return false;
    }
    // d
    if (!rosidl_runtime_c__double__Sequence__copy(&(input->d), &(output->d)))
    {
        return false;
    }
    // k
    ...
    // roi
    if (!sensor_msgs__msg__RegionOfInterest__copy(&(input->roi), &(output->roi)))
    {
        return false;
    }
    return true;
...
sensor_msgs__msg__CameraInfo* sensor_msgs__msg__CameraInfo__create()
{
    ...
    sensor_msgs__msg__CameraInfo* msg =
        (sensor_msgs__msg__CameraInfo*)allocator.allocate(sizeof(sensor_msgs__msg__CameraInfo), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool sensor_msgs__msg__CameraInfo__Sequence__init(sensor_msgs__msg__CameraInfo__Sequence* array, size_t size)
{
    if (!array)
    {
        return false;
...
void sensor_msgs__msg__CameraInfo__Sequence__fini(sensor_msgs__msg__CameraInfo__Sequence* array)
{
    if (!array)
    {
        return;
...
sensor_msgs__msg__CameraInfo__Sequence* sensor_msgs__msg__CameraInfo__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensor_msgs__msg__CameraInfo__Sequence* array = (sensor_msgs__msg__CameraInfo__Sequence*)allocator.allocate(
        sizeof(sensor_msgs__msg__CameraInfo__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void sensor_msgs__msg__CameraInfo__Sequence__destroy(sensor_msgs__msg__CameraInfo__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
    {
...
bool sensor_msgs__msg__CameraInfo__Sequence__are_equal(const sensor_msgs__msg__CameraInfo__Sequence* lhs,
                                                       const sensor_msgs__msg__CameraInfo__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool sensor_msgs__msg__CameraInfo__Sequence__copy(const sensor_msgs__msg__CameraInfo__Sequence* input,
                                                  sensor_msgs__msg__CameraInfo__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(sensor_msgs__msg__CameraInfo);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        sensor_msgs__msg__CameraInfo* data =
            (sensor_msgs__msg__CameraInfo*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!sensor_msgs__msg__CameraInfo__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
