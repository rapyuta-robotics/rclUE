...
{
public:
    explicit Init_BatteryState_serial_number(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_location(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_cell_temperature(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_cell_voltage(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_present(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_power_supply_technology(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_power_supply_health(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_power_supply_status(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_percentage(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_design_capacity(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_capacity(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_charge(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_current(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_temperature(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_BatteryState_voltage(::sensor_msgs::msg::BatteryState& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_BatteryState_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::BatteryState>()
{
