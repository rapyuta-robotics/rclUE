...
{
public:
    explicit Init_Imu_linear_acceleration_covariance(::sensor_msgs::msg::Imu& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Imu_linear_acceleration(::sensor_msgs::msg::Imu& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Imu_angular_velocity_covariance(::sensor_msgs::msg::Imu& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Imu_angular_velocity(::sensor_msgs::msg::Imu& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Imu_orientation_covariance(::sensor_msgs::msg::Imu& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Imu_orientation(::sensor_msgs::msg::Imu& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Imu_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::Imu>()
{
