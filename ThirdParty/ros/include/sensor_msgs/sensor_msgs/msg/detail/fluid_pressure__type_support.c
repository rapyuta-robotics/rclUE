...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_message_member_array[3] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_message_members = {
            ...
            sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_message_member_array,    // message
                                                                                                                        // members
            sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_init_function,    // function to
                                                                                                                 // initialize
                                                                                                                 // message memory
                                                                                                                 // (memory has to
                                                                                                                 // be allocated)
            sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_fini_function     // function to
                                                                                                                // terminate message
                                                                                                                // instance (will
                                                                                                                // not free memory)
    };
    ...
    static rosidl_message_type_support_t
        sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_message_type_support_handle = {
            0,
            &sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, FluidPressure)()
    {
        ...
        if (!sensor_msgs__msg__FluidPressure__rosidl_typesupport_introspection_c__FluidPressure_message_type_support_handle
