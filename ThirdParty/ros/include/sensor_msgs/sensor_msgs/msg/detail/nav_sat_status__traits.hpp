...
inline void to_flow_style_yaml(const NavSatStatus& msg, std::ostream& out)
{
    out << "{";
    // member: status
    {
...
inline void to_block_style_yaml(const NavSatStatus& msg, std::ostream& out, size_t indentation = 0)
{
    // member: status
    {
        if (indentation > 0)
...
[[deprecated("use sensor_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const sensor_msgs::msg::NavSatStatus& msg,
                                                                                          std::ostream& out,
...
[[deprecated("use sensor_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const sensor_msgs::msg::NavSatStatus& msg)
{
...
template<>
struct has_fixed_size<sensor_msgs::msg::NavSatStatus> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<sensor_msgs::msg::NavSatStatus> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<sensor_msgs::msg::NavSatStatus> : std::true_type
{
};
