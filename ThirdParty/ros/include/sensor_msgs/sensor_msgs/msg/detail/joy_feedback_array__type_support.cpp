...
void JoyFeedbackArray_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<sensor_msgs::msg::JoyFeedback>*>(untyped_member);
    return &member[index];
}

void fetch_function__JoyFeedbackArray__array(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const sensor_msgs::msg::JoyFeedback*>(get_const_function__JoyFeedbackArray__array(untyped_member, index));
    auto& value = *reinterpret_cast<sensor_msgs::msg::JoyFeedback*>(untyped_value);
    value = item;
}

void assign_function__JoyFeedbackArray__array(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<sensor_msgs::msg::JoyFeedback*>(get_function__JoyFeedbackArray__array(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JoyFeedbackArray_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sensor_msgs::msg::JoyFeedback>(),    // members of sub
                                                                                                                 // message
    true,                                                                                                        // is array
    0,                                                                                                           // array size
