...
{
public:
    explicit Init_RelativeHumidity_variance(::sensor_msgs::msg::RelativeHumidity& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_RelativeHumidity_relative_humidity(::sensor_msgs::msg::RelativeHumidity& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_RelativeHumidity_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::RelativeHumidity>()
{
