...
extern "C"
{
    ...
    {
        float* item =
            ((float*)sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__get_function__ChannelFloat32__values(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__ChannelFloat32_message_member_array[2] = {
            {
                "name",                                                 // name
            ...
            },
            {
                ...
                sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__get_function__ChannelFloat32__values,    // get(index)
                                                                                                                               // function
                                                                                                                               // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__ChannelFloat32_message_members = {
            ...
            sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__ChannelFloat32_message_member_array,    // message
                                                                                                                          // members
            sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__ChannelFloat32_init_function,    // function to
                                                                                                                   // initialize
                                                                                                                   // message memory
                                                                                                                   // (memory has to
                                                                                                                   // be allocated)
            sensor_msgs__msg__ChannelFloat32__rosidl_typesupport_introspection_c__ChannelFloat32_fini_function     // function to
                                                                                                                   // terminate
                                                                                                                   // message
                                                                                                                   // instance (will
                                                                                                                   // not free
