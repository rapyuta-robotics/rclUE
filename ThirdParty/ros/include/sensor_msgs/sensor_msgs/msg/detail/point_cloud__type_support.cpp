...
void PointCloud_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<geometry_msgs::msg::Point32>*>(untyped_member);
    return &member[index];
}

void fetch_function__PointCloud__points(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const geometry_msgs::msg::Point32*>(get_const_function__PointCloud__points(untyped_member, index));
    auto& value = *reinterpret_cast<geometry_msgs::msg::Point32*>(untyped_value);
    value = item;
}

void assign_function__PointCloud__points(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<geometry_msgs::msg::Point32*>(get_function__PointCloud__points(untyped_member, index));
...
{
    auto& member = *reinterpret_cast<std::vector<sensor_msgs::msg::ChannelFloat32>*>(untyped_member);
    return &member[index];
}

void fetch_function__PointCloud__channels(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const sensor_msgs::msg::ChannelFloat32*>(get_const_function__PointCloud__channels(untyped_member, index));
    auto& value = *reinterpret_cast<sensor_msgs::msg::ChannelFloat32*>(untyped_value);
    value = item;
}

void assign_function__PointCloud__channels(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<sensor_msgs::msg::ChannelFloat32*>(get_function__PointCloud__channels(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointCloud_message_member_array[3] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<geometry_msgs::msg::Point32>(),    // members of sub
                                                                                                                   // message
        true,                                                                                                      // is array
        0,                                                                                                         // array size
        false,                                                                                                     // is upper bound
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            sensor_msgs::msg::ChannelFloat32>(),             // members of sub message
        true,                                                // is array
        0,                                                   // array size
        false,                                               // is upper bound
