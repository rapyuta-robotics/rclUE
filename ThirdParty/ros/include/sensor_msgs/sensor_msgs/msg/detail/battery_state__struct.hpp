...
struct BatteryState_
{
    ...
    explicit BatteryState_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), location(_alloc), serial_number(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->voltage = 0.0f;
    ...
    using _header_type = std_msgs::msg::Header_<ContainerAllocator>;
    _header_type header;
    using _voltage_type = float;
    _voltage_type voltage;
    using _temperature_type = float;
    _temperature_type temperature;
    using _current_type = float;
    _current_type current;
    using _charge_type = float;
    _charge_type charge;
    using _capacity_type = float;
    _capacity_type capacity;
    using _design_capacity_type = float;
    _design_capacity_type design_capacity;
    using _percentage_type = float;
    _percentage_type percentage;
    using _power_supply_status_type = uint8_t;
    _power_supply_status_type power_supply_status;
    using _power_supply_health_type = uint8_t;
    _power_supply_health_type power_supply_health;
    using _power_supply_technology_type = uint8_t;
    _power_supply_technology_type power_supply_technology;
    using _present_type = bool;
    _present_type present;
    using _cell_voltage_type = std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>>;
    _cell_voltage_type cell_voltage;
    using _cell_temperature_type =
        std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>>;
    _cell_temperature_type cell_temperature;
    using _location_type = std::
        basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
    _location_type location;
    using _serial_number_type = std::
        basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
    ...
    Type& set__voltage(const float& _arg)
    {
        this->voltage = _arg;
        return *this;
    }
    Type& set__temperature(const float& _arg)
    {
        this->temperature = _arg;
        return *this;
    }
    Type& set__current(const float& _arg)
    {
        this->current = _arg;
        return *this;
    }
    Type& set__charge(const float& _arg)
    {
        this->charge = _arg;
        return *this;
    }
    Type& set__capacity(const float& _arg)
    {
        this->capacity = _arg;
        return *this;
    }
    Type& set__design_capacity(const float& _arg)
    {
        this->design_capacity = _arg;
        return *this;
    }
    Type& set__percentage(const float& _arg)
    {
        this->percentage = _arg;
        return *this;
    }
    Type& set__power_supply_status(const uint8_t& _arg)
    {
        this->power_supply_status = _arg;
        return *this;
    }
    Type& set__power_supply_health(const uint8_t& _arg)
    {
        this->power_supply_health = _arg;
        return *this;
    }
    Type& set__power_supply_technology(const uint8_t& _arg)
    {
        this->power_supply_technology = _arg;
        return *this;
    }
    Type& set__present(const bool& _arg)
    {
        this->present = _arg;
        return *this;
    }
    ...
    static constexpr uint8_t POWER_SUPPLY_STATUS_UNKNOWN = 0u;
    static constexpr uint8_t POWER_SUPPLY_STATUS_CHARGING = 1u;
    static constexpr uint8_t POWER_SUPPLY_STATUS_DISCHARGING = 2u;
    static constexpr uint8_t POWER_SUPPLY_STATUS_NOT_CHARGING = 3u;
    static constexpr uint8_t POWER_SUPPLY_STATUS_FULL = 4u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_UNKNOWN = 0u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_GOOD = 1u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_OVERHEAT = 2u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_DEAD = 3u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_OVERVOLTAGE = 4u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_UNSPEC_FAILURE = 5u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_COLD = 6u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_WATCHDOG_TIMER_EXPIRE = 7u;
    static constexpr uint8_t POWER_SUPPLY_HEALTH_SAFETY_TIMER_EXPIRE = 8u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_UNKNOWN = 0u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_NIMH = 1u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_LION = 2u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_LIPO = 3u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_LIFE = 4u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_NICD = 5u;
    static constexpr uint8_t POWER_SUPPLY_TECHNOLOGY_LIMN = 6u;

    // pointer types
    using RawPtr = sensor_msgs::msg::BatteryState_<ContainerAllocator>*;
    using ConstRawPtr = const sensor_msgs::msg::BatteryState_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::BatteryState_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::BatteryState_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__sensor_msgs__msg__BatteryState std::shared_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__sensor_msgs__msg__BatteryState std::shared_ptr<sensor_msgs::msg::BatteryState_<ContainerAllocator> const>
        ConstPtr;
...
using BatteryState = sensor_msgs::msg::BatteryState_<std::allocator<void>>;
