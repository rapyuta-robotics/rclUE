...
struct MultiDOFJointState_
{
    ...
    _twist_type twist;
    using _wrench_type = std::vector<
        geometry_msgs::msg::Wrench_<ContainerAllocator>,
        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geometry_msgs::msg::Wrench_<ContainerAllocator>>>;
    _wrench_type wrench;
    ...
    Type& set__twist(const std::vector<geometry_msgs::msg::Twist_<ContainerAllocator>,
                                       typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    Type& set__wrench(const std::vector<geometry_msgs::msg::Wrench_<ContainerAllocator>,
                                        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                            geometry_msgs::msg::Wrench_<ContainerAllocator>>>& _arg)
    {
        this->wrench = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>*;
    using ConstRawPtr = const sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator> const>;
...
using MultiDOFJointState = sensor_msgs::msg::MultiDOFJointState_<std::allocator<void>>;
