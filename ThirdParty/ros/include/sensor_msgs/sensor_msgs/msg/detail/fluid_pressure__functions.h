...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__FluidPressure__init(sensor_msgs__msg__FluidPressure* msg);

    /// Finalize msg/FluidPressure message.
    /**
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__FluidPressure__fini(sensor_msgs__msg__FluidPressure* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs sensor_msgs__msg__FluidPressure* sensor_msgs__msg__FluidPressure__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__FluidPressure__destroy(sensor_msgs__msg__FluidPressure* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__FluidPressure__are_equal(
        const sensor_msgs__msg__FluidPressure* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__FluidPressure__copy(const sensor_msgs__msg__FluidPressure* input,
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__FluidPressure__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__FluidPressure__Sequence__fini(
        sensor_msgs__msg__FluidPressure__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs sensor_msgs__msg__FluidPressure__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs void sensor_msgs__msg__FluidPressure__Sequence__destroy(
        sensor_msgs__msg__FluidPressure__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__FluidPressure__Sequence__are_equal(
        const sensor_msgs__msg__FluidPressure__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs bool sensor_msgs__msg__FluidPressure__Sequence__copy(
