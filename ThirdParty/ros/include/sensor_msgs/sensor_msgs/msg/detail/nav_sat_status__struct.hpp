...
struct NavSatStatus_
{
    ...
    static constexpr uint16_t SERVICE_GPS = 1u;
    static constexpr uint16_t SERVICE_GLONASS = 2u;
    static constexpr uint16_t SERVICE_COMPASS = 4u;
    static constexpr uint16_t SERVICE_GALILEO = 8u;

    // pointer types
    using RawPtr = sensor_msgs::msg::NavSatStatus_<ContainerAllocator>*;
    using ConstRawPtr = const sensor_msgs::msg::NavSatStatus_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__sensor_msgs__msg__NavSatStatus std::shared_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__sensor_msgs__msg__NavSatStatus std::shared_ptr<sensor_msgs::msg::NavSatStatus_<ContainerAllocator> const>
        ConstPtr;
...
using NavSatStatus = sensor_msgs::msg::NavSatStatus_<std::allocator<void>>;
