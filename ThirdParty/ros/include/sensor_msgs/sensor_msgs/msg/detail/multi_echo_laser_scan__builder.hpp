...
{
public:
    explicit Init_MultiEchoLaserScan_intensities(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_ranges(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_range_max(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_range_min(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_scan_time(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_time_increment(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_angle_increment(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_angle_max(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiEchoLaserScan_angle_min(::sensor_msgs::msg::MultiEchoLaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MultiEchoLaserScan_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::MultiEchoLaserScan>()
{
