...
{
public:
    explicit Init_LaserScan_intensities(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_ranges(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_range_max(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_range_min(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_scan_time(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_time_increment(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_angle_increment(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_angle_max(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LaserScan_angle_min(::sensor_msgs::msg::LaserScan& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_LaserScan_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::LaserScan>()
{
