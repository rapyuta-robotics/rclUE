...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sensor_msgs cdr_serialize(const sensor_msgs::msg::PointCloud& ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sensor_msgs get_serialized_size(const sensor_msgs::msg::PointCloud& ros_message,
                                                                              size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sensor_msgs max_serialized_size_PointCloud(bool& full_bounded,
                                                                                         bool& is_plain,
                                                                                         size_t current_alignment);
