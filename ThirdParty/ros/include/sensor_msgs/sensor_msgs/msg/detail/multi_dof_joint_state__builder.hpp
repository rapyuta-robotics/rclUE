...
{
public:
    explicit Init_MultiDOFJointState_wrench(::sensor_msgs::msg::MultiDOFJointState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiDOFJointState_twist(::sensor_msgs::msg::MultiDOFJointState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiDOFJointState_transforms(::sensor_msgs::msg::MultiDOFJointState& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiDOFJointState_joint_names(::sensor_msgs::msg::MultiDOFJointState& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MultiDOFJointState_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::MultiDOFJointState>()
{
