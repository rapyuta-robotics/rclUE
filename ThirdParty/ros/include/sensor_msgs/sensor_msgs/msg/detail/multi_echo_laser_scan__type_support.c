...
extern "C"
{
    ...
    void sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_fini_function(
        void* message_memory)
    {
    ...
    {
        const sensor_msgs__msg__LaserEcho__Sequence* member = (const sensor_msgs__msg__LaserEcho__Sequence*)(untyped_member);
        return member->size;
    }

    const void*
    sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__get_const_function__MultiEchoLaserScan__ranges(
        const void* untyped_member,
        size_t index)
    {
        const sensor_msgs__msg__LaserEcho__Sequence* member = (const sensor_msgs__msg__LaserEcho__Sequence*)(untyped_member);
    ...
    void* sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__get_function__MultiEchoLaserScan__ranges(
        ...
        size_t index)
    {
        sensor_msgs__msg__LaserEcho__Sequence* member = (sensor_msgs__msg__LaserEcho__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        sensor_msgs__msg__LaserEcho* value = (sensor_msgs__msg__LaserEcho*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        sensor_msgs__msg__LaserEcho* item =
            ((sensor_msgs__msg__LaserEcho*)
                 sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__get_function__MultiEchoLaserScan__ranges(
                     untyped_member, index));
        const sensor_msgs__msg__LaserEcho* value = (const sensor_msgs__msg__LaserEcho*)(untyped_value);
        *item = *value;
    }
    ...
    const void*
    sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__get_const_function__MultiEchoLaserScan__intensities(
        const void* untyped_member,
        size_t index)
    {
        const sensor_msgs__msg__LaserEcho__Sequence* member = (const sensor_msgs__msg__LaserEcho__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        sensor_msgs__msg__LaserEcho* item =
            ((sensor_msgs__msg__LaserEcho*)
                 sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__get_function__MultiEchoLaserScan__intensities(
                     untyped_member, index));
        const sensor_msgs__msg__LaserEcho* value = (const sensor_msgs__msg__LaserEcho*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_message_member_array[10] = {
            {
                "header",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_message_members = {
            ...
            sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_init_function,    // function
                                                                                                                           // to
                                                                                                                           // initialize
                                                                                                                           // message
                                                                                                                           // memory
                                                                                                                           ...
                                                                                                                           // be
                                                                                                                           // allocated)
            sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_fini_function    // function
                                                                                                                          // to
                                                                                                                          // terminate
                                                                                                                          // message
                                                                                                                          // instance
    ...
    {
        sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
        sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_message_member_array[8]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, LaserEcho)();
        sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_message_member_array[9]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, LaserEcho)();
        if (!sensor_msgs__msg__MultiEchoLaserScan__rosidl_typesupport_introspection_c__MultiEchoLaserScan_message_type_support_handle
