...
{
public:
    explicit Init_Joy_buttons(::sensor_msgs::msg::Joy& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Joy_axes(::sensor_msgs::msg::Joy& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Joy_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::Joy>()
{
