...
{
public:
    explicit Init_ChannelFloat32_values(::sensor_msgs::msg::ChannelFloat32& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_ChannelFloat32_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::sensor_msgs::msg::ChannelFloat32>()
{
