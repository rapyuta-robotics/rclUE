...
inline void to_flow_style_yaml(const SolidPrimitive& msg, std::ostream& out)
{
    out << "{";
    // member: type
    {
...
inline void to_block_style_yaml(const SolidPrimitive& msg, std::ostream& out, size_t indentation = 0)
{
    // member: type
    {
        if (indentation > 0)
...
[[deprecated("use shape_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const shape_msgs::msg::SolidPrimitive& msg,
                                                                                         std::ostream& out,
...
[[deprecated("use shape_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const shape_msgs::msg::SolidPrimitive& msg)
{
...
template<>
struct has_fixed_size<shape_msgs::msg::SolidPrimitive> : std::integral_constant<bool, false>
{
};
...
template<>
struct is_message<shape_msgs::msg::SolidPrimitive> : std::true_type
{
};
