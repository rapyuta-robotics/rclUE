...
{
public:
    explicit Init_Mesh_vertices(::shape_msgs::msg::Mesh& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Mesh_triangles() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::shape_msgs::msg::Mesh>()
{
