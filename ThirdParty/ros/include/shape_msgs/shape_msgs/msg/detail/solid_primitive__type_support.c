...
extern "C"
{
    ...
    {
        double* item =
            ((double*)shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__get_function__SolidPrimitive__dimensions(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_member_array[3] = {
            {
                "type",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_members = {
            ...
            shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_member_array,    // message
                                                                                                                         // members
            shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_init_function,    // function to
                                                                                                                  // initialize
                                                                                                                  // message memory
                                                                                                                  // (memory has to
                                                                                                                  // be allocated)
            shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_fini_function     // function to
                                                                                                                  // terminate
                                                                                                                 // message instance
                                                                                                                 // (will not free
                                                                                                                 // memory)
    ...
    static rosidl_message_type_support_t
        shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_type_support_handle = {
            0,
            &shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, shape_msgs, msg, SolidPrimitive)()
    {
        ...
        if (!shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_type_support_handle
