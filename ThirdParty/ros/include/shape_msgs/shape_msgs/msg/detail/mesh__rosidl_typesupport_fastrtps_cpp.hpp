...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_shape_msgs cdr_serialize(const shape_msgs::msg::Mesh& ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_shape_msgs get_serialized_size(const shape_msgs::msg::Mesh& ros_message,
                                                                             size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_shape_msgs max_serialized_size_Mesh(bool& full_bounded,
                                                                                  bool& is_plain,
                                                                                  size_t current_alignment);
