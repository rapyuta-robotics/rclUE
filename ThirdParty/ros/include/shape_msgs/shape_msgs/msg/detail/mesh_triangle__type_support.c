...
extern "C"
{
    ...
    const void* shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__get_const_function__MeshTriangle__vertex_indices(
        ...
        size_t index)
    {
        const uint32_t* member = (const uint32_t*)(untyped_member);
        return &member[index];
    }
    ...
    void* shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__get_function__MeshTriangle__vertex_indices(
        ...
        size_t index)
    {
        uint32_t* member = (uint32_t*)(untyped_member);
        return &member[index];
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__MeshTriangle_message_member_array[1] = {{
            "vertex_indices",                                           // name
            ...
            NULL,                                                       // default value
            shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__size_function__MeshTriangle__vertex_indices,    // size()
                                                                                                                               // function
                                                                                                                               // pointer
            ...
            shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__get_function__MeshTriangle__vertex_indices,    // get(index)
                                                                                                                              // function
                                                                                                                              // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__MeshTriangle_message_members = {
            ...
            shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__MeshTriangle_message_member_array,    // message
                                                                                                                     // members
            shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__MeshTriangle_init_function,           // function to
                                                                                                              // initialize message
                                                                                                              // memory (memory has
                                                                                                              // to be allocated)
            shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__MeshTriangle_fini_function    // function to
                                                                                                             // terminate message
                                                                                                             // instance (will not
                                                                                                             // free memory)
    };
    ...
    {
        if (!shape_msgs__msg__MeshTriangle__rosidl_typesupport_introspection_c__MeshTriangle_message_type_support_handle
