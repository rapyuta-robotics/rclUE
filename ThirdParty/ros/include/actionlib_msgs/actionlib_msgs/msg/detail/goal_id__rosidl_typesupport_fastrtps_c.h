...
extern "C"
{
    ...
    get_serialized_size_actionlib_msgs__msg__GoalID(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_actionlib_msgs size_t
    max_serialized_size_actionlib_msgs__msg__GoalID(bool& full_bounded, bool& is_plain, size_t current_alignment);
