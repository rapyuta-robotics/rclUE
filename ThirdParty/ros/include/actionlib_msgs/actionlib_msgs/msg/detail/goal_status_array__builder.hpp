...
{
public:
    explicit Init_GoalStatusArray_status_list(::actionlib_msgs::msg::GoalStatusArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GoalStatusArray_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::actionlib_msgs::msg::GoalStatusArray>()
{
