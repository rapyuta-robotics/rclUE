...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_member_array[3] = {
            {
                "goal_id",                                               // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_members = {
            ...
            actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_member_array,    // message
                                                                                                                     // members
            actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_init_function,           // function to
                                                                                                              // initialize message
                                                                                                              // memory (memory has
                                                                                                              // to be allocated)
            actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_fini_function    // function to
                                                                                                             // terminate message
                                                                                                             // instance (will not
                                                                                                             // free memory)
    };
    ...
    static rosidl_message_type_support_t
        actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_type_support_handle = {
            0,
            &actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actionlib_msgs, msg, GoalStatus)()
    {
        ...
        if (!actionlib_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_type_support_handle
