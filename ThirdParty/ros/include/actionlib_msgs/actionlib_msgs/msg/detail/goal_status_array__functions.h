...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs bool actionlib_msgs__msg__GoalStatusArray__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs void actionlib_msgs__msg__GoalStatusArray__fini(
        actionlib_msgs__msg__GoalStatusArray* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs actionlib_msgs__msg__GoalStatusArray* actionlib_msgs__msg__GoalStatusArray__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs void actionlib_msgs__msg__GoalStatusArray__destroy(
        actionlib_msgs__msg__GoalStatusArray* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs bool actionlib_msgs__msg__GoalStatusArray__are_equal(
        const actionlib_msgs__msg__GoalStatusArray* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs bool actionlib_msgs__msg__GoalStatusArray__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs bool actionlib_msgs__msg__GoalStatusArray__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs void actionlib_msgs__msg__GoalStatusArray__Sequence__fini(
        actionlib_msgs__msg__GoalStatusArray__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs actionlib_msgs__msg__GoalStatusArray__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs void actionlib_msgs__msg__GoalStatusArray__Sequence__destroy(
        actionlib_msgs__msg__GoalStatusArray__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs bool actionlib_msgs__msg__GoalStatusArray__Sequence__are_equal(
        const actionlib_msgs__msg__GoalStatusArray__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_actionlib_msgs bool actionlib_msgs__msg__GoalStatusArray__Sequence__copy(
