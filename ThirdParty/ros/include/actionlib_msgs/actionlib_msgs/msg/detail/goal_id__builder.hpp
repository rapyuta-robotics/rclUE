...
{
public:
    explicit Init_GoalID_id(::actionlib_msgs::msg::GoalID& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GoalID_stamp() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::actionlib_msgs::msg::GoalID>()
{
