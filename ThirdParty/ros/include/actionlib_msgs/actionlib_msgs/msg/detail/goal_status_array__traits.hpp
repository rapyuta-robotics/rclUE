...
to_yaml(const actionlib_msgs::msg::GoalStatusArray& msg, std::ostream& out, size_t indentation = 0)
{
    actionlib_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use actionlib_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct has_fixed_size<actionlib_msgs::msg::GoalStatusArray> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<actionlib_msgs::msg::GoalStatusArray> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<actionlib_msgs::msg::GoalStatusArray> : std::true_type
{
};
