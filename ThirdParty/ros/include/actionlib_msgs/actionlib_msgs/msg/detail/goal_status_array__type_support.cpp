...
{
    auto& member = *reinterpret_cast<std::vector<actionlib_msgs::msg::GoalStatus>*>(untyped_member);
    return &member[index];
}
...
{
    auto& item =
        *reinterpret_cast<actionlib_msgs::msg::GoalStatus*>(get_function__GoalStatusArray__status_list(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GoalStatusArray_message_member_array[2] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            actionlib_msgs::msg::GoalStatus>(),                         // members of sub message
        true,                                                           // is array
        0,                                                              // array size
        false,                                                          // is upper bound
