...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_member_array[2] = {
            {
                "stamp",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_members = {
            ...
            actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_init_function,    // function to initialize
                                                                                                      // message memory (memory has
                                                                                                      // to be allocated)
            actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_type_support_handle = {
            0,
            &actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actionlib_msgs, msg, GoalID)()
    {
        ...
        if (!actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_type_support_handle
