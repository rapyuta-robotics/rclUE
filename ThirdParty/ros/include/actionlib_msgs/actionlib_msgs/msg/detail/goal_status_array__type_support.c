...
extern "C"
{
    ...
    void actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_fini_function(
        void* message_memory)
    {
    ...
    const void*
    actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__get_const_function__GoalStatusArray__status_list(
        const void* untyped_member,
        size_t index)
    {
        const actionlib_msgs__msg__GoalStatus__Sequence* member =
    ...
    void* actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__get_function__GoalStatusArray__status_list(
        ...
        size_t index)
    {
        actionlib_msgs__msg__GoalStatus__Sequence* member = (actionlib_msgs__msg__GoalStatus__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        actionlib_msgs__msg__GoalStatus* value = (actionlib_msgs__msg__GoalStatus*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        actionlib_msgs__msg__GoalStatus* item =
            ((actionlib_msgs__msg__GoalStatus*)
                 actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__get_function__GoalStatusArray__status_list(
                     untyped_member, index));
        const actionlib_msgs__msg__GoalStatus* value = (const actionlib_msgs__msg__GoalStatus*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_member_array[2] = {
            {
                "header",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_members = {
            ...
            actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_member_array,    // message
                                                                                                                               // members
            actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_init_function,    // function
                                                                                                                        // to
                                                                                                                        // initialize
                                                                                                                        // message
                                                                                                                        // memory
                                                                                                                        ...
                                                                                                                        // has to be
                                                                                                                        // allocated)
            actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_fini_function    // function
                                                                                                                       // to
                                                                                                                       // terminate
                                                                                                                       // message
                                                                                                                       // instance
    ...
    static rosidl_message_type_support_t
        actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_type_support_handle = {
            0,
            &actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_members,
            get_message_typesupport_handle_function,
    };

    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_actionlib_msgs const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actionlib_msgs, msg, GoalStatusArray)()
    {
        ...
        actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_member_array[1].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, actionlib_msgs, msg, GoalStatus)();
        if (!actionlib_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_type_support_handle
