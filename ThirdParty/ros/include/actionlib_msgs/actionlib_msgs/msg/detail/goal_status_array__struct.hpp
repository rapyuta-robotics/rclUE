...
struct GoalStatusArray_
{
    ...
    _header_type header;
    using _status_list_type = std::vector<actionlib_msgs::msg::GoalStatus_<ContainerAllocator>,
    ...
    Type& set__status_list(const std::vector<actionlib_msgs::msg::GoalStatus_<ContainerAllocator>,
                                             typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                 actionlib_msgs::msg::GoalStatus_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>*;
    using ConstRawPtr = const actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<actionlib_msgs::msg::GoalStatusArray_<ContainerAllocator> const>;
...
using GoalStatusArray = actionlib_msgs::msg::GoalStatusArray_<std::allocator<void>>;
