...
{
public:
    explicit Init_GoalStatus_text(::actionlib_msgs::msg::GoalStatus& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_GoalStatus_status(::actionlib_msgs::msg::GoalStatus& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GoalStatus_goal_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::actionlib_msgs::msg::GoalStatus>()
{
