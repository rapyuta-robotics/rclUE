...
void MultiDOFJointTrajectory_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__MultiDOFJointTrajectory__joint_names(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__MultiDOFJointTrajectory__joint_names(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__MultiDOFJointTrajectory__joint_names(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__MultiDOFJointTrajectory__joint_names(untyped_member, index));
...
{
    auto& member = *reinterpret_cast<std::vector<trajectory_msgs::msg::MultiDOFJointTrajectoryPoint>*>(untyped_member);
    return &member[index];
}

void fetch_function__MultiDOFJointTrajectory__points(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__MultiDOFJointTrajectory__points(void* untyped_member, size_t index, const void* untyped_value)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiDOFJointTrajectory_message_member_array[3] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            trajectory_msgs::msg::MultiDOFJointTrajectoryPoint>(),          // members of sub message
        true,                                                               // is array
        0,                                                                  // array size
        false,                                                              // is upper bound
