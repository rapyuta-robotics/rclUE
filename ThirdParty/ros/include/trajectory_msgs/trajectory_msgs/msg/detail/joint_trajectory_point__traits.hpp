...
inline void to_flow_style_yaml(const JointTrajectoryPoint& msg, std::ostream& out)
{
    out << "{";
    // member: positions
    {
...
inline void to_block_style_yaml(const JointTrajectoryPoint& msg, std::ostream& out, size_t indentation = 0)
{
    // member: positions
    {
        if (indentation > 0)
...
to_yaml(const trajectory_msgs::msg::JointTrajectoryPoint& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<trajectory_msgs::msg::JointTrajectoryPoint> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<trajectory_msgs::msg::JointTrajectoryPoint> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<trajectory_msgs::msg::JointTrajectoryPoint> : std::true_type
{
};
