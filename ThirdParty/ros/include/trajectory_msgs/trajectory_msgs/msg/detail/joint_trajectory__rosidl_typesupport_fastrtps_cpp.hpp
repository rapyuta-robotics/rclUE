...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trajectory_msgs cdr_serialize(const trajectory_msgs::msg::JointTrajectory& ros_message,
                                                                          eprosima::fastcdr::Cdr& cdr);

bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trajectory_msgs cdr_deserialize(eprosima::fastcdr::Cdr& cdr,
                                                                            trajectory_msgs::msg::JointTrajectory& ros_message);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trajectory_msgs
get_serialized_size(const trajectory_msgs::msg::JointTrajectory& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_trajectory_msgs max_serialized_size_JointTrajectory(bool& full_bounded,
                                                                                                  bool& is_plain,
