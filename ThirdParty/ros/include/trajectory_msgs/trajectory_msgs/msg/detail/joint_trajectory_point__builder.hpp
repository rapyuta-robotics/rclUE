...
{
public:
    explicit Init_JointTrajectoryPoint_time_from_start(::trajectory_msgs::msg::JointTrajectoryPoint& msg) : msg_(msg)
    {
    }
    ::trajectory_msgs::msg::JointTrajectoryPoint time_from_start(
        ::trajectory_msgs::msg::JointTrajectoryPoint::_time_from_start_type arg)
    {
...
{
public:
    explicit Init_JointTrajectoryPoint_effort(::trajectory_msgs::msg::JointTrajectoryPoint& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JointTrajectoryPoint_accelerations(::trajectory_msgs::msg::JointTrajectoryPoint& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JointTrajectoryPoint_velocities(::trajectory_msgs::msg::JointTrajectoryPoint& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_JointTrajectoryPoint_positions() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::trajectory_msgs::msg::JointTrajectoryPoint>()
{
