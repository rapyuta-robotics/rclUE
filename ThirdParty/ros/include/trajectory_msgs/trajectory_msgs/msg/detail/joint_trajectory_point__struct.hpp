...
struct JointTrajectoryPoint_
{
    ...
    using _positions_type = std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>>;
    _positions_type positions;
    using _velocities_type = std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>>;
    ...
    // pointer types
    using RawPtr = trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator>*;
    using ConstRawPtr = const trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<trajectory_msgs::msg::JointTrajectoryPoint_<ContainerAllocator> const>;
...
using JointTrajectoryPoint = trajectory_msgs::msg::JointTrajectoryPoint_<std::allocator<void>>;
