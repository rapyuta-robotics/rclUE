...
extern "C"
{
    ...
    void trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_fini_function(
        void* message_memory)
    {
    ...
    size_t
    trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__size_function__MultiDOFJointTrajectory__joint_names(
    ...
    void*
    trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__get_function__MultiDOFJointTrajectory__joint_names(
        void* untyped_member,
        size_t index)
    {
    ...
    bool
    trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__resize_function__MultiDOFJointTrajectory__joint_names(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    size_t
    trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__size_function__MultiDOFJointTrajectory__points(
        const void* untyped_member)
    {
    ...
    bool
    trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__resize_function__MultiDOFJointTrajectory__points(
        void* untyped_member,
        size_t size)
    {
        trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* member =
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_message_member_array[3] = {
            {
                "header",                                                           // name
    ...
    static rosidl_message_type_support_t
        trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_message_type_support_handle =
            {
                0,
                &trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_message_members,
    ...
    {
        trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_message_member_array
            [0]
                .members_ =
        ...
        trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_message_member_array
            ...
            rosidl_typesupport_introspection_c, trajectory_msgs, msg, MultiDOFJointTrajectoryPoint)();
        if (!trajectory_msgs__msg__MultiDOFJointTrajectory__rosidl_typesupport_introspection_c__MultiDOFJointTrajectory_message_type_support_handle
