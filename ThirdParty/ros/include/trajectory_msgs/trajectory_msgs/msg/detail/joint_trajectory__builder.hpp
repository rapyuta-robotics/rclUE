...
{
public:
    explicit Init_JointTrajectory_points(::trajectory_msgs::msg::JointTrajectory& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_JointTrajectory_joint_names(::trajectory_msgs::msg::JointTrajectory& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_JointTrajectory_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::trajectory_msgs::msg::JointTrajectory>()
{
