...
extern "C"
{
        ...
        const void* untyped_value)
    {
        rosidl_runtime_c__String* item =
            ((rosidl_runtime_c__String*)
                 trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__get_function__JointTrajectory__joint_names(
                     untyped_member, index));
        ...
        void* untyped_value)
    {
        const trajectory_msgs__msg__JointTrajectoryPoint* item =
            ((const trajectory_msgs__msg__JointTrajectoryPoint*)
                 trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__get_const_function__JointTrajectory__points(
                     untyped_member, index));
        trajectory_msgs__msg__JointTrajectoryPoint* value = (trajectory_msgs__msg__JointTrajectoryPoint*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        trajectory_msgs__msg__JointTrajectoryPoint* item =
            ((trajectory_msgs__msg__JointTrajectoryPoint*)
                 trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__get_function__JointTrajectory__points(
                     untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__JointTrajectory_message_member_array[3] = {
            {
                "header",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__JointTrajectory_message_members = {
            ...
            trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__JointTrajectory_init_function,    // function
                                                                                                                         // to
                                                                                                                         // initialize
                                                                                                                         // message
                                                                                                                         // memory
                                                                                                                         ...
                                                                                                                         // be
                                                                                                                         // allocated)
            trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__JointTrajectory_fini_function    // function
                                                                                                                        // to
                                                                                                                        // terminate
                                                                                                                        // message
                                                                                                                        // instance
    ...
    {
        trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__JointTrajectory_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
        trajectory_msgs__msg__JointTrajectory__rosidl_typesupport_introspection_c__JointTrajectory_message_member_array[2]
            .members_ = ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
            rosidl_typesupport_introspection_c, trajectory_msgs, msg, JointTrajectoryPoint)();
