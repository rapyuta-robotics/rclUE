...
public:
    ...
    ::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint time_from_start(
        ::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint::_time_from_start_type arg)
    {
...
{
public:
    explicit Init_MultiDOFJointTrajectoryPoint_accelerations(::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint& msg) : msg_(msg)
    {
    }
    Init_MultiDOFJointTrajectoryPoint_time_from_start accelerations(
        ::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint::_accelerations_type arg)
    {
...
{
public:
    explicit Init_MultiDOFJointTrajectoryPoint_velocities(::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint& msg) : msg_(msg)
    {
    }
    Init_MultiDOFJointTrajectoryPoint_accelerations velocities(
        ::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint::_velocities_type arg)
    {
...
{
public:
    Init_MultiDOFJointTrajectoryPoint_transforms() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
    Init_MultiDOFJointTrajectoryPoint_velocities transforms(
        ::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint::_transforms_type arg)
    {
...
template<>
inline auto build<::trajectory_msgs::msg::MultiDOFJointTrajectoryPoint>()
{
