...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectory__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectory__fini(
        trajectory_msgs__msg__JointTrajectory* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs trajectory_msgs__msg__JointTrajectory*
    trajectory_msgs__msg__JointTrajectory__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectory__destroy(
        trajectory_msgs__msg__JointTrajectory* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectory__are_equal(
        const trajectory_msgs__msg__JointTrajectory* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectory__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectory__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectory__Sequence__fini(
        trajectory_msgs__msg__JointTrajectory__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs trajectory_msgs__msg__JointTrajectory__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectory__Sequence__destroy(
        trajectory_msgs__msg__JointTrajectory__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectory__Sequence__are_equal(
        const trajectory_msgs__msg__JointTrajectory__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectory__Sequence__copy(
