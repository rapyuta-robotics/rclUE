...
{
public:
    explicit Init_MultiDOFJointTrajectory_points(::trajectory_msgs::msg::MultiDOFJointTrajectory& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiDOFJointTrajectory_joint_names(::trajectory_msgs::msg::MultiDOFJointTrajectory& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MultiDOFJointTrajectory_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::trajectory_msgs::msg::MultiDOFJointTrajectory>()
{
