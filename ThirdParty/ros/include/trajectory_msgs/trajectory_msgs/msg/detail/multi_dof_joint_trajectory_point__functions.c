...
bool trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__are_equal(const trajectory_msgs__msg__MultiDOFJointTrajectoryPoint* lhs,
                                                                   const trajectory_msgs__msg__MultiDOFJointTrajectoryPoint* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // velocities
    if (!geometry_msgs__msg__Twist__Sequence__are_equal(&(lhs->velocities), &(rhs->velocities)))
    {
        return false;
    }
    // accelerations
    if (!geometry_msgs__msg__Twist__Sequence__are_equal(&(lhs->accelerations), &(rhs->accelerations)))
    {
        return false;
    }
    // time_from_start
...
bool trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__copy(const trajectory_msgs__msg__MultiDOFJointTrajectoryPoint* input,
                                                              trajectory_msgs__msg__MultiDOFJointTrajectoryPoint* output)
{
    ...
    // velocities
    if (!geometry_msgs__msg__Twist__Sequence__copy(&(input->velocities), &(output->velocities)))
    {
        return false;
    }
    // accelerations
    if (!geometry_msgs__msg__Twist__Sequence__copy(&(input->accelerations), &(output->accelerations)))
    {
        return false;
    }
    // time_from_start
...
trajectory_msgs__msg__MultiDOFJointTrajectoryPoint* trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__create()
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    trajectory_msgs__msg__MultiDOFJointTrajectoryPoint* msg =
        (trajectory_msgs__msg__MultiDOFJointTrajectoryPoint*)allocator.allocate(
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (trajectory_msgs__msg__MultiDOFJointTrajectoryPoint*)allocator.zero_allocate(
...
trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__create(
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* array =
        (trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence*)allocator.allocate(
            sizeof(trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__destroy(
    trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__are_equal(
    const trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* lhs,
    const trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(trajectory_msgs__msg__MultiDOFJointTrajectoryPoint);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ...
    {
        if (!trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
