...
struct MultiDOFJointTrajectory_
{
    ...
    explicit MultiDOFJointTrajectory_(
    ...
    using _points_type = std::vector<trajectory_msgs::msg::MultiDOFJointTrajectoryPoint_<ContainerAllocator>,
                                     typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    Type& set__points(const std::vector<trajectory_msgs::msg::MultiDOFJointTrajectoryPoint_<ContainerAllocator>,
                                        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                            trajectory_msgs::msg::MultiDOFJointTrajectoryPoint_<ContainerAllocator>>>& _arg)
    {
        this->points = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator>*;
    using ConstRawPtr = const trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<trajectory_msgs::msg::MultiDOFJointTrajectory_<ContainerAllocator> const>;
...
using MultiDOFJointTrajectory = trajectory_msgs::msg::MultiDOFJointTrajectory_<std::allocator<void>>;
