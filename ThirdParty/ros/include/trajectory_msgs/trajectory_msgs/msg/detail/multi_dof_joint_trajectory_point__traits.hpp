...
inline void to_flow_style_yaml(const MultiDOFJointTrajectoryPoint& msg, std::ostream& out)
{
    out << "{";
    // member: transforms
    {
...
inline void to_block_style_yaml(const MultiDOFJointTrajectoryPoint& msg, std::ostream& out, size_t indentation = 0)
{
    // member: transforms
    {
        if (indentation > 0)
...
[[deprecated("use trajectory_msgs::msg::to_block_style_yaml() instead")]] inline void
to_yaml(const trajectory_msgs::msg::MultiDOFJointTrajectoryPoint& msg, std::ostream& out, size_t indentation = 0)
{
    trajectory_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use trajectory_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct has_fixed_size<trajectory_msgs::msg::MultiDOFJointTrajectoryPoint> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<trajectory_msgs::msg::MultiDOFJointTrajectoryPoint> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<trajectory_msgs::msg::MultiDOFJointTrajectoryPoint> : std::true_type
{
};
