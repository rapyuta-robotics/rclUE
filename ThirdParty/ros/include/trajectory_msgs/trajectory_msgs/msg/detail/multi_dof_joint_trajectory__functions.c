...
bool trajectory_msgs__msg__MultiDOFJointTrajectory__are_equal(const trajectory_msgs__msg__MultiDOFJointTrajectory* lhs,
                                                              const trajectory_msgs__msg__MultiDOFJointTrajectory* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // points
    if (!trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__are_equal(&(lhs->points), &(rhs->points)))
    {
        return false;
    }
    return true;
...
bool trajectory_msgs__msg__MultiDOFJointTrajectory__copy(const trajectory_msgs__msg__MultiDOFJointTrajectory* input,
                                                         trajectory_msgs__msg__MultiDOFJointTrajectory* output)
{
    ...
    // points
    if (!trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__copy(&(input->points), &(output->points)))
    {
        return false;
    }
    return true;
...
trajectory_msgs__msg__MultiDOFJointTrajectory* trajectory_msgs__msg__MultiDOFJointTrajectory__create()
{
...
bool trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__init(trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* array,
                                                                   size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (trajectory_msgs__msg__MultiDOFJointTrajectory*)allocator.zero_allocate(
...
void trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__fini(trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* array)
{
    if (!array)
    {
        return;
...
trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__create(
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* array =
        (trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence*)allocator.allocate(
            sizeof(trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__destroy(
    trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__are_equal(
    const trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* lhs,
    const trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(trajectory_msgs__msg__MultiDOFJointTrajectory);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        trajectory_msgs__msg__MultiDOFJointTrajectory* data =
            (trajectory_msgs__msg__MultiDOFJointTrajectory*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!trajectory_msgs__msg__MultiDOFJointTrajectory__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
