...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectoryPoint__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectoryPoint__fini(
        trajectory_msgs__msg__JointTrajectoryPoint* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs trajectory_msgs__msg__JointTrajectoryPoint*
    trajectory_msgs__msg__JointTrajectoryPoint__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectoryPoint__destroy(
        trajectory_msgs__msg__JointTrajectoryPoint* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectoryPoint__are_equal(
        const trajectory_msgs__msg__JointTrajectoryPoint* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectoryPoint__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectoryPoint__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectoryPoint__Sequence__fini(
        trajectory_msgs__msg__JointTrajectoryPoint__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs trajectory_msgs__msg__JointTrajectoryPoint__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs void trajectory_msgs__msg__JointTrajectoryPoint__Sequence__destroy(
        trajectory_msgs__msg__JointTrajectoryPoint__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectoryPoint__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_trajectory_msgs bool trajectory_msgs__msg__JointTrajectoryPoint__Sequence__copy(
