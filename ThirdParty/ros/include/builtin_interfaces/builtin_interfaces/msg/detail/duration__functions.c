...
bool builtin_interfaces__msg__Duration__are_equal(const builtin_interfaces__msg__Duration* lhs,
...
bool builtin_interfaces__msg__Duration__copy(const builtin_interfaces__msg__Duration* input,
...
builtin_interfaces__msg__Duration* builtin_interfaces__msg__Duration__create()
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    builtin_interfaces__msg__Duration* msg =
        (builtin_interfaces__msg__Duration*)allocator.allocate(sizeof(builtin_interfaces__msg__Duration), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool builtin_interfaces__msg__Duration__Sequence__init(builtin_interfaces__msg__Duration__Sequence* array, size_t size)
{
    if (!array)
    {
        return false;
...
void builtin_interfaces__msg__Duration__Sequence__fini(builtin_interfaces__msg__Duration__Sequence* array)
{
    if (!array)
    {
        return;
...
builtin_interfaces__msg__Duration__Sequence* builtin_interfaces__msg__Duration__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    builtin_interfaces__msg__Duration__Sequence* array = (builtin_interfaces__msg__Duration__Sequence*)allocator.allocate(
...
void builtin_interfaces__msg__Duration__Sequence__destroy(builtin_interfaces__msg__Duration__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
    {
...
bool builtin_interfaces__msg__Duration__Sequence__are_equal(const builtin_interfaces__msg__Duration__Sequence* lhs,
...
bool builtin_interfaces__msg__Duration__Sequence__copy(const builtin_interfaces__msg__Duration__Sequence* input,
                                                       builtin_interfaces__msg__Duration__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(builtin_interfaces__msg__Duration);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        builtin_interfaces__msg__Duration* data =
            (builtin_interfaces__msg__Duration*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
