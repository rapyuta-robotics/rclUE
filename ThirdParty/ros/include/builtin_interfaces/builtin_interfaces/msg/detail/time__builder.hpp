...
{
public:
    explicit Init_Time_nanosec(::builtin_interfaces::msg::Time& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Time_sec() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::builtin_interfaces::msg::Time>()
{
