...
inline void to_flow_style_yaml(const Time& msg, std::ostream& out)
{
    out << "{";
    // member: sec
    {
...
inline void to_block_style_yaml(const Time& msg, std::ostream& out, size_t indentation = 0)
{
    // member: sec
    {
        if (indentation > 0)
...
to_yaml(const builtin_interfaces::msg::Time& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<builtin_interfaces::msg::Time> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<builtin_interfaces::msg::Time> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<builtin_interfaces::msg::Time> : std::true_type
{
};
