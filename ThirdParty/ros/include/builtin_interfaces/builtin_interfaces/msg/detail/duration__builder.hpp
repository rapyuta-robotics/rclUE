...
{
public:
    explicit Init_Duration_nanosec(::builtin_interfaces::msg::Duration& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Duration_sec() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::builtin_interfaces::msg::Duration>()
{
