...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Duration__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Duration__fini(
        builtin_interfaces__msg__Duration* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces builtin_interfaces__msg__Duration* builtin_interfaces__msg__Duration__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Duration__destroy(
        builtin_interfaces__msg__Duration* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Duration__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Duration__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Duration__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Duration__Sequence__fini(
        builtin_interfaces__msg__Duration__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces builtin_interfaces__msg__Duration__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Duration__Sequence__destroy(
        builtin_interfaces__msg__Duration__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Duration__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Duration__Sequence__copy(
