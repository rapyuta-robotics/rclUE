...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Time__init(builtin_interfaces__msg__Time* msg);

    /// Finalize msg/Time message.
    /**
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Time__fini(builtin_interfaces__msg__Time* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces builtin_interfaces__msg__Time* builtin_interfaces__msg__Time__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Time__destroy(builtin_interfaces__msg__Time* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Time__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Time__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Time__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Time__Sequence__fini(
        builtin_interfaces__msg__Time__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces builtin_interfaces__msg__Time__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces void builtin_interfaces__msg__Time__Sequence__destroy(
        builtin_interfaces__msg__Time__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Time__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces bool builtin_interfaces__msg__Time__Sequence__copy(
