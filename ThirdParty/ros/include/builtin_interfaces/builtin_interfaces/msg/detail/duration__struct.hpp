...
struct Duration_
{
    ...
    // pointer types
    using RawPtr = builtin_interfaces::msg::Duration_<ContainerAllocator>*;
    using ConstRawPtr = const builtin_interfaces::msg::Duration_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<builtin_interfaces::msg::Duration_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<builtin_interfaces::msg::Duration_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__builtin_interfaces__msg__Duration std::shared_ptr<builtin_interfaces::msg::Duration_<ContainerAllocator>>
        Ptr;
...
using Duration = builtin_interfaces::msg::Duration_<std::allocator<void>>;
