...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_message_member_array[2] = {
            {
                "sec",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_message_members = {
            ...
            builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_init_function,    // function to initialize
                                                                                                      // message memory (memory has
                                                                                                      // to be allocated)
            builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_message_type_support_handle = {
            0,
            &builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_message_members,
    ...
    {
        if (!builtin_interfaces__msg__Time__rosidl_typesupport_introspection_c__Time_message_type_support_handle
