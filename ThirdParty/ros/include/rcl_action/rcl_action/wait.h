...
#include "rcl_action/visibility_control.h"
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_wait_set_add_action_client(rcl_wait_set_t* wait_set,
    ...
    */
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_wait_set_add_action_server(rcl_wait_set_t* wait_set,
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_client_wait_set_get_num_entities(const rcl_action_client_t* action_client,
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_server_wait_set_get_num_entities(const rcl_action_server_t* action_server,
                                                          size_t* num_subscriptions,
                                                          size_t* num_guard_conditions,
                                                          size_t* num_timers,
                                                          size_t* num_clients,
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_client_wait_set_get_entities_ready(const rcl_wait_set_t* wait_set,
                                                            const rcl_action_client_t* action_client,
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_server_wait_set_get_entities_ready(const rcl_wait_set_t* wait_set,
                                                            const rcl_action_server_t* action_server,
