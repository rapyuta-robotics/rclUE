...
#define GOAL_STATE_NUM_STATES 7
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_goal_status_array_init(rcl_action_goal_status_array_t* status_array,
    ...
    RCL_ACTION_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_action_cancel_response_init(rcl_action_cancel_response_t* cancel_response,
