...
#define _TRACEPOINT_NOARGS(event_name) (ros_trace_##event_name)()
#define _TRACEPOINT_ARGS(event_name, ...) (ros_trace_##event_name)(__VA_ARGS__)
#define _DECLARE_TRACEPOINT_NOARGS(event_name) TRACETOOLS_PUBLIC void ros_trace_##event_name();
#define _DECLARE_TRACEPOINT_ARGS(event_name, ...) TRACETOOLS_PUBLIC void ros_trace_##event_name(__VA_ARGS__);
 ...
 */
#define TRACEPOINT(...) _GET_MACRO_TRACEPOINT(__VA_ARGS__)(__VA_ARGS__)
#define DECLARE_TRACEPOINT(...) _GET_MACRO_DECLARE_TRACEPOINT(__VA_ARGS__)(__VA_ARGS__)
#else
...
extern "C"
{
     ...
     */
    DECLARE_TRACEPOINT(rcl_init, const void* context_handle)
     ...
     */
    DECLARE_TRACEPOINT(rcl_node_init,
     ...
     */
    DECLARE_TRACEPOINT(rmw_publisher_init, const void* rmw_publisher_handle, const uint8_t* gid)
     ...
     */
    DECLARE_TRACEPOINT(rcl_publisher_init,
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_publish, const void* publisher_handle, const void* message)
     ...
     * \param[in] message pointer to the message being published
     */
    DECLARE_TRACEPOINT(rcl_publish, const void* publisher_handle, const void* message)
     ...
     * \param[in] message pointer to the message being published
     */
    DECLARE_TRACEPOINT(rmw_publish, const void* message)
     ...
     */
    DECLARE_TRACEPOINT(rmw_subscription_init, const void* rmw_subscription_handle, const uint8_t* gid)
     ...
     */
    DECLARE_TRACEPOINT(rcl_subscription_init,
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_subscription_callback_added, const void* subscription, const void* callback)
     ...
     * \param[in] message pointer to the message being taken
     */
    DECLARE_TRACEPOINT(rcl_take, const void* message)
     ...
     * \param[in] message pointer to the message being taken
     */
    DECLARE_TRACEPOINT(rclcpp_take, const void* message)
     ...
     */
    DECLARE_TRACEPOINT(rcl_service_init,
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_service_callback_added, const void* service_handle, const void* callback)
     ...
     */
    DECLARE_TRACEPOINT(rcl_client_init,
     ...
     */
    DECLARE_TRACEPOINT(rcl_timer_init, const void* timer_handle, int64_t period)
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_timer_callback_added, const void* timer_handle, const void* callback)
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_timer_link_node, const void* timer_handle, const void* node_handle)
     ...
     *  see \ref get_symbol()
     */
    DECLARE_TRACEPOINT(rclcpp_callback_register, const void* callback, const char* function_symbol)
     ...
     */
    DECLARE_TRACEPOINT(callback_start, const void* callback, const bool is_intra_process)
     ...
     *  `rclcpp::AnyServiceCallback`, timer `std::function`, etc.)
     */
    DECLARE_TRACEPOINT(callback_end, const void* callback)
     ...
     */
    DECLARE_TRACEPOINT(rcl_lifecycle_state_machine_init, const void* node_handle, const void* state_machine)
     ...
     */
    DECLARE_TRACEPOINT(rcl_lifecycle_transition, const void* state_machine, const char* start_label, const char* goal_label)

    /// `rclcpp_executor_get_next_ready`
    /**
     * Notes the start time of the executor phase that gets the next executable that's ready.
     */
    DECLARE_TRACEPOINT(rclcpp_executor_get_next_ready)
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_executor_wait_for_work, const int64_t timeout)
     ...
     */
    DECLARE_TRACEPOINT(rclcpp_executor_execute, const void* handle)
