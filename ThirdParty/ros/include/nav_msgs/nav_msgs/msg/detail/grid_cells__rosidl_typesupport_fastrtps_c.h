...
extern "C"
{
    ...
    get_serialized_size_nav_msgs__msg__GridCells(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav_msgs size_t max_serialized_size_nav_msgs__msg__GridCells(bool& full_bounded,
                                                                                                      bool& is_plain,
