...
inline void to_flow_style_yaml(const MapMetaData& msg, std::ostream& out)
{
    out << "{";
    // member: map_load_time
    {
...
inline void to_block_style_yaml(const MapMetaData& msg, std::ostream& out, size_t indentation = 0)
{
    // member: map_load_time
    {
        if (indentation > 0)
...
[[deprecated("use nav_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const nav_msgs::msg::MapMetaData& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use nav_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const nav_msgs::msg::MapMetaData& msg)
{
...
template<>
struct has_fixed_size<nav_msgs::msg::MapMetaData> : std::integral_constant<bool,
                                                                           has_fixed_size<builtin_interfaces::msg::Time>::value &&
                                                                               has_fixed_size<geometry_msgs::msg::Pose>::value>
{
};
...
struct has_bounded_size<nav_msgs::msg::MapMetaData>
    : std::integral_constant<bool,
                             has_bounded_size<builtin_interfaces::msg::Time>::value &&
                                 has_bounded_size<geometry_msgs::msg::Pose>::value>
{
};

template<>
struct is_message<nav_msgs::msg::MapMetaData> : std::true_type
{
};
