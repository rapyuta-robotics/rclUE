...
{
public:
    explicit Init_OccupancyGrid_data(::nav_msgs::msg::OccupancyGrid& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_OccupancyGrid_info(::nav_msgs::msg::OccupancyGrid& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_OccupancyGrid_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::msg::OccupancyGrid>()
{
