...
struct Odometry_
{
    ...
    explicit Odometry_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : header(_init), pose(_init), twist(_init)
    {
    ...
    explicit Odometry_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), child_frame_id(_alloc), pose(_alloc, _init), twist(_alloc, _init)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->child_frame_id = "";
    ...
    _header_type header;
    using _child_frame_id_type = std::
    ...
    using _pose_type = geometry_msgs::msg::PoseWithCovariance_<ContainerAllocator>;
    _pose_type pose;
    using _twist_type = geometry_msgs::msg::TwistWithCovariance_<ContainerAllocator>;
    _twist_type twist;
    ...
    // pointer types
    using RawPtr = nav_msgs::msg::Odometry_<ContainerAllocator>*;
    using ConstRawPtr = const nav_msgs::msg::Odometry_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<nav_msgs::msg::Odometry_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<nav_msgs::msg::Odometry_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<nav_msgs::msg::Odometry_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<nav_msgs::msg::Odometry_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<nav_msgs::msg::Odometry_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<nav_msgs::msg::Odometry_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<nav_msgs::msg::Odometry_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<nav_msgs::msg::Odometry_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__nav_msgs__msg__Odometry std::shared_ptr<nav_msgs::msg::Odometry_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__nav_msgs__msg__Odometry std::shared_ptr<nav_msgs::msg::Odometry_<ContainerAllocator> const> ConstPtr;
...
using Odometry = nav_msgs::msg::Odometry_<std::allocator<void>>;
