...
{
public:
    explicit Init_GridCells_cells(::nav_msgs::msg::GridCells& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_GridCells_cell_height(::nav_msgs::msg::GridCells& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_GridCells_cell_width(::nav_msgs::msg::GridCells& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GridCells_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::msg::GridCells>()
{
