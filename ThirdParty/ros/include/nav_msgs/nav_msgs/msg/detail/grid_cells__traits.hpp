...
inline void to_flow_style_yaml(const GridCells& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const GridCells& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
[[deprecated("use nav_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const nav_msgs::msg::GridCells& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use nav_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const nav_msgs::msg::GridCells& msg)
{
...
template<>
struct has_fixed_size<nav_msgs::msg::GridCells> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<nav_msgs::msg::GridCells> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<nav_msgs::msg::GridCells> : std::true_type
{
};
