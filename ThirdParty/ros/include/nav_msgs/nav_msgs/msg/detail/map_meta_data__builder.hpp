...
{
public:
    explicit Init_MapMetaData_origin(::nav_msgs::msg::MapMetaData& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MapMetaData_height(::nav_msgs::msg::MapMetaData& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MapMetaData_width(::nav_msgs::msg::MapMetaData& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MapMetaData_resolution(::nav_msgs::msg::MapMetaData& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MapMetaData_map_load_time() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::msg::MapMetaData>()
{
