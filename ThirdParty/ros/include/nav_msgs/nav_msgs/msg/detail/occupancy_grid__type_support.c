...
extern "C"
{
    ...
    {
        const rosidl_runtime_c__int8__Sequence* member = (const rosidl_runtime_c__int8__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__get_function__OccupancyGrid__data(void* untyped_member,
                                                                                                              size_t index)
    {
        rosidl_runtime_c__int8__Sequence* member = (rosidl_runtime_c__int8__Sequence*)(untyped_member);
        return &member->data[index];
    }
    ...
    {
        int8_t* item =
            ((int8_t*)nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__get_function__OccupancyGrid__data(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_message_member_array[3] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                 // default value
                nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__size_function__OccupancyGrid__data,    // size()
                                                                                                                         // function
                                                                                                                         // pointer
                nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__get_const_function__OccupancyGrid__data,    // get_const(index)
                                                                                                                              // function
                                                                                                                              // pointer
                nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__get_function__OccupancyGrid__data,    // get(index)
                                                                                                                        // function
                                                                                                                        // pointer
                nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__fetch_function__OccupancyGrid__data,    // fetch(index,
                                                                                                                          // &value)
                                                                                                                          // function
                                                                                                                          // pointer
                nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__assign_function__OccupancyGrid__data,    // assign(index,
                                                                                                                           // value)
                                                                                                                           // function
                                                                                                                           // pointer
                nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__resize_function__OccupancyGrid__data    // resize(index)
                                                                                                                          // function
                                                                                                                          // pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_message_members = {
            ...
            nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_message_member_array,    // message
                                                                                                                     // members
            nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_init_function,           // function to
                                                                                                              // initialize message
                                                                                                              // memory (memory has
                                                                                                              // to be allocated)
            nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_fini_function    // function to
                                                                                                             // terminate message
                                                                                                             // instance (will not
                                                                                                             // free memory)
    };
    ...
    static rosidl_message_type_support_t
        nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_message_type_support_handle = {
            0,
            &nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, msg, OccupancyGrid)()
    {
        ...
        if (!nav_msgs__msg__OccupancyGrid__rosidl_typesupport_introspection_c__OccupancyGrid_message_type_support_handle
