...
void OccupancyGrid_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__OccupancyGrid__data(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const int8_t*>(get_const_function__OccupancyGrid__data(untyped_member, index));
    auto& value = *reinterpret_cast<int8_t*>(untyped_value);
    value = item;
}

void assign_function__OccupancyGrid__data(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<int8_t*>(get_function__OccupancyGrid__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OccupancyGrid_message_member_array[3] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav_msgs::msg::MapMetaData>(),    // members of sub
                                                                                                                  // message
        false,                                                                                                    // is array
        0,                                                                                                        // array size
        false,                                                                                                    // is upper bound
