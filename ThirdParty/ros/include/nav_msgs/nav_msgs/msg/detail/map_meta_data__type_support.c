...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_member_array[5] = {
            {
                "map_load_time",                                         // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_members = {
            ...
            nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_init_function,    // function to initialize
                                                                                                          // message memory (memory
                                                                                                          // has to be allocated)
            nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_type_support_handle = {
            0,
            &nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, msg, MapMetaData)()
    {
        ...
        if (!nav_msgs__msg__MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_type_support_handle
