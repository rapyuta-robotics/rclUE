...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_message_member_array[4] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_message_members = {
            ...
            nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_init_function,           // function to initialize
                                                                                                    // message memory (memory has to
                                                                                                    // be allocated)
            nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_fini_function    // function to terminate message
    ...
    static rosidl_message_type_support_t
        nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_message_type_support_handle = {
            0,
            &nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, msg, Odometry)()
    {
        ...
        if (!nav_msgs__msg__Odometry__rosidl_typesupport_introspection_c__Odometry_message_type_support_handle
