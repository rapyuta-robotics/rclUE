...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__srv__LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_member_array[1] = {{
            "map_url",                                              // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__srv__LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_members = {
            ...
            nav_msgs__srv__LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_member_array,    // message
                                                                                                                         // members
            nav_msgs__srv__LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_init_function,    // function to
                                                                                                                  // initialize
                                                                                                                  // message memory
                                                                                                                  // (memory has to
                                                                                                                  // be allocated)
            nav_msgs__srv__LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_fini_function     // function to
                                                                                                                  // terminate
                                                                                                                 // message instance
                                                                                                                 // (will not free
                                                                                                                 // memory)
    ...
    {
        if (!nav_msgs__srv__LoadMap_Request__rosidl_typesupport_introspection_c__LoadMap_Request_message_type_support_handle
...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_member_array[2] = {
            {
                "map",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_members = {
            ...
            nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_member_array,    // message
                                                                                                                           // members
            nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_init_function,    // function to
                                                                                                                    // initialize
                                                                                                                    // message
                                                                                                                    // memory
                                                                                                                    // (memory has
                                                                                                                    // to be
                                                                                                                    // allocated)
            nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_fini_function     // function to
                                                                                                                    // terminate
                                                                                                                    // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, LoadMap_Response)()
    {
        ...
        if (!nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            nav_msgs__srv__LoadMap_Response__rosidl_typesupport_introspection_c__LoadMap_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_nav_msgs const rosidl_service_type_support_t*
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, LoadMap)()
{
    if (!nav_msgs__srv__detail__load_map__rosidl_typesupport_introspection_c__LoadMap_service_type_support_handle
             .typesupport_identifier)
    {
        nav_msgs__srv__detail__load_map__rosidl_typesupport_introspection_c__LoadMap_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    rosidl_typesupport_introspection_c__ServiceMembers* service_members =
        (rosidl_typesupport_introspection_c__ServiceMembers*)
            nav_msgs__srv__detail__load_map__rosidl_typesupport_introspection_c__LoadMap_service_type_support_handle.data;

    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, nav_msgs, srv, LoadMap_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, nav_msgs, srv, LoadMap_Response)()
                ->data;
    }
