...
{
public:
    explicit Init_GetPlan_Request_tolerance(::nav_msgs::srv::GetPlan_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_GetPlan_Request_goal(::nav_msgs::srv::GetPlan_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GetPlan_Request_start() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::GetPlan_Request>()
{
...
{
public:
    Init_GetPlan_Response_plan() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::GetPlan_Response>()
{
