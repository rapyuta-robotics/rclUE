...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__srv__SetMap_Request__rosidl_typesupport_introspection_c__SetMap_Request_message_member_array[2] = {
            {
                "map",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__srv__SetMap_Request__rosidl_typesupport_introspection_c__SetMap_Request_message_members = {
            ...
            nav_msgs__srv__SetMap_Request__rosidl_typesupport_introspection_c__SetMap_Request_message_member_array,    // message
                                                                                                                       // members
            nav_msgs__srv__SetMap_Request__rosidl_typesupport_introspection_c__SetMap_Request_init_function,    // function to
                                                                                                                // initialize
                                                                                                                // message memory
                                                                                                                // (memory has to be
                                                                                                                // allocated)
            nav_msgs__srv__SetMap_Request__rosidl_typesupport_introspection_c__SetMap_Request_fini_function     // function to
                                                                                                                // terminate message
                                                                                                               // instance (will not
                                                                                                               // free memory)
    };
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, SetMap_Request)()
    {
        ...
        if (!nav_msgs__srv__SetMap_Request__rosidl_typesupport_introspection_c__SetMap_Request_message_type_support_handle
...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_message_member_array[1] = {{
            "success",                                               // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_message_members = {
            ...
            nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_message_member_array,    // message
                                                                                                                         // members
            nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_init_function,    // function to
                                                                                                                  // initialize
                                                                                                                  // message memory
                                                                                                                  // (memory has to
                                                                                                                  // be allocated)
            nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_fini_function     // function to
                                                                                                                  // terminate
                                                                                                                 // message instance
                                                                                                                 // (will not free
                                                                                                                 // memory)
    ...
    {
        if (!nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            nav_msgs__srv__SetMap_Response__rosidl_typesupport_introspection_c__SetMap_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
{
    if (!nav_msgs__srv__detail__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle
             .typesupport_identifier)
    {
        nav_msgs__srv__detail__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    rosidl_typesupport_introspection_c__ServiceMembers* service_members =
        (rosidl_typesupport_introspection_c__ServiceMembers*)
            nav_msgs__srv__detail__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle.data;

    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, nav_msgs, srv, SetMap_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, nav_msgs, srv, SetMap_Response)()
                ->data;
    }
