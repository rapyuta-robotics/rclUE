...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_message_member_array[3] = {
            {
                "start",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_message_members = {
            ...
            nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_message_member_array,    // message
                                                                                                                         // members
            nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_init_function,    // function to
                                                                                                                  // initialize
                                                                                                                  // message memory
                                                                                                                  // (memory has to
                                                                                                                  // be allocated)
            nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_fini_function     // function to
                                                                                                                  // terminate
                                                                                                                 // message instance
                                                                                                                 // (will not free
                                                                                                                 // memory)
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, GetPlan_Request)()
    {
        ...
        nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_message_member_array[1].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, geometry_msgs, msg, PoseStamped)();
        if (!nav_msgs__srv__GetPlan_Request__rosidl_typesupport_introspection_c__GetPlan_Request_message_type_support_handle
...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_message_member_array[1] = {{
            "plan",                                                  // name
            rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,    // type
            0,                                                       // upper bound of string
            NULL,                                                    // members of sub message (initialized later)
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_message_members = {
            ...
            nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_message_member_array,    // message
                                                                                                                           // members
            nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_init_function,    // function to
                                                                                                                    // initialize
                                                                                                                    // message
                                                                                                                    // memory
                                                                                                                    // (memory has
                                                                                                                    // to be
                                                                                                                    // allocated)
            nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_fini_function     // function to
                                                                                                                    // terminate
                                                                                                                    // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, GetPlan_Response)()
    {
        ...
        if (!nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            nav_msgs__srv__GetPlan_Response__rosidl_typesupport_introspection_c__GetPlan_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
{
    if (!nav_msgs__srv__detail__get_plan__rosidl_typesupport_introspection_c__GetPlan_service_type_support_handle
             .typesupport_identifier)
    {
        nav_msgs__srv__detail__get_plan__rosidl_typesupport_introspection_c__GetPlan_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    rosidl_typesupport_introspection_c__ServiceMembers* service_members =
        (rosidl_typesupport_introspection_c__ServiceMembers*)
            nav_msgs__srv__detail__get_plan__rosidl_typesupport_introspection_c__GetPlan_service_type_support_handle.data;

    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, nav_msgs, srv, GetPlan_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, nav_msgs, srv, GetPlan_Response)()
                ->data;
    }
