...
{
public:
    Init_LoadMap_Request_map_url() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::LoadMap_Request>()
{
...
{
public:
    explicit Init_LoadMap_Response_result(::nav_msgs::srv::LoadMap_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_LoadMap_Response_map() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::LoadMap_Response>()
{
