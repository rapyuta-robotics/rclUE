...
template<>
inline auto build<::nav_msgs::srv::GetMap_Request>()
{
...
{
public:
    Init_GetMap_Response_map() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::GetMap_Response>()
{
