...
{
public:
    explicit Init_SetMap_Request_initial_pose(::nav_msgs::srv::SetMap_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SetMap_Request_map() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::SetMap_Request>()
{
...
{
public:
    Init_SetMap_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::nav_msgs::srv::SetMap_Response>()
{
