...
static inline bool rcutils_atomic_compare_exchange_strong_uint_least64_t(atomic_uint_least64_t* a_uint_least64_t,
                                                                         uint64_t* expected,
                                                                         uint64_t desired)
{
    bool result;
...
static inline int64_t rcutils_atomic_exchange_int64_t(atomic_int_least64_t* a_int64_t, int64_t desired)
{
    int64_t result;
...
static inline uint64_t rcutils_atomic_exchange_uint64_t(atomic_uint_least64_t* a_uint64_t, uint64_t desired)
{
    uint64_t result;
...
static inline uintptr_t rcutils_atomic_exchange_uintptr_t(atomic_uintptr_t* a_uintptr_t, uintptr_t desired)
{
    uintptr_t result;
...
static inline uint64_t rcutils_atomic_fetch_add_uint64_t(atomic_uint_least64_t* a_uint64_t, uint64_t arg)
{
    uint64_t result;
