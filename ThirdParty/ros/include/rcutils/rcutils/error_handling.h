...
#define RCUTILS_ERROR_STATE_FILE_MAX_LENGTH                                                                                       \
    (RCUTILS_ERROR_MESSAGE_MAX_LENGTH - RCUTILS_ERROR_STATE_MESSAGE_MAX_LENGTH - RCUTILS_ERROR_STATE_LINE_NUMBER_STR_MAX_LENGTH - \
     RCUTILS_ERROR_FORMATTING_CHARACTERS - 1)
    ...
    static_assert(sizeof(rcutils_error_string_t) == (RCUTILS_ERROR_STATE_MESSAGE_MAX_LENGTH + RCUTILS_ERROR_STATE_FILE_MAX_LENGTH +
                                                     RCUTILS_ERROR_STATE_LINE_NUMBER_STR_MAX_LENGTH +
                                                     RCUTILS_ERROR_FORMATTING_CHARACTERS + 1 /* null terminating character */),
