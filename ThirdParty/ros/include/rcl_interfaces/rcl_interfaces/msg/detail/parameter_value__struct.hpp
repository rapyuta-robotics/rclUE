...
struct ParameterValue_
{
    ...
    _type_type type;
    using _bool_value_type = bool;
    _bool_value_type bool_value;
    using _integer_value_type = int64_t;
    _integer_value_type integer_value;
    using _double_value_type = double;
    _double_value_type double_value;
    using _string_value_type = std::
    ...
    // pointer types
    using RawPtr = rcl_interfaces::msg::ParameterValue_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::msg::ParameterValue_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterValue_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterValue_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterValue_<ContainerAllocator> const>;
...
using ParameterValue = rcl_interfaces::msg::ParameterValue_<std::allocator<void>>;
