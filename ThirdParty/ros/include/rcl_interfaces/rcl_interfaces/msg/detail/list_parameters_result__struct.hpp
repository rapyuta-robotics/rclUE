...
struct ListParametersResult_
{
    ...
    // pointer types
    using RawPtr = rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::msg::ListParametersResult_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::msg::ListParametersResult_<ContainerAllocator> const>;
...
using ListParametersResult = rcl_interfaces::msg::ListParametersResult_<std::allocator<void>>;
