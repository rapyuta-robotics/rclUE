...
bool rcl_interfaces__msg__ParameterValue__are_equal(const rcl_interfaces__msg__ParameterValue* lhs,
                                                    const rcl_interfaces__msg__ParameterValue* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // string_value
    if (!rosidl_runtime_c__String__are_equal(&(lhs->string_value), &(rhs->string_value)))
    {
        return false;
    }
    // byte_array_value
    if (!rosidl_runtime_c__octet__Sequence__are_equal(&(lhs->byte_array_value), &(rhs->byte_array_value)))
    {
        return false;
    }
    // bool_array_value
    if (!rosidl_runtime_c__boolean__Sequence__are_equal(&(lhs->bool_array_value), &(rhs->bool_array_value)))
    {
        return false;
    }
    // integer_array_value
    if (!rosidl_runtime_c__int64__Sequence__are_equal(&(lhs->integer_array_value), &(rhs->integer_array_value)))
    {
        return false;
    }
    // double_array_value
    if (!rosidl_runtime_c__double__Sequence__are_equal(&(lhs->double_array_value), &(rhs->double_array_value)))
    {
        return false;
    }
    // string_array_value
    if (!rosidl_runtime_c__String__Sequence__are_equal(&(lhs->string_array_value), &(rhs->string_array_value)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__ParameterValue__copy(const rcl_interfaces__msg__ParameterValue* input,
                                               rcl_interfaces__msg__ParameterValue* output)
{
    ...
    // string_value
    if (!rosidl_runtime_c__String__copy(&(input->string_value), &(output->string_value)))
    {
        return false;
    }
    // byte_array_value
    if (!rosidl_runtime_c__octet__Sequence__copy(&(input->byte_array_value), &(output->byte_array_value)))
    {
        return false;
    }
    // bool_array_value
    if (!rosidl_runtime_c__boolean__Sequence__copy(&(input->bool_array_value), &(output->bool_array_value)))
    {
        return false;
    }
    // integer_array_value
    if (!rosidl_runtime_c__int64__Sequence__copy(&(input->integer_array_value), &(output->integer_array_value)))
    {
        return false;
    }
    // double_array_value
    if (!rosidl_runtime_c__double__Sequence__copy(&(input->double_array_value), &(output->double_array_value)))
    {
        return false;
    }
    // string_array_value
    if (!rosidl_runtime_c__String__Sequence__copy(&(input->string_array_value), &(output->string_array_value)))
    {
        return false;
    }
    return true;
...
rcl_interfaces__msg__ParameterValue* rcl_interfaces__msg__ParameterValue__create()
{
    ...
    rcl_interfaces__msg__ParameterValue* msg =
        (rcl_interfaces__msg__ParameterValue*)allocator.allocate(sizeof(rcl_interfaces__msg__ParameterValue), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__ParameterValue__Sequence__init(rcl_interfaces__msg__ParameterValue__Sequence* array, size_t size)
{
    ...
    if (size)
    {
        data = (rcl_interfaces__msg__ParameterValue*)allocator.zero_allocate(
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__msg__ParameterValue__Sequence* array = (rcl_interfaces__msg__ParameterValue__Sequence*)allocator.allocate(
        sizeof(rcl_interfaces__msg__ParameterValue__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__ParameterValue__Sequence__are_equal(const rcl_interfaces__msg__ParameterValue__Sequence* lhs,
                                                              const rcl_interfaces__msg__ParameterValue__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__msg__ParameterValue__Sequence__copy(const rcl_interfaces__msg__ParameterValue__Sequence* input,
                                                         rcl_interfaces__msg__ParameterValue__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__msg__ParameterValue);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__msg__ParameterValue* data =
            (rcl_interfaces__msg__ParameterValue*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__msg__ParameterValue__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
