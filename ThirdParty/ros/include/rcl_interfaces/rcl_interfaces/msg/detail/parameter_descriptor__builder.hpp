...
{
public:
    explicit Init_ParameterDescriptor_integer_range(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterDescriptor_floating_point_range(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
    Init_ParameterDescriptor_integer_range floating_point_range(
        ::rcl_interfaces::msg::ParameterDescriptor::_floating_point_range_type arg)
    {
...
{
public:
    explicit Init_ParameterDescriptor_dynamic_typing(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
    Init_ParameterDescriptor_floating_point_range dynamic_typing(
        ::rcl_interfaces::msg::ParameterDescriptor::_dynamic_typing_type arg)
    {
...
{
public:
    explicit Init_ParameterDescriptor_read_only(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterDescriptor_additional_constraints(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
    Init_ParameterDescriptor_read_only additional_constraints(
        ::rcl_interfaces::msg::ParameterDescriptor::_additional_constraints_type arg)
    {
...
{
public:
    explicit Init_ParameterDescriptor_description(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterDescriptor_type(::rcl_interfaces::msg::ParameterDescriptor& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_ParameterDescriptor_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::ParameterDescriptor>()
{
