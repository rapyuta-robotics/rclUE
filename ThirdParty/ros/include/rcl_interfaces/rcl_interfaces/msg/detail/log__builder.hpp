...
{
public:
    explicit Init_Log_line(::rcl_interfaces::msg::Log& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Log_function(::rcl_interfaces::msg::Log& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Log_file(::rcl_interfaces::msg::Log& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Log_msg(::rcl_interfaces::msg::Log& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Log_name(::rcl_interfaces::msg::Log& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Log_level(::rcl_interfaces::msg::Log& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Log_stamp() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::Log>()
{
