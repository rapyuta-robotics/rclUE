...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_message_member_array[3] = {
            {
                "from_value",                                               // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_message_members = {
            ...
            rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_message_member_array,    // message
                                                                                                                         // members
            rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_init_function,    // function to
                                                                                                                  // initialize
                                                                                                                  // message memory
                                                                                                                  // (memory has to
                                                                                                                  // be allocated)
            rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_fini_function     // function to
                                                                                                                  // terminate
                                                                                                                 // message instance
                                                                                                                 // (will not free
                                                                                                                 // memory)
    ...
    static rosidl_message_type_support_t
        rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_message_type_support_handle = {
            0,
            &rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_message_members,
    ...
    {
        if (!rcl_interfaces__msg__IntegerRange__rosidl_typesupport_introspection_c__IntegerRange_message_type_support_handle
