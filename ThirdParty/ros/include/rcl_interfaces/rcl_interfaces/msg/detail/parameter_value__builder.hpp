...
{
public:
    explicit Init_ParameterValue_string_array_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_double_array_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_integer_array_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_bool_array_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_byte_array_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_string_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_double_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_integer_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ParameterValue_bool_value(::rcl_interfaces::msg::ParameterValue& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_ParameterValue_type() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::ParameterValue>()
{
