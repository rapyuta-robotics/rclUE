...
bool rcl_interfaces__msg__ParameterEvent__are_equal(const rcl_interfaces__msg__ParameterEvent* lhs,
                                                    const rcl_interfaces__msg__ParameterEvent* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // node
    if (!rosidl_runtime_c__String__are_equal(&(lhs->node), &(rhs->node)))
    {
        return false;
    }
    // new_parameters
    if (!rcl_interfaces__msg__Parameter__Sequence__are_equal(&(lhs->new_parameters), &(rhs->new_parameters)))
    {
        return false;
    }
    // changed_parameters
    if (!rcl_interfaces__msg__Parameter__Sequence__are_equal(&(lhs->changed_parameters), &(rhs->changed_parameters)))
    {
        return false;
    }
    // deleted_parameters
    if (!rcl_interfaces__msg__Parameter__Sequence__are_equal(&(lhs->deleted_parameters), &(rhs->deleted_parameters)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__ParameterEvent__copy(const rcl_interfaces__msg__ParameterEvent* input,
                                               rcl_interfaces__msg__ParameterEvent* output)
{
    ...
    // node
    if (!rosidl_runtime_c__String__copy(&(input->node), &(output->node)))
    {
        return false;
    }
    // new_parameters
    if (!rcl_interfaces__msg__Parameter__Sequence__copy(&(input->new_parameters), &(output->new_parameters)))
    {
        return false;
    }
    // changed_parameters
    if (!rcl_interfaces__msg__Parameter__Sequence__copy(&(input->changed_parameters), &(output->changed_parameters)))
    {
        return false;
    }
    // deleted_parameters
    if (!rcl_interfaces__msg__Parameter__Sequence__copy(&(input->deleted_parameters), &(output->deleted_parameters)))
    {
        return false;
    }
    return true;
...
rcl_interfaces__msg__ParameterEvent* rcl_interfaces__msg__ParameterEvent__create()
{
    ...
    rcl_interfaces__msg__ParameterEvent* msg =
        (rcl_interfaces__msg__ParameterEvent*)allocator.allocate(sizeof(rcl_interfaces__msg__ParameterEvent), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__ParameterEvent__Sequence__init(rcl_interfaces__msg__ParameterEvent__Sequence* array, size_t size)
{
    ...
    if (size)
    {
        data = (rcl_interfaces__msg__ParameterEvent*)allocator.zero_allocate(
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__msg__ParameterEvent__Sequence* array = (rcl_interfaces__msg__ParameterEvent__Sequence*)allocator.allocate(
        sizeof(rcl_interfaces__msg__ParameterEvent__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__ParameterEvent__Sequence__are_equal(const rcl_interfaces__msg__ParameterEvent__Sequence* lhs,
                                                              const rcl_interfaces__msg__ParameterEvent__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__msg__ParameterEvent__Sequence__copy(const rcl_interfaces__msg__ParameterEvent__Sequence* input,
                                                         rcl_interfaces__msg__ParameterEvent__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__msg__ParameterEvent);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__msg__ParameterEvent* data =
            (rcl_interfaces__msg__ParameterEvent*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__msg__ParameterEvent__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
