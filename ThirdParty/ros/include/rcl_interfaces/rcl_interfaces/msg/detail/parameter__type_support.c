...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_message_member_array[2] = {
            {
                "name",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_message_members = {
            ...
            rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_message_member_array,    // message
                                                                                                                   // members
            rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_init_function,           // function to
                                                                                                            // initialize message
                                                                                                            // memory (memory has to
                                                                                                            // be allocated)
            rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_fini_function    // function to terminate
    ...
    static rosidl_message_type_support_t
        rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_message_type_support_handle = {
            0,
            &rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, msg, Parameter)()
    {
        ...
        if (!rcl_interfaces__msg__Parameter__rosidl_typesupport_introspection_c__Parameter_message_type_support_handle
