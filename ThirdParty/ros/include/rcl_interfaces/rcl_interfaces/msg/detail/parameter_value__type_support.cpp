...
void ParameterValue_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__ParameterValue__byte_array_value(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const unsigned char*>(get_const_function__ParameterValue__byte_array_value(untyped_member, index));
    auto& value = *reinterpret_cast<unsigned char*>(untyped_value);
    value = item;
}

void assign_function__ParameterValue__byte_array_value(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<unsigned char*>(get_function__ParameterValue__byte_array_value(untyped_member, index));
...
void fetch_function__ParameterValue__bool_array_value(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& member = *reinterpret_cast<const std::vector<bool>*>(untyped_member);
...
void assign_function__ParameterValue__bool_array_value(void* untyped_member, size_t index, const void* untyped_value)
{
...
{
    auto& member = *reinterpret_cast<std::vector<int64_t>*>(untyped_member);
    return &member[index];
}

void fetch_function__ParameterValue__integer_array_value(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const int64_t*>(get_const_function__ParameterValue__integer_array_value(untyped_member, index));
    auto& value = *reinterpret_cast<int64_t*>(untyped_value);
    value = item;
}

void assign_function__ParameterValue__integer_array_value(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<int64_t*>(get_function__ParameterValue__integer_array_value(untyped_member, index));
...
void fetch_function__ParameterValue__double_array_value(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const double*>(get_const_function__ParameterValue__double_array_value(untyped_member, index));
    auto& value = *reinterpret_cast<double*>(untyped_value);
    value = item;
}

void assign_function__ParameterValue__double_array_value(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<double*>(get_function__ParameterValue__double_array_value(untyped_member, index));
...
void fetch_function__ParameterValue__string_array_value(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__ParameterValue__string_array_value(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__ParameterValue__string_array_value(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__ParameterValue__string_array_value(untyped_member, index));
