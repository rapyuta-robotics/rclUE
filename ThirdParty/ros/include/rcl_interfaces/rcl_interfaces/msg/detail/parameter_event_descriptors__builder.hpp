...
{
public:
    explicit Init_ParameterEventDescriptors_deleted_parameters(::rcl_interfaces::msg::ParameterEventDescriptors& msg) : msg_(msg)
    {
    }
    ::rcl_interfaces::msg::ParameterEventDescriptors deleted_parameters(
        ::rcl_interfaces::msg::ParameterEventDescriptors::_deleted_parameters_type arg)
    {
...
{
public:
    explicit Init_ParameterEventDescriptors_changed_parameters(::rcl_interfaces::msg::ParameterEventDescriptors& msg) : msg_(msg)
    {
    }
    Init_ParameterEventDescriptors_deleted_parameters changed_parameters(
        ::rcl_interfaces::msg::ParameterEventDescriptors::_changed_parameters_type arg)
    {
...
{
public:
    Init_ParameterEventDescriptors_new_parameters() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
    Init_ParameterEventDescriptors_changed_parameters new_parameters(
        ::rcl_interfaces::msg::ParameterEventDescriptors::_new_parameters_type arg)
    {
...
template<>
inline auto build<::rcl_interfaces::msg::ParameterEventDescriptors>()
{
