...
inline void to_flow_style_yaml(const Log& msg, std::ostream& out)
{
    out << "{";
    // member: stamp
    {
...
inline void to_block_style_yaml(const Log& msg, std::ostream& out, size_t indentation = 0)
{
    // member: stamp
    {
        if (indentation > 0)
...
[[deprecated("use rcl_interfaces::msg::to_block_style_yaml() instead")]] inline void to_yaml(const rcl_interfaces::msg::Log& msg,
                                                                                             std::ostream& out,
...
[[deprecated("use rcl_interfaces::msg::to_yaml() instead")]] inline std::string to_yaml(const rcl_interfaces::msg::Log& msg)
{
...
template<>
struct has_fixed_size<rcl_interfaces::msg::Log> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<rcl_interfaces::msg::Log> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<rcl_interfaces::msg::Log> : std::true_type
{
};
