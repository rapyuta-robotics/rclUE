...
bool rcl_interfaces__msg__ParameterEventDescriptors__are_equal(const rcl_interfaces__msg__ParameterEventDescriptors* lhs,
                                                               const rcl_interfaces__msg__ParameterEventDescriptors* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // new_parameters
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__are_equal(&(lhs->new_parameters), &(rhs->new_parameters)))
    {
        return false;
    }
    // changed_parameters
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__are_equal(&(lhs->changed_parameters), &(rhs->changed_parameters)))
    {
        return false;
    }
    // deleted_parameters
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__are_equal(&(lhs->deleted_parameters), &(rhs->deleted_parameters)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__ParameterEventDescriptors__copy(const rcl_interfaces__msg__ParameterEventDescriptors* input,
                                                          rcl_interfaces__msg__ParameterEventDescriptors* output)
{
    ...
    // new_parameters
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__copy(&(input->new_parameters), &(output->new_parameters)))
    {
        return false;
    }
    // changed_parameters
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__copy(&(input->changed_parameters), &(output->changed_parameters)))
    {
        return false;
    }
    // deleted_parameters
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__copy(&(input->deleted_parameters), &(output->deleted_parameters)))
    {
        return false;
    }
    return true;
...
rcl_interfaces__msg__ParameterEventDescriptors* rcl_interfaces__msg__ParameterEventDescriptors__create()
{
...
bool rcl_interfaces__msg__ParameterEventDescriptors__Sequence__init(rcl_interfaces__msg__ParameterEventDescriptors__Sequence* array,
                                                                    size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (rcl_interfaces__msg__ParameterEventDescriptors*)allocator.zero_allocate(
...
void rcl_interfaces__msg__ParameterEventDescriptors__Sequence__fini(rcl_interfaces__msg__ParameterEventDescriptors__Sequence* array)
{
    if (!array)
    {
        return;
    ...
    size_t size)
{
    ...
    rcl_interfaces__msg__ParameterEventDescriptors__Sequence* array =
        (rcl_interfaces__msg__ParameterEventDescriptors__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__msg__ParameterEventDescriptors__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__ParameterEventDescriptors__Sequence__are_equal(
    const rcl_interfaces__msg__ParameterEventDescriptors__Sequence* lhs,
    const rcl_interfaces__msg__ParameterEventDescriptors__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__msg__ParameterEventDescriptors__Sequence__copy(
    ...
    rcl_interfaces__msg__ParameterEventDescriptors__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__msg__ParameterEventDescriptors);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__msg__ParameterEventDescriptors* data =
            (rcl_interfaces__msg__ParameterEventDescriptors*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__msg__ParameterEventDescriptors__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
