...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterValue__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterValue__fini(
        rcl_interfaces__msg__ParameterValue* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces rcl_interfaces__msg__ParameterValue* rcl_interfaces__msg__ParameterValue__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterValue__destroy(
        rcl_interfaces__msg__ParameterValue* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterValue__are_equal(
        const rcl_interfaces__msg__ParameterValue* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterValue__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterValue__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterValue__Sequence__fini(
        rcl_interfaces__msg__ParameterValue__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces rcl_interfaces__msg__ParameterValue__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterValue__Sequence__destroy(
        rcl_interfaces__msg__ParameterValue__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterValue__Sequence__are_equal(
        const rcl_interfaces__msg__ParameterValue__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterValue__Sequence__copy(
