...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterEventDescriptors__init(
        rcl_interfaces__msg__ParameterEventDescriptors* msg);

    /// Finalize msg/ParameterEventDescriptors message.
    /**
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterEventDescriptors__fini(
        rcl_interfaces__msg__ParameterEventDescriptors* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces rcl_interfaces__msg__ParameterEventDescriptors*
    rcl_interfaces__msg__ParameterEventDescriptors__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterEventDescriptors__destroy(
        rcl_interfaces__msg__ParameterEventDescriptors* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterEventDescriptors__are_equal(
        const rcl_interfaces__msg__ParameterEventDescriptors* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterEventDescriptors__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterEventDescriptors__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterEventDescriptors__Sequence__fini(
        rcl_interfaces__msg__ParameterEventDescriptors__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces rcl_interfaces__msg__ParameterEventDescriptors__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces void rcl_interfaces__msg__ParameterEventDescriptors__Sequence__destroy(
        rcl_interfaces__msg__ParameterEventDescriptors__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterEventDescriptors__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces bool rcl_interfaces__msg__ParameterEventDescriptors__Sequence__copy(
