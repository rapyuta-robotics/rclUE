...
{
public:
    explicit Init_Parameter_value(::rcl_interfaces::msg::Parameter& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Parameter_name() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::Parameter>()
{
