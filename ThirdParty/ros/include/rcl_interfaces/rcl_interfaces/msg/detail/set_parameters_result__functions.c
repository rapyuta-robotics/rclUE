...
bool rcl_interfaces__msg__SetParametersResult__are_equal(const rcl_interfaces__msg__SetParametersResult* lhs,
                                                         const rcl_interfaces__msg__SetParametersResult* rhs)
{
    ...
    // reason
    if (!rosidl_runtime_c__String__are_equal(&(lhs->reason), &(rhs->reason)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__SetParametersResult__copy(const rcl_interfaces__msg__SetParametersResult* input,
                                                    rcl_interfaces__msg__SetParametersResult* output)
{
    ...
    // reason
    if (!rosidl_runtime_c__String__copy(&(input->reason), &(output->reason)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__SetParametersResult__Sequence__init(rcl_interfaces__msg__SetParametersResult__Sequence* array,
                                                              size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (rcl_interfaces__msg__SetParametersResult*)allocator.zero_allocate(
...
rcl_interfaces__msg__SetParametersResult__Sequence* rcl_interfaces__msg__SetParametersResult__Sequence__create(size_t size)
{
    ...
    rcl_interfaces__msg__SetParametersResult__Sequence* array =
        (rcl_interfaces__msg__SetParametersResult__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__msg__SetParametersResult__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__SetParametersResult__Sequence__are_equal(const rcl_interfaces__msg__SetParametersResult__Sequence* lhs,
...
bool rcl_interfaces__msg__SetParametersResult__Sequence__copy(const rcl_interfaces__msg__SetParametersResult__Sequence* input,
                                                              rcl_interfaces__msg__SetParametersResult__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__msg__SetParametersResult);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__msg__SetParametersResult* data =
            (rcl_interfaces__msg__SetParametersResult*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__msg__SetParametersResult__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
