...
{
public:
    explicit Init_IntegerRange_step(::rcl_interfaces::msg::IntegerRange& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_IntegerRange_to_value(::rcl_interfaces::msg::IntegerRange& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_IntegerRange_from_value() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::IntegerRange>()
{
