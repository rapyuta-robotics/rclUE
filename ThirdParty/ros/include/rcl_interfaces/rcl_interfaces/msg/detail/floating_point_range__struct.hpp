...
struct FloatingPointRange_
{
    ...
    explicit FloatingPointRange_(const ContainerAllocator& _alloc,
    ...
    using _from_value_type = double;
    _from_value_type from_value;
    using _to_value_type = double;
    _to_value_type to_value;
    using _step_type = double;
    _step_type step;

    // setters for named parameter idiom
    Type& set__from_value(const double& _arg)
    {
        this->from_value = _arg;
        return *this;
    }
    Type& set__to_value(const double& _arg)
    {
        this->to_value = _arg;
        return *this;
    }
    Type& set__step(const double& _arg)
    {
        this->step = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator> const>;
...
using FloatingPointRange = rcl_interfaces::msg::FloatingPointRange_<std::allocator<void>>;
