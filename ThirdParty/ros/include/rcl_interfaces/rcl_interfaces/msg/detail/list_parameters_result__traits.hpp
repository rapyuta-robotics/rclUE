...
inline void to_flow_style_yaml(const ListParametersResult& msg, std::ostream& out)
{
    out << "{";
    // member: names
    {
...
inline void to_block_style_yaml(const ListParametersResult& msg, std::ostream& out, size_t indentation = 0)
{
    // member: names
    {
        if (indentation > 0)
...
to_yaml(const rcl_interfaces::msg::ListParametersResult& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<rcl_interfaces::msg::ListParametersResult> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<rcl_interfaces::msg::ListParametersResult> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<rcl_interfaces::msg::ListParametersResult> : std::true_type
{
};
