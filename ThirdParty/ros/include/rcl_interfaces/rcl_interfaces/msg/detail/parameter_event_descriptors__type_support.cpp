...
void ParameterEventDescriptors_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__ParameterEventDescriptors__new_parameters(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__ParameterEventDescriptors__new_parameters(void* untyped_member, size_t index, const void* untyped_value)
{
...
void fetch_function__ParameterEventDescriptors__changed_parameters(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const rcl_interfaces::msg::ParameterDescriptor*>(
...
void assign_function__ParameterEventDescriptors__changed_parameters(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<rcl_interfaces::msg::ParameterDescriptor*>(
...
void fetch_function__ParameterEventDescriptors__deleted_parameters(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const rcl_interfaces::msg::ParameterDescriptor*>(
...
void assign_function__ParameterEventDescriptors__deleted_parameters(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<rcl_interfaces::msg::ParameterDescriptor*>(
