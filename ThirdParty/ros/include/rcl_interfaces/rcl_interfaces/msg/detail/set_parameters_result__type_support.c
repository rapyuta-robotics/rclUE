...
extern "C"
{
    ...
    void rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_member_array[2] =
            {{
                 "successful",                                                      // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_members = {
            ...
            rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_fini_function    // function
                                                                                                                               // to
                                                                                                                               // terminate
                                                                                                                               // message
                                                                                                                               // instance
    ...
    static rosidl_message_type_support_t
        rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_type_support_handle =
            {
                0,
                &rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_members,
