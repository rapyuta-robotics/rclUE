...
inline void to_flow_style_yaml(const ParameterType& msg, std::ostream& out)
{
    (void)msg;
    out << "null";
}    // NOLINT(readability/fn_size)

inline void to_block_style_yaml(const ParameterType& msg, std::ostream& out, size_t indentation = 0)
{
    (void)msg;
    (void)indentation;
    out << "null\n";
...
to_yaml(const rcl_interfaces::msg::ParameterType& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<rcl_interfaces::msg::ParameterType> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<rcl_interfaces::msg::ParameterType> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<rcl_interfaces::msg::ParameterType> : std::true_type
{
};
