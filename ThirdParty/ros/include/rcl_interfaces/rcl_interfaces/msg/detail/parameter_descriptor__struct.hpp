...
struct ParameterDescriptor_
{
    ...
    explicit ParameterDescriptor_(const ContainerAllocator& _alloc,
        ...
        : name(_alloc), description(_alloc), additional_constraints(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
            rosidl_runtime_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
        {
    ...
    using _additional_constraints_type = std::
        basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
    _additional_constraints_type additional_constraints;
    using _read_only_type = bool;
    _read_only_type read_only;
    using _dynamic_typing_type = bool;
    _dynamic_typing_type dynamic_typing;
    using _floating_point_range_type =
        rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>,
                                          1,
    ...
    using _integer_range_type =
        rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::IntegerRange_<ContainerAllocator>,
                                          1,
                                          typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    Type& set__read_only(const bool& _arg)
    {
        this->read_only = _arg;
        return *this;
    }
    Type& set__dynamic_typing(const bool& _arg)
    {
        this->dynamic_typing = _arg;
        return *this;
    }
    Type& set__floating_point_range(
        const rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>,
                                                1,
                                                typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                    rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>>& _arg)
    {
        this->floating_point_range = _arg;
        return *this;
    }
    Type& set__integer_range(
        const rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::IntegerRange_<ContainerAllocator>,
                                                1,
                                                typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                    rcl_interfaces::msg::IntegerRange_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator> const>;
...
using ParameterDescriptor = rcl_interfaces::msg::ParameterDescriptor_<std::allocator<void>>;
