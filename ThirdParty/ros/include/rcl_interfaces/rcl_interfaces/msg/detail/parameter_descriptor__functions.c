...
bool rcl_interfaces__msg__ParameterDescriptor__are_equal(const rcl_interfaces__msg__ParameterDescriptor* lhs,
                                                         const rcl_interfaces__msg__ParameterDescriptor* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // additional_constraints
    if (!rosidl_runtime_c__String__are_equal(&(lhs->additional_constraints), &(rhs->additional_constraints)))
    {
        return false;
    }
    // read_only
    ...
    // floating_point_range
    if (!rcl_interfaces__msg__FloatingPointRange__Sequence__are_equal(&(lhs->floating_point_range), &(rhs->floating_point_range)))
    {
        return false;
    }
    // integer_range
    if (!rcl_interfaces__msg__IntegerRange__Sequence__are_equal(&(lhs->integer_range), &(rhs->integer_range)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__ParameterDescriptor__copy(const rcl_interfaces__msg__ParameterDescriptor* input,
                                                    rcl_interfaces__msg__ParameterDescriptor* output)
{
    ...
    // additional_constraints
    if (!rosidl_runtime_c__String__copy(&(input->additional_constraints), &(output->additional_constraints)))
    {
        return false;
    }
    // read_only
    ...
    // floating_point_range
    if (!rcl_interfaces__msg__FloatingPointRange__Sequence__copy(&(input->floating_point_range), &(output->floating_point_range)))
    {
        return false;
    }
    // integer_range
    if (!rcl_interfaces__msg__IntegerRange__Sequence__copy(&(input->integer_range), &(output->integer_range)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__ParameterDescriptor__Sequence__init(rcl_interfaces__msg__ParameterDescriptor__Sequence* array,
                                                              size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (rcl_interfaces__msg__ParameterDescriptor*)allocator.zero_allocate(
...
rcl_interfaces__msg__ParameterDescriptor__Sequence* rcl_interfaces__msg__ParameterDescriptor__Sequence__create(size_t size)
{
    ...
    rcl_interfaces__msg__ParameterDescriptor__Sequence* array =
        (rcl_interfaces__msg__ParameterDescriptor__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__msg__ParameterDescriptor__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__ParameterDescriptor__Sequence__are_equal(const rcl_interfaces__msg__ParameterDescriptor__Sequence* lhs,
                                                                   const rcl_interfaces__msg__ParameterDescriptor__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__msg__ParameterDescriptor__Sequence__copy(const rcl_interfaces__msg__ParameterDescriptor__Sequence* input,
                                                              rcl_interfaces__msg__ParameterDescriptor__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__msg__ParameterDescriptor);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__msg__ParameterDescriptor* data =
            (rcl_interfaces__msg__ParameterDescriptor*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__msg__ParameterDescriptor__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
