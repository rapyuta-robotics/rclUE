...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces cdr_serialize(const rcl_interfaces::msg::IntegerRange& ros_message,
...
get_serialized_size(const rcl_interfaces::msg::IntegerRange& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces max_serialized_size_IntegerRange(bool& full_bounded,
                                                                                              bool& is_plain,
