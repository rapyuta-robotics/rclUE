...
{
public:
    explicit Init_SetParametersResult_reason(::rcl_interfaces::msg::SetParametersResult& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SetParametersResult_successful() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::SetParametersResult>()
{
