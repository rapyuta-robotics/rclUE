...
struct ParameterType_
{
    ...
    static constexpr uint8_t PARAMETER_NOT_SET = 0u;
    static constexpr uint8_t PARAMETER_BOOL = 1u;
    static constexpr uint8_t PARAMETER_INTEGER = 2u;
    static constexpr uint8_t PARAMETER_DOUBLE = 3u;
    static constexpr uint8_t PARAMETER_STRING = 4u;
    static constexpr uint8_t PARAMETER_BYTE_ARRAY = 5u;
    static constexpr uint8_t PARAMETER_BOOL_ARRAY = 6u;
    static constexpr uint8_t PARAMETER_INTEGER_ARRAY = 7u;
    static constexpr uint8_t PARAMETER_DOUBLE_ARRAY = 8u;
    static constexpr uint8_t PARAMETER_STRING_ARRAY = 9u;

    // pointer types
    using RawPtr = rcl_interfaces::msg::ParameterType_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::msg::ParameterType_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterType_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterType_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__rcl_interfaces__msg__ParameterType std::shared_ptr<rcl_interfaces::msg::ParameterType_<ContainerAllocator>>
        Ptr;
...
using ParameterType = rcl_interfaces::msg::ParameterType_<std::allocator<void>>;
