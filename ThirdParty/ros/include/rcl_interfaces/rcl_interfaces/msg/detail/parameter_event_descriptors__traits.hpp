...
inline void to_flow_style_yaml(const ParameterEventDescriptors& msg, std::ostream& out)
{
    out << "{";
    // member: new_parameters
    {
...
inline void to_block_style_yaml(const ParameterEventDescriptors& msg, std::ostream& out, size_t indentation = 0)
{
    // member: new_parameters
    {
        if (indentation > 0)
...
to_yaml(const rcl_interfaces::msg::ParameterEventDescriptors& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<rcl_interfaces::msg::ParameterEventDescriptors> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<rcl_interfaces::msg::ParameterEventDescriptors> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<rcl_interfaces::msg::ParameterEventDescriptors> : std::true_type
{
};
