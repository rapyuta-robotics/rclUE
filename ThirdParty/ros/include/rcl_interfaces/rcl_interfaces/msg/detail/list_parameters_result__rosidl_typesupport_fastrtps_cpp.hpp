...
cdr_serialize(const rcl_interfaces::msg::ListParametersResult& ros_message, eprosima::fastcdr::Cdr& cdr);
...
get_serialized_size(const rcl_interfaces::msg::ListParametersResult& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces max_serialized_size_ListParametersResult(bool& full_bounded,
                                                                                                      bool& is_plain,
