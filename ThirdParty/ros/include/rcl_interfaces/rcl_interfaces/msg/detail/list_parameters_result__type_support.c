...
extern "C"
{
    ...
    void rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__size_function__ListParametersResult__names(
    ...
    void
    rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__assign_function__ListParametersResult__names(
        void* untyped_member,
        size_t index,
    ...
    bool
    rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__resize_function__ListParametersResult__names(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    size_t
    rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__size_function__ListParametersResult__prefixes(
        const void* untyped_member)
    {
        const rosidl_runtime_c__String__Sequence* member = (const rosidl_runtime_c__String__Sequence*)(untyped_member);
        return member->size;
    ...
    void*
    rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__get_function__ListParametersResult__prefixes(
        void* untyped_member,
        size_t index)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    bool
    rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__resize_function__ListParametersResult__prefixes(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_message_member_array[2] = {
            {
                "names",                                                       // name
    ...
    static rosidl_message_type_support_t
        rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_message_type_support_handle =
            {
                0,
                &rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_message_members,
    ...
    {
        if (!rcl_interfaces__msg__ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_message_type_support_handle
