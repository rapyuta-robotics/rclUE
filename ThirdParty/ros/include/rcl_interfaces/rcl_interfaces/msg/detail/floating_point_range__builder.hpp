...
{
public:
    explicit Init_FloatingPointRange_step(::rcl_interfaces::msg::FloatingPointRange& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_FloatingPointRange_to_value(::rcl_interfaces::msg::FloatingPointRange& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_FloatingPointRange_from_value() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::msg::FloatingPointRange>()
{
