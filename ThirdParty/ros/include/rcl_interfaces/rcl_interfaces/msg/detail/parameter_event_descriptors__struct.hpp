...
struct ParameterEventDescriptors_
{
    ...
    explicit ParameterEventDescriptors_(
    ...
    using _new_parameters_type = std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
    ...
    using _changed_parameters_type = std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                                 typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                     rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>;
    _changed_parameters_type changed_parameters;
    using _deleted_parameters_type = std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                                 typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                     rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>;
    _deleted_parameters_type deleted_parameters;

    // setters for named parameter idiom
    Type& set__new_parameters(const std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                                typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    Type& set__changed_parameters(const std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                                    typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                        rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>& _arg)
    {
    ...
    Type& set__deleted_parameters(const std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                                    typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                        rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::msg::ParameterEventDescriptors_<ContainerAllocator> const>;
...
using ParameterEventDescriptors = rcl_interfaces::msg::ParameterEventDescriptors_<std::allocator<void>>;
