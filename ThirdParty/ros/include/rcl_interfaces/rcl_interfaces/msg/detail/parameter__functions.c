...
bool rcl_interfaces__msg__Parameter__are_equal(const rcl_interfaces__msg__Parameter* lhs, const rcl_interfaces__msg__Parameter* rhs)
{
    ...
    // value
    if (!rcl_interfaces__msg__ParameterValue__are_equal(&(lhs->value), &(rhs->value)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__msg__Parameter__copy(const rcl_interfaces__msg__Parameter* input, rcl_interfaces__msg__Parameter* output)
{
    ...
    // value
    if (!rcl_interfaces__msg__ParameterValue__copy(&(input->value), &(output->value)))
    {
        return false;
    }
    return true;
...
rcl_interfaces__msg__Parameter* rcl_interfaces__msg__Parameter__create()
{
    ...
    rcl_interfaces__msg__Parameter* msg =
        (rcl_interfaces__msg__Parameter*)allocator.allocate(sizeof(rcl_interfaces__msg__Parameter), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__Parameter__Sequence__init(rcl_interfaces__msg__Parameter__Sequence* array, size_t size)
{
    ...
    {
        data =
            (rcl_interfaces__msg__Parameter*)allocator.zero_allocate(size, sizeof(rcl_interfaces__msg__Parameter), allocator.state);
        if (!data)
        {
            return false;
        }
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__msg__Parameter__Sequence* array = (rcl_interfaces__msg__Parameter__Sequence*)allocator.allocate(
        sizeof(rcl_interfaces__msg__Parameter__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__msg__Parameter__Sequence__are_equal(const rcl_interfaces__msg__Parameter__Sequence* lhs,
...
bool rcl_interfaces__msg__Parameter__Sequence__copy(const rcl_interfaces__msg__Parameter__Sequence* input,
                                                    rcl_interfaces__msg__Parameter__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__msg__Parameter);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__msg__Parameter* data =
            (rcl_interfaces__msg__Parameter*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__msg__Parameter__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
