...
inline void to_flow_style_yaml(const FloatingPointRange& msg, std::ostream& out)
{
    out << "{";
    // member: from_value
    {
...
inline void to_block_style_yaml(const FloatingPointRange& msg, std::ostream& out, size_t indentation = 0)
{
    // member: from_value
    {
        if (indentation > 0)
...
to_yaml(const rcl_interfaces::msg::FloatingPointRange& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<rcl_interfaces::msg::FloatingPointRange> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<rcl_interfaces::msg::FloatingPointRange> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<rcl_interfaces::msg::FloatingPointRange> : std::true_type
{
};
