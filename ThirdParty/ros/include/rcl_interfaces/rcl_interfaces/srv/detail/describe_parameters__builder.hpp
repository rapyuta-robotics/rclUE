...
{
public:
    Init_DescribeParameters_Request_names() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::DescribeParameters_Request>()
{
...
{
public:
    Init_DescribeParameters_Response_descriptors() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
    ::rcl_interfaces::srv::DescribeParameters_Response descriptors(
        ::rcl_interfaces::srv::DescribeParameters_Response::_descriptors_type arg)
    {
...
template<>
inline auto build<::rcl_interfaces::srv::DescribeParameters_Response>()
{
