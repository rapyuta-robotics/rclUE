...
bool rcl_interfaces__srv__DescribeParameters_Request__are_equal(const rcl_interfaces__srv__DescribeParameters_Request* lhs,
...
bool rcl_interfaces__srv__DescribeParameters_Request__copy(const rcl_interfaces__srv__DescribeParameters_Request* input,
...
rcl_interfaces__srv__DescribeParameters_Request* rcl_interfaces__srv__DescribeParameters_Request__create()
{
    ...
    rcl_interfaces__srv__DescribeParameters_Request* msg = (rcl_interfaces__srv__DescribeParameters_Request*)allocator.allocate(
        sizeof(rcl_interfaces__srv__DescribeParameters_Request), allocator.state);
    if (!msg)
    {
        return NULL;
    }
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (rcl_interfaces__srv__DescribeParameters_Request*)allocator.zero_allocate(
            size, sizeof(rcl_interfaces__srv__DescribeParameters_Request), allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__DescribeParameters_Request__Sequence* array =
        (rcl_interfaces__srv__DescribeParameters_Request__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__srv__DescribeParameters_Request__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__srv__DescribeParameters_Request__Sequence__are_equal(
...
bool rcl_interfaces__srv__DescribeParameters_Request__Sequence__copy(
    ...
    rcl_interfaces__srv__DescribeParameters_Request__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__srv__DescribeParameters_Request);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__srv__DescribeParameters_Request* data =
            (rcl_interfaces__srv__DescribeParameters_Request*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__srv__DescribeParameters_Request__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
...
bool rcl_interfaces__srv__DescribeParameters_Response__are_equal(const rcl_interfaces__srv__DescribeParameters_Response* lhs,
                                                                 const rcl_interfaces__srv__DescribeParameters_Response* rhs)
{
    ...
    // descriptors
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__are_equal(&(lhs->descriptors), &(rhs->descriptors)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__srv__DescribeParameters_Response__copy(const rcl_interfaces__srv__DescribeParameters_Response* input,
                                                            rcl_interfaces__srv__DescribeParameters_Response* output)
{
    ...
    // descriptors
    if (!rcl_interfaces__msg__ParameterDescriptor__Sequence__copy(&(input->descriptors), &(output->descriptors)))
    {
        return false;
    }
    return true;
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__DescribeParameters_Response* msg = (rcl_interfaces__srv__DescribeParameters_Response*)allocator.allocate(
        sizeof(rcl_interfaces__srv__DescribeParameters_Response), allocator.state);
    if (!msg)
    {
        return NULL;
    }
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (rcl_interfaces__srv__DescribeParameters_Response*)allocator.zero_allocate(
            size, sizeof(rcl_interfaces__srv__DescribeParameters_Response), allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__DescribeParameters_Response__Sequence* array =
        (rcl_interfaces__srv__DescribeParameters_Response__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__srv__DescribeParameters_Response__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__srv__DescribeParameters_Response__Sequence__are_equal(
...
bool rcl_interfaces__srv__DescribeParameters_Response__Sequence__copy(
    ...
    rcl_interfaces__srv__DescribeParameters_Response__Sequence* output)
{
    ...
    if (output->capacity < input->size)
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__srv__DescribeParameters_Response);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__srv__DescribeParameters_Response* data =
            (rcl_interfaces__srv__DescribeParameters_Response*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    for (size_t i = 0; i < input->size; ++i)
    {
        if (!rcl_interfaces__srv__DescribeParameters_Response__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
