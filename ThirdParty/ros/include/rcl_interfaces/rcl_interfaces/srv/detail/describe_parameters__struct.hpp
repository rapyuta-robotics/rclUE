...
struct DescribeParameters_Request_
{
    ...
    explicit DescribeParameters_Request_(
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator> const>;
...
using DescribeParameters_Request = rcl_interfaces::srv::DescribeParameters_Request_<std::allocator<void>>;
...
struct DescribeParameters_Response_
{
    ...
    explicit DescribeParameters_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
    {
        (void)_init;
    }
    ...
    // field types and members
    using _descriptors_type = std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                          typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                              rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>;
    _descriptors_type descriptors;

    // setters for named parameter idiom
    Type& set__descriptors(const std::vector<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>,
                                             typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                 rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::DescribeParameters_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using DescribeParameters_Response = rcl_interfaces::srv::DescribeParameters_Response_<std::allocator<void>>;
