...
extern "C"
{
    ...
    void rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__SetParameters_Request_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__size_function__SetParameters_Request__parameters(
        const void* untyped_member)
    {
        const rcl_interfaces__msg__Parameter__Sequence* member = (const rcl_interfaces__msg__Parameter__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void*
    rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__get_function__SetParameters_Request__parameters(
        void* untyped_member,
        size_t index)
    {
        rcl_interfaces__msg__Parameter__Sequence* member = (rcl_interfaces__msg__Parameter__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void
    rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__fetch_function__SetParameters_Request__parameters(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        ...
        rcl_interfaces__msg__Parameter* value = (rcl_interfaces__msg__Parameter*)(untyped_value);
        *value = *item;
    }

    void
    rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__assign_function__SetParameters_Request__parameters(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        rcl_interfaces__msg__Parameter* item =
            ((rcl_interfaces__msg__Parameter*)
                 rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__get_function__SetParameters_Request__parameters(
                     untyped_member, index));
        const rcl_interfaces__msg__Parameter* value = (const rcl_interfaces__msg__Parameter*)(untyped_value);
        *item = *value;
    }

    bool
    rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__resize_function__SetParameters_Request__parameters(
        void* untyped_member,
        size_t size)
    {
        rcl_interfaces__msg__Parameter__Sequence* member = (rcl_interfaces__msg__Parameter__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__SetParameters_Request_message_member_array[1] = {{
            "parameters",                                                        // name
    ...
    {
        rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__SetParameters_Request_message_member_array
            [0]
                .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, msg, Parameter)();
        if (!rcl_interfaces__srv__SetParameters_Request__rosidl_typesupport_introspection_c__SetParameters_Request_message_type_support_handle
...
extern "C"
{
    ...
    size_t
    rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__size_function__SetParameters_Response__results(
        const void* untyped_member)
    {
    ...
    void
    rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__fetch_function__SetParameters_Response__results(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        const rcl_interfaces__msg__SetParametersResult* item =
            ((const rcl_interfaces__msg__SetParametersResult*)
                 rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__get_const_function__SetParameters_Response__results(
                     untyped_member, index));
        rcl_interfaces__msg__SetParametersResult* value = (rcl_interfaces__msg__SetParametersResult*)(untyped_value);
        *value = *item;
    }

    void
    rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__assign_function__SetParameters_Response__results(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        rcl_interfaces__msg__SetParametersResult* item =
            ((rcl_interfaces__msg__SetParametersResult*)
                 rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__get_function__SetParameters_Response__results(
                     untyped_member, index));
        const rcl_interfaces__msg__SetParametersResult* value = (const rcl_interfaces__msg__SetParametersResult*)(untyped_value);
        *item = *value;
    }

    bool
    rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__resize_function__SetParameters_Response__results(
        void* untyped_member,
        size_t size)
    {
        rcl_interfaces__msg__SetParametersResult__Sequence* member =
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__SetParameters_Response_message_member_array[1] = {{
            "results",                                                         // name
            rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,              // type
            0,                                                                 // upper bound of string
            NULL,                                                              // members of sub message (initialized later)
                                                      ...
                                                      SetParameters_Response)()
    {
        rcl_interfaces__srv__SetParameters_Response__rosidl_typesupport_introspection_c__SetParameters_Response_message_member_array
            ...
            rosidl_typesupport_introspection_c, rcl_interfaces, msg, SetParametersResult)();
...
{
    if (!rcl_interfaces__srv__detail__set_parameters__rosidl_typesupport_introspection_c__SetParameters_service_type_support_handle
             .typesupport_identifier)
    {
        rcl_interfaces__srv__detail__set_parameters__rosidl_typesupport_introspection_c__SetParameters_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, SetParameters_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, SetParameters_Response)()
                ->data;
    }
