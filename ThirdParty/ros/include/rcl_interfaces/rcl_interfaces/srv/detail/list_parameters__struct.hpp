...
struct ListParameters_Request_
{
    ...
    explicit ListParameters_Request_(
    ...
    static constexpr uint64_t DEPTH_RECURSIVE = 0u;

    // pointer types
    using RawPtr = rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::ListParameters_Request_<ContainerAllocator> const>;
...
using ListParameters_Request = rcl_interfaces::srv::ListParameters_Request_<std::allocator<void>>;
...
struct ListParameters_Response_
{
    ...
    explicit ListParameters_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : result(_init)
    {
        (void)_init;
    ...
    // field types and members
    using _result_type = rcl_interfaces::msg::ListParametersResult_<ContainerAllocator>;
    _result_type result;
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::ListParameters_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using ListParameters_Response = rcl_interfaces::srv::ListParameters_Response_<std::allocator<void>>;
