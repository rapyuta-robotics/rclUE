...
extern "C"
{
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__GetParameterTypes_Request_init_function(
        void* message_memory,
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__GetParameterTypes_Request_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__size_function__GetParameterTypes_Request__names(
    ...
    const void*
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__get_const_function__GetParameterTypes_Request__names(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__String__Sequence* member = (const rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    void*
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__get_function__GetParameterTypes_Request__names(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__fetch_function__GetParameterTypes_Request__names(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__assign_function__GetParameterTypes_Request__names(
        void* untyped_member,
        size_t index,
    ...
    bool
    rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__resize_function__GetParameterTypes_Request__names(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__GetParameterTypes_Request_message_member_array
        [1] = {{
            "names",                                                            // name
    ...
    {
        if (!rcl_interfaces__srv__GetParameterTypes_Request__rosidl_typesupport_introspection_c__GetParameterTypes_Request_message_type_support_handle
...
extern "C"
{
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__GetParameterTypes_Response_init_function(
        void* message_memory,
        enum rosidl_runtime_c__message_initialization _init)
    {
        // TODO(karsten1987): initializers are not yet implemented for typesupport c
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__GetParameterTypes_Response_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__size_function__GetParameterTypes_Response__types(
        const void* untyped_member)
    {
        const rosidl_runtime_c__uint8__Sequence* member = (const rosidl_runtime_c__uint8__Sequence*)(untyped_member);
        return member->size;
    }

    const void*
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__get_const_function__GetParameterTypes_Response__types(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__uint8__Sequence* member = (const rosidl_runtime_c__uint8__Sequence*)(untyped_member);
    ...
    void*
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__get_function__GetParameterTypes_Response__types(
        void* untyped_member,
        size_t index)
    {
        rosidl_runtime_c__uint8__Sequence* member = (rosidl_runtime_c__uint8__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__fetch_function__GetParameterTypes_Response__types(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__assign_function__GetParameterTypes_Response__types(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
    ...
    bool
    rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__resize_function__GetParameterTypes_Response__types(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__uint8__Sequence* member = (rosidl_runtime_c__uint8__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__GetParameterTypes_Response_message_member_array
        [1] = {{
            "types",                                                             // name
    ...
    {
        if (!rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__GetParameterTypes_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            rcl_interfaces__srv__GetParameterTypes_Response__rosidl_typesupport_introspection_c__GetParameterTypes_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameterTypes)()
{
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameterTypes_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameterTypes_Response)()
                ->data;
    }
