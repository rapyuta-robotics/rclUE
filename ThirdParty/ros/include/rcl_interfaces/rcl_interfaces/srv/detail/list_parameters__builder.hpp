...
{
public:
    explicit Init_ListParameters_Request_depth(::rcl_interfaces::srv::ListParameters_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_ListParameters_Request_prefixes() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::ListParameters_Request>()
{
...
{
public:
    Init_ListParameters_Response_result() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::ListParameters_Response>()
{
