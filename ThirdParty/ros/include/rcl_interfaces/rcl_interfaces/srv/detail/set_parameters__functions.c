...
bool rcl_interfaces__srv__SetParameters_Request__are_equal(const rcl_interfaces__srv__SetParameters_Request* lhs,
                                                           const rcl_interfaces__srv__SetParameters_Request* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__srv__SetParameters_Request__copy(const rcl_interfaces__srv__SetParameters_Request* input,
...
rcl_interfaces__srv__SetParameters_Request* rcl_interfaces__srv__SetParameters_Request__create()
{
    ...
    rcl_interfaces__srv__SetParameters_Request* msg = (rcl_interfaces__srv__SetParameters_Request*)allocator.allocate(
        sizeof(rcl_interfaces__srv__SetParameters_Request), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool rcl_interfaces__srv__SetParameters_Request__Sequence__init(rcl_interfaces__srv__SetParameters_Request__Sequence* array,
                                                                size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (rcl_interfaces__srv__SetParameters_Request*)allocator.zero_allocate(
            size, sizeof(rcl_interfaces__srv__SetParameters_Request), allocator.state);
        if (!data)
        {
            return false;
        }
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__SetParameters_Request__Sequence* array =
        (rcl_interfaces__srv__SetParameters_Request__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__srv__SetParameters_Request__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__srv__SetParameters_Request__Sequence__are_equal(
    const rcl_interfaces__srv__SetParameters_Request__Sequence* lhs,
    const rcl_interfaces__srv__SetParameters_Request__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__srv__SetParameters_Request__Sequence__copy(const rcl_interfaces__srv__SetParameters_Request__Sequence* input,
                                                                rcl_interfaces__srv__SetParameters_Request__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__srv__SetParameters_Request);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__srv__SetParameters_Request* data =
            (rcl_interfaces__srv__SetParameters_Request*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!rcl_interfaces__srv__SetParameters_Request__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
...
bool rcl_interfaces__srv__SetParameters_Response__are_equal(const rcl_interfaces__srv__SetParameters_Response* lhs,
                                                            const rcl_interfaces__srv__SetParameters_Response* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // results
    if (!rcl_interfaces__msg__SetParametersResult__Sequence__are_equal(&(lhs->results), &(rhs->results)))
    {
        return false;
    }
    return true;
...
bool rcl_interfaces__srv__SetParameters_Response__copy(const rcl_interfaces__srv__SetParameters_Response* input,
                                                       rcl_interfaces__srv__SetParameters_Response* output)
{
    ...
    // results
    if (!rcl_interfaces__msg__SetParametersResult__Sequence__copy(&(input->results), &(output->results)))
    {
        return false;
    }
    return true;
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__SetParameters_Response* msg = (rcl_interfaces__srv__SetParameters_Response*)allocator.allocate(
        sizeof(rcl_interfaces__srv__SetParameters_Response), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool rcl_interfaces__srv__SetParameters_Response__Sequence__init(rcl_interfaces__srv__SetParameters_Response__Sequence* array,
                                                                 size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (rcl_interfaces__srv__SetParameters_Response*)allocator.zero_allocate(
            size, sizeof(rcl_interfaces__srv__SetParameters_Response), allocator.state);
        if (!data)
        {
            return false;
        }
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__SetParameters_Response__Sequence* array =
        (rcl_interfaces__srv__SetParameters_Response__Sequence*)allocator.allocate(
            sizeof(rcl_interfaces__srv__SetParameters_Response__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool rcl_interfaces__srv__SetParameters_Response__Sequence__are_equal(
    const rcl_interfaces__srv__SetParameters_Response__Sequence* lhs,
    const rcl_interfaces__srv__SetParameters_Response__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool rcl_interfaces__srv__SetParameters_Response__Sequence__copy(const rcl_interfaces__srv__SetParameters_Response__Sequence* input,
                                                                 rcl_interfaces__srv__SetParameters_Response__Sequence* output)
{
    ...
    if (output->capacity < input->size)
    {
        const size_t allocation_size = input->size * sizeof(rcl_interfaces__srv__SetParameters_Response);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        rcl_interfaces__srv__SetParameters_Response* data =
            (rcl_interfaces__srv__SetParameters_Response*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    for (size_t i = 0; i < input->size; ++i)
    {
        if (!rcl_interfaces__srv__SetParameters_Response__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
