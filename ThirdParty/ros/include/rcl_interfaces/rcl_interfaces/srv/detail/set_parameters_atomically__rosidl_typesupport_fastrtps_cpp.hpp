...
cdr_serialize(const rcl_interfaces::srv::SetParametersAtomically_Request& ros_message, eprosima::fastcdr::Cdr& cdr);

bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
cdr_deserialize(eprosima::fastcdr::Cdr& cdr, rcl_interfaces::srv::SetParametersAtomically_Request& ros_message);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
get_serialized_size(const rcl_interfaces::srv::SetParametersAtomically_Request& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
max_serialized_size_SetParametersAtomically_Request(bool& full_bounded, bool& is_plain, size_t current_alignment);
...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
cdr_serialize(const rcl_interfaces::srv::SetParametersAtomically_Response& ros_message, eprosima::fastcdr::Cdr& cdr);

bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
cdr_deserialize(eprosima::fastcdr::Cdr& cdr, rcl_interfaces::srv::SetParametersAtomically_Response& ros_message);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
get_serialized_size(const rcl_interfaces::srv::SetParametersAtomically_Response& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rcl_interfaces
max_serialized_size_SetParametersAtomically_Response(bool& full_bounded, bool& is_plain, size_t current_alignment);
