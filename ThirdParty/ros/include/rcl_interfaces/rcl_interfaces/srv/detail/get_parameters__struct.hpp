...
struct GetParameters_Request_
{
    ...
    explicit GetParameters_Request_(
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameters_Request_<ContainerAllocator> const>;
...
using GetParameters_Request = rcl_interfaces::srv::GetParameters_Request_<std::allocator<void>>;
...
struct GetParameters_Response_
{
    ...
    explicit GetParameters_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
    {
        (void)_init;
    }
    ...
    // field types and members
    using _values_type = std::vector<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>,
                                     typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                         rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>>;
    _values_type values;

    // setters for named parameter idiom
    Type& set__values(const std::vector<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>,
                                        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                            rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>>& _arg)
    {
        this->values = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameters_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using GetParameters_Response = rcl_interfaces::srv::GetParameters_Response_<std::allocator<void>>;
