...
extern "C"
{
    ...
    void
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__SetParametersAtomically_Request_init_function(
        void* message_memory,
    ...
    void
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__SetParametersAtomically_Request_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__size_function__SetParametersAtomically_Request__parameters(
    ...
    void*
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__get_function__SetParametersAtomically_Request__parameters(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__fetch_function__SetParametersAtomically_Request__parameters(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__assign_function__SetParametersAtomically_Request__parameters(
        void* untyped_member,
        size_t index,
    ...
    bool
    rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__resize_function__SetParametersAtomically_Request__parameters(
        void* untyped_member,
        size_t size)
    {
        rcl_interfaces__msg__Parameter__Sequence* member = (rcl_interfaces__msg__Parameter__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__SetParametersAtomically_Request_message_member_array
        [1] = {{
            "parameters",                                            // name
    ...
    {
        rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__SetParametersAtomically_Request_message_member_array
            [0]
                .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, msg, Parameter)();
        if (!rcl_interfaces__srv__SetParametersAtomically_Request__rosidl_typesupport_introspection_c__SetParametersAtomically_Request_message_type_support_handle
...
extern "C"
{
    ...
    void
    rcl_interfaces__srv__SetParametersAtomically_Response__rosidl_typesupport_introspection_c__SetParametersAtomically_Response_init_function(
        void* message_memory,
        enum rosidl_runtime_c__message_initialization _init)
    {
        // TODO(karsten1987): initializers are not yet implemented for typesupport c
    ...
    void
    rcl_interfaces__srv__SetParametersAtomically_Response__rosidl_typesupport_introspection_c__SetParametersAtomically_Response_fini_function(
        void* message_memory)
    {
...
{
    if (!rcl_interfaces__srv__detail__set_parameters_atomically__rosidl_typesupport_introspection_c__SetParametersAtomically_service_type_support_handle
             .typesupport_identifier)
    {
        rcl_interfaces__srv__detail__set_parameters_atomically__rosidl_typesupport_introspection_c__SetParametersAtomically_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, SetParametersAtomically_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, SetParametersAtomically_Response)()
                ->data;
    }
