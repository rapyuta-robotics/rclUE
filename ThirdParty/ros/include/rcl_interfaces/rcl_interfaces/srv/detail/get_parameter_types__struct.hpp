...
struct GetParameterTypes_Request_
{
    ...
    explicit GetParameterTypes_Request_(
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameterTypes_Request_<ContainerAllocator> const>;
...
using GetParameterTypes_Request = rcl_interfaces::srv::GetParameterTypes_Request_<std::allocator<void>>;
...
struct GetParameterTypes_Response_
{
    ...
    explicit GetParameterTypes_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
    {
        (void)_init;
    }
    ...
    // field types and members
    using _types_type = std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>>;
    _types_type types;
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::GetParameterTypes_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using GetParameterTypes_Response = rcl_interfaces::srv::GetParameterTypes_Response_<std::allocator<void>>;
