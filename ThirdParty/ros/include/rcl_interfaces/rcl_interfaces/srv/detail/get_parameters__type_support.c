...
extern "C"
{
    ...
    void rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__GetParameters_Request_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__size_function__GetParameters_Request__names(
    ...
    const void*
    rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Request__names(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__String__Sequence* member = (const rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    void*
    rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__get_function__GetParameters_Request__names(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__fetch_function__GetParameters_Request__names(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__assign_function__GetParameters_Request__names(
        void* untyped_member,
        size_t index,
    ...
    bool
    rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__resize_function__GetParameters_Request__names(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__GetParameters_Request_message_member_array[1] = {{
            "names",                                                        // name
    ...
    {
        if (!rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__GetParameters_Request_message_type_support_handle
...
extern "C"
{
    ...
    void rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__GetParameters_Response_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__size_function__GetParameters_Response__values(
        const void* untyped_member)
    {
    ...
    void*
    rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__get_function__GetParameters_Response__values(
        void* untyped_member,
        size_t index)
    {
        rcl_interfaces__msg__ParameterValue__Sequence* member = (rcl_interfaces__msg__ParameterValue__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void
    rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__fetch_function__GetParameters_Response__values(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        const rcl_interfaces__msg__ParameterValue* item =
            ((const rcl_interfaces__msg__ParameterValue*)
                 rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Response__values(
                     untyped_member, index));
        rcl_interfaces__msg__ParameterValue* value = (rcl_interfaces__msg__ParameterValue*)(untyped_value);
        *value = *item;
    }

    void
    rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__assign_function__GetParameters_Response__values(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        rcl_interfaces__msg__ParameterValue* item =
            ((rcl_interfaces__msg__ParameterValue*)
                 rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__get_function__GetParameters_Response__values(
                     untyped_member, index));
        const rcl_interfaces__msg__ParameterValue* value = (const rcl_interfaces__msg__ParameterValue*)(untyped_value);
        *item = *value;
    }

    bool
    rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__resize_function__GetParameters_Response__values(
        void* untyped_member,
        size_t size)
    {
        rcl_interfaces__msg__ParameterValue__Sequence* member = (rcl_interfaces__msg__ParameterValue__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__GetParameters_Response_message_member_array[1] = {{
            "values",                                                         // name
                                                      ...
                                                      GetParameters_Response)()
    {
        rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__GetParameters_Response_message_member_array
            ...
            rosidl_typesupport_introspection_c, rcl_interfaces, msg, ParameterValue)();
        if (!rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__GetParameters_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__GetParameters_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
{
    if (!rcl_interfaces__srv__detail__get_parameters__rosidl_typesupport_introspection_c__GetParameters_service_type_support_handle
             .typesupport_identifier)
    {
        rcl_interfaces__srv__detail__get_parameters__rosidl_typesupport_introspection_c__GetParameters_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Response)()
                ->data;
    }
