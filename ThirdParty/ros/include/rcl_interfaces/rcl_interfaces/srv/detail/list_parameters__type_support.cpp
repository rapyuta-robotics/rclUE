...
void ListParameters_Request_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__ListParameters_Request__prefixes(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__ListParameters_Request__prefixes(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__ListParameters_Request__prefixes(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__ListParameters_Request__prefixes(untyped_member, index));
...
void ListParameters_Response_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ListParameters_Response_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        rcl_interfaces::msg::ListParametersResult>(),                  // members of sub message
    false,                                                             // is array
    0,                                                                 // array size
    false,                                                             // is upper bound
