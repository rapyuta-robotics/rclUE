...
{
public:
    Init_GetParameterTypes_Request_names() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::GetParameterTypes_Request>()
{
...
{
public:
    Init_GetParameterTypes_Response_types() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::GetParameterTypes_Response>()
{
