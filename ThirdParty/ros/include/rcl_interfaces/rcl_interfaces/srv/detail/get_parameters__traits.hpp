...
inline void to_flow_style_yaml(const GetParameters_Request& msg, std::ostream& out)
{
    out << "{";
    // member: names
    {
...
inline void to_block_style_yaml(const GetParameters_Request& msg, std::ostream& out, size_t indentation = 0)
{
    // member: names
    {
        if (indentation > 0)
...
to_yaml(const rcl_interfaces::srv::GetParameters_Request& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<rcl_interfaces::srv::GetParameters_Request> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<rcl_interfaces::srv::GetParameters_Request> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<rcl_interfaces::srv::GetParameters_Request> : std::true_type
{
};
...
inline void to_flow_style_yaml(const GetParameters_Response& msg, std::ostream& out)
{
    out << "{";
    // member: values
    {
...
inline void to_block_style_yaml(const GetParameters_Response& msg, std::ostream& out, size_t indentation = 0)
{
    // member: values
    {
        if (indentation > 0)
...
[[deprecated("use rcl_interfaces::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const rcl_interfaces::srv::GetParameters_Response& msg, std::ostream& out, size_t indentation = 0)
{
    rcl_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
template<>
struct has_fixed_size<rcl_interfaces::srv::GetParameters_Response> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<rcl_interfaces::srv::GetParameters_Response> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<rcl_interfaces::srv::GetParameters_Response> : std::true_type
{
};
...
template<>
struct is_service<rcl_interfaces::srv::GetParameters> : std::true_type
{
};

template<>
struct is_service_request<rcl_interfaces::srv::GetParameters_Request> : std::true_type
{
};

template<>
struct is_service_response<rcl_interfaces::srv::GetParameters_Response> : std::true_type
{
};
