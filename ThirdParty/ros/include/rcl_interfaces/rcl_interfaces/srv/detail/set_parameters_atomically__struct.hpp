...
struct SetParametersAtomically_Request_
{
    ...
    explicit SetParametersAtomically_Request_(
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::SetParametersAtomically_Request_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::SetParametersAtomically_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::SetParametersAtomically_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::SetParametersAtomically_Request_<ContainerAllocator> const>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::SetParametersAtomically_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::SetParametersAtomically_Request_<ContainerAllocator> const>;
...
using SetParametersAtomically_Request = rcl_interfaces::srv::SetParametersAtomically_Request_<std::allocator<void>>;
...
struct SetParametersAtomically_Response_
{
    ...
    explicit SetParametersAtomically_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : result(_init)
    {
        (void)_init;
    ...
    // field types and members
    using _result_type = rcl_interfaces::msg::SetParametersResult_<ContainerAllocator>;
    _result_type result;
    ...
    // pointer types
    using RawPtr = rcl_interfaces::srv::SetParametersAtomically_Response_<ContainerAllocator>*;
    using ConstRawPtr = const rcl_interfaces::srv::SetParametersAtomically_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rcl_interfaces::srv::SetParametersAtomically_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rcl_interfaces::srv::SetParametersAtomically_Response_<ContainerAllocator> const>;
    ...
    using WeakPtr = std::weak_ptr<rcl_interfaces::srv::SetParametersAtomically_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rcl_interfaces::srv::SetParametersAtomically_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using SetParametersAtomically_Response = rcl_interfaces::srv::SetParametersAtomically_Response_<std::allocator<void>>;
