...
void SetParameters_Request_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__SetParameters_Request__parameters(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__SetParameters_Request__parameters(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<rcl_interfaces::msg::Parameter*>(get_function__SetParameters_Request__parameters(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParameters_Request_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rcl_interfaces::msg::Parameter>(),    // members of sub
                                                                                                                  // message
    true,                                                                                                         // is array
    0,                                                                                                            // array size
...
void SetParameters_Response_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<rcl_interfaces::msg::SetParametersResult>*>(untyped_member);
    return &member[index];
}

void fetch_function__SetParameters_Response__results(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__SetParameters_Response__results(void* untyped_member, size_t index, const void* untyped_value)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParameters_Response_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        rcl_interfaces::msg::SetParametersResult>(),                   // members of sub message
    true,                                                              // is array
    0,                                                                 // array size
    false,                                                             // is upper bound
