...
{
public:
    Init_SetParameters_Request_parameters() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::SetParameters_Request>()
{
...
{
public:
    Init_SetParameters_Response_results() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rcl_interfaces::srv::SetParameters_Response>()
{
