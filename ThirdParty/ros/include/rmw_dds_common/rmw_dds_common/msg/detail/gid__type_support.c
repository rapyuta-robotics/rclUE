...
extern "C"
{
    ...
    size_t rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__size_function__Gid__data(const void* untyped_member)
    {
        (void)untyped_member;
        return 24;
    }
    ...
    const void* rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__get_const_function__Gid__data(
        ...
        size_t index)
    {
        const uint8_t* member = (const uint8_t*)(untyped_member);
        return &member[index];
    }

    void* rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__get_function__Gid__data(void* untyped_member, size_t index)
    {
        uint8_t* member = (uint8_t*)(untyped_member);
        return &member[index];
    }

    void rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__fetch_function__Gid__data(const void* untyped_member,
                                                                                                 size_t index,
                                                                                                 void* untyped_value)
    {
        const uint8_t* item =
            ((const uint8_t*)rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__get_const_function__Gid__data(
                untyped_member, index));
        uint8_t* value = (uint8_t*)(untyped_value);
        *value = *item;
    }

    void rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__assign_function__Gid__data(void* untyped_member,
                                                                                                  size_t index,
                                                                                                  const void* untyped_value)
    {
        uint8_t* item = ((uint8_t*)rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__get_function__Gid__data(
            untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__Gid_message_member_array[1] = {{
            "data",                                                                                    // name
            ...
            rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__get_const_function__Gid__data,    // get_const(index)
                                                                                                            // function pointer
            rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__get_function__Gid__data,    // get(index) function pointer
            rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__fetch_function__Gid__data,     // fetch(index, &value)
                                                                                                         // function pointer
            rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__assign_function__Gid__data,    // assign(index, value)
                                                                                                         // function pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__Gid_message_members = {
            ...
            rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__Gid_init_function,    // function to initialize message
                                                                                                // memory (memory has to be
                                                                                                // allocated)
            rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__Gid_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__Gid_message_type_support_handle = {
            0,
            &rmw_dds_common__msg__Gid__rosidl_typesupport_introspection_c__Gid_message_members,
