...
void ParticipantEntitiesInfo_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<rmw_dds_common::msg::NodeEntitiesInfo>*>(untyped_member);
    return &member[index];
}

void fetch_function__ParticipantEntitiesInfo__node_entities_info_seq(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__ParticipantEntitiesInfo__node_entities_info_seq(void* untyped_member, size_t index, const void* untyped_value)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ParticipantEntitiesInfo_message_member_array[2] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            rmw_dds_common::msg::NodeEntitiesInfo>(),                                      // members of sub message
        true,                                                                              // is array
        0,                                                                                 // array size
        false,                                                                             // is upper bound
