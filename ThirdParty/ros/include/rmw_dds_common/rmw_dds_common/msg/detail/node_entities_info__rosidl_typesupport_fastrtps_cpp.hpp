...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rmw_dds_common cdr_serialize(const rmw_dds_common::msg::NodeEntitiesInfo& ros_message,
                                                                         eprosima::fastcdr::Cdr& cdr);

bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rmw_dds_common cdr_deserialize(eprosima::fastcdr::Cdr& cdr,
                                                                           rmw_dds_common::msg::NodeEntitiesInfo& ros_message);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rmw_dds_common
get_serialized_size(const rmw_dds_common::msg::NodeEntitiesInfo& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rmw_dds_common max_serialized_size_NodeEntitiesInfo(bool& full_bounded,
                                                                                                  bool& is_plain,
