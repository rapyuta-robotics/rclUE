...
struct ParticipantEntitiesInfo_
{
    ...
    explicit ParticipantEntitiesInfo_(
    ...
    using _gid_type = rmw_dds_common::msg::Gid_<ContainerAllocator>;
    _gid_type gid;
    using _node_entities_info_seq_type = std::vector<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>,
    ...
    Type& set__gid(const rmw_dds_common::msg::Gid_<ContainerAllocator>& _arg)
    {
        this->gid = _arg;
        return *this;
    }
    Type& set__node_entities_info_seq(const std::vector<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>,
                                                        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                            rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator>*;
    using ConstRawPtr = const rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rmw_dds_common::msg::ParticipantEntitiesInfo_<ContainerAllocator> const>;
...
using ParticipantEntitiesInfo = rmw_dds_common::msg::ParticipantEntitiesInfo_<std::allocator<void>>;
