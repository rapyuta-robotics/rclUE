...
inline void to_flow_style_yaml(const ParticipantEntitiesInfo& msg, std::ostream& out)
{
    out << "{";
    // member: gid
    {
...
inline void to_block_style_yaml(const ParticipantEntitiesInfo& msg, std::ostream& out, size_t indentation = 0)
{
    // member: gid
    {
        if (indentation > 0)
...
to_yaml(const rmw_dds_common::msg::ParticipantEntitiesInfo& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<rmw_dds_common::msg::ParticipantEntitiesInfo> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<rmw_dds_common::msg::ParticipantEntitiesInfo> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<rmw_dds_common::msg::ParticipantEntitiesInfo> : std::true_type
{
};
