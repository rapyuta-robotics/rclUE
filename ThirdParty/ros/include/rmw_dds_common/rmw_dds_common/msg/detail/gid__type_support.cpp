...
void Gid_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    const auto& member = *reinterpret_cast<const std::array<uint8_t, 24>*>(untyped_member);
    return &member[index];
}

void* get_function__Gid__data(void* untyped_member, size_t index)
{
    auto& member = *reinterpret_cast<std::array<uint8_t, 24>*>(untyped_member);
    return &member[index];
}

void fetch_function__Gid__data(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const uint8_t*>(get_const_function__Gid__data(untyped_member, index));
    auto& value = *reinterpret_cast<uint8_t*>(untyped_value);
    value = item;
}

void assign_function__Gid__data(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<uint8_t*>(get_function__Gid__data(untyped_member, index));
