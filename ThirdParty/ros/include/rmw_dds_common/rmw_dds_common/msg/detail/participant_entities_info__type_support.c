...
extern "C"
{
    ...
    void rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__ParticipantEntitiesInfo_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__size_function__ParticipantEntitiesInfo__node_entities_info_seq(
    ...
    void*
    rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__get_function__ParticipantEntitiesInfo__node_entities_info_seq(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__fetch_function__ParticipantEntitiesInfo__node_entities_info_seq(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        ...
        rmw_dds_common__msg__NodeEntitiesInfo* value = (rmw_dds_common__msg__NodeEntitiesInfo*)(untyped_value);
        *value = *item;
    }

    void
    rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__assign_function__ParticipantEntitiesInfo__node_entities_info_seq(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        rmw_dds_common__msg__NodeEntitiesInfo* item =
            ((rmw_dds_common__msg__NodeEntitiesInfo*)
                 rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__get_function__ParticipantEntitiesInfo__node_entities_info_seq(
                     untyped_member, index));
        const rmw_dds_common__msg__NodeEntitiesInfo* value = (const rmw_dds_common__msg__NodeEntitiesInfo*)(untyped_value);
        *item = *value;
    }

    bool
    rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__resize_function__ParticipantEntitiesInfo__node_entities_info_seq(
        void* untyped_member,
        size_t size)
    {
        rmw_dds_common__msg__NodeEntitiesInfo__Sequence* member =
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__ParticipantEntitiesInfo_message_member_array[2] = {
            {
                "gid",                                                          // name
    ...
    static rosidl_message_type_support_t
        rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__ParticipantEntitiesInfo_message_type_support_handle =
            {
                0,
                &rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__ParticipantEntitiesInfo_message_members,
                                                      ...
                                                      ParticipantEntitiesInfo)()
    {
        ...
        rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__ParticipantEntitiesInfo_message_member_array
            ...
            rosidl_typesupport_introspection_c, rmw_dds_common, msg, NodeEntitiesInfo)();
        if (!rmw_dds_common__msg__ParticipantEntitiesInfo__rosidl_typesupport_introspection_c__ParticipantEntitiesInfo_message_type_support_handle
