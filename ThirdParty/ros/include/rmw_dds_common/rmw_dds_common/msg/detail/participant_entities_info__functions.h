...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common bool rmw_dds_common__msg__ParticipantEntitiesInfo__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common void rmw_dds_common__msg__ParticipantEntitiesInfo__fini(
        rmw_dds_common__msg__ParticipantEntitiesInfo* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common rmw_dds_common__msg__ParticipantEntitiesInfo*
    rmw_dds_common__msg__ParticipantEntitiesInfo__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common void rmw_dds_common__msg__ParticipantEntitiesInfo__destroy(
        rmw_dds_common__msg__ParticipantEntitiesInfo* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common bool rmw_dds_common__msg__ParticipantEntitiesInfo__are_equal(
        const rmw_dds_common__msg__ParticipantEntitiesInfo* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common bool rmw_dds_common__msg__ParticipantEntitiesInfo__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common bool rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common void rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence__fini(
        rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common void rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence__destroy(
        rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common bool rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_rmw_dds_common bool rmw_dds_common__msg__ParticipantEntitiesInfo__Sequence__copy(
