...
{
public:
    explicit Init_NodeEntitiesInfo_writer_gid_seq(::rmw_dds_common::msg::NodeEntitiesInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NodeEntitiesInfo_reader_gid_seq(::rmw_dds_common::msg::NodeEntitiesInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_NodeEntitiesInfo_node_name(::rmw_dds_common::msg::NodeEntitiesInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_NodeEntitiesInfo_node_namespace() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::rmw_dds_common::msg::NodeEntitiesInfo>()
{
