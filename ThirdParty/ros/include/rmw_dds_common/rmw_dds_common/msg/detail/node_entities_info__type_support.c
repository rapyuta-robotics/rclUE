...
extern "C"
{
    ...
    void rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_fini_function(
        void* message_memory)
    {
    ...
    size_t
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__size_function__NodeEntitiesInfo__reader_gid_seq(
        const void* untyped_member)
    {
        const rmw_dds_common__msg__Gid__Sequence* member = (const rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
        return member->size;
    }

    const void*
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__get_const_function__NodeEntitiesInfo__reader_gid_seq(
        const void* untyped_member,
        size_t index)
    {
        const rmw_dds_common__msg__Gid__Sequence* member = (const rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
    ...
    void* rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__get_function__NodeEntitiesInfo__reader_gid_seq(
        ...
        size_t index)
    {
        rmw_dds_common__msg__Gid__Sequence* member = (rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__fetch_function__NodeEntitiesInfo__reader_gid_seq(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        ...
        rmw_dds_common__msg__Gid* value = (rmw_dds_common__msg__Gid*)(untyped_value);
        *value = *item;
    }

    void
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__assign_function__NodeEntitiesInfo__reader_gid_seq(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        rmw_dds_common__msg__Gid* item =
            ((rmw_dds_common__msg__Gid*)
                 rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__get_function__NodeEntitiesInfo__reader_gid_seq(
                     untyped_member, index));
        const rmw_dds_common__msg__Gid* value = (const rmw_dds_common__msg__Gid*)(untyped_value);
        *item = *value;
    }

    bool
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__resize_function__NodeEntitiesInfo__reader_gid_seq(
        void* untyped_member,
        size_t size)
    {
        rmw_dds_common__msg__Gid__Sequence* member = (rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
    ...
    size_t
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__size_function__NodeEntitiesInfo__writer_gid_seq(
        const void* untyped_member)
    {
        const rmw_dds_common__msg__Gid__Sequence* member = (const rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
        return member->size;
    ...
    const void*
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__get_const_function__NodeEntitiesInfo__writer_gid_seq(
        const void* untyped_member,
        size_t index)
    {
        const rmw_dds_common__msg__Gid__Sequence* member = (const rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
    ...
    void
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__fetch_function__NodeEntitiesInfo__writer_gid_seq(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__assign_function__NodeEntitiesInfo__writer_gid_seq(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        rmw_dds_common__msg__Gid* item =
            ((rmw_dds_common__msg__Gid*)
                 rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__get_function__NodeEntitiesInfo__writer_gid_seq(
                     untyped_member, index));
        const rmw_dds_common__msg__Gid* value = (const rmw_dds_common__msg__Gid*)(untyped_value);
        *item = *value;
    }
    ...
    bool
    rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__resize_function__NodeEntitiesInfo__writer_gid_seq(
        void* untyped_member,
        size_t size)
    {
        rmw_dds_common__msg__Gid__Sequence* member = (rmw_dds_common__msg__Gid__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_member_array[4] = {
            {
                "node_namespace",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_members = {
            ...
            rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_init_function,    // function
                                                                                                                          // to
                                                                                                                          // initialize
                                                                                                                          // message
                                                                                                                          // memory
                                                                                                                          ...
                                                                                                                          // be
                                                                                                                          // allocated)
            rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_fini_function    // function
                                                                                                                         // to
                                                                                                                         // terminate
                                                                                                                         // message
                                                                                                                         // instance
    ...
    static rosidl_message_type_support_t
        rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_type_support_handle = {
            0,
            &rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_members,
            get_message_typesupport_handle_function,
    };

    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rmw_dds_common const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmw_dds_common, msg, NodeEntitiesInfo)()
    {
        rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_member_array[2]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmw_dds_common, msg, Gid)();
        rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_member_array[3]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmw_dds_common, msg, Gid)();
        if (!rmw_dds_common__msg__NodeEntitiesInfo__rosidl_typesupport_introspection_c__NodeEntitiesInfo_message_type_support_handle
