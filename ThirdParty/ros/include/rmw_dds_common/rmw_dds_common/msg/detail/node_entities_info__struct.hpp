...
struct NodeEntitiesInfo_
{
    ...
    explicit NodeEntitiesInfo_(const ContainerAllocator& _alloc,
                               rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : node_namespace(_alloc), node_name(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->node_namespace = "";
    ...
    using _node_namespace_type = std::
    ...
    using _node_name_type = std::
        basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
    _node_name_type node_name;
    using _reader_gid_seq_type = std::vector<
        rmw_dds_common::msg::Gid_<ContainerAllocator>,
        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rmw_dds_common::msg::Gid_<ContainerAllocator>>>;
    _reader_gid_seq_type reader_gid_seq;
    using _writer_gid_seq_type = std::vector<
        rmw_dds_common::msg::Gid_<ContainerAllocator>,
        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rmw_dds_common::msg::Gid_<ContainerAllocator>>>;
    ...
    Type& set__reader_gid_seq(const std::vector<rmw_dds_common::msg::Gid_<ContainerAllocator>,
                                                typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                    rmw_dds_common::msg::Gid_<ContainerAllocator>>>& _arg)
    {
        this->reader_gid_seq = _arg;
        return *this;
    }
    Type& set__writer_gid_seq(const std::vector<rmw_dds_common::msg::Gid_<ContainerAllocator>,
                                                typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                    rmw_dds_common::msg::Gid_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>*;
    using ConstRawPtr = const rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator> const>;
...
using NodeEntitiesInfo = rmw_dds_common::msg::NodeEntitiesInfo_<std::allocator<void>>;
