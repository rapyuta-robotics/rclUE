...
void NodeEntitiesInfo_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<rmw_dds_common::msg::Gid>*>(untyped_member);
    return &member[index];
}

void fetch_function__NodeEntitiesInfo__reader_gid_seq(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__NodeEntitiesInfo__reader_gid_seq(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<rmw_dds_common::msg::Gid*>(get_function__NodeEntitiesInfo__reader_gid_seq(untyped_member, index));
...
void fetch_function__NodeEntitiesInfo__writer_gid_seq(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item = *reinterpret_cast<const rmw_dds_common::msg::Gid*>(
...
void assign_function__NodeEntitiesInfo__writer_gid_seq(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<rmw_dds_common::msg::Gid*>(get_function__NodeEntitiesInfo__writer_gid_seq(untyped_member, index));
    const auto& value = *reinterpret_cast<const rmw_dds_common::msg::Gid*>(untyped_value);
    item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NodeEntitiesInfo_message_member_array[4] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rmw_dds_common::msg::Gid>(),    // members of sub
                                                                                                                // message
        true,                                                                                                   // is array
        0,                                                                                                      // array size
        false,                                                                                                  // is upper bound
