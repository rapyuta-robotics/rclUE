...
{
public:
    explicit Init_LookupTransform_Goal_advanced(::tf2_msgs::action::LookupTransform_Goal& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LookupTransform_Goal_fixed_frame(::tf2_msgs::action::LookupTransform_Goal& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LookupTransform_Goal_target_time(::tf2_msgs::action::LookupTransform_Goal& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LookupTransform_Goal_timeout(::tf2_msgs::action::LookupTransform_Goal& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LookupTransform_Goal_source_time(::tf2_msgs::action::LookupTransform_Goal& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_LookupTransform_Goal_source_frame(::tf2_msgs::action::LookupTransform_Goal& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_LookupTransform_Goal_target_frame() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_Goal>()
{
...
{
public:
    explicit Init_LookupTransform_Result_error(::tf2_msgs::action::LookupTransform_Result& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_LookupTransform_Result_transform() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_Result>()
{
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_Feedback>()
{
...
{
public:
    explicit Init_LookupTransform_SendGoal_Request_goal(::tf2_msgs::action::LookupTransform_SendGoal_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_LookupTransform_SendGoal_Request_goal_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_SendGoal_Request>()
{
...
{
public:
    explicit Init_LookupTransform_SendGoal_Response_stamp(::tf2_msgs::action::LookupTransform_SendGoal_Response& msg) : msg_(msg)
    {
    }
    ::tf2_msgs::action::LookupTransform_SendGoal_Response stamp(
        ::tf2_msgs::action::LookupTransform_SendGoal_Response::_stamp_type arg)
    {
...
{
public:
    Init_LookupTransform_SendGoal_Response_accepted() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_SendGoal_Response>()
{
...
{
public:
    Init_LookupTransform_GetResult_Request_goal_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
    ::tf2_msgs::action::LookupTransform_GetResult_Request goal_id(
        ::tf2_msgs::action::LookupTransform_GetResult_Request::_goal_id_type arg)
    {
        msg_.goal_id = std::move(arg);
        return std::move(msg_);
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_GetResult_Request>()
{
...
{
public:
    explicit Init_LookupTransform_GetResult_Response_result(::tf2_msgs::action::LookupTransform_GetResult_Response& msg) : msg_(msg)
    {
    }
    ::tf2_msgs::action::LookupTransform_GetResult_Response result(
        ::tf2_msgs::action::LookupTransform_GetResult_Response::_result_type arg)
    {
...
{
public:
    Init_LookupTransform_GetResult_Response_status() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_GetResult_Response>()
{
...
{
public:
    explicit Init_LookupTransform_FeedbackMessage_feedback(::tf2_msgs::action::LookupTransform_FeedbackMessage& msg) : msg_(msg)
    {
    }
    ::tf2_msgs::action::LookupTransform_FeedbackMessage feedback(
        ::tf2_msgs::action::LookupTransform_FeedbackMessage::_feedback_type arg)
    {
...
{
public:
    Init_LookupTransform_FeedbackMessage_goal_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::action::LookupTransform_FeedbackMessage>()
{
