...
template<>
inline auto build<::tf2_msgs::srv::FrameGraph_Request>()
{
...
{
public:
    Init_FrameGraph_Response_frame_yaml() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::srv::FrameGraph_Response>()
{
