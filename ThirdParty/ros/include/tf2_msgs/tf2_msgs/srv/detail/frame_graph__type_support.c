...
extern "C"
{
    ...
    void tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_message_member_array[1] = {{
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_message_members = {
            ...
            tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_message_member_array,    // message
                                                                                                                               // members
            tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_init_function,    // function
                                                                                                                        // to
                                                                                                                        // initialize
                                                                                                                        // message
                                                                                                                        // memory
                                                                                                                        ...
                                                                                                                        // has to be
                                                                                                                        // allocated)
            tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_fini_function    // function
                                                                                                                       // to
                                                                                                                       // terminate
                                                                                                                       // message
                                                                                                                       // instance
    ...
    {
        if (!tf2_msgs__srv__FrameGraph_Request__rosidl_typesupport_introspection_c__FrameGraph_Request_message_type_support_handle
...
extern "C"
{
    ...
    void tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_message_member_array[1] = {{
            "frame_yaml",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_message_members = {
            ...
            tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_init_function,    // function
                                                                                                                          // to
                                                                                                                          // initialize
                                                                                                                          // message
                                                                                                                          // memory
                                                                                                                          ...
                                                                                                                          // be
                                                                                                                          // allocated)
            tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_fini_function    // function
                                                                                                                         // to
                                                                                                                         // terminate
                                                                                                                         // message
                                                                                                                         // instance
    ...
    {
        if (!tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            tf2_msgs__srv__FrameGraph_Response__rosidl_typesupport_introspection_c__FrameGraph_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
{
    if (!tf2_msgs__srv__detail__frame_graph__rosidl_typesupport_introspection_c__FrameGraph_service_type_support_handle
             .typesupport_identifier)
    {
        tf2_msgs__srv__detail__frame_graph__rosidl_typesupport_introspection_c__FrameGraph_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    rosidl_typesupport_introspection_c__ServiceMembers* service_members =
        (rosidl_typesupport_introspection_c__ServiceMembers*)
            tf2_msgs__srv__detail__frame_graph__rosidl_typesupport_introspection_c__FrameGraph_service_type_support_handle.data;

    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, tf2_msgs, srv, FrameGraph_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, tf2_msgs, srv, FrameGraph_Response)()
                ->data;
    }
