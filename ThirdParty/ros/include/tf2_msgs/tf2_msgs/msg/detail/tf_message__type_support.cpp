...
void TFMessage_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<geometry_msgs::msg::TransformStamped>*>(untyped_member);
    return &member[index];
}

void fetch_function__TFMessage__transforms(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__TFMessage__transforms(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<geometry_msgs::msg::TransformStamped*>(get_function__TFMessage__transforms(untyped_member, index));
