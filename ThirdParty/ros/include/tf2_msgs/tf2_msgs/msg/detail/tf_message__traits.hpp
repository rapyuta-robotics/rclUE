...
inline void to_flow_style_yaml(const TFMessage& msg, std::ostream& out)
{
    out << "{";
    // member: transforms
    {
...
inline void to_block_style_yaml(const TFMessage& msg, std::ostream& out, size_t indentation = 0)
{
    // member: transforms
    {
        if (indentation > 0)
...
[[deprecated("use tf2_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const tf2_msgs::msg::TFMessage& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use tf2_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const tf2_msgs::msg::TFMessage& msg)
{
...
template<>
struct has_fixed_size<tf2_msgs::msg::TFMessage> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<tf2_msgs::msg::TFMessage> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<tf2_msgs::msg::TFMessage> : std::true_type
{
};
