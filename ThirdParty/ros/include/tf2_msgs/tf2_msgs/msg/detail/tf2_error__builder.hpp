...
{
public:
    explicit Init_TF2Error_error_string(::tf2_msgs::msg::TF2Error& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_TF2Error_error() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::tf2_msgs::msg::TF2Error>()
{
