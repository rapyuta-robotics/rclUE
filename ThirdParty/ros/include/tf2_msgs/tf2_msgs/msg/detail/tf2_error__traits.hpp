...
inline void to_flow_style_yaml(const TF2Error& msg, std::ostream& out)
{
    out << "{";
    // member: error
    {
...
inline void to_block_style_yaml(const TF2Error& msg, std::ostream& out, size_t indentation = 0)
{
    // member: error
    {
        if (indentation > 0)
...
[[deprecated("use tf2_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const tf2_msgs::msg::TF2Error& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use tf2_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const tf2_msgs::msg::TF2Error& msg)
{
...
template<>
struct has_fixed_size<tf2_msgs::msg::TF2Error> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<tf2_msgs::msg::TF2Error> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<tf2_msgs::msg::TF2Error> : std::true_type
{
};
