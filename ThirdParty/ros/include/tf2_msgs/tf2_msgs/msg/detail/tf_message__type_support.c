...
extern "C"
{
    ...
    void* tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__get_function__TFMessage__transforms(void* untyped_member,
                                                                                                            size_t index)
    {
        geometry_msgs__msg__TransformStamped__Sequence* member = (geometry_msgs__msg__TransformStamped__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        const geometry_msgs__msg__TransformStamped* item =
            ((const geometry_msgs__msg__TransformStamped*)
                 tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__get_const_function__TFMessage__transforms(
                     untyped_member, index));
        geometry_msgs__msg__TransformStamped* value = (geometry_msgs__msg__TransformStamped*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__TransformStamped* item =
            ((geometry_msgs__msg__TransformStamped*)
                 tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__get_function__TFMessage__transforms(untyped_member,
                                                                                                                   index));
        const geometry_msgs__msg__TransformStamped* value = (const geometry_msgs__msg__TransformStamped*)(untyped_value);
        *item = *value;
    }

    bool tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__resize_function__TFMessage__transforms(void* untyped_member,
                                                                                                              size_t size)
    {
        geometry_msgs__msg__TransformStamped__Sequence* member = (geometry_msgs__msg__TransformStamped__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_message_member_array[1] = {{
            "transforms",                                            // name
            ...
            NULL,                                                    // default value
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__size_function__TFMessage__transforms,    // size()
                                                                                                                   // function
                                                                                                                   // pointer
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__get_const_function__TFMessage__transforms,    // get_const(index)
                                                                                                                        // function
                                                                                                                        // pointer
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__get_function__TFMessage__transforms,       // get(index)
                                                                                                                     // function
                                                                                                                     // pointer
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__fetch_function__TFMessage__transforms,     // fetch(index,
                                                                                                                     // &value)
                                                                                                                     // function
                                                                                                                     // pointer
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__assign_function__TFMessage__transforms,    // assign(index,
                                                                                                                     // value)
                                                                                                                     // function
                                                                                                                     // pointer
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__resize_function__TFMessage__transforms    // resize(index)
                                                                                                                    // function
                                                                                                                    // pointer
        }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_message_members = {
            ...
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_init_function,    // function to initialize
                                                                                                      // message memory (memory has
                                                                                                      // to be allocated)
            tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_message_type_support_handle = {
            0,
            &tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tf2_msgs, msg, TFMessage)()
    {
        ...
        if (!tf2_msgs__msg__TFMessage__rosidl_typesupport_introspection_c__TFMessage_message_type_support_handle
