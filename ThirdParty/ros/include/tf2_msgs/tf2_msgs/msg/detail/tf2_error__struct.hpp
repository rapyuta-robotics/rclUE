...
struct TF2Error_
{
    ...
    using _error_type = uint8_t;
    _error_type error;
    using _error_string_type = std::
    ...
    Type& set__error(const uint8_t& _arg)
    {
        this->error = _arg;
        return *this;
    }
...
#endif
#endif
    static constexpr uint8_t NO_ERROR = 0u;
#if defined(_WIN32)
#pragma warning(suppress : 4602)
#pragma pop_macro("NO_ERROR")
#endif
    static constexpr uint8_t LOOKUP_ERROR = 1u;
    static constexpr uint8_t CONNECTIVITY_ERROR = 2u;
    static constexpr uint8_t EXTRAPOLATION_ERROR = 3u;
    static constexpr uint8_t INVALID_ARGUMENT_ERROR = 4u;
    static constexpr uint8_t TIMEOUT_ERROR = 5u;
    static constexpr uint8_t TRANSFORM_ERROR = 6u;

    // pointer types
    using RawPtr = tf2_msgs::msg::TF2Error_<ContainerAllocator>*;
    using ConstRawPtr = const tf2_msgs::msg::TF2Error_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<tf2_msgs::msg::TF2Error_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<tf2_msgs::msg::TF2Error_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__tf2_msgs__msg__TF2Error std::shared_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__tf2_msgs__msg__TF2Error std::shared_ptr<tf2_msgs::msg::TF2Error_<ContainerAllocator> const> ConstPtr;
...
using TF2Error = tf2_msgs::msg::TF2Error_<std::allocator<void>>;
