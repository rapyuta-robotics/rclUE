...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        tf2_msgs__msg__TF2Error__rosidl_typesupport_introspection_c__TF2Error_message_member_array[2] = {
            {
                "error",                                               // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        tf2_msgs__msg__TF2Error__rosidl_typesupport_introspection_c__TF2Error_message_members = {
            ...
            tf2_msgs__msg__TF2Error__rosidl_typesupport_introspection_c__TF2Error_init_function,           // function to initialize
                                                                                                    // message memory (memory has to
                                                                                                    // be allocated)
            tf2_msgs__msg__TF2Error__rosidl_typesupport_introspection_c__TF2Error_fini_function    // function to terminate message
    ...
    {
        if (!tf2_msgs__msg__TF2Error__rosidl_typesupport_introspection_c__TF2Error_message_type_support_handle
