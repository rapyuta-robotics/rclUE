...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tf2_msgs cdr_serialize(const tf2_msgs::msg::TFMessage& ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tf2_msgs get_serialized_size(const tf2_msgs::msg::TFMessage& ros_message,
                                                                           size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tf2_msgs max_serialized_size_TFMessage(bool& full_bounded,
                                                                                     bool& is_plain,
                                                                                     size_t current_alignment);
