  ...
  tf2_msgs__action__LookupTransform_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_Goal * data =
      (tf2_msgs__action__LookupTransform_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_Result * data =
      (tf2_msgs__action__LookupTransform_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_Feedback * data =
      (tf2_msgs__action__LookupTransform_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_SendGoal_Request * data =
      (tf2_msgs__action__LookupTransform_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_SendGoal_Response * data =
      (tf2_msgs__action__LookupTransform_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_GetResult_Request * data =
      (tf2_msgs__action__LookupTransform_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_GetResult_Response * data =
      (tf2_msgs__action__LookupTransform_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tf2_msgs__action__LookupTransform_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_msgs__action__LookupTransform_FeedbackMessage * data =
      (tf2_msgs__action__LookupTransform_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__action__LookupTransform_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tf2_msgs__action__LookupTransform_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
