...
inline void to_flow_style_yaml(const DisparityImage& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const DisparityImage& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
[[deprecated("use stereo_msgs::msg::to_block_style_yaml() instead")]] inline void
to_yaml(const stereo_msgs::msg::DisparityImage& msg, std::ostream& out, size_t indentation = 0)
{
    stereo_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use stereo_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const stereo_msgs::msg::DisparityImage& msg)
{
...
struct has_fixed_size<stereo_msgs::msg::DisparityImage>
    : std::integral_constant<bool,
                             has_fixed_size<sensor_msgs::msg::Image>::value &&
                                 has_fixed_size<sensor_msgs::msg::RegionOfInterest>::value &&
                                 has_fixed_size<std_msgs::msg::Header>::value>
{
};
...
struct has_bounded_size<stereo_msgs::msg::DisparityImage>
    : std::integral_constant<bool,
                             has_bounded_size<sensor_msgs::msg::Image>::value &&
                                 has_bounded_size<sensor_msgs::msg::RegionOfInterest>::value &&
                                 has_bounded_size<std_msgs::msg::Header>::value>
{
};

template<>
struct is_message<stereo_msgs::msg::DisparityImage> : std::true_type
{
};
