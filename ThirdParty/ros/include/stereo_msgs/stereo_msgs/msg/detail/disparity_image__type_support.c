...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_member_array[8] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_members = {
            ...
            stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_member_array,    // message
                                                                                                                          // members
            stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_init_function,    // function to
                                                                                                                   // initialize
                                                                                                                   // message memory
                                                                                                                   // (memory has to
                                                                                                                   // be allocated)
            stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_fini_function     // function to
                                                                                                                   // terminate
                                                                                                                   // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    static rosidl_message_type_support_t
        stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_type_support_handle = {
            0,
            &stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_members,
            get_message_typesupport_handle_function,
    };

    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_stereo_msgs const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stereo_msgs, msg, DisparityImage)()
    {
        ...
        if (!stereo_msgs__msg__DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_type_support_handle
