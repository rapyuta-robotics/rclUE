...
{
public:
    explicit Init_DisparityImage_delta_d(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DisparityImage_max_disparity(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DisparityImage_min_disparity(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DisparityImage_valid_window(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DisparityImage_t(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DisparityImage_f(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DisparityImage_image(::stereo_msgs::msg::DisparityImage& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_DisparityImage_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::stereo_msgs::msg::DisparityImage>()
{
