...
extern "C"
{
    ...
    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stereo_msgs size_t
    get_serialized_size_stereo_msgs__msg__DisparityImage(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stereo_msgs size_t
    max_serialized_size_stereo_msgs__msg__DisparityImage(bool& full_bounded, bool& is_plain, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stereo_msgs const rosidl_message_type_support_t*
