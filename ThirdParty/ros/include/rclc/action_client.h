...
#include <rclc/types.h>
    ...
    typedef void (*rclc_action_client_goal_callback_t)(rclc_action_goal_handle_t* goal_handle, bool accepted, void* args);
    typedef void (*rclc_action_client_feedback_callback_t)(rclc_action_goal_handle_t* goal_handle, void* ros_feedback, void* args);
    typedef void (*rclc_action_client_result_callback_t)(rclc_action_goal_handle_t* goal_handle,
                                                         void* ros_result_response,
                                                         void* args);
    typedef void (*rclc_action_client_cancel_callback_t)(rclc_action_goal_handle_t* goal_handle, bool cancelled, void* args);
     ...
     */
    RCLC_PUBLIC
    rcl_ret_t rclc_action_client_init_default(rclc_action_client_t* action_client,
                                              rcl_node_t* node,
     ...
     */
    RCLC_PUBLIC
    rcl_ret_t rclc_action_send_goal_request(rclc_action_client_t* action_client,
                                            void* ros_request,
