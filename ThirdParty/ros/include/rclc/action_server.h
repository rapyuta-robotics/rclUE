...
#define RCLC_RET_ACTION_WAIT_RESULT_REQUEST 2104
    ...
    typedef rcl_ret_t (*rclc_action_server_handle_goal_callback_t)(rclc_action_goal_handle_t* goal_handle, void* args);

    typedef bool (*rclc_action_server_handle_cancel_callback_t)(rclc_action_goal_handle_t* ros_cancel_request, void* args);
     ...
     */
    RCLC_PUBLIC
    rcl_ret_t rclc_action_server_init_default(rclc_action_server_t* action_server,
                                              rcl_node_t* node,
