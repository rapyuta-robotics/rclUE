...
struct DiagnosticStatus_
{
    ...
    explicit DiagnosticStatus_(const ContainerAllocator& _alloc,
        ...
        : name(_alloc), message(_alloc), hardware_id(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->level = 0;
    ...
    using _level_type = unsigned char;
    _level_type level;
    ...
    using _hardware_id_type = std::
        basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
    _hardware_id_type hardware_id;
    using _values_type = std::vector<diagnostic_msgs::msg::KeyValue_<ContainerAllocator>,
    ...
    Type& set__level(const unsigned char& _arg)
    {
        this->level = _arg;
        return *this;
    }
    ...
    Type& set__values(const std::vector<diagnostic_msgs::msg::KeyValue_<ContainerAllocator>,
                                        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                            diagnostic_msgs::msg::KeyValue_<ContainerAllocator>>>& _arg)
    {
        this->values = _arg;
        return *this;
    }
...
#pragma pop_macro("ERROR")
    ...
    // pointer types
    using RawPtr = diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>*;
    using ConstRawPtr = const diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<diagnostic_msgs::msg::DiagnosticStatus_<ContainerAllocator> const>;
...
using DiagnosticStatus = diagnostic_msgs::msg::DiagnosticStatus_<std::allocator<void>>;
