...
{
public:
    explicit Init_KeyValue_value(::diagnostic_msgs::msg::KeyValue& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_KeyValue_key() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::diagnostic_msgs::msg::KeyValue>()
{
