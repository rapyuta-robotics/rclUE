...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticArray__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticArray__fini(
        diagnostic_msgs__msg__DiagnosticArray* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs diagnostic_msgs__msg__DiagnosticArray*
    diagnostic_msgs__msg__DiagnosticArray__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticArray__destroy(
        diagnostic_msgs__msg__DiagnosticArray* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticArray__are_equal(
        const diagnostic_msgs__msg__DiagnosticArray* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticArray__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticArray__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticArray__Sequence__fini(
        diagnostic_msgs__msg__DiagnosticArray__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs diagnostic_msgs__msg__DiagnosticArray__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticArray__Sequence__destroy(
        diagnostic_msgs__msg__DiagnosticArray__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticArray__Sequence__are_equal(
        const diagnostic_msgs__msg__DiagnosticArray__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticArray__Sequence__copy(
