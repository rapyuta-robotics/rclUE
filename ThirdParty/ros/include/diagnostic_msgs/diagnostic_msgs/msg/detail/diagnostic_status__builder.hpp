...
{
public:
    explicit Init_DiagnosticStatus_values(::diagnostic_msgs::msg::DiagnosticStatus& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DiagnosticStatus_hardware_id(::diagnostic_msgs::msg::DiagnosticStatus& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DiagnosticStatus_message(::diagnostic_msgs::msg::DiagnosticStatus& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_DiagnosticStatus_name(::diagnostic_msgs::msg::DiagnosticStatus& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_DiagnosticStatus_level() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::diagnostic_msgs::msg::DiagnosticStatus>()
{
