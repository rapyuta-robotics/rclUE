...
extern "C"
{
    ...
    void diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_member_array[2] = {
            {
                "header",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_members = {
            ...
            diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_init_function,    // function
                                                                                                                         // to
                                                                                                                         // initialize
                                                                                                                         // message
                                                                                                                         // memory
                                                                                                                         ...
                                                                                                                         // be
                                                                                                                         // allocated)
            diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_fini_function    // function
                                                                                                                        // to
                                                                                                                        // terminate
                                                                                                                        // message
                                                                                                                        // instance
    ...
    static rosidl_message_type_support_t
        diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_type_support_handle = {
            0,
            &diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_members,
    ...
    {
        diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
        diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_member_array[1]
        ...
        if (!diagnostic_msgs__msg__DiagnosticArray__rosidl_typesupport_introspection_c__DiagnosticArray_message_type_support_handle
