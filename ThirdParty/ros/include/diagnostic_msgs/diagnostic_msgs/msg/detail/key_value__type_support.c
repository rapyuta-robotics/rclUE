...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_member_array[2] = {
            {
                "key",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_members = {
            ...
            diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_init_function,    // function to initialize
                                                                                                           // message memory (memory
                                                                                                           // has to be allocated)
            diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_type_support_handle = {
            0,
            &diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_members,
    ...
    {
        if (!diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_type_support_handle
