...
inline void to_flow_style_yaml(const DiagnosticStatus& msg, std::ostream& out)
{
    out << "{";
    // member: level
    {
...
inline void to_block_style_yaml(const DiagnosticStatus& msg, std::ostream& out, size_t indentation = 0)
{
    // member: level
    {
        if (indentation > 0)
...
[[deprecated("use diagnostic_msgs::msg::to_block_style_yaml() instead")]] inline void
to_yaml(const diagnostic_msgs::msg::DiagnosticStatus& msg, std::ostream& out, size_t indentation = 0)
{
    diagnostic_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use diagnostic_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct has_fixed_size<diagnostic_msgs::msg::DiagnosticStatus> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<diagnostic_msgs::msg::DiagnosticStatus> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<diagnostic_msgs::msg::DiagnosticStatus> : std::true_type
{
};
