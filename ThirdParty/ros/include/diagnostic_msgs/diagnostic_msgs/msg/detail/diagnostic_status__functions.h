...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticStatus__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticStatus__fini(
        diagnostic_msgs__msg__DiagnosticStatus* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs diagnostic_msgs__msg__DiagnosticStatus*
    diagnostic_msgs__msg__DiagnosticStatus__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticStatus__destroy(
        diagnostic_msgs__msg__DiagnosticStatus* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticStatus__are_equal(
        const diagnostic_msgs__msg__DiagnosticStatus* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticStatus__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticStatus__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticStatus__Sequence__fini(
        diagnostic_msgs__msg__DiagnosticStatus__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs diagnostic_msgs__msg__DiagnosticStatus__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs void diagnostic_msgs__msg__DiagnosticStatus__Sequence__destroy(
        diagnostic_msgs__msg__DiagnosticStatus__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticStatus__Sequence__are_equal(
        const diagnostic_msgs__msg__DiagnosticStatus__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_diagnostic_msgs bool diagnostic_msgs__msg__DiagnosticStatus__Sequence__copy(
