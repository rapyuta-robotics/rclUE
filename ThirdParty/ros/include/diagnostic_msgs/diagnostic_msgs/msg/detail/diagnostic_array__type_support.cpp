...
void DiagnosticArray_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__DiagnosticArray__status(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__DiagnosticArray__status(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<diagnostic_msgs::msg::DiagnosticStatus*>(get_function__DiagnosticArray__status(untyped_member, index));
