...
struct AddDiagnostics_Request_
{
    ...
    explicit AddDiagnostics_Request_(
    ...
    using _load_namespace_type = std::
    ...
    // pointer types
    using RawPtr = diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator>*;
    using ConstRawPtr = const diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<diagnostic_msgs::srv::AddDiagnostics_Request_<ContainerAllocator> const>;
...
using AddDiagnostics_Request = diagnostic_msgs::srv::AddDiagnostics_Request_<std::allocator<void>>;
...
struct AddDiagnostics_Response_
{
    ...
    explicit AddDiagnostics_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
    ...
    // pointer types
    using RawPtr = diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator>*;
    using ConstRawPtr = const diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<diagnostic_msgs::srv::AddDiagnostics_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using AddDiagnostics_Response = diagnostic_msgs::srv::AddDiagnostics_Response_<std::allocator<void>>;
