...
inline void to_flow_style_yaml(const AddDiagnostics_Request& msg, std::ostream& out)
{
    out << "{";
...
inline void to_block_style_yaml(const AddDiagnostics_Request& msg, std::ostream& out, size_t indentation = 0)
{
    // member: load_namespace
    {
        if (indentation > 0)
...
[[deprecated("use diagnostic_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const diagnostic_msgs::srv::AddDiagnostics_Request& msg, std::ostream& out, size_t indentation = 0)
{
    diagnostic_msgs::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use diagnostic_msgs::srv::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct has_fixed_size<diagnostic_msgs::srv::AddDiagnostics_Request> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<diagnostic_msgs::srv::AddDiagnostics_Request> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<diagnostic_msgs::srv::AddDiagnostics_Request> : std::true_type
{
};
...
inline void to_flow_style_yaml(const AddDiagnostics_Response& msg, std::ostream& out)
{
    out << "{";
    // member: success
    {
...
inline void to_block_style_yaml(const AddDiagnostics_Response& msg, std::ostream& out, size_t indentation = 0)
{
    // member: success
    {
        if (indentation > 0)
...
[[deprecated("use diagnostic_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const diagnostic_msgs::srv::AddDiagnostics_Response& msg, std::ostream& out, size_t indentation = 0)
{
    diagnostic_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
template<>
struct has_fixed_size<diagnostic_msgs::srv::AddDiagnostics_Response> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<diagnostic_msgs::srv::AddDiagnostics_Response> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<diagnostic_msgs::srv::AddDiagnostics_Response> : std::true_type
{
};
...
template<>
struct is_service<diagnostic_msgs::srv::AddDiagnostics> : std::true_type
{
};

template<>
struct is_service_request<diagnostic_msgs::srv::AddDiagnostics_Request> : std::true_type
{
};

template<>
struct is_service_response<diagnostic_msgs::srv::AddDiagnostics_Response> : std::true_type
{
};
