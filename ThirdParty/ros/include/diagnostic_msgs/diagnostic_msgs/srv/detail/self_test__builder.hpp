...
template<>
inline auto build<::diagnostic_msgs::srv::SelfTest_Request>()
{
...
{
public:
    explicit Init_SelfTest_Response_status(::diagnostic_msgs::srv::SelfTest_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_SelfTest_Response_passed(::diagnostic_msgs::srv::SelfTest_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_SelfTest_Response_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::diagnostic_msgs::srv::SelfTest_Response>()
{
