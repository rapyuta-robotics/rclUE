 ...
 */
#define RCPPUTILS_TSA_ACQUIRED_BEFORE(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(acquired_before(__VA_ARGS__))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#acquired-before-acquired-after
 */
#define RCPPUTILS_TSA_ACQUIRED_AFTER(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(acquired_after(__VA_ARGS__))
 ...
 */
#define RCPPUTILS_TSA_REQUIRES(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(requires_capability(__VA_ARGS__))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#requires-requires-shared
 */
#define RCPPUTILS_TSA_REQUIRES_SHARED(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(requires_shared_capability(__VA_ARGS__))
 ...
 */
#define RCPPUTILS_TSA_ACQUIRE(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(acquire_capability(__VA_ARGS__))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#acquire-acquire-shared-release-release-shared
 */
#define RCPPUTILS_TSA_ACQUIRE_SHARED(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(acquire_shared_capability(__VA_ARGS__))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#acquire-acquire-shared-release-release-shared
 */
#define RCPPUTILS_TSA_RELEASE(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(release_capability(__VA_ARGS__))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#acquire-acquire-shared-release-release-shared
 */
#define RCPPUTILS_TSA_RELEASE_SHARED(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(release_shared_capability(__VA_ARGS__))
 ...
 */
#define RCPPUTILS_TSA_TRY_ACQUIRE(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(try_acquire_capability(__VA_ARGS__))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#try-acquire-bool-try-acquire-shared-bool
 */
#define RCPPUTILS_TSA_TRY_ACQUIRE_SHARED(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(try_acquire_shared_capability(__VA_ARGS__))
 ...
 */
#define RCPPUTILS_TSA_EXCLUDES(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(locks_excluded(__VA_ARGS__))
 ...
 */
#define RCPPUTILS_TSA_ASSERT_CAPABILITY(...) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(assert_capability(__VA_ARGS__))
 ...
 */
#define RCPPUTILS_TSA_RETURN_CAPABILITY(x) RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(lock_returned(x))
 ...
 * https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#return-capability-c
 */
#define RCPPUTILS_TSA_NO_THREAD_SAFETY_ANALYSIS RCPPUTILS_THREAD_ANNOTATION_ATTRIBUTE_IMPL(no_thread_safety_analysis)
