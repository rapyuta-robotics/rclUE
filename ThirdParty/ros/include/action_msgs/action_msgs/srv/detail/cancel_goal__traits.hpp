...
inline void to_flow_style_yaml(const CancelGoal_Request& msg, std::ostream& out)
{
    out << "{";
    // member: goal_info
    {
...
inline void to_block_style_yaml(const CancelGoal_Request& msg, std::ostream& out, size_t indentation = 0)
{
    // member: goal_info
    {
        if (indentation > 0)
...
[[deprecated("use action_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const action_msgs::srv::CancelGoal_Request& msg, std::ostream& out, size_t indentation = 0)
{
    action_msgs::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use action_msgs::srv::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct is_message<action_msgs::srv::CancelGoal_Request> : std::true_type
{
};
...
inline void to_flow_style_yaml(const CancelGoal_Response& msg, std::ostream& out)
{
    out << "{";
    // member: return_code
    {
...
inline void to_block_style_yaml(const CancelGoal_Response& msg, std::ostream& out, size_t indentation = 0)
{
    // member: return_code
    {
        if (indentation > 0)
...
[[deprecated("use action_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const action_msgs::srv::CancelGoal_Response& msg, std::ostream& out, size_t indentation = 0)
{
    action_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
template<>
struct has_fixed_size<action_msgs::srv::CancelGoal_Response> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<action_msgs::srv::CancelGoal_Response> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<action_msgs::srv::CancelGoal_Response> : std::true_type
{
};
...
template<>
struct is_service<action_msgs::srv::CancelGoal> : std::true_type
{
};

template<>
struct is_service_request<action_msgs::srv::CancelGoal_Request> : std::true_type
{
};

template<>
struct is_service_response<action_msgs::srv::CancelGoal_Response> : std::true_type
{
};
