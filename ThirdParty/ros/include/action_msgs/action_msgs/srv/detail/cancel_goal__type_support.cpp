...
void CancelGoal_Request_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CancelGoal_Request_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<action_msgs::msg::GoalInfo>(),    // members of sub
                                                                                                              // message
    false,                                                                                                    // is array
    0,                                                                                                        // array size
...
void CancelGoal_Response_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<action_msgs::msg::GoalInfo>*>(untyped_member);
    return &member[index];
}

void fetch_function__CancelGoal_Response__goals_canceling(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__CancelGoal_Response__goals_canceling(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<action_msgs::msg::GoalInfo*>(get_function__CancelGoal_Response__goals_canceling(untyped_member, index));
...
get_service_type_support_handle<action_msgs::srv::CancelGoal>()
{
    ...
    auto service_type_support = &::action_msgs::srv::rosidl_typesupport_introspection_cpp::CancelGoal_service_type_support_handle;
