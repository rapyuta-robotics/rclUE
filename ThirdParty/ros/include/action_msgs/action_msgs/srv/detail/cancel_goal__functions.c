...
bool action_msgs__srv__CancelGoal_Request__are_equal(const action_msgs__srv__CancelGoal_Request* lhs,
                                                     const action_msgs__srv__CancelGoal_Request* rhs)
{
    ...
    // goal_info
    if (!action_msgs__msg__GoalInfo__are_equal(&(lhs->goal_info), &(rhs->goal_info)))
    {
        return false;
    }
    return true;
...
bool action_msgs__srv__CancelGoal_Request__copy(const action_msgs__srv__CancelGoal_Request* input,
                                                action_msgs__srv__CancelGoal_Request* output)
{
    ...
    // goal_info
    if (!action_msgs__msg__GoalInfo__copy(&(input->goal_info), &(output->goal_info)))
    {
        return false;
    }
    return true;
...
action_msgs__srv__CancelGoal_Request* action_msgs__srv__CancelGoal_Request__create()
{
    ...
    action_msgs__srv__CancelGoal_Request* msg =
        (action_msgs__srv__CancelGoal_Request*)allocator.allocate(sizeof(action_msgs__srv__CancelGoal_Request), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool action_msgs__srv__CancelGoal_Request__Sequence__init(action_msgs__srv__CancelGoal_Request__Sequence* array, size_t size)
{
    ...
    if (size)
    {
        data = (action_msgs__srv__CancelGoal_Request*)allocator.zero_allocate(
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_msgs__srv__CancelGoal_Request__Sequence* array = (action_msgs__srv__CancelGoal_Request__Sequence*)allocator.allocate(
        sizeof(action_msgs__srv__CancelGoal_Request__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool action_msgs__srv__CancelGoal_Request__Sequence__are_equal(const action_msgs__srv__CancelGoal_Request__Sequence* lhs,
...
bool action_msgs__srv__CancelGoal_Request__Sequence__copy(const action_msgs__srv__CancelGoal_Request__Sequence* input,
                                                          action_msgs__srv__CancelGoal_Request__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(action_msgs__srv__CancelGoal_Request);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        action_msgs__srv__CancelGoal_Request* data =
            (action_msgs__srv__CancelGoal_Request*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!action_msgs__srv__CancelGoal_Request__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
...
bool action_msgs__srv__CancelGoal_Response__are_equal(const action_msgs__srv__CancelGoal_Response* lhs,
                                                      const action_msgs__srv__CancelGoal_Response* rhs)
{
    ...
    // goals_canceling
    if (!action_msgs__msg__GoalInfo__Sequence__are_equal(&(lhs->goals_canceling), &(rhs->goals_canceling)))
    {
        return false;
    }
    return true;
...
bool action_msgs__srv__CancelGoal_Response__copy(const action_msgs__srv__CancelGoal_Response* input,
                                                 action_msgs__srv__CancelGoal_Response* output)
{
    ...
    // goals_canceling
    if (!action_msgs__msg__GoalInfo__Sequence__copy(&(input->goals_canceling), &(output->goals_canceling)))
    {
        return false;
    }
    return true;
...
action_msgs__srv__CancelGoal_Response* action_msgs__srv__CancelGoal_Response__create()
{
    ...
    action_msgs__srv__CancelGoal_Response* msg =
        (action_msgs__srv__CancelGoal_Response*)allocator.allocate(sizeof(action_msgs__srv__CancelGoal_Response), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool action_msgs__srv__CancelGoal_Response__Sequence__init(action_msgs__srv__CancelGoal_Response__Sequence* array, size_t size)
{
    ...
    if (size)
    {
        data = (action_msgs__srv__CancelGoal_Response*)allocator.zero_allocate(
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_msgs__srv__CancelGoal_Response__Sequence* array = (action_msgs__srv__CancelGoal_Response__Sequence*)allocator.allocate(
        sizeof(action_msgs__srv__CancelGoal_Response__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool action_msgs__srv__CancelGoal_Response__Sequence__are_equal(const action_msgs__srv__CancelGoal_Response__Sequence* lhs,
...
bool action_msgs__srv__CancelGoal_Response__Sequence__copy(const action_msgs__srv__CancelGoal_Response__Sequence* input,
                                                           action_msgs__srv__CancelGoal_Response__Sequence* output)
{
    ...
    if (output->capacity < input->size)
    {
        const size_t allocation_size = input->size * sizeof(action_msgs__srv__CancelGoal_Response);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        action_msgs__srv__CancelGoal_Response* data =
            (action_msgs__srv__CancelGoal_Response*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    for (size_t i = 0; i < input->size; ++i)
    {
        if (!action_msgs__srv__CancelGoal_Response__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
