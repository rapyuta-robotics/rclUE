...
extern "C"
{
    ...
    void action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_message_member_array[1] = {{
            "goal_info",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_message_members = {
            ...
            action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_init_function,    // function
                                                                                                                           // to
                                                                                                                           // initialize
                                                                                                                           // message
                                                                                                                           // memory
                                                                                                                           ...
                                                                                                                           // be
                                                                                                                           // allocated)
            action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_fini_function    // function
                                                                                                                          // to
                                                                                                                          // terminate
                                                                                                                          // message
                                                                                                                          // instance
    ...
    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_msgs const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, srv, CancelGoal_Request)()
    {
        action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, msg, GoalInfo)();
        if (!action_msgs__srv__CancelGoal_Request__rosidl_typesupport_introspection_c__CancelGoal_Request_message_type_support_handle
...
extern "C"
{
    ...
    size_t
    action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__size_function__CancelGoal_Response__goals_canceling(
        const void* untyped_member)
    {
        const action_msgs__msg__GoalInfo__Sequence* member = (const action_msgs__msg__GoalInfo__Sequence*)(untyped_member);
        return member->size;
    }

    const void*
    action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__get_const_function__CancelGoal_Response__goals_canceling(
        const void* untyped_member,
        size_t index)
    {
        const action_msgs__msg__GoalInfo__Sequence* member = (const action_msgs__msg__GoalInfo__Sequence*)(untyped_member);
    ...
    void*
    action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__get_function__CancelGoal_Response__goals_canceling(
        void* untyped_member,
        size_t index)
    {
        action_msgs__msg__GoalInfo__Sequence* member = (action_msgs__msg__GoalInfo__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void
    action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__fetch_function__CancelGoal_Response__goals_canceling(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        ...
        action_msgs__msg__GoalInfo* value = (action_msgs__msg__GoalInfo*)(untyped_value);
        *value = *item;
    }

    void
    action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__assign_function__CancelGoal_Response__goals_canceling(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        action_msgs__msg__GoalInfo* item =
            ((action_msgs__msg__GoalInfo*)
                 action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__get_function__CancelGoal_Response__goals_canceling(
                     untyped_member, index));
        const action_msgs__msg__GoalInfo* value = (const action_msgs__msg__GoalInfo*)(untyped_value);
        *item = *value;
    }

    bool
    action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__resize_function__CancelGoal_Response__goals_canceling(
        void* untyped_member,
        size_t size)
    {
        action_msgs__msg__GoalInfo__Sequence* member = (action_msgs__msg__GoalInfo__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_message_member_array[2] = {
            {
                "return_code",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_message_members = {
            ...
            action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_init_function,    // function
                                                                                                                             // to
                                                                                                                             // initialize
                                                                                                                             // message
                                                                                                                             // memory
                                                                                                                             ...
                                                                                                                             // be
                                                                                                                             // allocated)
            action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_fini_function    // function
                                                                                                                            // to
                                                                                                                            // terminate
                                                                                                                            // message
                                                                                                                            // instance
    ...
    {
        action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_message_member_array[1]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, msg, GoalInfo)();
        if (!action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_message_type_support_handle
                 .typesupport_identifier)
        {
            action_msgs__srv__CancelGoal_Response__rosidl_typesupport_introspection_c__CancelGoal_Response_message_type_support_handle
                .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_msgs const rosidl_service_type_support_t*
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, srv, CancelGoal)()
{
    if (!action_msgs__srv__detail__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle
             .typesupport_identifier)
    {
        action_msgs__srv__detail__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    rosidl_typesupport_introspection_c__ServiceMembers* service_members =
        (rosidl_typesupport_introspection_c__ServiceMembers*)
            action_msgs__srv__detail__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle.data;

    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, action_msgs, srv, CancelGoal_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, action_msgs, srv, CancelGoal_Response)()
                ->data;
    }
