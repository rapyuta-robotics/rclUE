...
struct CancelGoal_Request_
{
    ...
    explicit CancelGoal_Request_(const ContainerAllocator& _alloc,
    ...
    using _goal_info_type = action_msgs::msg::GoalInfo_<ContainerAllocator>;
    _goal_info_type goal_info;

    // setters for named parameter idiom
    Type& set__goal_info(const action_msgs::msg::GoalInfo_<ContainerAllocator>& _arg)
    {
        this->goal_info = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = action_msgs::srv::CancelGoal_Request_<ContainerAllocator>*;
    using ConstRawPtr = const action_msgs::srv::CancelGoal_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<action_msgs::srv::CancelGoal_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<action_msgs::srv::CancelGoal_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<action_msgs::srv::CancelGoal_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<action_msgs::srv::CancelGoal_Request_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<action_msgs::srv::CancelGoal_Request_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<action_msgs::srv::CancelGoal_Request_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<action_msgs::srv::CancelGoal_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<action_msgs::srv::CancelGoal_Request_<ContainerAllocator> const>;
...
using CancelGoal_Request = action_msgs::srv::CancelGoal_Request_<std::allocator<void>>;
...
struct CancelGoal_Response_
{
    ...
    explicit CancelGoal_Response_(const ContainerAllocator& _alloc,
                                  rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
    {
        (void)_alloc;
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    ...
    // field types and members
    using _return_code_type = int8_t;
    _return_code_type return_code;
    using _goals_canceling_type = std::vector<
        action_msgs::msg::GoalInfo_<ContainerAllocator>,
        typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<action_msgs::msg::GoalInfo_<ContainerAllocator>>>;
    _goals_canceling_type goals_canceling;

    // setters for named parameter idiom
    Type& set__return_code(const int8_t& _arg)
    {
        this->return_code = _arg;
        return *this;
    }
    Type& set__goals_canceling(const std::vector<action_msgs::msg::GoalInfo_<ContainerAllocator>,
                                                 typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                     action_msgs::msg::GoalInfo_<ContainerAllocator>>>& _arg)
    {
    ...
    // pointer types
    using RawPtr = action_msgs::srv::CancelGoal_Response_<ContainerAllocator>*;
    using ConstRawPtr = const action_msgs::srv::CancelGoal_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<action_msgs::srv::CancelGoal_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<action_msgs::srv::CancelGoal_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<action_msgs::srv::CancelGoal_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<action_msgs::srv::CancelGoal_Response_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<action_msgs::srv::CancelGoal_Response_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<action_msgs::srv::CancelGoal_Response_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<action_msgs::srv::CancelGoal_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<action_msgs::srv::CancelGoal_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using CancelGoal_Response = action_msgs::srv::CancelGoal_Response_<std::allocator<void>>;
