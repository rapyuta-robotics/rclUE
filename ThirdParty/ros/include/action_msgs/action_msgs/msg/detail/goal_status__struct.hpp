...
struct GoalStatus_
{
    ...
    // pointer types
    using RawPtr = action_msgs::msg::GoalStatus_<ContainerAllocator>*;
    using ConstRawPtr = const action_msgs::msg::GoalStatus_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<action_msgs::msg::GoalStatus_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<action_msgs::msg::GoalStatus_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__action_msgs__msg__GoalStatus std::shared_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator>> Ptr;
    typedef DEPRECATED__action_msgs__msg__GoalStatus std::shared_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator> const>
        ConstPtr;
...
using GoalStatus = action_msgs::msg::GoalStatus_<std::allocator<void>>;
