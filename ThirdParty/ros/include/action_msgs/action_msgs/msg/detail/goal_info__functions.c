...
action_msgs__msg__GoalInfo* action_msgs__msg__GoalInfo__create()
{
    ...
    action_msgs__msg__GoalInfo* msg =
        (action_msgs__msg__GoalInfo*)allocator.allocate(sizeof(action_msgs__msg__GoalInfo), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
action_msgs__msg__GoalInfo__Sequence* action_msgs__msg__GoalInfo__Sequence__create(size_t size)
{
    ...
    action_msgs__msg__GoalInfo__Sequence* array =
        (action_msgs__msg__GoalInfo__Sequence*)allocator.allocate(sizeof(action_msgs__msg__GoalInfo__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool action_msgs__msg__GoalInfo__Sequence__are_equal(const action_msgs__msg__GoalInfo__Sequence* lhs,
...
bool action_msgs__msg__GoalInfo__Sequence__copy(const action_msgs__msg__GoalInfo__Sequence* input,
                                                action_msgs__msg__GoalInfo__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(action_msgs__msg__GoalInfo);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        action_msgs__msg__GoalInfo* data =
            (action_msgs__msg__GoalInfo*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!action_msgs__msg__GoalInfo__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
