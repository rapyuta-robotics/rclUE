...
action_msgs__msg__GoalStatus* action_msgs__msg__GoalStatus__create()
{
    ...
    action_msgs__msg__GoalStatus* msg =
        (action_msgs__msg__GoalStatus*)allocator.allocate(sizeof(action_msgs__msg__GoalStatus), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_msgs__msg__GoalStatus__Sequence* array = (action_msgs__msg__GoalStatus__Sequence*)allocator.allocate(
        sizeof(action_msgs__msg__GoalStatus__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool action_msgs__msg__GoalStatus__Sequence__are_equal(const action_msgs__msg__GoalStatus__Sequence* lhs,
...
bool action_msgs__msg__GoalStatus__Sequence__copy(const action_msgs__msg__GoalStatus__Sequence* input,
                                                  action_msgs__msg__GoalStatus__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(action_msgs__msg__GoalStatus);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        action_msgs__msg__GoalStatus* data =
            (action_msgs__msg__GoalStatus*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!action_msgs__msg__GoalStatus__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
