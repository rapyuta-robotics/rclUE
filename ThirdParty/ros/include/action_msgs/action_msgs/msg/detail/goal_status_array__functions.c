...
bool action_msgs__msg__GoalStatusArray__are_equal(const action_msgs__msg__GoalStatusArray* lhs,
                                                  const action_msgs__msg__GoalStatusArray* rhs)
{
    ...
    // status_list
    if (!action_msgs__msg__GoalStatus__Sequence__are_equal(&(lhs->status_list), &(rhs->status_list)))
    {
        return false;
    }
    return true;
...
bool action_msgs__msg__GoalStatusArray__copy(const action_msgs__msg__GoalStatusArray* input,
                                             action_msgs__msg__GoalStatusArray* output)
{
    ...
    // status_list
    if (!action_msgs__msg__GoalStatus__Sequence__copy(&(input->status_list), &(output->status_list)))
    {
        return false;
    }
    return true;
...
action_msgs__msg__GoalStatusArray* action_msgs__msg__GoalStatusArray__create()
{
    ...
    action_msgs__msg__GoalStatusArray* msg =
        (action_msgs__msg__GoalStatusArray*)allocator.allocate(sizeof(action_msgs__msg__GoalStatusArray), allocator.state);
    if (!msg)
    {
        return NULL;
    }
...
bool action_msgs__msg__GoalStatusArray__Sequence__init(action_msgs__msg__GoalStatusArray__Sequence* array, size_t size)
{
    ...
    if (size)
    {
        data = (action_msgs__msg__GoalStatusArray*)allocator.zero_allocate(
...
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_msgs__msg__GoalStatusArray__Sequence* array = (action_msgs__msg__GoalStatusArray__Sequence*)allocator.allocate(
        sizeof(action_msgs__msg__GoalStatusArray__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
bool action_msgs__msg__GoalStatusArray__Sequence__are_equal(const action_msgs__msg__GoalStatusArray__Sequence* lhs,
...
bool action_msgs__msg__GoalStatusArray__Sequence__copy(const action_msgs__msg__GoalStatusArray__Sequence* input,
                                                       action_msgs__msg__GoalStatusArray__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(action_msgs__msg__GoalStatusArray);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        action_msgs__msg__GoalStatusArray* data =
            (action_msgs__msg__GoalStatusArray*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!action_msgs__msg__GoalStatusArray__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
