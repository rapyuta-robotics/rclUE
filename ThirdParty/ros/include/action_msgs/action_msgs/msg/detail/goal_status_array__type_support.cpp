...
void GoalStatusArray_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<action_msgs::msg::GoalStatus>*>(untyped_member);
    return &member[index];
}

void fetch_function__GoalStatusArray__status_list(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__GoalStatusArray__status_list(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item =
        *reinterpret_cast<action_msgs::msg::GoalStatus*>(get_function__GoalStatusArray__status_list(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GoalStatusArray_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<action_msgs::msg::GoalStatus>(),    // members of sub
                                                                                                                // message
    true,                                                                                                       // is array
    0,                                                                                                          // array size
