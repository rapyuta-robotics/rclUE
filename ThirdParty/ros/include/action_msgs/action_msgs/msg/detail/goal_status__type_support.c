...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_member_array[2] = {
            {
                "goal_info",                                             // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_members = {
            ...
            action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_init_function,    // function to initialize
                                                                                                           // message memory (memory
                                                                                                           // has to be allocated)
            action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_type_support_handle = {
            0,
            &action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, msg, GoalStatus)()
    {
        ...
        if (!action_msgs__msg__GoalStatus__rosidl_typesupport_introspection_c__GoalStatus_message_type_support_handle
