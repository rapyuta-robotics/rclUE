...
extern "C"
{
    ...
    {
        const action_msgs__msg__GoalStatus__Sequence* member = (const action_msgs__msg__GoalStatus__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__get_function__GoalStatusArray__status_list(
        ...
        size_t index)
    {
        action_msgs__msg__GoalStatus__Sequence* member = (action_msgs__msg__GoalStatus__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        action_msgs__msg__GoalStatus* value = (action_msgs__msg__GoalStatus*)(untyped_value);
        *value = *item;
    }
        ...
        action_msgs__msg__GoalStatus* item =
            ((action_msgs__msg__GoalStatus*)
                 action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__get_function__GoalStatusArray__status_list(
                     untyped_member, index));
        const action_msgs__msg__GoalStatus* value = (const action_msgs__msg__GoalStatus*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_member_array[1] = {{
            "status_list",                                               // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_members = {
            ...
            action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_member_array,    // message
                                                                                                                            // members
            action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_init_function,    // function to
                                                                                                                     // initialize
                                                                                                                     // message
                                                                                                                     // memory
                                                                                                                     // (memory has
                                                                                                                     // to be
                                                                                                                     // allocated)
            action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_fini_function     // function to
                                                                                                                     // terminate
                                                                                                                     // message
                                                                                                                     // instance
                                                                                                                     // (will not
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, msg, GoalStatusArray)()
    {
        ...
        if (!action_msgs__msg__GoalStatusArray__rosidl_typesupport_introspection_c__GoalStatusArray_message_type_support_handle
