...
inline void to_flow_style_yaml(const GoalInfo& msg, std::ostream& out)
{
    out << "{";
    // member: goal_id
    {
...
inline void to_block_style_yaml(const GoalInfo& msg, std::ostream& out, size_t indentation = 0)
{
    // member: goal_id
    {
        if (indentation > 0)
...
[[deprecated("use action_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const action_msgs::msg::GoalInfo& msg,
                                                                                          std::ostream& out,
...
[[deprecated("use action_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const action_msgs::msg::GoalInfo& msg)
{
...
template<>
struct is_message<action_msgs::msg::GoalInfo> : std::true_type
{
};
