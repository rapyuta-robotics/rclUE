...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_action_msgs cdr_serialize(const action_msgs::msg::GoalStatus& ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_action_msgs get_serialized_size(const action_msgs::msg::GoalStatus& ros_message,
                                                                              size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_action_msgs max_serialized_size_GoalStatus(bool& full_bounded,
                                                                                         bool& is_plain,
                                                                                         size_t current_alignment);
