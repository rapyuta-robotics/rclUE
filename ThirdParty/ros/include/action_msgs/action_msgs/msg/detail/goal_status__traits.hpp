...
[[deprecated("use action_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const action_msgs::msg::GoalStatus& msg,
                                                                                          std::ostream& out,
...
[[deprecated("use action_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const action_msgs::msg::GoalStatus& msg)
{
...
template<>
struct is_message<action_msgs::msg::GoalStatus> : std::true_type
{
};
