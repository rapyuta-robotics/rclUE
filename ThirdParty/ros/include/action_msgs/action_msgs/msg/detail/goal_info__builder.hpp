...
{
public:
    explicit Init_GoalInfo_stamp(::action_msgs::msg::GoalInfo& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_GoalInfo_goal_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::action_msgs::msg::GoalInfo>()
{
