...
inline void to_flow_style_yaml(const GoalStatusArray& msg, std::ostream& out)
{
    out << "{";
    // member: status_list
    {
...
inline void to_block_style_yaml(const GoalStatusArray& msg, std::ostream& out, size_t indentation = 0)
{
    // member: status_list
    {
        if (indentation > 0)
...
[[deprecated("use action_msgs::msg::to_block_style_yaml() instead")]] inline void
to_yaml(const action_msgs::msg::GoalStatusArray& msg, std::ostream& out, size_t indentation = 0)
{
    action_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use action_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const action_msgs::msg::GoalStatusArray& msg)
{
...
template<>
struct has_fixed_size<action_msgs::msg::GoalStatusArray> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<action_msgs::msg::GoalStatusArray> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<action_msgs::msg::GoalStatusArray> : std::true_type
{
};
