...
inline void to_flow_style_yaml(const UUID& msg, std::ostream& out)
{
    out << "{";
    // member: uuid
    {
...
inline void to_block_style_yaml(const UUID& msg, std::ostream& out, size_t indentation = 0)
{
    // member: uuid
    {
        if (indentation > 0)
...
[[deprecated("use unique_identifier_msgs::msg::to_block_style_yaml() instead")]] inline void
to_yaml(const unique_identifier_msgs::msg::UUID& msg, std::ostream& out, size_t indentation = 0)
{
    unique_identifier_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use unique_identifier_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct has_fixed_size<unique_identifier_msgs::msg::UUID> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<unique_identifier_msgs::msg::UUID> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<unique_identifier_msgs::msg::UUID> : std::true_type
{
};
