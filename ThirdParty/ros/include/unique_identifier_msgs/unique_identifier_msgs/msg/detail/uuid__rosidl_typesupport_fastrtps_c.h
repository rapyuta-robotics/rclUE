...
extern "C"
{
    ...
    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unique_identifier_msgs size_t
    get_serialized_size_unique_identifier_msgs__msg__UUID(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unique_identifier_msgs size_t
    max_serialized_size_unique_identifier_msgs__msg__UUID(bool& full_bounded, bool& is_plain, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unique_identifier_msgs const rosidl_message_type_support_t*
