...
extern "C"
{
    ...
    void* unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__get_function__UUID__uuid(void* untyped_member,
                                                                                                          size_t index)
    {
    ...
    {
        const uint8_t* item =
            ((const uint8_t*)unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__get_const_function__UUID__uuid(
    ...
    {
        uint8_t* item = ((uint8_t*)unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__get_function__UUID__uuid(
            untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__UUID_message_member_array[1] = {{
            "uuid",                                                // name
            ...
            NULL,                                                  // default value
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__size_function__UUID__uuid,    // size() function
                                                                                                                 // pointer
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__get_const_function__UUID__uuid,    // get_const(index)
                                                                                                                      // function
                                                                                                                      // pointer
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__get_function__UUID__uuid,    // get(index)
                                                                                                                // function pointer
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__fetch_function__UUID__uuid,     // fetch(index,
                                                                                                                   // &value)
                                                                                                                   // function
                                                                                                                   // pointer
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__assign_function__UUID__uuid,    // assign(index,
                                                                                                                   // value)
                                                                                                                   // function
                                                                                                                   // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__UUID_message_members = {
            ...
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__UUID_init_function,    // function to initialize
                                                                                                          // message memory (memory
                                                                                                          // has to be allocated)
            unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__UUID_fini_function     // function to terminate
    ...
    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_unique_identifier_msgs const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unique_identifier_msgs, msg, UUID)()
    {
        if (!unique_identifier_msgs__msg__UUID__rosidl_typesupport_introspection_c__UUID_message_type_support_handle
