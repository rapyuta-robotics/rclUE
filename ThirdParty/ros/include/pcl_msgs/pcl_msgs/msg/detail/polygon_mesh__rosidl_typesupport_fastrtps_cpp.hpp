...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pcl_msgs cdr_serialize(const pcl_msgs::msg::PolygonMesh& ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pcl_msgs get_serialized_size(const pcl_msgs::msg::PolygonMesh& ros_message,
                                                                           size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pcl_msgs max_serialized_size_PolygonMesh(bool& full_bounded,
                                                                                       bool& is_plain,
                                                                                       size_t current_alignment);
