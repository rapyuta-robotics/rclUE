...
void PolygonMesh_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<pcl_msgs::msg::Vertices>*>(untyped_member);
    return &member[index];
}

void fetch_function__PolygonMesh__polygons(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const pcl_msgs::msg::Vertices*>(get_const_function__PolygonMesh__polygons(untyped_member, index));
    auto& value = *reinterpret_cast<pcl_msgs::msg::Vertices*>(untyped_value);
    value = item;
}

void assign_function__PolygonMesh__polygons(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<pcl_msgs::msg::Vertices*>(get_function__PolygonMesh__polygons(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PolygonMesh_message_member_array[3] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sensor_msgs::msg::PointCloud2>(),    // members of
                                                                                                                     // sub message
        false,                                                                                                       // is array
        0,                                                                                                           // array size
        false,                                          // is upper bound
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,    // type
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<pcl_msgs::msg::Vertices>(),    // members of sub
                                                                                                               // message
        true,                                                                                                  // is array
        0,                                                                                                     // array size
        false,                                                                                                 // is upper bound
