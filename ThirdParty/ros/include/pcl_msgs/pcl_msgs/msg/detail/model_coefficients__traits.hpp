...
inline void to_flow_style_yaml(const ModelCoefficients& msg, std::ostream& out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const ModelCoefficients& msg, std::ostream& out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0)
...
[[deprecated("use pcl_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const pcl_msgs::msg::ModelCoefficients& msg,
                                                                                       std::ostream& out,
...
[[deprecated("use pcl_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const pcl_msgs::msg::ModelCoefficients& msg)
{
...
template<>
struct has_fixed_size<pcl_msgs::msg::ModelCoefficients> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<pcl_msgs::msg::ModelCoefficients> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<pcl_msgs::msg::ModelCoefficients> : std::true_type
{
};
