...
{
public:
    explicit Init_PolygonMesh_polygons(::pcl_msgs::msg::PolygonMesh& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_PolygonMesh_cloud(::pcl_msgs::msg::PolygonMesh& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PolygonMesh_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::pcl_msgs::msg::PolygonMesh>()
{
