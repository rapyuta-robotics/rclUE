...
extern "C"
{
    ...
    {
        const pcl_msgs__msg__Vertices__Sequence* member = (const pcl_msgs__msg__Vertices__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__get_function__PolygonMesh__polygons(void* untyped_member,
                                                                                                              size_t index)
    {
        pcl_msgs__msg__Vertices__Sequence* member = (pcl_msgs__msg__Vertices__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        ...
        pcl_msgs__msg__Vertices* value = (pcl_msgs__msg__Vertices*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        pcl_msgs__msg__Vertices* item =
            ((pcl_msgs__msg__Vertices*)
                 pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__get_function__PolygonMesh__polygons(untyped_member,
                                                                                                                     index));
        const pcl_msgs__msg__Vertices* value = (const pcl_msgs__msg__Vertices*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_message_member_array[3] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                    // default value
                pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__size_function__PolygonMesh__polygons,    // size()
                                                                                                                         // function
                                                                                                                         // pointer
                pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__get_const_function__PolygonMesh__polygons,    // get_const(index)
                                                                                                                              // function
                                                                                                                              // pointer
                pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__get_function__PolygonMesh__polygons,    // get(index)
                                                                                                                        // function
                                                                                                                        // pointer
                pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__fetch_function__PolygonMesh__polygons,    // fetch(index,
                                                                                                                          // &value)
                                                                                                                          // function
                                                                                                                          // pointer
                pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__assign_function__PolygonMesh__polygons,    // assign(index,
                                                                                                                           // value)
                                                                                                                           // function
                                                                                                                           // pointer
                pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__resize_function__PolygonMesh__polygons    // resize(index)
                                                                                                                          // function
                                                                                                                          // pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_message_members = {
            ...
            pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_init_function,    // function to initialize
                                                                                                          // message memory (memory
                                                                                                          // has to be allocated)
            pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_message_type_support_handle = {
            0,
            &pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pcl_msgs, msg, PolygonMesh)()
    {
        ...
        if (!pcl_msgs__msg__PolygonMesh__rosidl_typesupport_introspection_c__PolygonMesh_message_type_support_handle
