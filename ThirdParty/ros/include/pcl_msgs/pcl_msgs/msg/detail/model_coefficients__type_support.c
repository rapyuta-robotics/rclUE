...
extern "C"
{
        ...
        void* untyped_value)
    {
        const float* item =
            ((const float*)
                 pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__get_const_function__ModelCoefficients__values(
    ...
    {
        float* item =
            ((float*)pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__get_function__ModelCoefficients__values(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_message_member_array[2] = {
            {
                "header",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_message_members = {
            ...
            pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_message_member_array,    // message
                                                                                                                             // members
            pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_init_function,    // function to
                                                                                                                      // initialize
                                                                                                                      // message
                                                                                                                      // memory
                                                                                                                      // (memory has
                                                                                                                      // to be
                                                                                                                      // allocated)
            pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_fini_function     // function to
                                                                                                                      // terminate
                                                                                                                      // message
                                                                                                                      // instance
                                                                                                                      // (will not
    ...
    static rosidl_message_type_support_t
        pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_message_type_support_handle = {
            0,
            &pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pcl_msgs, msg, ModelCoefficients)()
    {
        ...
        if (!pcl_msgs__msg__ModelCoefficients__rosidl_typesupport_introspection_c__ModelCoefficients_message_type_support_handle
