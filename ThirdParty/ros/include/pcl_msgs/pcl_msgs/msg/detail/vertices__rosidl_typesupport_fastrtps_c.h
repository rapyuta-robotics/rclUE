...
extern "C"
{
    ...
    get_serialized_size_pcl_msgs__msg__Vertices(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pcl_msgs size_t max_serialized_size_pcl_msgs__msg__Vertices(bool& full_bounded,
                                                                                                     bool& is_plain,
