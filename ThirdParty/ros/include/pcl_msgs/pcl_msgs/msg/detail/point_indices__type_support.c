...
extern "C"
{
    ...
    void* pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__get_function__PointIndices__indices(void* untyped_member,
                                                                                                               size_t index)
    {
        ...
        void* untyped_value)
    {
        const int32_t* item =
            ((const int32_t*)
                 pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__get_const_function__PointIndices__indices(
    ...
    {
        int32_t* item =
            ((int32_t*)pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__get_function__PointIndices__indices(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_message_member_array[2] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                  // default value
                pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__size_function__PointIndices__indices,    // size()
                                                                                                                          // function
                                                                                                                          // pointer
                pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__get_const_function__PointIndices__indices,    // get_const(index)
                                                                                                                               // function
                                                                                                                               // pointer
                pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__get_function__PointIndices__indices,    // get(index)
                                                                                                                         // function
                                                                                                                         // pointer
                pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__fetch_function__PointIndices__indices,    // fetch(index,
                                                                                                                           // &value)
                                                                                                                           // function
                                                                                                                           // pointer
                pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__assign_function__PointIndices__indices,    // assign(index,
                                                                                                                            // value)
                                                                                                                            // function
                                                                                                                            // pointer
                pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__resize_function__PointIndices__indices    // resize(index)
                                                                                                                           // function
                                                                                                                           // pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_message_members = {
            ...
            pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_message_member_array,    // message
                                                                                                                   // members
            pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_init_function,           // function to
                                                                                                            // initialize message
                                                                                                            // memory (memory has to
                                                                                                            // be allocated)
            pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_fini_function    // function to terminate
    ...
    static rosidl_message_type_support_t
        pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_message_type_support_handle = {
            0,
            &pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pcl_msgs, msg, PointIndices)()
    {
        ...
        if (!pcl_msgs__msg__PointIndices__rosidl_typesupport_introspection_c__PointIndices_message_type_support_handle
