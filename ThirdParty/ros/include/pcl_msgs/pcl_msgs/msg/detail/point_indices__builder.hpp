...
{
public:
    explicit Init_PointIndices_indices(::pcl_msgs::msg::PointIndices& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_PointIndices_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::pcl_msgs::msg::PointIndices>()
{
