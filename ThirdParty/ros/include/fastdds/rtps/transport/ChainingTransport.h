...
public:
    ...
    RTPS_DllAPI ChainingTransport(const ChainingTransportDescriptor& t)
        : TransportInterface(0), low_level_transport_(t.low_level_descriptor->create_transport())
    {
     ...
     */
    RTPS_DllAPI bool init(const fastrtps::rtps::PropertyPolicy* properties = nullptr) override
    {
     ...
     */
    RTPS_DllAPI bool IsInputChannelOpen(const fastrtps::rtps::Locator_t& loc) const override
    {
     ...
     */
    RTPS_DllAPI bool IsLocatorSupported(const fastrtps::rtps::Locator_t& loc) const override
    {
     ...
     */
    RTPS_DllAPI fastrtps::rtps::Locator_t RemoteToMainLocal(const fastrtps::rtps::Locator_t& loc) const override
    {
     ...
     */
    RTPS_DllAPI bool OpenInputChannel(const fastrtps::rtps::Locator_t& loc,
     ...
     */
    RTPS_DllAPI bool OpenOutputChannel(SendResourceList& sender_resource_list, const fastrtps::rtps::Locator_t& loc) override;
     ...
     */
    RTPS_DllAPI bool CloseInputChannel(const fastrtps::rtps::Locator_t& loc) override
    {
     ...
     */
    RTPS_DllAPI fastrtps::rtps::LocatorList_t NormalizeLocator(const fastrtps::rtps::Locator_t& locator) override
    {
     ...
     */
    RTPS_DllAPI bool is_local_locator(const fastrtps::rtps::Locator_t& locator) const override
    {
     ...
     */
    RTPS_DllAPI bool is_locator_allowed(const fastrtps::rtps::Locator_t& locator) const override
    {
     ...
     */
    RTPS_DllAPI bool DoInputLocatorsMatch(const fastrtps::rtps::Locator_t& locator_1,
     ...
     */
    RTPS_DllAPI void select_locators(fastrtps::rtps::LocatorSelector& selector) const override
    {
     ...
     */
    RTPS_DllAPI void AddDefaultOutputLocator(fastrtps::rtps::LocatorList_t& defaultList) override
    {
     ...
     */
    RTPS_DllAPI bool getDefaultMetatrafficMulticastLocators(fastrtps::rtps::LocatorList_t& locators,
     ...
     */
    RTPS_DllAPI bool getDefaultMetatrafficUnicastLocators(fastrtps::rtps::LocatorList_t& locators,
     ...
     */
    RTPS_DllAPI bool getDefaultUnicastLocators(fastrtps::rtps::LocatorList_t& locators, uint32_t unicast_port) const override
    {
     ...
     */
    RTPS_DllAPI bool fillMetatrafficMulticastLocator(fastrtps::rtps::Locator_t& locator,
                                                     uint32_t metatraffic_multicast_port) const override
    {
     ...
     */
    RTPS_DllAPI bool fillMetatrafficUnicastLocator(fastrtps::rtps::Locator_t& locator,
                                                   uint32_t metatraffic_unicast_port) const override
    {
     ...
     */
    RTPS_DllAPI bool configureInitialPeerLocator(fastrtps::rtps::Locator_t& locator,
     ...
     */
    RTPS_DllAPI bool fillUnicastLocator(fastrtps::rtps::Locator_t& locator, uint32_t well_known_port) const override
    {
    ...
    RTPS_DllAPI bool transform_remote_locator(const fastrtps::rtps::Locator_t& remote_locator,
     ...
     */
    RTPS_DllAPI virtual bool send(fastrtps::rtps::SenderResource* low_sender_resource,
     ...
     */
    RTPS_DllAPI virtual void receive(TransportReceiverInterface* next_receiver,
