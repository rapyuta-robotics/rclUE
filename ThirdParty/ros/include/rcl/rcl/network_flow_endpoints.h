...
#define rcl_get_zero_initialized_network_flow_endpoint_array rmw_get_zero_initialized_network_flow_endpoint_array
...
#define rcl_network_flow_endpoint_get_internet_protocol_string rmw_network_flow_endpoint_get_internet_protocol_string
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_publisher_get_network_flow_endpoints(const rcl_publisher_t* publisher,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_subscription_get_network_flow_endpoints(const rcl_subscription_t* subscription,
                                                          rcutils_allocator_t* allocator,
                                                          rcl_network_flow_endpoint_array_t* network_flow_endpoint_array);
