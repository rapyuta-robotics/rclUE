...
#define rcl_topic_endpoint_info_array_fini rmw_topic_endpoint_info_array_fini
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_publisher_names_and_types_by_node(const rcl_node_t* node,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_subscriber_names_and_types_by_node(const rcl_node_t* node,
                                                         rcl_allocator_t* allocator,
                                                         bool no_demangle,
                                                         const char* node_name,
                                                         const char* node_namespace,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_service_names_and_types_by_node(const rcl_node_t* node,
                                                      rcl_allocator_t* allocator,
                                                      const char* node_name,
                                                      const char* node_namespace,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_client_names_and_types_by_node(const rcl_node_t* node,
                                                     rcl_allocator_t* allocator,
                                                     const char* node_name,
                                                     const char* node_namespace,
                                                     rcl_names_and_types_t* service_names_and_types);
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_service_names_and_types(const rcl_node_t* node,
                                              rcl_allocator_t* allocator,
                                              rcl_names_and_types_t* service_names_and_types);
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_node_names(const rcl_node_t* node,
                                 rcl_allocator_t allocator,
                                 rcutils_string_array_t* node_names,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_node_names_with_enclaves(const rcl_node_t* node,
                                               rcl_allocator_t allocator,
                                               rcutils_string_array_t* node_names,
                                               rcutils_string_array_t* node_namespaces,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_wait_for_publishers(const rcl_node_t* node,
                                      rcl_allocator_t* allocator,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_wait_for_subscribers(const rcl_node_t* node,
                                       rcl_allocator_t* allocator,
                                       const char* topic_name,
                                       const size_t count,
                                       rcutils_duration_value_t timeout,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_publishers_info_by_topic(const rcl_node_t* node,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_get_subscriptions_info_by_topic(const rcl_node_t* node,
                                                  rcutils_allocator_t* allocator,
                                                  const char* topic_name,
                                                  bool no_mangle,
