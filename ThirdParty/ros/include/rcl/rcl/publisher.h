...
#include "rosidl_runtime_c/message_type_support_struct.h"
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_borrow_loaned_message(const rcl_publisher_t* publisher,
                                        const rosidl_message_type_support_t* type_support,
                                        void** ros_message);
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_publish_serialized_message(const rcl_publisher_t* publisher,
    ...
    RCL_PUBLIC
    RCL_WARN_UNUSED
    rcl_ret_t rcl_publish_loaned_message(const rcl_publisher_t* publisher,
                                         void* ros_message,
                                         rmw_publisher_allocation_t* allocation);
