...
extern "C"
{
     ...
     * - lifespan = {10, 0}
     */
    static const rmw_qos_profile_t rcl_qos_profile_rosout_default = {RMW_QOS_POLICY_HISTORY_KEEP_LAST,
                                                                     1000,
     ...
     */
    RCL_PUBLIC
    void rcl_logging_rosout_output_handler(const rcutils_log_location_t* location,
                                           int severity,
                                           const char* name,
