...
#include "rosidl_runtime_c/action_type_support_struct.h"
    ...
    ROSIDL_GENERATOR_C_PUBLIC_example_interfaces const rosidl_action_type_support_t*
        ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_c, example_interfaces, action, Fibonacci)();
