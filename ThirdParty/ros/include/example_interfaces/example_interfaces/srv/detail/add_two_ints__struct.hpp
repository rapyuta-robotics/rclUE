...
struct AddTwoInts_Request_
{
    ...
    using _a_type = int64_t;
    _a_type a;
    using _b_type = int64_t;
    _b_type b;
    ...
    // pointer types
    using RawPtr = example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator>*;
    using ConstRawPtr = const example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<example_interfaces::srv::AddTwoInts_Request_<ContainerAllocator> const>;
...
using AddTwoInts_Request = example_interfaces::srv::AddTwoInts_Request_<std::allocator<void>>;
...
struct AddTwoInts_Response_
{
    ...
    // pointer types
    using RawPtr = example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator>*;
    using ConstRawPtr = const example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<example_interfaces::srv::AddTwoInts_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using AddTwoInts_Response = example_interfaces::srv::AddTwoInts_Response_<std::allocator<void>>;
