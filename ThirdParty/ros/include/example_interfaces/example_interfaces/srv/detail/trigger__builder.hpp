...
template<>
inline auto build<::example_interfaces::srv::Trigger_Request>()
{
...
{
public:
    explicit Init_Trigger_Response_message(::example_interfaces::srv::Trigger_Response& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Trigger_Response_success() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::srv::Trigger_Response>()
{
