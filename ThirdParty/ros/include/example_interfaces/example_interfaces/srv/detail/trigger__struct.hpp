...
struct Trigger_Request_
{
    ...
    // pointer types
    using RawPtr = example_interfaces::srv::Trigger_Request_<ContainerAllocator>*;
    using ConstRawPtr = const example_interfaces::srv::Trigger_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<example_interfaces::srv::Trigger_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<example_interfaces::srv::Trigger_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<example_interfaces::srv::Trigger_Request_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<example_interfaces::srv::Trigger_Request_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<example_interfaces::srv::Trigger_Request_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<example_interfaces::srv::Trigger_Request_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<example_interfaces::srv::Trigger_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<example_interfaces::srv::Trigger_Request_<ContainerAllocator> const>;
...
using Trigger_Request = example_interfaces::srv::Trigger_Request_<std::allocator<void>>;
...
struct Trigger_Response_
{
    ...
    // pointer types
    using RawPtr = example_interfaces::srv::Trigger_Response_<ContainerAllocator>*;
    using ConstRawPtr = const example_interfaces::srv::Trigger_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<example_interfaces::srv::Trigger_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<example_interfaces::srv::Trigger_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<example_interfaces::srv::Trigger_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<example_interfaces::srv::Trigger_Response_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<example_interfaces::srv::Trigger_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<example_interfaces::srv::Trigger_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using Trigger_Response = example_interfaces::srv::Trigger_Response_<std::allocator<void>>;
