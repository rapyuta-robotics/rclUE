...
template<>
inline auto build<::example_interfaces::srv::SetBool_Request>()
{
...
{
public:
    explicit Init_SetBool_Response_message(::example_interfaces::srv::SetBool_Response& msg) : msg_(msg)
    {
    }
...
template<>
inline auto build<::example_interfaces::srv::SetBool_Response>()
{
