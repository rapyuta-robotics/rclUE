...
{
public:
    explicit Init_AddTwoInts_Request_b(::example_interfaces::srv::AddTwoInts_Request& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_AddTwoInts_Request_a() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::srv::AddTwoInts_Request>()
{
...
{
public:
    Init_AddTwoInts_Response_sum() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::srv::AddTwoInts_Response>()
{
