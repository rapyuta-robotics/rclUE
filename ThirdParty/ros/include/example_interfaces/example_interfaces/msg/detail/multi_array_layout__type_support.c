...
extern "C"
{
    ...
    void example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_fini_function(
        void* message_memory)
    {
    ...
    const void*
    example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__get_const_function__MultiArrayLayout__dim(
        const void* untyped_member,
        size_t index)
    {
        const example_interfaces__msg__MultiArrayDimension__Sequence* member =
        ...
        void* untyped_value)
    {
        ...
        example_interfaces__msg__MultiArrayDimension* value = (example_interfaces__msg__MultiArrayDimension*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        example_interfaces__msg__MultiArrayDimension* item =
            ((example_interfaces__msg__MultiArrayDimension*)
                 example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__get_function__MultiArrayLayout__dim(
                     untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_member_array[2] = {
            {
                "dim",                                                       // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_members = {
            ...
            example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_init_function,    // function
                                                                                                                              // to
                                                                                                                              // initialize
                                                                                                                              // message
                                                                                                                              // memory
                                                                                                                              ...
                                                                                                                              // be
                                                                                                                              // allocated)
            example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_fini_function    // function
                                                                                                                             // to
                                                                                                                             // terminate
                                                                                                                             // message
                                                                                                                             // instance
    ...
    static rosidl_message_type_support_t
        example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_type_support_handle =
            {
                0,
                &example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c,
                                                      ...
                                                      MultiArrayLayout)()
    {
        example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_member_array[0]
            .members_ = ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
            rosidl_typesupport_introspection_c, example_interfaces, msg, MultiArrayDimension)();
        if (!example_interfaces__msg__MultiArrayLayout__rosidl_typesupport_introspection_c__MultiArrayLayout_message_type_support_handle
