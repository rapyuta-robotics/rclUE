...
{
public:
    explicit Init_ByteMultiArray_data(::example_interfaces::msg::ByteMultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_ByteMultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::ByteMultiArray>()
{
