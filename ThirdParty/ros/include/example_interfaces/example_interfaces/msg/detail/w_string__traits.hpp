...
inline void to_flow_style_yaml(const WString& msg, std::ostream& out)
{
    out << "{";
    // member: data
    {
...
inline void to_block_style_yaml(const WString& msg, std::ostream& out, size_t indentation = 0)
{
    // member: data
    {
        if (indentation > 0)
...
to_yaml(const example_interfaces::msg::WString& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<example_interfaces::msg::WString> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<example_interfaces::msg::WString> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<example_interfaces::msg::WString> : std::true_type
{
};
