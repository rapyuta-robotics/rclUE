...
to_yaml(const example_interfaces::msg::UInt32MultiArray& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<example_interfaces::msg::UInt32MultiArray> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<example_interfaces::msg::UInt32MultiArray> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<example_interfaces::msg::UInt32MultiArray> : std::true_type
{
};
