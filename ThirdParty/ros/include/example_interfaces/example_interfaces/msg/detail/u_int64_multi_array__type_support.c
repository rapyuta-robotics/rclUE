...
extern "C"
{
    ...
    const void*
    example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__get_const_function__UInt64MultiArray__data(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__uint64__Sequence* member = (const rosidl_runtime_c__uint64__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        uint64_t* item =
            ((uint64_t*)
                 example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__get_function__UInt64MultiArray__data(
                     untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_member_array[2] = {
            {
                "layout",                                                       // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_members = {
            ...
            example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_init_function,    // function
                                                                                                                              // to
                                                                                                                              // initialize
                                                                                                                              // message
                                                                                                                              // memory
                                                                                                                              ...
                                                                                                                              // be
                                                                                                                              // allocated)
            example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_fini_function    // function
                                                                                                                             // to
                                                                                                                             // terminate
                                                                                                                             // message
                                                                                                                             // instance
    ...
    static rosidl_message_type_support_t
        example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_type_support_handle =
            {
                0,
                &example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c,
                                                      ...
                                                      UInt64MultiArray)()
    {
        example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_member_array[0]
        ...
        if (!example_interfaces__msg__UInt64MultiArray__rosidl_typesupport_introspection_c__UInt64MultiArray_message_type_support_handle
