...
extern "C"
{
    ...
    void example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_fini_function(
        void* message_memory)
    {
    ...
    const void*
    example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__get_const_function__ByteMultiArray__data(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__octet__Sequence* member = (const rosidl_runtime_c__octet__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        uint8_t* item =
            ((uint8_t*)
                 example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__get_function__ByteMultiArray__data(
                     untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_message_member_array[2] = {
            {
                "layout",                                                     // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_message_members = {
            ...
            example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_init_function,    // function
                                                                                                                          // to
                                                                                                                          // initialize
                                                                                                                          // message
                                                                                                                          // memory
                                                                                                                          ...
                                                                                                                          // be
                                                                                                                          // allocated)
            example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_fini_function    // function
                                                                                                                         // to
                                                                                                                         // terminate
                                                                                                                         // message
                                                                                                                         // instance
    ...
    {
        example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_message_member_array[0]
        ...
        if (!example_interfaces__msg__ByteMultiArray__rosidl_typesupport_introspection_c__ByteMultiArray_message_type_support_handle
