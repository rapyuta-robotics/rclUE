...
extern "C"
{
    ...
    get_serialized_size_example_interfaces__msg__Float32(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces size_t
    max_serialized_size_example_interfaces__msg__Float32(bool& full_bounded, bool& is_plain, size_t current_alignment);
