...
extern "C"
{
    ...
    void example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_fini_function(
        void* message_memory)
    {
    ...
    const void*
    example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__get_const_function__Float32MultiArray__data(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__float__Sequence* member = (const rosidl_runtime_c__float__Sequence*)(untyped_member);
        ...
        const void* untyped_value)
    {
        float* item =
            ((float*)
                 example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__get_function__Float32MultiArray__data(
                     untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_message_member_array[2] = {
            {
                "layout",                                                        // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_message_members = {
            ...
            example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_fini_function    // function
                                                                                                                               // to
                                                                                                                               // terminate
                                                                                                                               // message
                                                                                                                               // instance
    ...
    static rosidl_message_type_support_t
        example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_message_type_support_handle =
            {
                0,
                &example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c,
                                                      ...
                                                      Float32MultiArray)()
    {
        example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_message_member_array[0]
        ...
        if (!example_interfaces__msg__Float32MultiArray__rosidl_typesupport_introspection_c__Float32MultiArray_message_type_support_handle
