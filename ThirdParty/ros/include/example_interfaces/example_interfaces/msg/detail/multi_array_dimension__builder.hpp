...
{
public:
    explicit Init_MultiArrayDimension_stride(::example_interfaces::msg::MultiArrayDimension& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MultiArrayDimension_size(::example_interfaces::msg::MultiArrayDimension& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MultiArrayDimension_label() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::MultiArrayDimension>()
{
