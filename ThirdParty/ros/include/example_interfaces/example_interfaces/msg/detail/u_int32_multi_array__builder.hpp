...
{
public:
    explicit Init_UInt32MultiArray_data(::example_interfaces::msg::UInt32MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_UInt32MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::UInt32MultiArray>()
{
