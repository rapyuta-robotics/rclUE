...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        example_interfaces__msg__WString__rosidl_typesupport_introspection_c__WString_message_member_array[1] = {{
            "data",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        example_interfaces__msg__WString__rosidl_typesupport_introspection_c__WString_message_members = {
            ...
            example_interfaces__msg__WString__rosidl_typesupport_introspection_c__WString_message_member_array,    // message
                                                                                                                   // members
            example_interfaces__msg__WString__rosidl_typesupport_introspection_c__WString_init_function,           // function to
                                                                                                            // initialize message
                                                                                                            // memory (memory has to
                                                                                                            // be allocated)
            example_interfaces__msg__WString__rosidl_typesupport_introspection_c__WString_fini_function    // function to terminate
    ...
    {
        if (!example_interfaces__msg__WString__rosidl_typesupport_introspection_c__WString_message_type_support_handle
