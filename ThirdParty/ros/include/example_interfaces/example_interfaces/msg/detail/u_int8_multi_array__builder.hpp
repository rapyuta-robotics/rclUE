...
{
public:
    explicit Init_UInt8MultiArray_data(::example_interfaces::msg::UInt8MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_UInt8MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::UInt8MultiArray>()
{
