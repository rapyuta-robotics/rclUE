...
{
public:
    explicit Init_UInt16MultiArray_data(::example_interfaces::msg::UInt16MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_UInt16MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::UInt16MultiArray>()
{
