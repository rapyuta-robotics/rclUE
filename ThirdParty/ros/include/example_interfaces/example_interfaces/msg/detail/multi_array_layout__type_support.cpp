...
{
    auto& member = *reinterpret_cast<std::vector<example_interfaces::msg::MultiArrayDimension>*>(untyped_member);
    return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiArrayLayout_message_member_array[2] = {
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            example_interfaces::msg::MultiArrayDimension>(),         // members of sub message
        true,                                                        // is array
        0,                                                           // array size
