...
struct UInt32MultiArray_
{
    ...
    // pointer types
    using RawPtr = example_interfaces::msg::UInt32MultiArray_<ContainerAllocator>*;
    using ConstRawPtr = const example_interfaces::msg::UInt32MultiArray_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<example_interfaces::msg::UInt32MultiArray_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<example_interfaces::msg::UInt32MultiArray_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<example_interfaces::msg::UInt32MultiArray_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<example_interfaces::msg::UInt32MultiArray_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<example_interfaces::msg::UInt32MultiArray_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<example_interfaces::msg::UInt32MultiArray_<ContainerAllocator> const>;
...
using UInt32MultiArray = example_interfaces::msg::UInt32MultiArray_<std::allocator<void>>;
