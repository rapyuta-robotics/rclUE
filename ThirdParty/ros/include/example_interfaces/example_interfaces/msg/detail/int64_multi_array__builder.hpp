...
{
public:
    explicit Init_Int64MultiArray_data(::example_interfaces::msg::Int64MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Int64MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::Int64MultiArray>()
{
