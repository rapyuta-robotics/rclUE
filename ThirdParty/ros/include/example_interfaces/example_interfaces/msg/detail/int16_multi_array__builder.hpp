...
{
public:
    explicit Init_Int16MultiArray_data(::example_interfaces::msg::Int16MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Int16MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::Int16MultiArray>()
{
