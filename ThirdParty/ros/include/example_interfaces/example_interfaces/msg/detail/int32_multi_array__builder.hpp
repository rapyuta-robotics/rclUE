...
{
public:
    explicit Init_Int32MultiArray_data(::example_interfaces::msg::Int32MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Int32MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::Int32MultiArray>()
{
