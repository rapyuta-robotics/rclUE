...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces cdr_serialize(const example_interfaces::msg::WString& ros_message,
...
get_serialized_size(const example_interfaces::msg::WString& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces max_serialized_size_WString(bool& full_bounded,
                                                                                             bool& is_plain,
