...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_message_member_array[1] = {{
            "data",                                                // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_message_members = {
            ...
            example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_init_function,    // function to initialize
                                                                                                        // message memory (memory
                                                                                                        // has to be allocated)
            example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_fini_function     // function to terminate
    ...
    static rosidl_message_type_support_t
        example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_message_type_support_handle = {
            0,
            &example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_message_members,
    ...
    {
        if (!example_interfaces__msg__Int64__rosidl_typesupport_introspection_c__Int64_message_type_support_handle
