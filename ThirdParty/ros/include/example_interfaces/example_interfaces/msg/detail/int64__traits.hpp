...
to_yaml(const example_interfaces::msg::Int64& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<example_interfaces::msg::Int64> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<example_interfaces::msg::Int64> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<example_interfaces::msg::Int64> : std::true_type
{
};
