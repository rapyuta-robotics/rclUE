...
{
public:
    explicit Init_UInt64MultiArray_data(::example_interfaces::msg::UInt64MultiArray& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_UInt64MultiArray_layout() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::example_interfaces::msg::UInt64MultiArray>()
{
