...
struct MultiArrayLayout_
{
    ...
    using _dim_type = std::vector<example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>,
    ...
    Type& set__dim(const std::vector<example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>,
                                     typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                         example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>>>& _arg)
    {
        this->dim = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = example_interfaces::msg::MultiArrayLayout_<ContainerAllocator>*;
    using ConstRawPtr = const example_interfaces::msg::MultiArrayLayout_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<example_interfaces::msg::MultiArrayLayout_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<example_interfaces::msg::MultiArrayLayout_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<example_interfaces::msg::MultiArrayLayout_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<example_interfaces::msg::MultiArrayLayout_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<example_interfaces::msg::MultiArrayLayout_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<example_interfaces::msg::MultiArrayLayout_<ContainerAllocator> const>;
...
using MultiArrayLayout = example_interfaces::msg::MultiArrayLayout_<std::allocator<void>>;
