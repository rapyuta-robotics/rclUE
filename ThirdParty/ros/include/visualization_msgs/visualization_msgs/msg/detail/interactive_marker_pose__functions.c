...
bool visualization_msgs__msg__InteractiveMarkerPose__are_equal(const visualization_msgs__msg__InteractiveMarkerPose* lhs,
...
bool visualization_msgs__msg__InteractiveMarkerPose__copy(const visualization_msgs__msg__InteractiveMarkerPose* input,
...
visualization_msgs__msg__InteractiveMarkerPose* visualization_msgs__msg__InteractiveMarkerPose__create()
{
...
bool visualization_msgs__msg__InteractiveMarkerPose__Sequence__init(visualization_msgs__msg__InteractiveMarkerPose__Sequence* array,
                                                                    size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (visualization_msgs__msg__InteractiveMarkerPose*)allocator.zero_allocate(
...
void visualization_msgs__msg__InteractiveMarkerPose__Sequence__fini(visualization_msgs__msg__InteractiveMarkerPose__Sequence* array)
{
    if (!array)
    {
        return;
...
visualization_msgs__msg__InteractiveMarkerPose__Sequence* visualization_msgs__msg__InteractiveMarkerPose__Sequence__create(
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__msg__InteractiveMarkerPose__Sequence* array =
        (visualization_msgs__msg__InteractiveMarkerPose__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__msg__InteractiveMarkerPose__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__msg__InteractiveMarkerPose__Sequence__destroy(
    visualization_msgs__msg__InteractiveMarkerPose__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__msg__InteractiveMarkerPose__Sequence__are_equal(
...
bool visualization_msgs__msg__InteractiveMarkerPose__Sequence__copy(
    ...
    visualization_msgs__msg__InteractiveMarkerPose__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__msg__InteractiveMarkerPose);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        visualization_msgs__msg__InteractiveMarkerPose* data =
            (visualization_msgs__msg__InteractiveMarkerPose*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!visualization_msgs__msg__InteractiveMarkerPose__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
