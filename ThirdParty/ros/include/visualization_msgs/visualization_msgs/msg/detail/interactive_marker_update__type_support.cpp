...
void InteractiveMarkerUpdate_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    auto& member = *reinterpret_cast<std::vector<visualization_msgs::msg::InteractiveMarker>*>(untyped_member);
    return &member[index];
}

void fetch_function__InteractiveMarkerUpdate__markers(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__InteractiveMarkerUpdate__markers(void* untyped_member, size_t index, const void* untyped_value)
{
...
{
    auto& member = *reinterpret_cast<std::vector<visualization_msgs::msg::InteractiveMarkerPose>*>(untyped_member);
    return &member[index];
}

void fetch_function__InteractiveMarkerUpdate__poses(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__InteractiveMarkerUpdate__poses(void* untyped_member, size_t index, const void* untyped_value)
{
...
void fetch_function__InteractiveMarkerUpdate__erases(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const std::string*>(get_const_function__InteractiveMarkerUpdate__erases(untyped_member, index));
    auto& value = *reinterpret_cast<std::string*>(untyped_value);
    value = item;
}

void assign_function__InteractiveMarkerUpdate__erases(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<std::string*>(get_function__InteractiveMarkerUpdate__erases(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InteractiveMarkerUpdate_message_member_array[6] = {
    ...
    },
    {
        ...
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            visualization_msgs::msg::InteractiveMarker>(),                      // members of sub message
        true,                                                                   // is array
        0,                                                                      // array size
        false,                                                                  // is upper bound
    ...
    },
    {
        ...
        0,                                                           // upper bound of string
        ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
            visualization_msgs::msg::InteractiveMarkerPose>(),                // members of sub message
        true,                                                                 // is array
        0,                                                                    // array size
        false,                                                                // is upper bound
...
extern "C"
{
    ...
    {
        return &::visualization_msgs::msg::rosidl_typesupport_introspection_cpp::
            InteractiveMarkerUpdate_message_type_support_handle;
    }
