...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_member_array[5] = {
            {
                "id",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_members = {
            ...
            visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_member_array,    // message
                                                                                                                       // members
            visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_init_function,    // function to
                                                                                                                // initialize
                                                                                                                // message memory
                                                                                                                // (memory has to be
                                                                                                                // allocated)
            visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_fini_function     // function to
                                                                                                                // terminate message
                                                                                                               // instance (will not
                                                                                                               // free memory)
    };
    ...
    {
        if (!visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_type_support_handle
