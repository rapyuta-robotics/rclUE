...
extern "C"
{
    ...
    void* visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__get_function__MeshFile__data(void* untyped_member,
                                                                                                              size_t index)
    {
        ...
        void* untyped_value)
    {
        const uint8_t* item =
            ((const uint8_t*)
                 visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__get_const_function__MeshFile__data(
    ...
    {
        uint8_t* item =
            ((uint8_t*)visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__get_function__MeshFile__data(
                untyped_member, index));
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__MeshFile_message_member_array[2] = {
            {
                "filename",                                               // name
            ...
            },
            {
                ...
                NULL,                                                  // default value
                visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__size_function__MeshFile__data,    // size()
                                                                                                                         // function
                                                                                                                         // pointer
                visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__get_const_function__MeshFile__data,    // get_const(index)
                                                                                                                              // function
                                                                                                                              // pointer
                visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__get_function__MeshFile__data,    // get(index)
                                                                                                                        // function
                                                                                                                        // pointer
                visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__fetch_function__MeshFile__data,    // fetch(index,
                                                                                                                          // &value)
                                                                                                                          // function
                                                                                                                          // pointer
                visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__assign_function__MeshFile__data,    // assign(index,
                                                                                                                           // value)
                                                                                                                           // function
                                                                                                                           // pointer
                visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__resize_function__MeshFile__data    // resize(index)
                                                                                                                          // function
                                                                                                                          // pointer
            }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__MeshFile_message_members = {
            ...
            visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__MeshFile_message_member_array,    // message
                                                                                                                     // members
            visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__MeshFile_init_function,           // function to
                                                                                                              // initialize message
                                                                                                              // memory (memory has
                                                                                                              // to be allocated)
            visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__MeshFile_fini_function    // function to
                                                                                                             // terminate message
                                                                                                             // instance (will not
                                                                                                             // free memory)
    };
    ...
    {
        if (!visualization_msgs__msg__MeshFile__rosidl_typesupport_introspection_c__MeshFile_message_type_support_handle
