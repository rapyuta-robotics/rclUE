...
extern "C"
{
    ...
    void
    visualization_msgs__msg__InteractiveMarkerFeedback__rosidl_typesupport_introspection_c__InteractiveMarkerFeedback_init_function(
        void* message_memory,
    ...
    void
    visualization_msgs__msg__InteractiveMarkerFeedback__rosidl_typesupport_introspection_c__InteractiveMarkerFeedback_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__InteractiveMarkerFeedback__rosidl_typesupport_introspection_c__InteractiveMarkerFeedback_message_member_array
            [9] = {{
                       "header",                                                // name
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__InteractiveMarkerFeedback__rosidl_typesupport_introspection_c__InteractiveMarkerFeedback_message_type_support_handle =
            {
                0,
                &visualization_msgs__msg__InteractiveMarkerFeedback__rosidl_typesupport_introspection_c__InteractiveMarkerFeedback_message_members,
                                                      ...
                                                      InteractiveMarkerFeedback)()
    {
        ...
        if (!visualization_msgs__msg__InteractiveMarkerFeedback__rosidl_typesupport_introspection_c__InteractiveMarkerFeedback_message_type_support_handle
