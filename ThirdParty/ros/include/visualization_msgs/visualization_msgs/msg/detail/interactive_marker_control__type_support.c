...
extern "C"
{
    ...
    size_t
    visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__size_function__InteractiveMarkerControl__markers(
    ...
    void
    visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__assign_function__InteractiveMarkerControl__markers(
        void* untyped_member,
        size_t index,
    ...
    bool
    visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__resize_function__InteractiveMarkerControl__markers(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__Marker__Sequence* member = (visualization_msgs__msg__Marker__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__InteractiveMarkerControl_message_member_array
        [8] = {
            {
                "name",                                                               // name
            ...
            },
            {
                ...
                0,                                                       // array size
                false,                                                   // is upper bound
                offsetof(visualization_msgs__msg__InteractiveMarkerControl,
                         independent_marker_orientation),    // bytes offset in struct
                NULL,                                        // default value
                NULL,                                        // size() function pointer
                NULL,                                        // get_const(index) function pointer
                NULL,                                        // get(index) function pointer
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__InteractiveMarkerControl_message_type_support_handle =
            {
                0,
                &visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__InteractiveMarkerControl_message_members,
    ...
    {
        visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__InteractiveMarkerControl_message_member_array
            [1]
                .members_ =
        ...
        if (!visualization_msgs__msg__InteractiveMarkerControl__rosidl_typesupport_introspection_c__InteractiveMarkerControl_message_type_support_handle
