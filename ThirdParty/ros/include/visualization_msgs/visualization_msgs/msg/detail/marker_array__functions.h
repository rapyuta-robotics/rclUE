...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__MarkerArray__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__MarkerArray__fini(
        visualization_msgs__msg__MarkerArray* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__MarkerArray*
    visualization_msgs__msg__MarkerArray__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__MarkerArray__destroy(
        visualization_msgs__msg__MarkerArray* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__MarkerArray__are_equal(
        const visualization_msgs__msg__MarkerArray* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__MarkerArray__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__MarkerArray__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__MarkerArray__Sequence__fini(
        visualization_msgs__msg__MarkerArray__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__MarkerArray__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__MarkerArray__Sequence__destroy(
        visualization_msgs__msg__MarkerArray__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__MarkerArray__Sequence__are_equal(
        const visualization_msgs__msg__MarkerArray__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__MarkerArray__Sequence__copy(
