...
struct MenuEntry_
{
    ...
    Type& set__parent_id(const uint32_t& _arg)
    {
        this->parent_id = _arg;
        return *this;
    }
    Type& set__title(const std::basic_string<char,
    ...
    Type& set__command_type(const uint8_t& _arg)
    {
    ...
    static constexpr uint8_t FEEDBACK = 0u;
    static constexpr uint8_t ROSRUN = 1u;
    static constexpr uint8_t ROSLAUNCH = 2u;

    // pointer types
    using RawPtr = visualization_msgs::msg::MenuEntry_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::MenuEntry_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::MenuEntry_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::MenuEntry_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator> const>;

    // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
    // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
    typedef DEPRECATED__visualization_msgs__msg__MenuEntry std::shared_ptr<visualization_msgs::msg::MenuEntry_<ContainerAllocator>>
        Ptr;
...
using MenuEntry = visualization_msgs::msg::MenuEntry_<std::allocator<void>>;
