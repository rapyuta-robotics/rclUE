...
void MarkerArray_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__MarkerArray__markers(const void* untyped_member, size_t index, void* untyped_value)
{
    const auto& item =
        *reinterpret_cast<const visualization_msgs::msg::Marker*>(get_const_function__MarkerArray__markers(untyped_member, index));
    auto& value = *reinterpret_cast<visualization_msgs::msg::Marker*>(untyped_value);
    value = item;
}

void assign_function__MarkerArray__markers(void* untyped_member, size_t index, const void* untyped_value)
{
    auto& item = *reinterpret_cast<visualization_msgs::msg::Marker*>(get_function__MarkerArray__markers(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MarkerArray_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<visualization_msgs::msg::Marker>(),    // members of sub
                                                                                                                   // message
    true,                                                                                                          // is array
    0,                                                                                                             // array size
