...
struct ImageMarker_
{
    ...
    explicit ImageMarker_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : header(_init), position(_init), outline_color(_init), fill_color(_init), lifetime(_init)
    {
    ...
    _action_type action;
    using _position_type = geometry_msgs::msg::Point_<ContainerAllocator>;
    _position_type position;
    using _scale_type = float;
    _scale_type scale;
    using _outline_color_type = std_msgs::msg::ColorRGBA_<ContainerAllocator>;
    _outline_color_type outline_color;
    using _filled_type = uint8_t;
    _filled_type filled;
    using _fill_color_type = std_msgs::msg::ColorRGBA_<ContainerAllocator>;
    ...
    _points_type points;
    using _outline_colors_type = std::vector<
    ...
    Type& set__scale(const float& _arg)
    {
        this->scale = _arg;
        return *this;
    }
    Type& set__outline_color(const std_msgs::msg::ColorRGBA_<ContainerAllocator>& _arg)
    {
        this->outline_color = _arg;
        return *this;
    }
    Type& set__filled(const uint8_t& _arg)
    {
        this->filled = _arg;
        return *this;
    }
    Type& set__fill_color(const std_msgs::msg::ColorRGBA_<ContainerAllocator>& _arg)
    {
    ...
    Type& set__outline_colors(const std::vector<std_msgs::msg::ColorRGBA_<ContainerAllocator>,
                                                typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    // pointer types
    using RawPtr = visualization_msgs::msg::ImageMarker_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::ImageMarker_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::ImageMarker_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::ImageMarker_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::ImageMarker_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::ImageMarker_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::ImageMarker_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::ImageMarker_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<visualization_msgs::msg::ImageMarker_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::ImageMarker_<ContainerAllocator> const>;
...
using ImageMarker = visualization_msgs::msg::ImageMarker_<std::allocator<void>>;
