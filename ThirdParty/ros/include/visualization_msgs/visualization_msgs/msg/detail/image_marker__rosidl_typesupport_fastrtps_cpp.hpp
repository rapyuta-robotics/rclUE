...
cdr_serialize(const visualization_msgs::msg::ImageMarker& ros_message, eprosima::fastcdr::Cdr& cdr);
...
get_serialized_size(const visualization_msgs::msg::ImageMarker& ros_message, size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_visualization_msgs max_serialized_size_ImageMarker(bool& full_bounded,
                                                                                                 bool& is_plain,
