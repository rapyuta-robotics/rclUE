...
bool visualization_msgs__msg__InteractiveMarkerFeedback__are_equal(const visualization_msgs__msg__InteractiveMarkerFeedback* lhs,
                                                                   const visualization_msgs__msg__InteractiveMarkerFeedback* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // client_id
    if (!rosidl_runtime_c__String__are_equal(&(lhs->client_id), &(rhs->client_id)))
    {
        return false;
    }
    // marker_name
    if (!rosidl_runtime_c__String__are_equal(&(lhs->marker_name), &(rhs->marker_name)))
    {
        return false;
    }
    // control_name
    if (!rosidl_runtime_c__String__are_equal(&(lhs->control_name), &(rhs->control_name)))
    {
        return false;
    }
    // event_type
    ...
    // mouse_point
    if (!geometry_msgs__msg__Point__are_equal(&(lhs->mouse_point), &(rhs->mouse_point)))
    {
        return false;
    }
    // mouse_point_valid
...
bool visualization_msgs__msg__InteractiveMarkerFeedback__copy(const visualization_msgs__msg__InteractiveMarkerFeedback* input,
                                                              visualization_msgs__msg__InteractiveMarkerFeedback* output)
{
    ...
    // client_id
    if (!rosidl_runtime_c__String__copy(&(input->client_id), &(output->client_id)))
    {
        return false;
    }
    // marker_name
    if (!rosidl_runtime_c__String__copy(&(input->marker_name), &(output->marker_name)))
    {
        return false;
    }
    // control_name
    if (!rosidl_runtime_c__String__copy(&(input->control_name), &(output->control_name)))
    {
        return false;
    }
    // event_type
    ...
    // mouse_point
    if (!geometry_msgs__msg__Point__copy(&(input->mouse_point), &(output->mouse_point)))
    {
        return false;
    }
    // mouse_point_valid
...
visualization_msgs__msg__InteractiveMarkerFeedback* visualization_msgs__msg__InteractiveMarkerFeedback__create()
{
    ...
    visualization_msgs__msg__InteractiveMarkerFeedback* msg =
        (visualization_msgs__msg__InteractiveMarkerFeedback*)allocator.allocate(
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (visualization_msgs__msg__InteractiveMarkerFeedback*)allocator.zero_allocate(
    ...
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* array =
        (visualization_msgs__msg__InteractiveMarkerFeedback__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__msg__InteractiveMarkerFeedback__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__destroy(
    visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__are_equal(
    const visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* lhs,
    const visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__copy(
    ...
    visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__msg__InteractiveMarkerFeedback);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ...
    {
        if (!visualization_msgs__msg__InteractiveMarkerFeedback__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
