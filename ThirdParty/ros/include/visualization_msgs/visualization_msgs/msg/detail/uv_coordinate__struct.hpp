...
struct UVCoordinate_
{
    ...
    explicit UVCoordinate_(const ContainerAllocator& _alloc,
    ...
    Type& set__u(const float& _arg)
    {
        this->u = _arg;
        return *this;
    }
    Type& set__v(const float& _arg)
    {
        this->v = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = visualization_msgs::msg::UVCoordinate_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::UVCoordinate_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::UVCoordinate_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::UVCoordinate_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::UVCoordinate_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::UVCoordinate_<ContainerAllocator>, Deleter>;

    using UniquePtr = UniquePtrWithDeleter<>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::UVCoordinate_<ContainerAllocator>>>
    using ConstUniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::UVCoordinate_<ContainerAllocator> const, Deleter>;
    using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

    using WeakPtr = std::weak_ptr<visualization_msgs::msg::UVCoordinate_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::UVCoordinate_<ContainerAllocator> const>;
...
using UVCoordinate = visualization_msgs::msg::UVCoordinate_<std::allocator<void>>;
