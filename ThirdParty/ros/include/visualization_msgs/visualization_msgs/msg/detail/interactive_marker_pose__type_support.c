...
extern "C"
{
    ...
    void visualization_msgs__msg__InteractiveMarkerPose__rosidl_typesupport_introspection_c__InteractiveMarkerPose_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__InteractiveMarkerPose__rosidl_typesupport_introspection_c__InteractiveMarkerPose_message_member_array
            [3] = {{
                       "header",                                                // name
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__InteractiveMarkerPose__rosidl_typesupport_introspection_c__InteractiveMarkerPose_message_type_support_handle =
            {
                0,
                &visualization_msgs__msg__InteractiveMarkerPose__rosidl_typesupport_introspection_c__InteractiveMarkerPose_message_members,
                                                      ...
                                                      InteractiveMarkerPose)()
    {
        ...
        if (!visualization_msgs__msg__InteractiveMarkerPose__rosidl_typesupport_introspection_c__InteractiveMarkerPose_message_type_support_handle
