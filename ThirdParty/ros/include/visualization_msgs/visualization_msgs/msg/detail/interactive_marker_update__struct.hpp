...
struct InteractiveMarkerUpdate_
{
    ...
    explicit InteractiveMarkerUpdate_(
    ...
    using _poses_type = std::vector<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>,
                                    typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    Type& set__seq_num(const uint64_t& _arg)
    {
        this->seq_num = _arg;
        return *this;
    }
    ...
    Type& set__poses(const std::vector<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>,
                                       typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                           visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>>>& _arg)
    {
        this->poses = _arg;
        return *this;
    }
    ...
    static constexpr uint8_t UPDATE = 1u;

    // pointer types
    using RawPtr = visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerUpdate_<ContainerAllocator> const>;
...
using InteractiveMarkerUpdate = visualization_msgs::msg::InteractiveMarkerUpdate_<std::allocator<void>>;
