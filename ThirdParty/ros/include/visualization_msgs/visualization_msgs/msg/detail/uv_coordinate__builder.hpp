...
{
public:
    explicit Init_UVCoordinate_v(::visualization_msgs::msg::UVCoordinate& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_UVCoordinate_u() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::UVCoordinate>()
{
