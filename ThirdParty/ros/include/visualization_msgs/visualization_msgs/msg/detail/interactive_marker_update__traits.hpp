...
inline void to_flow_style_yaml(const InteractiveMarkerUpdate& msg, std::ostream& out)
{
    out << "{";
    // member: server_id
    {
...
inline void to_block_style_yaml(const InteractiveMarkerUpdate& msg, std::ostream& out, size_t indentation = 0)
{
    // member: server_id
    {
        if (indentation > 0)
...
to_yaml(const visualization_msgs::msg::InteractiveMarkerUpdate& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<visualization_msgs::msg::InteractiveMarkerUpdate> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<visualization_msgs::msg::InteractiveMarkerUpdate> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<visualization_msgs::msg::InteractiveMarkerUpdate> : std::true_type
{
};
