...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_message_member_array[2] = {
            {
                "u",                                                   // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_message_members = {
            ...
            visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_message_member_array,    // message
                                                                                                                             // members
            visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_init_function,    // function to
                                                                                                                      // initialize
                                                                                                                      // message
                                                                                                                      // memory
                                                                                                                      // (memory has
                                                                                                                      // to be
                                                                                                                      // allocated)
            visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_fini_function     // function to
                                                                                                                      // terminate
                                                                                                                      // message
                                                                                                                      // instance
                                                                                                                      // (will not
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_message_type_support_handle = {
            0,
            &visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_message_members,
    ...
    {
        if (!visualization_msgs__msg__UVCoordinate__rosidl_typesupport_introspection_c__UVCoordinate_message_type_support_handle
