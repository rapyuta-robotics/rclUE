...
extern "C"
{
    ...
    size_t
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__size_function__InteractiveMarker__menu_entries(
    ...
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__get_function__InteractiveMarker__menu_entries(
        ...
        size_t index)
    {
        visualization_msgs__msg__MenuEntry__Sequence* member = (visualization_msgs__msg__MenuEntry__Sequence*)(untyped_member);
        return &member->data[index];
    }

    void
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__fetch_function__InteractiveMarker__menu_entries(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
        ...
        visualization_msgs__msg__MenuEntry* value = (visualization_msgs__msg__MenuEntry*)(untyped_value);
        *value = *item;
    }

    void
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__assign_function__InteractiveMarker__menu_entries(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
        visualization_msgs__msg__MenuEntry* item =
            ((visualization_msgs__msg__MenuEntry*)
                 visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__get_function__InteractiveMarker__menu_entries(
                     untyped_member, index));
        const visualization_msgs__msg__MenuEntry* value = (const visualization_msgs__msg__MenuEntry*)(untyped_value);
        *item = *value;
    }

    bool
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__resize_function__InteractiveMarker__menu_entries(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__MenuEntry__Sequence* member = (visualization_msgs__msg__MenuEntry__Sequence*)(untyped_member);
    ...
    size_t
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__size_function__InteractiveMarker__controls(
        const void* untyped_member)
    {
    ...
    const void*
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__get_const_function__InteractiveMarker__controls(
        const void* untyped_member,
        size_t index)
    {
        const visualization_msgs__msg__InteractiveMarkerControl__Sequence* member =
    ...
    void
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__fetch_function__InteractiveMarker__controls(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__assign_function__InteractiveMarker__controls(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
    ...
    bool
    visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__resize_function__InteractiveMarker__controls(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__InteractiveMarkerControl__Sequence* member =
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_member_array[7] = {
            {
                "header",                                                        // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_members = {
            ...
            visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_fini_function    // function
                                                                                                                               // to
                                                                                                                               // terminate
                                                                                                                               // message
                                                                                                                               // instance
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c,
                                                      ...
                                                      InteractiveMarker)()
    {
        visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_member_array[0]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
        visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_member_array[1]
            .members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
        visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_member_array[5]
            .members_ = ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
            rosidl_typesupport_introspection_c, visualization_msgs, msg, MenuEntry)();
        visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_member_array[6]
            .members_ = ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
            rosidl_typesupport_introspection_c, visualization_msgs, msg, InteractiveMarkerControl)();
        if (!visualization_msgs__msg__InteractiveMarker__rosidl_typesupport_introspection_c__InteractiveMarker_message_type_support_handle
