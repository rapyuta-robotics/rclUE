...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__ImageMarker__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__ImageMarker__fini(
        visualization_msgs__msg__ImageMarker* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__ImageMarker*
    visualization_msgs__msg__ImageMarker__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__ImageMarker__destroy(
        visualization_msgs__msg__ImageMarker* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__ImageMarker__are_equal(
        const visualization_msgs__msg__ImageMarker* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__ImageMarker__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__ImageMarker__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__ImageMarker__Sequence__fini(
        visualization_msgs__msg__ImageMarker__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__ImageMarker__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__ImageMarker__Sequence__destroy(
        visualization_msgs__msg__ImageMarker__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__ImageMarker__Sequence__are_equal(
        const visualization_msgs__msg__ImageMarker__Sequence* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__ImageMarker__Sequence__copy(
