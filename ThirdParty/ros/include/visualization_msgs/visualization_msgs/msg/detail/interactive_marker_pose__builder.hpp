...
{
public:
    explicit Init_InteractiveMarkerPose_name(::visualization_msgs::msg::InteractiveMarkerPose& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerPose_pose(::visualization_msgs::msg::InteractiveMarkerPose& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_InteractiveMarkerPose_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::InteractiveMarkerPose>()
{
