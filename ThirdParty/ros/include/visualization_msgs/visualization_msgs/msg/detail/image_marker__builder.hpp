...
{
public:
    explicit Init_ImageMarker_outline_colors(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_points(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_lifetime(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_fill_color(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_filled(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_outline_color(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_scale(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_position(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_action(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_type(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_id(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_ImageMarker_ns(::visualization_msgs::msg::ImageMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_ImageMarker_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::ImageMarker>()
{
