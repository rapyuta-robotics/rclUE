...
bool visualization_msgs__msg__InteractiveMarkerUpdate__are_equal(const visualization_msgs__msg__InteractiveMarkerUpdate* lhs,
                                                                 const visualization_msgs__msg__InteractiveMarkerUpdate* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // server_id
    if (!rosidl_runtime_c__String__are_equal(&(lhs->server_id), &(rhs->server_id)))
    {
        return false;
    }
    // seq_num
    ...
    // poses
    if (!visualization_msgs__msg__InteractiveMarkerPose__Sequence__are_equal(&(lhs->poses), &(rhs->poses)))
    {
        return false;
    }
    // erases
    if (!rosidl_runtime_c__String__Sequence__are_equal(&(lhs->erases), &(rhs->erases)))
    {
        return false;
    }
    return true;
...
bool visualization_msgs__msg__InteractiveMarkerUpdate__copy(const visualization_msgs__msg__InteractiveMarkerUpdate* input,
                                                            visualization_msgs__msg__InteractiveMarkerUpdate* output)
{
    ...
    // server_id
    if (!rosidl_runtime_c__String__copy(&(input->server_id), &(output->server_id)))
    {
        return false;
    }
    // seq_num
    ...
    // poses
    if (!visualization_msgs__msg__InteractiveMarkerPose__Sequence__copy(&(input->poses), &(output->poses)))
    {
        return false;
    }
    // erases
    if (!rosidl_runtime_c__String__Sequence__copy(&(input->erases), &(output->erases)))
    {
        return false;
    }
    return true;
...
visualization_msgs__msg__InteractiveMarkerUpdate* visualization_msgs__msg__InteractiveMarkerUpdate__create()
{
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (visualization_msgs__msg__InteractiveMarkerUpdate*)allocator.zero_allocate(
...
visualization_msgs__msg__InteractiveMarkerUpdate__Sequence* visualization_msgs__msg__InteractiveMarkerUpdate__Sequence__create(
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__msg__InteractiveMarkerUpdate__Sequence* array =
        (visualization_msgs__msg__InteractiveMarkerUpdate__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__msg__InteractiveMarkerUpdate__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__msg__InteractiveMarkerUpdate__Sequence__destroy(
    visualization_msgs__msg__InteractiveMarkerUpdate__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__msg__InteractiveMarkerUpdate__Sequence__are_equal(
    const visualization_msgs__msg__InteractiveMarkerUpdate__Sequence* lhs,
    const visualization_msgs__msg__InteractiveMarkerUpdate__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool visualization_msgs__msg__InteractiveMarkerUpdate__Sequence__copy(
    ...
    visualization_msgs__msg__InteractiveMarkerUpdate__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__msg__InteractiveMarkerUpdate);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        visualization_msgs__msg__InteractiveMarkerUpdate* data =
            (visualization_msgs__msg__InteractiveMarkerUpdate*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!visualization_msgs__msg__InteractiveMarkerUpdate__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
