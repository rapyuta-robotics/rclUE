...
struct InteractiveMarkerInit_
{
    ...
    explicit InteractiveMarkerInit_(
    ...
    // pointer types
    using RawPtr = visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerInit_<ContainerAllocator> const>;
...
using InteractiveMarkerInit = visualization_msgs::msg::InteractiveMarkerInit_<std::allocator<void>>;
