...
extern "C"
{
    ...
    void visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__InteractiveMarkerInit_fini_function(
        void* message_memory)
    {
    ...
    size_t
    visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__size_function__InteractiveMarkerInit__markers(
    ...
    const void*
    visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__get_const_function__InteractiveMarkerInit__markers(
        const void* untyped_member,
        size_t index)
    {
        const visualization_msgs__msg__InteractiveMarker__Sequence* member =
    ...
    void*
    visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__get_function__InteractiveMarkerInit__markers(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__fetch_function__InteractiveMarkerInit__markers(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__assign_function__InteractiveMarkerInit__markers(
        void* untyped_member,
        size_t index,
    ...
    bool
    visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__resize_function__InteractiveMarkerInit__markers(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__InteractiveMarker__Sequence* member =
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__InteractiveMarkerInit__rosidl_typesupport_introspection_c__InteractiveMarkerInit_message_member_array[3] = {
            {
                "server_id",                                                            // name
