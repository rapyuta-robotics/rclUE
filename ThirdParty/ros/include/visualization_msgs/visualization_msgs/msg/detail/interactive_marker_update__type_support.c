...
extern "C"
{
    ...
    void
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_init_function(
        void* message_memory,
    ...
    void
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_fini_function(
        void* message_memory)
    {
    ...
    size_t
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__size_function__InteractiveMarkerUpdate__markers(
    ...
    const void*
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__get_const_function__InteractiveMarkerUpdate__markers(
        const void* untyped_member,
        size_t index)
    {
        const visualization_msgs__msg__InteractiveMarker__Sequence* member =
    ...
    void*
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__get_function__InteractiveMarkerUpdate__markers(
        void* untyped_member,
        size_t index)
    {
        ...
        void* untyped_value)
    {
        ...
        visualization_msgs__msg__InteractiveMarker* value = (visualization_msgs__msg__InteractiveMarker*)(untyped_value);
        *value = *item;
    }
    ...
    bool
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__resize_function__InteractiveMarkerUpdate__markers(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__InteractiveMarker__Sequence* member =
    ...
    size_t
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__size_function__InteractiveMarkerUpdate__poses(
        const void* untyped_member)
    {
        ...
        void* untyped_value)
    {
        const visualization_msgs__msg__InteractiveMarkerPose* item =
            ((const visualization_msgs__msg__InteractiveMarkerPose*)
                 visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__get_const_function__InteractiveMarkerUpdate__poses(
                     untyped_member, index));
        visualization_msgs__msg__InteractiveMarkerPose* value = (visualization_msgs__msg__InteractiveMarkerPose*)(untyped_value);
        *value = *item;
    }
    ...
    bool
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__resize_function__InteractiveMarkerUpdate__poses(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__InteractiveMarkerPose__Sequence* member =
    ...
    size_t
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__size_function__InteractiveMarkerUpdate__erases(
        const void* untyped_member)
    {
    ...
    const void*
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__get_const_function__InteractiveMarkerUpdate__erases(
        const void* untyped_member,
        size_t index)
    {
        const rosidl_runtime_c__String__Sequence* member = (const rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    void*
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__get_function__InteractiveMarkerUpdate__erases(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__assign_function__InteractiveMarkerUpdate__erases(
        void* untyped_member,
        size_t index,
        const void* untyped_value)
    {
    ...
    bool
    visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__resize_function__InteractiveMarkerUpdate__erases(
        void* untyped_member,
        size_t size)
    {
        rosidl_runtime_c__String__Sequence* member = (rosidl_runtime_c__String__Sequence*)(untyped_member);
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_message_member_array[6] = {
            {
                "server_id",                                                              // name
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_message_type_support_handle =
            {
                0,
                &visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_message_members,
                                                      ...
                                                      InteractiveMarkerUpdate)()
    {
        visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_message_member_array
            ...
            rosidl_typesupport_introspection_c, visualization_msgs, msg, InteractiveMarker)();
        visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_message_member_array
            [4]
                .members_ = ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
            rosidl_typesupport_introspection_c, visualization_msgs, msg, InteractiveMarkerPose)();
        if (!visualization_msgs__msg__InteractiveMarkerUpdate__rosidl_typesupport_introspection_c__InteractiveMarkerUpdate_message_type_support_handle
