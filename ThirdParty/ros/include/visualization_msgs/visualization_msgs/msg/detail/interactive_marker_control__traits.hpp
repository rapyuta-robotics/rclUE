...
inline void to_flow_style_yaml(const InteractiveMarkerControl& msg, std::ostream& out)
{
    out << "{";
    // member: name
    {
...
inline void to_block_style_yaml(const InteractiveMarkerControl& msg, std::ostream& out, size_t indentation = 0)
{
    // member: name
    {
        if (indentation > 0)
...
to_yaml(const visualization_msgs::msg::InteractiveMarkerControl& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<visualization_msgs::msg::InteractiveMarkerControl> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<visualization_msgs::msg::InteractiveMarkerControl> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<visualization_msgs::msg::InteractiveMarkerControl> : std::true_type
{
};
