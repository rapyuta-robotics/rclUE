...
inline void to_flow_style_yaml(const UVCoordinate& msg, std::ostream& out)
{
    out << "{";
    // member: u
    {
...
inline void to_block_style_yaml(const UVCoordinate& msg, std::ostream& out, size_t indentation = 0)
{
    // member: u
    {
        if (indentation > 0)
...
to_yaml(const visualization_msgs::msg::UVCoordinate& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<visualization_msgs::msg::UVCoordinate> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<visualization_msgs::msg::UVCoordinate> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<visualization_msgs::msg::UVCoordinate> : std::true_type
{
};
