...
inline void to_flow_style_yaml(const MenuEntry& msg, std::ostream& out)
{
    out << "{";
    // member: id
    {
...
inline void to_block_style_yaml(const MenuEntry& msg, std::ostream& out, size_t indentation = 0)
{
    // member: id
    {
        if (indentation > 0)
...
to_yaml(const visualization_msgs::msg::MenuEntry& msg, std::ostream& out, size_t indentation = 0)
{
...
template<>
struct has_fixed_size<visualization_msgs::msg::MenuEntry> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<visualization_msgs::msg::MenuEntry> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<visualization_msgs::msg::MenuEntry> : std::true_type
{
};
