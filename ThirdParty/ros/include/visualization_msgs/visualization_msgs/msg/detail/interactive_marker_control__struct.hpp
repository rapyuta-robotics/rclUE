...
struct InteractiveMarkerControl_
{
    ...
    explicit InteractiveMarkerControl_(
    ...
    explicit InteractiveMarkerControl_(
        ...
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : name(_alloc), orientation(_alloc, _init), description(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->name = "";
    ...
    _name_type name;
    using _orientation_type = geometry_msgs::msg::Quaternion_<ContainerAllocator>;
    _orientation_type orientation;
    using _orientation_mode_type = uint8_t;
    _orientation_mode_type orientation_mode;
    using _interaction_mode_type = uint8_t;
    _interaction_mode_type interaction_mode;
    using _always_visible_type = bool;
    _always_visible_type always_visible;
    using _markers_type = std::vector<visualization_msgs::msg::Marker_<ContainerAllocator>,
    ...
    using _independent_marker_orientation_type = bool;
    _independent_marker_orientation_type independent_marker_orientation;
    using _description_type = std::
        basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
    ...
    Type& set__orientation_mode(const uint8_t& _arg)
    {
        this->orientation_mode = _arg;
        return *this;
    }
    Type& set__interaction_mode(const uint8_t& _arg)
    {
        this->interaction_mode = _arg;
        return *this;
    }
    Type& set__always_visible(const bool& _arg)
    {
        this->always_visible = _arg;
        return *this;
    }
    Type& set__markers(const std::vector<visualization_msgs::msg::Marker_<ContainerAllocator>,
                                         typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                             visualization_msgs::msg::Marker_<ContainerAllocator>>>& _arg)
    {
        this->markers = _arg;
        return *this;
    }
    Type& set__independent_marker_orientation(const bool& _arg)
    {
    ...
    static constexpr uint8_t INHERIT = 0u;
    static constexpr uint8_t FIXED = 1u;
    static constexpr uint8_t VIEW_FACING = 2u;
    static constexpr uint8_t NONE = 0u;
    static constexpr uint8_t MENU = 1u;
    static constexpr uint8_t BUTTON = 2u;
    static constexpr uint8_t MOVE_AXIS = 3u;
    static constexpr uint8_t MOVE_PLANE = 4u;
    static constexpr uint8_t ROTATE_AXIS = 5u;
    static constexpr uint8_t MOVE_ROTATE = 6u;
    static constexpr uint8_t MOVE_3D = 7u;
    static constexpr uint8_t ROTATE_3D = 8u;
    static constexpr uint8_t MOVE_ROTATE_3D = 9u;

    // pointer types
    using RawPtr = visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator> const>;
...
using InteractiveMarkerControl = visualization_msgs::msg::InteractiveMarkerControl_<std::allocator<void>>;
