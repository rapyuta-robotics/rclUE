...
{
public:
    explicit Init_InteractiveMarkerFeedback_mouse_point_valid(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
    ::visualization_msgs::msg::InteractiveMarkerFeedback mouse_point_valid(
        ::visualization_msgs::msg::InteractiveMarkerFeedback::_mouse_point_valid_type arg)
    {
...
{
public:
    explicit Init_InteractiveMarkerFeedback_mouse_point(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
    Init_InteractiveMarkerFeedback_mouse_point_valid mouse_point(
        ::visualization_msgs::msg::InteractiveMarkerFeedback::_mouse_point_type arg)
    {
...
{
public:
    explicit Init_InteractiveMarkerFeedback_menu_entry_id(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
    Init_InteractiveMarkerFeedback_mouse_point menu_entry_id(
        ::visualization_msgs::msg::InteractiveMarkerFeedback::_menu_entry_id_type arg)
    {
...
{
public:
    explicit Init_InteractiveMarkerFeedback_pose(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerFeedback_event_type(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerFeedback_control_name(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
    Init_InteractiveMarkerFeedback_event_type control_name(
        ::visualization_msgs::msg::InteractiveMarkerFeedback::_control_name_type arg)
    {
...
{
public:
    explicit Init_InteractiveMarkerFeedback_marker_name(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
    Init_InteractiveMarkerFeedback_control_name marker_name(
        ::visualization_msgs::msg::InteractiveMarkerFeedback::_marker_name_type arg)
    {
...
{
public:
    explicit Init_InteractiveMarkerFeedback_client_id(::visualization_msgs::msg::InteractiveMarkerFeedback& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_InteractiveMarkerFeedback_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::InteractiveMarkerFeedback>()
{
