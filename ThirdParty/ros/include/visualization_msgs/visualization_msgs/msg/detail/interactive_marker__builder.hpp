...
{
public:
    explicit Init_InteractiveMarker_controls(::visualization_msgs::msg::InteractiveMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarker_menu_entries(::visualization_msgs::msg::InteractiveMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarker_scale(::visualization_msgs::msg::InteractiveMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarker_description(::visualization_msgs::msg::InteractiveMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarker_name(::visualization_msgs::msg::InteractiveMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarker_pose(::visualization_msgs::msg::InteractiveMarker& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_InteractiveMarker_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::InteractiveMarker>()
{
