...
{
public:
    explicit Init_Marker_mesh_use_embedded_materials(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
    ::visualization_msgs::msg::Marker mesh_use_embedded_materials(
        ::visualization_msgs::msg::Marker::_mesh_use_embedded_materials_type arg)
    {
...
{
public:
    explicit Init_Marker_mesh_file(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_mesh_resource(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_text(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_uv_coordinates(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_texture(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_texture_resource(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_colors(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_points(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_frame_locked(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_lifetime(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_color(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_scale(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_pose(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_action(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_type(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_id(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_Marker_ns(::visualization_msgs::msg::Marker& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_Marker_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::Marker>()
{
