...
struct InteractiveMarker_
{
    ...
    explicit InteractiveMarker_(const ContainerAllocator& _alloc,
        ...
        : header(_alloc, _init), pose(_alloc, _init), name(_alloc), description(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->name = "";
    ...
    _scale_type scale;
    using _menu_entries_type = std::vector<visualization_msgs::msg::MenuEntry_<ContainerAllocator>,
    ...
    using _controls_type = std::vector<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>,
                                       typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
    ...
    Type& set__menu_entries(const std::vector<visualization_msgs::msg::MenuEntry_<ContainerAllocator>,
                                              typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                                  visualization_msgs::msg::MenuEntry_<ContainerAllocator>>>& _arg)
    {
        this->menu_entries = _arg;
        return *this;
    }
    Type& set__controls(const std::vector<visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>,
                                          typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                              visualization_msgs::msg::InteractiveMarkerControl_<ContainerAllocator>>>& _arg)
    {
        this->controls = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator> const>;
...
using InteractiveMarker = visualization_msgs::msg::InteractiveMarker_<std::allocator<void>>;
