...
{
public:
    explicit Init_MenuEntry_command_type(::visualization_msgs::msg::MenuEntry& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MenuEntry_command(::visualization_msgs::msg::MenuEntry& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MenuEntry_title(::visualization_msgs::msg::MenuEntry& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_MenuEntry_parent_id(::visualization_msgs::msg::MenuEntry& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MenuEntry_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::MenuEntry>()
{
