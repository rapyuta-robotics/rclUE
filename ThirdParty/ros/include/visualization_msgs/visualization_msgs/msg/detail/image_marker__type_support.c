...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_member_array[13] = {
            {
                "header",                                                  // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_members = {
            ...
            visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_member_array,    // message
                                                                                                                           // members
            visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_init_function,    // function to
                                                                                                                    // initialize
                                                                                                                    // message
                                                                                                                    // memory
                                                                                                                    // (memory has
                                                                                                                    // to be
                                                                                                                    // allocated)
            visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_fini_function     // function to
                                                                                                                    // terminate
                                                                                                                    // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_type_support_handle = {
            0,
            &visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, visualization_msgs, msg, ImageMarker)()
    {
        ...
        visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_member_array[12].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, ColorRGBA)();
        if (!visualization_msgs__msg__ImageMarker__rosidl_typesupport_introspection_c__ImageMarker_message_type_support_handle
