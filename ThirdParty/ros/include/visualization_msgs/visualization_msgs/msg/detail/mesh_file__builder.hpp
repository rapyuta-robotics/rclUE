...
{
public:
    explicit Init_MeshFile_data(::visualization_msgs::msg::MeshFile& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_MeshFile_filename() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::MeshFile>()
{
