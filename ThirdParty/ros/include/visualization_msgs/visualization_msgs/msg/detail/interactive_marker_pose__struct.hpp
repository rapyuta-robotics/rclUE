...
struct InteractiveMarkerPose_
{
    ...
    explicit InteractiveMarkerPose_(
    ...
    explicit InteractiveMarkerPose_(
        ...
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
        : header(_alloc, _init), pose(_alloc, _init), name(_alloc)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
            this->name = "";
    ...
    // pointer types
    using RawPtr = visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>>>
    using UniquePtrWithDeleter = std::unique_ptr<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>, Deleter>;
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::msg::InteractiveMarkerPose_<ContainerAllocator> const>;
...
using InteractiveMarkerPose = visualization_msgs::msg::InteractiveMarkerPose_<std::allocator<void>>;
