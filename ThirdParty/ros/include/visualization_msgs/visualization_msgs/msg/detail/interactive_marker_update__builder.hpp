...
{
public:
    explicit Init_InteractiveMarkerUpdate_erases(::visualization_msgs::msg::InteractiveMarkerUpdate& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerUpdate_poses(::visualization_msgs::msg::InteractiveMarkerUpdate& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerUpdate_markers(::visualization_msgs::msg::InteractiveMarkerUpdate& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerUpdate_type(::visualization_msgs::msg::InteractiveMarkerUpdate& msg) : msg_(msg)
    {
    }
...
{
public:
    explicit Init_InteractiveMarkerUpdate_seq_num(::visualization_msgs::msg::InteractiveMarkerUpdate& msg) : msg_(msg)
    {
    }
...
{
public:
    Init_InteractiveMarkerUpdate_server_id() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
...
template<>
inline auto build<::visualization_msgs::msg::InteractiveMarkerUpdate>()
{
