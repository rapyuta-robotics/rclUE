...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerFeedback__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerFeedback__fini(
        visualization_msgs__msg__InteractiveMarkerFeedback* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__InteractiveMarkerFeedback*
    visualization_msgs__msg__InteractiveMarkerFeedback__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerFeedback__destroy(
        visualization_msgs__msg__InteractiveMarkerFeedback* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerFeedback__are_equal(
        const visualization_msgs__msg__InteractiveMarkerFeedback* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerFeedback__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__fini(
        visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__InteractiveMarkerFeedback__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__destroy(
        visualization_msgs__msg__InteractiveMarkerFeedback__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__copy(
