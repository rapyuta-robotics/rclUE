...
#include <stdlib.h>
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerControl__init(
        visualization_msgs__msg__InteractiveMarkerControl* msg);

    /// Finalize msg/InteractiveMarkerControl message.
    /**
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerControl__fini(
        visualization_msgs__msg__InteractiveMarkerControl* msg);
     ...
     * otherwise NULL
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__InteractiveMarkerControl*
    visualization_msgs__msg__InteractiveMarkerControl__create();
     ...
     * \param[in,out] msg The allocated message pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerControl__destroy(
        visualization_msgs__msg__InteractiveMarkerControl* msg);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerControl__are_equal(
        const visualization_msgs__msg__InteractiveMarkerControl* lhs,
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerControl__copy(
     ...
     * If the array pointer is valid and the size is zero it is guaranteed
     # to return true.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerControl__Sequence__init(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerControl__Sequence__fini(
        visualization_msgs__msg__InteractiveMarkerControl__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs visualization_msgs__msg__InteractiveMarkerControl__Sequence*
     ...
     * \param[in,out] array The initialized array pointer.
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs void visualization_msgs__msg__InteractiveMarkerControl__Sequence__destroy(
        visualization_msgs__msg__InteractiveMarkerControl__Sequence* array);
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerControl__Sequence__are_equal(
     ...
     */
    ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs bool visualization_msgs__msg__InteractiveMarkerControl__Sequence__copy(
