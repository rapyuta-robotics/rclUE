...
extern "C"
{
    ...
    get_serialized_size_visualization_msgs__msg__InteractiveMarkerPose(const void* untyped_ros_message, size_t current_alignment);

    ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_visualization_msgs size_t
    max_serialized_size_visualization_msgs__msg__InteractiveMarkerPose(bool& full_bounded,
                                                                       bool& is_plain,
