...
bool visualization_msgs__msg__InteractiveMarkerControl__are_equal(const visualization_msgs__msg__InteractiveMarkerControl* lhs,
                                                                  const visualization_msgs__msg__InteractiveMarkerControl* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
    ...
    // orientation
    if (!geometry_msgs__msg__Quaternion__are_equal(&(lhs->orientation), &(rhs->orientation)))
    {
        return false;
    }
    // orientation_mode
    ...
    // markers
    if (!visualization_msgs__msg__Marker__Sequence__are_equal(&(lhs->markers), &(rhs->markers)))
    {
        return false;
    }
    // independent_marker_orientation
...
bool visualization_msgs__msg__InteractiveMarkerControl__copy(const visualization_msgs__msg__InteractiveMarkerControl* input,
                                                             visualization_msgs__msg__InteractiveMarkerControl* output)
{
    ...
    // orientation
    if (!geometry_msgs__msg__Quaternion__copy(&(input->orientation), &(output->orientation)))
    {
        return false;
    }
    // orientation_mode
    ...
    // markers
    if (!visualization_msgs__msg__Marker__Sequence__copy(&(input->markers), &(output->markers)))
    {
        return false;
    }
    // independent_marker_orientation
...
visualization_msgs__msg__InteractiveMarkerControl* visualization_msgs__msg__InteractiveMarkerControl__create()
{
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (visualization_msgs__msg__InteractiveMarkerControl*)allocator.zero_allocate(
...
visualization_msgs__msg__InteractiveMarkerControl__Sequence* visualization_msgs__msg__InteractiveMarkerControl__Sequence__create(
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__msg__InteractiveMarkerControl__Sequence* array =
        (visualization_msgs__msg__InteractiveMarkerControl__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__msg__InteractiveMarkerControl__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__msg__InteractiveMarkerControl__Sequence__destroy(
    visualization_msgs__msg__InteractiveMarkerControl__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__msg__InteractiveMarkerControl__Sequence__are_equal(
    const visualization_msgs__msg__InteractiveMarkerControl__Sequence* lhs,
    const visualization_msgs__msg__InteractiveMarkerControl__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool visualization_msgs__msg__InteractiveMarkerControl__Sequence__copy(
    ...
    visualization_msgs__msg__InteractiveMarkerControl__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__msg__InteractiveMarkerControl);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ...
    {
        if (!visualization_msgs__msg__InteractiveMarkerControl__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
