...
extern "C"
{
    ...
    {
        const geometry_msgs__msg__Point__Sequence* member = (const geometry_msgs__msg__Point__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__points(void* untyped_member,
                                                                                                            size_t index)
    {
        geometry_msgs__msg__Point__Sequence* member = (geometry_msgs__msg__Point__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        const geometry_msgs__msg__Point* item =
            ((const geometry_msgs__msg__Point*)
                 visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_const_function__Marker__points(
                     untyped_member, index));
        geometry_msgs__msg__Point* value = (geometry_msgs__msg__Point*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        geometry_msgs__msg__Point* item =
            ((geometry_msgs__msg__Point*)
                 visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__points(untyped_member,
                                                                                                                   index));
        const geometry_msgs__msg__Point* value = (const geometry_msgs__msg__Point*)(untyped_value);
        *item = *value;
    }

    bool visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__resize_function__Marker__points(void* untyped_member,
                                                                                                              size_t size)
    {
        geometry_msgs__msg__Point__Sequence* member = (geometry_msgs__msg__Point__Sequence*)(untyped_member);
    ...
    size_t visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__size_function__Marker__colors(
        const void* untyped_member)
    {
        const std_msgs__msg__ColorRGBA__Sequence* member = (const std_msgs__msg__ColorRGBA__Sequence*)(untyped_member);
        return member->size;
    }
    ...
    void* visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__colors(void* untyped_member,
                                                                                                            size_t index)
    {
        std_msgs__msg__ColorRGBA__Sequence* member = (std_msgs__msg__ColorRGBA__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        const std_msgs__msg__ColorRGBA* item =
            ((const std_msgs__msg__ColorRGBA*)
                 visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_const_function__Marker__colors(
                     untyped_member, index));
        std_msgs__msg__ColorRGBA* value = (std_msgs__msg__ColorRGBA*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        std_msgs__msg__ColorRGBA* item =
            ((std_msgs__msg__ColorRGBA*)
                 visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__colors(untyped_member,
                                                                                                                   index));
        const std_msgs__msg__ColorRGBA* value = (const std_msgs__msg__ColorRGBA*)(untyped_value);
        *item = *value;
    }

    bool visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__resize_function__Marker__colors(void* untyped_member,
                                                                                                              size_t size)
    {
        std_msgs__msg__ColorRGBA__Sequence* member = (std_msgs__msg__ColorRGBA__Sequence*)(untyped_member);
        ...
        const visualization_msgs__msg__UVCoordinate* item =
            ((const visualization_msgs__msg__UVCoordinate*)
                 visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_const_function__Marker__uv_coordinates(
                     untyped_member, index));
        visualization_msgs__msg__UVCoordinate* value = (visualization_msgs__msg__UVCoordinate*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        visualization_msgs__msg__UVCoordinate* item =
            ((visualization_msgs__msg__UVCoordinate*)
                 visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__uv_coordinates(
                     untyped_member, index));
        const visualization_msgs__msg__UVCoordinate* value = (const visualization_msgs__msg__UVCoordinate*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_message_member_array[19] = {
            {
                "header",                                                // name
            ...
            },
            {
                ...
                NULL,                                                    // default value
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__size_function__Marker__points,    // size()
                                                                                                                       // function
                                                                                                                       // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_const_function__Marker__points,    // get_const(index)
                                                                                                                            // function
                                                                                                                            // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__points,    // get(index)
                                                                                                                      // function
                                                                                                                      // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__fetch_function__Marker__points,    // fetch(index,
                                                                                                                        // &value)
                                                                                                                        // function
                                                                                                                        // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__assign_function__Marker__points,    // assign(index,
                                                                                                                         // value)
                                                                                                                         // function
                                                                                                                         // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__resize_function__Marker__points    // resize(index)
                                                                                                                        // function
                                                                                                                        // pointer
            },
            {
                ...
                NULL,                                                    // default value
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__size_function__Marker__colors,    // size()
                                                                                                                       // function
                                                                                                                       // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_const_function__Marker__colors,    // get_const(index)
                                                                                                                            // function
                                                                                                                            // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__colors,    // get(index)
                                                                                                                      // function
                                                                                                                      // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__fetch_function__Marker__colors,    // fetch(index,
                                                                                                                        // &value)
                                                                                                                        // function
                                                                                                                        // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__assign_function__Marker__colors,    // assign(index,
                                                                                                                         // value)
                                                                                                                         // function
                                                                                                                         // pointer
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__resize_function__Marker__colors    // resize(index)
                                                                                                                        // function
                                                                                                                        // pointer
            },
            {
            ...
            },
            {
                ...
                NULL,                                                         // default value
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__size_function__Marker__uv_coordinates,    // size()
                                                                                                                               // function
                                                                                                                               // pointer
                ...
                visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__get_function__Marker__uv_coordinates,    // get(index)
                                                                                                                              // function
                                                                                                                              // pointer
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_message_members = {
            ...
            visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_init_function,    // function to initialize
                                                                                                          // message memory (memory
                                                                                                          // has to be allocated)
            visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_fini_function     // function to terminate
    ...
    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_visualization_msgs const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, visualization_msgs, msg, Marker)()
    {
        ...
        visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_message_member_array[14].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, visualization_msgs, msg, UVCoordinate)();
        visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_message_member_array[17].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, visualization_msgs, msg, MeshFile)();
        if (!visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_message_type_support_handle
