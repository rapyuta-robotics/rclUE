...
bool visualization_msgs__msg__InteractiveMarkerInit__are_equal(const visualization_msgs__msg__InteractiveMarkerInit* lhs,
                                                               const visualization_msgs__msg__InteractiveMarkerInit* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool visualization_msgs__msg__InteractiveMarkerInit__copy(const visualization_msgs__msg__InteractiveMarkerInit* input,
...
visualization_msgs__msg__InteractiveMarkerInit* visualization_msgs__msg__InteractiveMarkerInit__create()
{
...
bool visualization_msgs__msg__InteractiveMarkerInit__Sequence__init(visualization_msgs__msg__InteractiveMarkerInit__Sequence* array,
                                                                    size_t size)
{
    if (!array)
    {
    ...
    if (size)
    {
        data = (visualization_msgs__msg__InteractiveMarkerInit*)allocator.zero_allocate(
...
void visualization_msgs__msg__InteractiveMarkerInit__Sequence__fini(visualization_msgs__msg__InteractiveMarkerInit__Sequence* array)
{
    if (!array)
    {
        return;
...
visualization_msgs__msg__InteractiveMarkerInit__Sequence* visualization_msgs__msg__InteractiveMarkerInit__Sequence__create(
    size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__msg__InteractiveMarkerInit__Sequence* array =
        (visualization_msgs__msg__InteractiveMarkerInit__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__msg__InteractiveMarkerInit__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__msg__InteractiveMarkerInit__Sequence__destroy(
    visualization_msgs__msg__InteractiveMarkerInit__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__msg__InteractiveMarkerInit__Sequence__are_equal(
    const visualization_msgs__msg__InteractiveMarkerInit__Sequence* lhs,
    const visualization_msgs__msg__InteractiveMarkerInit__Sequence* rhs)
{
    if (!lhs || !rhs)
    {
        return false;
...
bool visualization_msgs__msg__InteractiveMarkerInit__Sequence__copy(
    ...
    visualization_msgs__msg__InteractiveMarkerInit__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__msg__InteractiveMarkerInit);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
        visualization_msgs__msg__InteractiveMarkerInit* data =
            (visualization_msgs__msg__InteractiveMarkerInit*)allocator.reallocate(output->data, allocation_size, allocator.state);
        if (!data)
        {
            return false;
        }
    ...
    {
        if (!visualization_msgs__msg__InteractiveMarkerInit__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
