...
extern "C"
{
    ...
    void* visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__get_function__MarkerArray__markers(
        ...
        size_t index)
    {
        visualization_msgs__msg__Marker__Sequence* member = (visualization_msgs__msg__Marker__Sequence*)(untyped_member);
        return &member->data[index];
    }
        ...
        void* untyped_value)
    {
        const visualization_msgs__msg__Marker* item =
            ((const visualization_msgs__msg__Marker*)
                 visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__get_const_function__MarkerArray__markers(
                     untyped_member, index));
        visualization_msgs__msg__Marker* value = (visualization_msgs__msg__Marker*)(untyped_value);
        *value = *item;
    }
        ...
        const void* untyped_value)
    {
        visualization_msgs__msg__Marker* item =
            ((visualization_msgs__msg__Marker*)
                 visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__get_function__MarkerArray__markers(
                     untyped_member, index));
        const visualization_msgs__msg__Marker* value = (const visualization_msgs__msg__Marker*)(untyped_value);
        *item = *value;
    }
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_member_array[1] = {{
            "markers",                                                  // name
            ...
            NULL,                                                       // default value
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__size_function__MarkerArray__markers,    // size()
                                                                                                                              // function
                                                                                                                              // pointer
            ...
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__get_function__MarkerArray__markers,    // get(index)
                                                                                                                             // function
                                                                                                                             // pointer
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__fetch_function__MarkerArray__markers,    // fetch(index,
                                                                                                                               // &value)
                                                                                                                               // function
                                                                                                                               // pointer
            ...
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__resize_function__MarkerArray__markers    // resize(index)
                                                                                                                               // function
                                                                                                                               // pointer
        }};
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_members = {
            ...
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_member_array,    // message
                                                                                                                           // members
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_init_function,    // function to
                                                                                                                    // initialize
                                                                                                                    // message
                                                                                                                    // memory
                                                                                                                    // (memory has
                                                                                                                    // to be
                                                                                                                    // allocated)
            visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_fini_function     // function to
                                                                                                                    // terminate
                                                                                                                    // message
                                                                                                                   // instance (will
                                                                                                                   // not free
    ...
    static rosidl_message_type_support_t
        visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_type_support_handle = {
            0,
            &visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_members,
    ...
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, visualization_msgs, msg, MarkerArray)()
    {
        visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_member_array[0].members_ =
            ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, visualization_msgs, msg, Marker)();
        if (!visualization_msgs__msg__MarkerArray__rosidl_typesupport_introspection_c__MarkerArray_message_type_support_handle
