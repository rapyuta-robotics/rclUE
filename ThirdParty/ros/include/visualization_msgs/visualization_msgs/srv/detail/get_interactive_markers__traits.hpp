...
inline void to_flow_style_yaml(const GetInteractiveMarkers_Request& msg, std::ostream& out)
{
    (void)msg;
    out << "null";
}    // NOLINT(readability/fn_size)

inline void to_block_style_yaml(const GetInteractiveMarkers_Request& msg, std::ostream& out, size_t indentation = 0)
{
    (void)msg;
    (void)indentation;
    out << "null\n";
...
[[deprecated("use visualization_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const visualization_msgs::srv::GetInteractiveMarkers_Request& msg, std::ostream& out, size_t indentation = 0)
{
    visualization_msgs::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use visualization_msgs::srv::to_yaml() instead")]] inline std::string to_yaml(
...
template<>
struct has_fixed_size<visualization_msgs::srv::GetInteractiveMarkers_Request> : std::integral_constant<bool, true>
{
};

template<>
struct has_bounded_size<visualization_msgs::srv::GetInteractiveMarkers_Request> : std::integral_constant<bool, true>
{
};

template<>
struct is_message<visualization_msgs::srv::GetInteractiveMarkers_Request> : std::true_type
{
};
...
inline void to_flow_style_yaml(const GetInteractiveMarkers_Response& msg, std::ostream& out)
{
    out << "{";
...
inline void to_block_style_yaml(const GetInteractiveMarkers_Response& msg, std::ostream& out, size_t indentation = 0)
{
    // member: sequence_number
    {
        if (indentation > 0)
...
[[deprecated("use visualization_msgs::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const visualization_msgs::srv::GetInteractiveMarkers_Response& msg, std::ostream& out, size_t indentation = 0)
{
    visualization_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
template<>
struct has_fixed_size<visualization_msgs::srv::GetInteractiveMarkers_Response> : std::integral_constant<bool, false>
{
};

template<>
struct has_bounded_size<visualization_msgs::srv::GetInteractiveMarkers_Response> : std::integral_constant<bool, false>
{
};

template<>
struct is_message<visualization_msgs::srv::GetInteractiveMarkers_Response> : std::true_type
{
};
...
template<>
struct is_service<visualization_msgs::srv::GetInteractiveMarkers> : std::true_type
{
};

template<>
struct is_service_request<visualization_msgs::srv::GetInteractiveMarkers_Request> : std::true_type
{
};

template<>
struct is_service_response<visualization_msgs::srv::GetInteractiveMarkers_Response> : std::true_type
{
};
