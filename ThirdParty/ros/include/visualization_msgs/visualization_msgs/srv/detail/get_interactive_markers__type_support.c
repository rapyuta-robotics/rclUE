...
extern "C"
{
    ...
    void
    visualization_msgs__srv__GetInteractiveMarkers_Request__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Request_init_function(
        void* message_memory,
    ...
    void
    visualization_msgs__srv__GetInteractiveMarkers_Request__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Request_fini_function(
        void* message_memory)
    {
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        visualization_msgs__srv__GetInteractiveMarkers_Request__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Request_message_member_array
            [1] = {{
                ...
                offsetof(visualization_msgs__srv__GetInteractiveMarkers_Request,
    ...
    {
        if (!visualization_msgs__srv__GetInteractiveMarkers_Request__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Request_message_type_support_handle
...
extern "C"
{
    ...
    void
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Response_init_function(
        void* message_memory,
        enum rosidl_runtime_c__message_initialization _init)
    {
        // TODO(karsten1987): initializers are not yet implemented for typesupport c
    ...
    void
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Response_fini_function(
        void* message_memory)
    {
    ...
    size_t
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__size_function__GetInteractiveMarkers_Response__markers(
    ...
    const void*
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__get_const_function__GetInteractiveMarkers_Response__markers(
        const void* untyped_member,
        size_t index)
    {
        const visualization_msgs__msg__InteractiveMarker__Sequence* member =
    ...
    void*
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__get_function__GetInteractiveMarkers_Response__markers(
        void* untyped_member,
        size_t index)
    {
    ...
    void
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__fetch_function__GetInteractiveMarkers_Response__markers(
        const void* untyped_member,
        size_t index,
        void* untyped_value)
    {
    ...
    void
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__assign_function__GetInteractiveMarkers_Response__markers(
        void* untyped_member,
        size_t index,
    ...
    bool
    visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__resize_function__GetInteractiveMarkers_Response__markers(
        void* untyped_member,
        size_t size)
    {
        visualization_msgs__msg__InteractiveMarker__Sequence* member =
    ...
    static rosidl_typesupport_introspection_c__MessageMember visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Response_message_member_array
        [2] = {
            {
    ...
    {
        visualization_msgs__srv__GetInteractiveMarkers_Response__rosidl_typesupport_introspection_c__GetInteractiveMarkers_Response_message_member_array
            [1]
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_visualization_msgs const rosidl_service_type_support_t*
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c,
                                                  visualization_msgs,
                                                  srv,
                                                  GetInteractiveMarkers)()
{
    if (!visualization_msgs__srv__detail__get_interactive_markers__rosidl_typesupport_introspection_c__GetInteractiveMarkers_service_type_support_handle
             .typesupport_identifier)
    {
        visualization_msgs__srv__detail__get_interactive_markers__rosidl_typesupport_introspection_c__GetInteractiveMarkers_service_type_support_handle
            .typesupport_identifier = rosidl_typesupport_introspection_c__identifier;
    ...
    if (!service_members->request_members_)
    {
        service_members->request_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, visualization_msgs, srv, GetInteractiveMarkers_Request)()
                ->data;
    }
    if (!service_members->response_members_)
    {
        service_members->response_members_ =
            (const rosidl_typesupport_introspection_c__MessageMembers*)ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
                rosidl_typesupport_introspection_c, visualization_msgs, srv, GetInteractiveMarkers_Response)()
                ->data;
    }
