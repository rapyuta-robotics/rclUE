...
void GetInteractiveMarkers_Request_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetInteractiveMarkers_Request_message_member_array[1] = {{
    ...
    offsetof(visualization_msgs::srv::GetInteractiveMarkers_Request,
...
{
    return &::visualization_msgs::srv::rosidl_typesupport_introspection_cpp::
...
void GetInteractiveMarkers_Response_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
void fetch_function__GetInteractiveMarkers_Response__markers(const void* untyped_member, size_t index, void* untyped_value)
{
...
void assign_function__GetInteractiveMarkers_Response__markers(void* untyped_member, size_t index, const void* untyped_value)
{
