...
bool visualization_msgs__srv__GetInteractiveMarkers_Request__are_equal(
...
bool visualization_msgs__srv__GetInteractiveMarkers_Request__copy(
...
visualization_msgs__srv__GetInteractiveMarkers_Request* visualization_msgs__srv__GetInteractiveMarkers_Request__create()
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__srv__GetInteractiveMarkers_Request* msg =
        (visualization_msgs__srv__GetInteractiveMarkers_Request*)allocator.allocate(
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (visualization_msgs__srv__GetInteractiveMarkers_Request*)allocator.zero_allocate(
...
visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence* array =
        (visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence__destroy(
    visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence__are_equal(
...
bool visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence__copy(
    ...
    visualization_msgs__srv__GetInteractiveMarkers_Request__Sequence* output)
{
    ...
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__srv__GetInteractiveMarkers_Request);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ...
    {
        if (!visualization_msgs__srv__GetInteractiveMarkers_Request__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
...
bool visualization_msgs__srv__GetInteractiveMarkers_Response__are_equal(
    ...
    const visualization_msgs__srv__GetInteractiveMarkers_Response* rhs)
{
    ...
    // markers
    if (!visualization_msgs__msg__InteractiveMarker__Sequence__are_equal(&(lhs->markers), &(rhs->markers)))
    {
        return false;
    }
    return true;
...
bool visualization_msgs__srv__GetInteractiveMarkers_Response__copy(
    ...
    visualization_msgs__srv__GetInteractiveMarkers_Response* output)
{
    ...
    // markers
    if (!visualization_msgs__msg__InteractiveMarker__Sequence__copy(&(input->markers), &(output->markers)))
    {
        return false;
    }
    return true;
...
visualization_msgs__srv__GetInteractiveMarkers_Response* visualization_msgs__srv__GetInteractiveMarkers_Response__create()
{
    ...
    visualization_msgs__srv__GetInteractiveMarkers_Response* msg =
        (visualization_msgs__srv__GetInteractiveMarkers_Response*)allocator.allocate(
    ...
    size_t size)
{
    ...
    if (size)
    {
        data = (visualization_msgs__srv__GetInteractiveMarkers_Response*)allocator.zero_allocate(
...
visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence__create(size_t size)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence* array =
        (visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence*)allocator.allocate(
            sizeof(visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence), allocator.state);
    if (!array)
    {
        return NULL;
    }
...
void visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence__destroy(
    visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence* array)
{
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    if (array)
...
bool visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence__are_equal(
...
bool visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence__copy(
    ...
    visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence* output)
{
    ...
    if (output->capacity < input->size)
    {
        const size_t allocation_size = input->size * sizeof(visualization_msgs__srv__GetInteractiveMarkers_Response);
        rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ...
    for (size_t i = 0; i < input->size; ++i)
    {
        if (!visualization_msgs__srv__GetInteractiveMarkers_Response__copy(&(input->data[i]), &(output->data[i])))
        {
            return false;
        }
    }
