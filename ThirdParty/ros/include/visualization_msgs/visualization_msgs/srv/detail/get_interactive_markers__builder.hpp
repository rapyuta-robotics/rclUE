...
template<>
inline auto build<::visualization_msgs::srv::GetInteractiveMarkers_Request>()
{
...
{
public:
    explicit Init_GetInteractiveMarkers_Response_markers(::visualization_msgs::srv::GetInteractiveMarkers_Response& msg) : msg_(msg)
    {
    }
    ::visualization_msgs::srv::GetInteractiveMarkers_Response markers(
        ::visualization_msgs::srv::GetInteractiveMarkers_Response::_markers_type arg)
    {
...
{
public:
    Init_GetInteractiveMarkers_Response_sequence_number() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
    {
    }
    Init_GetInteractiveMarkers_Response_markers sequence_number(
        ::visualization_msgs::srv::GetInteractiveMarkers_Response::_sequence_number_type arg)
    {
...
template<>
inline auto build<::visualization_msgs::srv::GetInteractiveMarkers_Response>()
{
