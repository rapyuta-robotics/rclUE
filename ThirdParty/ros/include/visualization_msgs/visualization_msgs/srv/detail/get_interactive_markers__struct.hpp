...
struct GetInteractiveMarkers_Request_
{
    ...
    explicit GetInteractiveMarkers_Request_(
    ...
    // pointer types
    using RawPtr = visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator>>>
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::srv::GetInteractiveMarkers_Request_<ContainerAllocator> const>;
...
using GetInteractiveMarkers_Request = visualization_msgs::srv::GetInteractiveMarkers_Request_<std::allocator<void>>;
...
struct GetInteractiveMarkers_Response_
{
    ...
    explicit GetInteractiveMarkers_Response_(
        rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
    {
        if (rosidl_runtime_cpp::MessageInitialization::ALL == _init || rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
        {
    ...
    // field types and members
    using _sequence_number_type = uint64_t;
    _sequence_number_type sequence_number;
    using _markers_type = std::vector<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>,
    ...
    Type& set__sequence_number(const uint64_t& _arg)
    {
        this->sequence_number = _arg;
        return *this;
    }
    Type& set__markers(const std::vector<visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>,
                                         typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
                                             visualization_msgs::msg::InteractiveMarker_<ContainerAllocator>>>& _arg)
    {
        this->markers = _arg;
        return *this;
    }
    ...
    // pointer types
    using RawPtr = visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator>*;
    using ConstRawPtr = const visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator>*;
    using SharedPtr = std::shared_ptr<visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator>>;
    using ConstSharedPtr = std::shared_ptr<visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator> const>;

    template<typename Deleter = std::default_delete<visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator>>>
    using UniquePtrWithDeleter =
    ...
    using WeakPtr = std::weak_ptr<visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator>>;
    using ConstWeakPtr = std::weak_ptr<visualization_msgs::srv::GetInteractiveMarkers_Response_<ContainerAllocator> const>;
...
// alias to use template instance with default allocator
using GetInteractiveMarkers_Response = visualization_msgs::srv::GetInteractiveMarkers_Response_<std::allocator<void>>;
