...
extern "C"
{
    ...
    static rosidl_typesupport_introspection_c__MessageMember
        rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_message_member_array[1] = {{
            "clock",                                                 // name
    ...
    static const rosidl_typesupport_introspection_c__MessageMembers
        rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_message_members = {
            ...
            rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_init_function,    // function to initialize message
                                                                                                   // memory (memory has to be
                                                                                                   // allocated)
            rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_fini_function     // function to terminate message
    ...
    static rosidl_message_type_support_t
        rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_message_type_support_handle = {
            0,
            &rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_message_members,
            get_message_typesupport_handle_function,
    };

    ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rosgraph_msgs const rosidl_message_type_support_t*
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosgraph_msgs, msg, Clock)()
    {
        ...
        if (!rosgraph_msgs__msg__Clock__rosidl_typesupport_introspection_c__Clock_message_type_support_handle
