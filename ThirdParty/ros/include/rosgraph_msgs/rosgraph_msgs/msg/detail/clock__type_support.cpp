...
void Clock_init_function(void* message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Clock_message_member_array[1] = {{
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<builtin_interfaces::msg::Time>(),    // members of sub
                                                                                                                 // message
    false,                                                                                                       // is array
    0,                                                                                                           // array size
