...
inline void to_flow_style_yaml(const Clock& msg, std::ostream& out)
{
    out << "{";
    // member: clock
    {
...
inline void to_block_style_yaml(const Clock& msg, std::ostream& out, size_t indentation = 0)
{
    // member: clock
    {
        if (indentation > 0)
...
[[deprecated("use rosgraph_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(const rosgraph_msgs::msg::Clock& msg,
                                                                                            std::ostream& out,
...
[[deprecated("use rosgraph_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(const rosgraph_msgs::msg::Clock& msg)
{
...
template<>
struct is_message<rosgraph_msgs::msg::Clock> : std::true_type
{
};
