...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosgraph_msgs cdr_serialize(const rosgraph_msgs::msg::Clock& ros_message,
                                                                        eprosima::fastcdr::Cdr& cdr);

bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosgraph_msgs cdr_deserialize(eprosima::fastcdr::Cdr& cdr,
                                                                          rosgraph_msgs::msg::Clock& ros_message);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosgraph_msgs get_serialized_size(const rosgraph_msgs::msg::Clock& ros_message,
                                                                                size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosgraph_msgs max_serialized_size_Clock(bool& full_bounded,
                                                                                      bool& is_plain,
                                                                                      size_t current_alignment);
...
extern "C"
{
    ...
    ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosgraph_msgs const rosidl_message_type_support_t*
